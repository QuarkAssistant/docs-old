...
```json
{
  ...
  "supplier_part_numbers": {
    "minim_71b": [
      "laborum sint ea sunt officia",
      "Ut in elit",
      "nostrud labore pariatur tempor",
      "do ex Ut"
    ]
  }
}
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["velit non officia enim Ut"],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 81719843.80456689
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "amet ut velit Ut incididunt",
  "supplier_part_numbers": {
    "sunt_8a5": [
      "Excepteur",
      "veniam",
      "magna labore fugiat",
      "aute nisi mollit incididunt fugiat",
      "deserunt cupidatat aliquip est eiusmod"
    ],
    "qui51": [
      "deserunt",
      "enim id",
      "cupidatat quis incididunt labore sint",
      "sed amet reprehenderit"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "autea": [
      "occaecat quis Duis aliqua",
      "in sed laborum nostrud",
      "deserunt mollit cillum dolor",
      "laborum mollit fugiat dolor esse"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "id in cupidatat quis",
  "supplier_part_numbers": {
    "occaecat__": [
      "nisi cupidatat",
      "incididunt ea dolor consequat fugiat",
      "dolore aliqua aliquip laboris",
      "cillum sed in amet eu",
      "dolor in quis"
    ],
    "do_e": [
      "ad adipisicing",
      "aliqua velit nostrud adipisicing",
      "esse magna laborum nulla dolore",
      "amet"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "sunt laboris occaecat",
  "supplier_part_numbers": {
    "in6": [],
    "dolor_6c": [
      "et sed sit Ut enim",
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "sunt_8": ["commodo eiusmod nisi anim", "anim", "sed dolor aliquip velit"],
    "esse_300": ["in ut", "dolor", "occaecat", "officia"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "veniamb2": [
      "nulla sunt consectetur ea consequat",
      "ad consectetur mollit sed in",
      "laborum qui",
...
```json
{
  ...
  "connected_source_port_ids": [
    "cillum sed",
    "minim irure et",
    "laboris cillum adipisicing eiusmod ipsum"
  ],
  "connected_source_net_ids": ["enim amet in ad", "pariatur adipisicing"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 21433617.79379362,
  "pin_styles": {},
  "box_width": 85083344.5000565,
  "symbol_name": "nulla commodo ad anim",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "eiusmod qui cupidatat ea"
}
```
...
```json
{
  ...
  "radius_x": "occaecat Excepteur cillum deserunt ut",
  "radius_y": 8688430.766126126,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "irure dolore mollit labore",
  "supplier_part_numbers": {
    "eiusmod_55b": [
      "nisi id reprehenderit",
      "nulla ut consectetur proident magna",
      "sint labore"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "occaecat in ut ullamco cupidatat"
  },
  "layer": "top",
  "footprinter_string": "qui anim",
  "model_stl_url": "officia non",
  "model_3mf_url": "enim Duis id dolor sit"
}
```
...
{
  "nulla_834": {
    "left_margin": -98280985.22783013,
    "right_margin": "quis",
    "top_margin": -69704489.93893515,
    "bottom_margin": 38095147.79616475
  }
}
```
