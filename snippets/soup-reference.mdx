...
```json
{
  ...
  "name": "E1",
  "manufacturer_part_number": "amet consequat sit aliqua",
  "supplier_part_numbers": {
    "in_2a": ["mollit in Ut fugiat minim", "in voluptate qui mollit"],
    "Loremb3": ["sed", "officia non culpa nulla adipisicing"],
    "et_32": ["velit eu laborum nostrud minim", "velit mollit Excepteur sunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "commodo voluptate ex ea do",
  "supplier_part_numbers": {
    "do_2": [
      "ex Duis sit reprehenderit veniam",
      "irure Duis voluptate adipisicing ipsum",
      "Duis magna est",
      "ipsum sed in minim aute",
      "nisi ut culpa sed"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "amet_e56": ["fugiat voluptate", "esse", "veniam sint", "proident laboris"],
    "fugiat2ea": [
      "nostrud non reprehenderit esse dolor",
      "magna mollit quis ad",
      "aliquip qui occaecat",
      "dolore elit do"
    ],
    "quise": ["aute esse sed sit", "mollit dolor in qui elit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "et enim consectetur",
  "supplier_part_numbers": {
    "nisi_": ["cillum in", "eu dolor sed do"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "tempor sit commodo"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "est enim exercitation",
  "supplier_part_numbers": {
    "eiusmod98c": ["consequat occaecat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "aliqua nisi commodo aute",
  "supplier_part_numbers": {
    "laborise": [],
    "Lorem8f1": ["incididunt mollit", "proident esse Excepteur consequat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "in in est ut proident",
  "supplier_part_numbers": {
    "enim6": [
      "do ad velit",
      "Duis quis in",
      "reprehenderit sunt ullamco",
      "incididunt consectetur",
      "ut et non adipisicing"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "id officia nulla",
  "supplier_part_numbers": {
    "dolor4": [
      "est nostrud",
      "laboris cupidatat occaecat proident",
      "sit ullamco veniam"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "irure pariatur ut cupidatat",
    "commodo Duis aliqua ex proident"
  ],
  "connected_source_net_ids": ["ex ut in consectetur"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 71080528.40520832,
  "pin_styles": {},
  "box_width": -44539425.21174446,
  "symbol_name": "eu labore pariatur",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "color": "reprehenderit eiusmod aute voluptate ipsum"
}
```
...
```json
{
  ...
  "message": "laborum minim labore aliquip"
}
```
...
```json
{
  ...
  "radius_x": "Excepteur voluptate",
  "radius_y": -75247880.29982643,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "ipsum Lorem in dolore nisi",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "footprinter_string": "quis est ut ex",
  "model_obj_url": "quis"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "officia id deserunt"
}
```
...
{
  "dolor_c4": {
    "left_margin": -39195732.450538754
  }
}
```
