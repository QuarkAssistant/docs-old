...
```json
{
  ...
  "name": "Q1",
  "manufacturer_part_number": "elit consequat",
  "supplier_part_numbers": {
    "dolore9": [],
    "aliquip_80": [
      "culpa Duis laborum aute",
      "anim Excepteur voluptate",
      "dolor minim nulla",
      "Lorem fugiat laboris ut",
      "Ut labore"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "fugiat id ad",
  "supplier_part_numbers": {
    "cupidatatc": ["sed nostrud laboris enim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "et quis dolor ullamco nostrud"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "consequat ullamco",
  "supplier_part_numbers": {
    "in_3": [
      "laboris proident ullamco deserunt",
      "pariatur est occaecat",
      "elit eiusmod amet"
    ],
    "nulla_a7": [
      "culpa elit incididunt eiusmod",
      "minim",
      "velit qui voluptate officia pariatur",
      "aute ut in",
      "Duis eiusmod dolor laboris adipisicing"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "commodo do nulla",
  "supplier_part_numbers": {
    "aliquip_82": [
      "ipsum in magna",
      "in consequat incididunt",
      "exercitation anim minim consequat",
      "cupidatat fugiat in exercitation"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ea ut",
  "supplier_part_numbers": {
    "laboris_a": ["cupidatat amet"],
    "consequat_f0": [
      "voluptate mollit occaecat velit commodo",
      "mollit anim ex elit laboris",
      "magna",
      "non",
      "velit quis ipsum eiusmod est"
    ],
    "qui_f8c": [
      "eiusmod",
      "sit",
      "dolor sit proident cillum Ut",
      "amet aute sunt"
    ],
    "Excepteur3f7": [
      "dolore ex",
      "pariatur dolor",
      "culpa reprehenderit Excepteur irure"
    ],
    "deserunt_b": [
      "est nostrud in eu officia",
      "exercitation labore adipisicing elit",
      "nisi sit",
      "exercitation aliqua"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "adipisicing voluptate veniam",
  "supplier_part_numbers": {
    "velit8b7": [
      "eu irure ipsum nostrud",
      "officia eu irure ut consectetur",
      "occaecat minim",
      "anim Duis nisi occaecat"
    ],
    "enim_1": [
      "Ut tempor",
      "officia veniam nisi",
      "pariatur mollit ipsum id labore",
      "elit id reprehenderit quis"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "occaecat4": ["occaecat mollit ex"],
    "in_60": [
      "sint aute aliqua ex",
      "exercitation dolore anim Duis",
      "exercitation Ut"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_net_ids": [
    ...
    "ut",
    "aute in",
    "magna commodo dolore sit officia"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "cupidatat nisi voluptate dolore",
  "pin_styles": {},
  "box_width": -71626559.31227367,
  "symbol_name": "officia ut Duis",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "color": "in laboris irure Excepteur"
}
```
...
```json
{
  ...
  "message": "voluptate quis minim sunt nostrud"
}
```
...
```json
{
  ...
  "radius_x": "proident sunt",
  "radius_y": "laborum amet aliqua",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "consequat laboris consectetur ad",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "et proident Duis Excepteur labore",
  "supplier_part_numbers": {
    "ullamco_8": [
      "amet",
      "mollit Excepteur cillum",
      "dolore ullamco id pariatur",
      "eu amet ea",
      "consectetur"
    ],
    "in_63d": [
      "in non in proident id",
      "aliqua",
      "ad adipisicing non esse",
      "ut eiusmod",
      "pariatur et"
    ]
  }
...
```json
{
  ...
  "model_obj_url": "eiusmod esse et aliqua in"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "veniam cupidatat id"
}
```
...
```json
{
  "type": "pcb_plated_hole",
  "shape": "pill",
  "outer_width": 83211494.11359379,
  "outer_height": 81649459.35183877,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "labore_470": {
    "left_margin": "ut non est anim eiusmod",
    "right_margin": "ut velit aliquip reprehenderit Duis",
    "top_margin": -80092832.50949517,
    "bottom_margin": "voluptate ad"
  },
  "aliqua_e9": {
    "right_margin": "esse",
    "top_margin": -90529126.67144448,
    "bottom_margin": "magna eu nulla"
  }
}
```
