...
```json
{
  ...
  "member_source_group_ids": [
    "eu esse",
    "sint eiusmod et",
    "enim culpa dolor ipsum",
    "anim ut",
    "deserunt aliqua dolor eiusmod ad"
  ],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": -2254606.051714614
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "nisi ut qui in",
  "supplier_part_numbers": {
    "est234": ["proident"]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "supplier_part_numbers": {
    "utd": [],
    "do0_": [
      "consectetur aliqua et fugiat",
      "in dolor aliquip mollit",
      "sit in qui aliquip quis",
      "mollit labore aliqua elit",
      "Excepteur eiusmod commodo enim exercitation"
    ],
    "ine44": ["id", "occaecat", "in ut"],
    "laborum2bc": [
      "Ut",
      "sunt",
      "voluptate ullamco anim veniam",
      "aute occaecat",
      "officia"
    ]
  }
...
```json
{
  ...
  "supplier_part_numbers": {
    "et9": [
      "pariatur fugiat non esse aute",
      "aute aliqua labore voluptate tempor"
    ],
    "in_a3": ["Duis", "incididunt sed officia et"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "in ullamco ea",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "velit culpa in nulla sint",
  "supplier_part_numbers": {
    "deserunt_2a": [
      "consequat ad veniam magna ullamco",
      "culpa minim officia consequat laboris",
      "magna in ipsum",
      "dolor",
      "nostrud"
    ]
...
```json
{
  ...
  "connected_source_port_ids": [
    "qui ipsum elit irure",
    "in nostrud Excepteur consectetur",
    "laborum minim ut",
    "consectetur sed magna sunt",
    "ad in esse"
  ],
  "connected_source_net_ids": [
    "et in eiusmod",
    "cillum Excepteur ea Duis eu",
    "velit ea nisi in nulla",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -26756509.384209484,
  "pin_styles": {},
  "box_width": 41321694.83380616,
  "symbol_name": "pariatur eu amet incididunt veniam",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "color": "reprehenderit sunt adipisicing irure aliqua"
}
```
...
```json
{
  ...
  "radius_x": 74484121.59310186,
  "radius_y": -1124351.9943242073,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "voluptate aliquip nostrud veniam",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "dolore_9d": ["Lorem esse quis labore", "ea qui nulla ipsum magna"],
    "cupidatatb": ["nostrud nulla", "occaecat laborum reprehenderit esse"]
  }
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -649027.8545708209,
  "outer_height": 54042070.69288945,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "sunt345": {
    "left_margin": 8969361.11075814,
    "right_margin": "aliqua",
    "top_margin": 39558845.16908136,
    "bottom_margin": "eiusmod ut Ut do"
  }
}
```
