...
```json
{
  ...
  "name": "E1",
  "manufacturer_part_number": "ut voluptate fugiat incididunt",
  "supplier_part_numbers": {
    "irureae": [
      "dolore proident ex officia",
      "ut ipsum",
      "aliquip eu",
      "amet dolor in ex"
    ]
...
```json
{
  ...
  "supplier_part_numbers": {
    "amet_e": ["ex", "aliqua Ut fugiat", "in dolor nostrud consequat nulla"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "amet adipisicing nostrud elit eiusmod",
    "culpa deserunt",
    "in",
    "Duis in qui",
    "dolore"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cupidatat ut nisi Ut deserunt",
  "supplier_part_numbers": {
    "ad_0": ["Ut", "eiusmod", "ut"]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "supplier_part_numbers": {
    "reprehenderit42c": [
      "mollit incididunt ea est ut",
      "dolor minim ex",
      "aliquip eiusmod dolor nulla",
      "nisi incididunt"
    ],
    "Duis4d": [
      "commodo",
      "id est labore",
      "ipsum quis elit magna velit",
      "aute ut occaecat consequat",
    ...
    "in_6a3": [
      ...
      "elit irure exercitation anim"
    ],
    "et_ed": [
      "sit amet eu",
      "minim pariatur adipisicing esse",
      "dolor",
      "aute et"
    ],
    "amete0": ["aute reprehenderit officia veniam", "eu"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "quis sunt dolore",
  "supplier_part_numbers": {
    "voluptate_ada": [
      "in Duis laborum",
      "fugiat Excepteur sed sunt Duis",
      "nisi mollit voluptate ullamco enim"
    ],
    "Duis_ac": [
      "est proident aliqua non pariatur",
      "aliqua officia cillum",
      "nulla enim tempor fugiat nisi",
      "aliquip Lorem",
      "ipsum minim Duis quis"
    ],
    "amet_6_": [],
    "do__b": ["proident", "Duis exercitation", "tempor officia"],
    "site": ["cillum", "eu nostrud ea laboris proident"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "nostrud do eu ipsum quis",
  "supplier_part_numbers": {
    "non_c8": [
      "dolore nostrud amet id esse",
      "ex laborum ea",
      "ullamco sit elit in minim"
    ],
    "nostrud_e5": [],
    "ine45": ["reprehenderit amet eu in"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "est sunt",
  "supplier_part_numbers": {
    "aliqua_c6": [],
    "culpaacb": [
      "ut eu sint aliqua",
    ...
    "Duis_d": [],
    "magna_8c": ["Excepteur enim", "fugiat"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["sunt", "ipsum dolor ea cupidatat"],
  "connected_source_net_ids": [
    "Duis ut est mollit nisi",
    "voluptate",
    "aliquip id",
    "eu adipisicing"
  ]
...
```json
{
  ...
  "color": "ea ut nisi laborum voluptate"
}
```
...
```json
{
  ...
  "message": "ad qui mollit fugiat officia"
}
```
...
```json
{
  ...
  "message": "deserunt in consequat ex id",
...
```json
{
  ...
  "radius_x": 6150282.90097177,
  "radius_y": "occaecat eu pariatur",
  "layer": "top"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "enim velit Excepteur nulla in",
  "model_obj_url": "velit occaecat consequat aliqua eiusmod",
  "model_stl_url": "non ea veniam",
  "model_3mf_url": "laborum Duis et est",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "in Excepteur non minim sunt"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 67232736.82942614,
  "outer_height": 6130125.355958432,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "quis_d": {
    "left_margin": -16758571.565506756,
    "right_margin": "consequat Ut",
    "bottom_margin": "deserunt in est sint quis"
  },
  "sit_4": {
    "left_margin": "nisi adipisicing",
    "right_margin": "velit cupidatat non",
    "top_margin": -2103081.27858001,
    "bottom_margin": "tempor deserunt sunt"
  }
}
```
