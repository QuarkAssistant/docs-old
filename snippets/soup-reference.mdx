...
```json
{
  ...
  "name": "I1",
  "manufacturer_part_number": "ea velit",
  "supplier_part_numbers": {
    "utaf3": ["velit", "est", "aliquip sit laborum qui cupidatat"],
    "utf": []
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "adipisicing8": ["cupidatat nulla", "deserunt pariatur sit do in"],
    "fugiat_5": [
      "officia ullamco",
      "dolor eiusmod aliquip labore",
      "do est sed"
    ]
  }
}
...
```json
{
  ...
  "member_source_group_ids": [
    "commodo quis",
    "proident Ut in aliqua",
    "veniam Duis eu eiusmod anim",
    "labore esse anim magna exercitation"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "eiusmod aliquip",
  "supplier_part_numbers": {
    "occaecat43": [
      "elit fugiat dolor",
      "ad quis pariatur",
    ...
    "consequat8cc": ["labore voluptate"],
    "dolore96": [
      "proident incididunt enim",
      "ut minim eiusmod",
      "non",
      "laboris esse qui aliqua"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in quis voluptate non consectetur",
  "supplier_part_numbers": {
    "nisi_83": [
      "dolor ut dolore laboris id",
      "adipisicing laboris officia ea quis",
      "in anim commodo"
    ],
    "id_04": [],
    "elit93": [
      "esse",
      "quis",
      "occaecat ullamco reprehenderit velit",
      "ut aute nulla ex",
      "laborum"
    ]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "et nulla eu dolore",
  "supplier_part_numbers": {
    "ea846": [],
    "officia4": ["irure anim eiusmod", "laborum dolore voluptate"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat_b": [
      "cillum",
      "Excepteur qui",
      "consectetur eiusmod adipisicing ut",
      "est nostrud adipisicing veniam",
      "consectetur sunt in laboris"
    ],
    "do_e": [
      "officia",
      "ullamco amet veniam",
      "velit tempor et nulla fugiat",
      "reprehenderit sunt consectetur",
      "sed veniam officia elit occaecat"
    ],
    "culpa_3c": [
      "magna",
      "labore enim",
      "labore nisi qui culpa anim",
      "sint aliqua",
      "ut incididunt"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "aliqua veniam do"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "incididunt ut tempor",
  "supplier_part_numbers": {
    "laborumf": ["adipisicing Ut"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "qui elit",
  "supplier_part_numbers": {
    "nisi_f": ["sit qui", "Excepteur aliqua anim in"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "incididunt",
    "labore Excepteur",
    "eu eiusmod ipsum sint minim",
    "magna esse cupidatat"
  ],
  "connected_source_net_ids": ["minim elit"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -11733133.047942385,
  "pin_styles": {},
  "box_width": "adipisicing cupidatat",
  "symbol_name": "dolor qui mollit consequat exercitation",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "eu laboris veniam elit reprehenderit"
}
```
...
```json
{
  ...
  "color": "magna dolor nisi culpa ad"
}
```
...
```json
{
  ...
  "radius_x": "sint",
  "radius_y": "aliquip dolor ullamco",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "exercitation laboris in aliquip aute",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "tempor nulla commodo dolore laborum",
  "supplier_part_numbers": {
    "reprehenderit_8_": [
      "adipisicing proident mollit",
      "dolore laborum Ut",
      "consectetur ut fugiat ut aliquip",
      "enim",
      "deserunt dolor consectetur"
    ],
    "inf10": ["nisi commodo quis", "eu", "voluptate Ut", "ex quis sit"]
  }
}
```
...
```json
{
  ...
  "rotation": "90deg",
  "model_obj_url": "sunt aliqua nulla in",
  "model_stl_url": "enim adipisicing nisi eiusmod occaecat",
  "model_3mf_url": "amet minim consectetur",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "nisi quis nulla aliquip adipisicing"
}
```
...
{
  "eub": {
    "left_margin": "officia consequat dolore",
    "right_margin": "dolore",
    "top_margin": -17237075.909669384,
    "bottom_margin": "reprehenderit ullamco"
  },
  "culpa_d": {
    "left_margin": "quis in",
    "right_margin": -30220066.885767415,
    "top_margin": -34678891.40291565,
    "bottom_margin": -20467928.49884355
  },
  "Lorem_7d0": {
    "left_margin": "qui dolor",
    "right_margin": "Excepteur anim",
    "bottom_margin": "Excepteur sed"
  }
}
```
