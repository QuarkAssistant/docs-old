...
```json
{
  ...
  "ftype": "cupidatat Excepteur officia eu ut",
  "source_component_id": "source_component_1",
  "name": "C1",
  "supplier_part_numbers": {
    "dolor2e": [
      "sed incididunt veniam Ut",
      "irure",
      "non in ut consectetur voluptate",
      "in eiusmod adipisicing",
      "exercitation quis ut pariatur velit"
    ],
    "qui615": [],
    "incididunte": [
      "labore nulla do in consequat",
      "nisi cillum et",
      "laboris adipisicing tempor",
      "culpa reprehenderit labore cupidatat qui"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "et veniam dolor aliquip",
    "velit ut sint",
    "sed deserunt quis Duis"
  ],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -99686262.53651856
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ea ipsum magna ex cillum",
  "supplier_part_numbers": {
    "officia9_": ["esse"]
  }
}
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "aute78": ["ex dolore est nisi et", "minim et laboris"],
    "incididuntd1": [
      "ut occaecat magna sint qui",
      "aute dolore",
      "tempor",
      "Excepteur esse enim"
    ],
    "elit07": [
      "ex commodo Ut nisi Duis",
      "eiusmod proident nisi sit",
      "Lorem dolor quis",
      "do qui ex laborum ipsum"
    ],
    "sed_9c_": []
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "supplier_part_numbers": {
    "velit885": [
      "pariatur velit voluptate eiusmod ipsum",
      "tempor Ut dolor enim in",
      "minim mollit exercitation",
      "ex elit culpa sed"
    ],
    "et_9b": ["dolore mollit", "nulla et in"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "quis_7": [
      "id esse cupidatat laboris ipsum",
      "amet officia velit sint",
      "occaecat officia consequat",
      "ipsum qui Lorem dolore veniam",
      "nulla"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "consectetur sit velit ex",
  "supplier_part_numbers": {
    "amet_2b": [
      "enim veniam dolore ut",
      "ut culpa dolor",
      "Lorem",
      "deserunt quis ipsum culpa dolor"
    ],
    "eiusmod_b95": [
      "minim irure nostrud cillum",
      "quis in laboris",
      "officia ullamco",
      "sint laboris non mollit"
    ],
    "labore_3": []
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "do8b": [
      "exercitation magna in non",
      "voluptate aliquip",
      "Duis nulla esse",
      "commodo esse dolore nisi in",
      "nostrud ea do ut commodo"
    ],
    "velit_13": [
      "commodo ullamco consectetur aliquip dolor",
      "dolor exercitation in"
    ],
    "in_f": ["minim", "do et pariatur minim", "sed aliqua"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_net_ids": [
    ...
    "non laboris Lorem et consequat",
    "laborum",
    "elit",
    "sed et"
  ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "quis do enim",
  "pin_styles": {},
  "box_width": "veniam eiusmod ad et occaecat",
  "symbol_name": "amet eu ipsum dolore",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "exercitation pariatur magna adipisicing fugiat"
}
```
...
```json
{
  ...
  "message": "enim dolore incididunt"
}
```
...
```json
{
  ...
  "radius_x": "dolor",
  "radius_y": "labore deserunt exercitation ea",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "ea sint pariatur dolore",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_trace_id": "source_trace_1",
  "connected_source_port_ids": [
    "laborum enim sunt dolore tempor",
    "velit",
    "adipisicing tempor aliqua commodo nostrud",
    "aliquip"
  ],
  "connected_source_net_ids": ["ipsum", "voluptate Ut anim"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ad aliqua culpa officia laborum",
  "supplier_part_numbers": {
    "dolore18": ["sed minim", "mollit ut consectetur"],
    "officia__": [
      "exercitation",
      "veniam et occaecat in",
      "dolore ea Duis aliquip anim"
    ]
  }
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -28591699.337871775,
  "outer_height": -61266374.84756494,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
