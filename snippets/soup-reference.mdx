...
```json
{
  ...
  "supplier_part_numbers": {
    "aute9": ["proident consequat Excepteur dolore"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ut_65": [
      "labore aute minim occaecat enim",
      "ipsum",
      "ad in",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "reprehenderit irure",
  "supplier_part_numbers": {
    "do_8": [],
    "Duis1": ["ea eiusmod deserunt in", "Lorem aliqua qui esse elit"],
    "Excepteurc05": ["sint ut voluptate enim eiusmod", "in eu in quis", "non"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "eu in aliqua commodo",
  "supplier_part_numbers": {
    "deserunt_d03": ["cupidatat sit qui labore"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "tempor irure in",
  "supplier_part_numbers": {
    "enim_aad": ["deserunt dolor voluptate", "velit fugiat", "proident nisi"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "est41": ["dolor ea id", "eiusmod", "consequat"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "irure enim ex nulla in",
  "pin_styles": {},
  "box_width": "et est",
  "symbol_name": "ut reprehenderit",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "fugiat cillum est deserunt ex"
}
```
...
```json
{
  ...
  "message": "laborum adipisicing in"
}
```
...
```json
{
  ...
  "message": "anim adipisicing quis dolor",
...
```json
{
  ...
  "radius_x": 26846203.523574904,
  "radius_y": "in fugiat velit aliquip in",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "magna amet sint dolor adipisicing",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "occaecat officia reprehenderit",
  "supplier_part_numbers": {
    "culpa_2": [
      "dolore laboris ut consectetur",
      "quis Excepteur sit in",
      "laboris eiusmod ea elit Ut",
      "ullamco",
      "in velit Ut eu Duis"
    ]
  }
...
```json
{
  ...
  "manufacturer_part_number": "magna",
  "supplier_part_numbers": {
    "reprehenderitb": ["Excepteur minim qui nulla"],
    "et758": ["pariatur culpa", "labore minim", "ut tempor"],
    "velit8cf": []
  }
}
```
...
```json
{
  ...
  "model_3mf_url": "et reprehenderit dolor laboris aute"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "consectetur sed proident"
}
```
...
{
  "nisi9": {
    "left_margin": "elit incididunt",
    "right_margin": -3514989.613224134
  },
  "in_5_": {
    "right_margin": -34348960.521319285,
    "top_margin": "ut"
  },
  "aliquip6": {
    "left_margin": "elit ullamco",
    "top_margin": "veniam ullamco exercitation ad"
  },
  "exercitation_5": {
    "left_margin": -5300536.842026159,
    "right_margin": "dolore cillum Lorem Duis commodo",
    "top_margin": "do ea consequat ex in",
    "bottom_margin": "nostrud dolore in dolor labore"
  }
}
```
