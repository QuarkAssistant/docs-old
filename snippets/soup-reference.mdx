...
```json
{
  ...
  "ftype": "Ut id in exercitation",
  "source_component_id": "source_component_1",
  "name": "U1",
  "manufacturer_part_number": "ea",
  "supplier_part_numbers": {
    "fugiatef": ["Ut laboris", "id", "consectetur deserunt", "ea irure"],
    "eiusmod220": [],
    "consectetur35": [
      "consectetur in sint nisi",
      "voluptate",
      "commodo",
      "ea incididunt laboris Excepteur eiusmod"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "aute velit cillum Ut consectetur",
  "supplier_part_numbers": {
    "qui7": [
      "in occaecat cupidatat",
      "qui culpa sed deserunt",
      "sunt consectetur"
    ],
    "nulla8": [
      "voluptate ea in irure",
      "commodo nulla cupidatat sint reprehenderit",
      "adipisicing esse ipsum"
    ],
    "cupidatat88": [
      "exercitation tempor nisi",
      "in aliquip adipisicing",
      "ut Excepteur eiusmod sit nisi",
      "do proident",
      "eiusmod"
    ],
    "enim_74": ["velit", "aliquip"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "ut Duis",
    "ut labore id do Excepteur",
    "nisi ullamco consectetur non in",
    "consectetur veniam aute"
  ],
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 7492200.829791829
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "qui_9cc": [
      "commodo magna dolor eiusmod reprehenderit",
      "aliquip in ex",
      "Ut",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "enim ut ipsum fugiat in",
  "supplier_part_numbers": {
    "adipisicing6a": ["adipisicing exercitation reprehenderit aliquip ipsum"],
    "id6a": ["adipisicing aliqua officia nisi"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "quis pariatur voluptate cillum",
  "supplier_part_numbers": {
    "Ut_03": [
      "laboris",
      "dolor reprehenderit",
      "in laboris est do",
      "amet mollit esse irure"
    ],
    "eiusmod_81": [
      "laboris cillum dolor quis",
      "dolor officia",
      "adipisicing mollit",
      "laboris ipsum laborum irure",
      "velit non"
    ],
    "minim_b72": [
      "labore",
      "consequat aliquip",
      "dolor quis et",
      "nostrud sit consequat magna aliquip"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ind": [
      "in",
      "est qui consectetur",
      "culpa laboris officia incididunt",
      "culpa et exercitation",
      "Duis deserunt magna laborum fugiat"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "occaecat_0ca": [],
    "labore_1": ["dolor ullamco in eu", "consectetur Excepteur"],
    "enim_da": ["Excepteur eiusmod"],
    "in_0": [
      "irure voluptate officia labore nulla",
    ...
    "ad_e2": [
      "velit sint in officia dolor",
      "ad ullamco ut",
      "Lorem tempor nisi ad"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "dolor nisi ex consectetur ipsum",
    "deserunt sit ea consectetur occaecat",
    "veniam ut enim id nulla",
    "Duis in aliqua est magna"
  ],
  "connected_source_net_ids": [
    "reprehenderit tempor Duis elit",
    "est aute deserunt eu aliquip",
    "dolor",
    "magna do anim in nisi"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -47518552.21639225,
  "pin_styles": {},
  "box_width": -80950693.82342772,
  "symbol_name": "non dolore aliquip esse enim",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "cillum ad ut consequat Ut"
}
```
...
```json
{
  ...
  "color": "do qui ea pariatur velit"
}
```
...
```json
{
  ...
  "radius_x": "Lorem dolore consectetur ut Excepteur",
  "radius_y": "magna sed",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "commodo et in deserunt dolore",
  "supplier_part_numbers": {
    "in0_4": [],
    "temporf": ["in nulla enim nisi"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "reprehenderit cillum dolor qui"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
  ...
  "layer": "top",
  "footprinter_string": "mollit fugiat laboris Duis dolor",
  "model_obj_url": "anim officia labore",
  "model_stl_url": "in",
  "model_3mf_url": "dolore sint sunt occaecat",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ut nostrud enim Excepteur"
}
```
...
{
  "non2_": {
    "left_margin": -24891946.036288008,
    "top_margin": "irure incididunt",
    "bottom_margin": "voluptate"
  },
  "in3": {
    "left_margin": -82309953.43619809,
    "right_margin": "veniam in ea mollit eiusmod",
    "top_margin": "incididunt"
  },
  "mollit_9": {
    "left_margin": "Lorem",
    "right_margin": 60244251.89704594,
    "top_margin": -39903828.60832318,
    "bottom_margin": 3331336.716973692
  },
  "ine": {
    "left_margin": "ex dolor officia",
    "right_margin": -63455863.43142311
  }
}
```
