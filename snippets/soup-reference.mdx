...
```json
{
  ...
  "name": "A1",
  "manufacturer_part_number": "laboris sed officia",
  "supplier_part_numbers": {
    "aliqua_24b": [
      "irure magna nisi",
      "ut sint in exercitation",
      "exercitation in in nostrud cillum"
    ],
    "elit31": ["sit exercitation nulla"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sunt_6e": [
      "id in Excepteur",
      "dolore ex cupidatat ad",
      "nulla in quis occaecat"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["pariatur"],
  "is_power": true
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "aute ipsum tempor incididunt",
  "supplier_part_numbers": {
    "fugiat2": [],
    "ut5e7": [
      "ex non aliquip in",
      "eu consequat amet laborum",
      "non cillum eu tempor ea",
      "irure ullamco non",
      "eiusmod"
    ],
    "qui_230": ["velit Ut in"]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "proident ut Lorem ullamco voluptate",
  "supplier_part_numbers": {
    "Duis80": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ex Excepteur nulla in sed"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sed0e": ["dolor anim", "veniam id", "aliquip tempor aliqua", "sit"],
    "velit4": [
      "id",
      "voluptate irure commodo",
      "Excepteur proident irure magna non",
      "aliquip labore id cillum"
    ],
    "qui_47": ["ex enim cillum"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "consectetur eu minim Ut",
  "supplier_part_numbers": {
    "adipisicingc0b": [
      "dolor voluptate fugiat",
      "incididunt dolore deserunt minim",
      "non dolor Lorem"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "aute proident adipisicing est",
  "supplier_part_numbers": {
    "ad__64": ["reprehenderit cupidatat sint mollit", "deserunt ut"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "exercitation",
    "pariatur fugiat",
    "Duis fugiat ullamco et",
    "velit enim elit commodo Excepteur"
  ],
  "connected_source_net_ids": [
    "Excepteur ut tempor",
    "occaecat laborum mollit ex sint",
    "veniam pariatur magna Excepteur"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "amet ex dolore Lorem",
  "pin_styles": {},
  "box_width": "amet minim dolor culpa",
  "symbol_name": "laboris deserunt ullamco amet aliquip",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "dolore mollit laboris cillum ullamco",
...
```json
{
  ...
  "radius_x": "dolore commodo ullamco non",
  "radius_y": "velit consequat laboris sunt magna",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "sit elit culpa tempor",
  "supplier_part_numbers": {
    "inb": ["nostrud ad", "in"],
    "quis17a": ["sit Duis commodo ipsum in", "deserunt exercitation"],
    "elit9": ["Ut"],
    "veniam56": ["sed fugiat incididunt nisi aute", "Duis cupidatat"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "footprinter_string": "in aute velit consequat",
  "model_obj_url": "ex aliquip est elit",
  "model_stl_url": "nostrud eiusmod est Excepteur"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "Excepteur pariatur eu sunt"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 8096330.567235425,
  "outer_height": 54278959.96919921,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "eiusmod852": {
    "left_margin": "veniam non nostrud pariatur",
    "right_margin": 18125818.808752522,
    "top_margin": "aute commodo irure",
    "bottom_margin": 69508704.91302541
  },
  "consequat_d7": {
    "left_margin": -69934482.11471911,
    "right_margin": -15329919.570169762,
    "top_margin": "veniam id dolore nulla elit",
    "bottom_margin": 76915246.04186773
  }
}
```
