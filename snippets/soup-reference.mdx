...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "non Excepteur amet",
  "supplier_part_numbers": {
    "voluptate_2": [
      "ipsum adipisicing",
      "do id cupidatat Duis commodo",
      "laboris dolor",
      "irure cupidatat enim Lorem"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["aute nostrud minim culpa sed", "ut et in Ut"],
  "trace_width": -96802310.02322178
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "dolorec": [
      "dolor",
      "labore Excepteur officia nostrud",
      "exercitation",
      "ea sit cupidatat irure qui"
    ],
    "doloree": [
      "incididunt labore",
      "pariatur tempor Lorem eu ut",
      "dolor",
      "non exercitation nulla"
    ],
    "reprehenderit_5": []
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "anim_9": ["dolor incididunt esse dolore", "consequat dolore", "do"],
    "elit_35": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "aliqua labore non Duis",
  "supplier_part_numbers": {
    "elit_0": [
      "ut ea tempor reprehenderit in",
      "in cupidatat",
      "ipsum",
      "incididunt eu est deserunt commodo",
      "deserunt esse quis"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "connected_source_port_ids": [
    "Duis id aliquip cupidatat Excepteur",
    "elit fugiat dolor"
  ],
  "connected_source_net_ids": [
    "sit in adipisicing occaecat",
    "non elit",
    "et adipisicing cupidatat aliqua minim"
  ]
}
```
...
```json
{
  ...
  "pin_styles": {
    "velit_75f": {
      "top_margin": "enim nostrud",
      "bottom_margin": "sint irure magna dolor adipisicing"
    }
  }
}
```
...
```json
{
  ...
  "message": "sit consectetur aute mollit nisi"
}
```
...
```json
{
  ...
  "radius_x": 80902509.34619606,
  "radius_y": "Excepteur voluptate",
  "layer": "top"
}
```
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "voluptate eu enim ea"
    }
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "mollit labore amet",
  "supplier_part_numbers": {
    "aliquip_b22": [],
    "ad92": ["adipisicing nisi qui", "sit in irure Duis"]
  }
}
```
...
```json
{
  ...
  "model_obj_url": "sit reprehenderit"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "nisi qui magna sint"
}
```
...
{
  "qui5": {
    "left_margin": "mollit sunt Ut nisi consectetur",
    "right_margin": "aliquip"
  }
}
```
