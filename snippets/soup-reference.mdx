...
```json
{
  ...
  "name": "I1",
  "manufacturer_part_number": "in esse ut",
  "supplier_part_numbers": {
    "Excepteur5": ["consectetur reprehenderit", "tempor non", "esse Lorem in"],
    "fugiatb": ["elit", "culpa", "ad", "ex elit in", "Excepteur eu dolor"],
    "cillumbc": ["tempor reprehenderit", "fugiat ullamco tempor"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["qui Duis", "in deserunt"],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -89158524.30032305
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ex mollit non minim"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in laboris",
  "supplier_part_numbers": {
    "aliquacf": []
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "sed_62": [
      "id elit incididunt mollit",
      "ut incididunt id ea labore",
      "occaecat in sint minim"
    ],
    "incididunt93": [],
    "minim5": [
      "adipisicing",
      "non do reprehenderit qui",
      "dolore incididunt consequat proident"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "voluptate Ut veniam mollit et",
  "supplier_part_numbers": {
    "dolore2": [
      "velit officia in",
      "sed nostrud velit",
      "officia id reprehenderit",
      "fugiat ex"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "elit fugiat dolore ut",
  "supplier_part_numbers": {
    "aliqua8": ["Lorem ullamco officia Excepteur", "Excepteur cupidatat non"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "irure ullamco in nisi",
  "supplier_part_numbers": {
    "do_7": [
      "exercitation mollit Ut reprehenderit",
      "Lorem adipisicing ullamco Ut consectetur"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["veniam esse ex"],
  "connected_source_net_ids": ["irure amet proident velit", "in consequat"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "dolore enim commodo amet",
  "pin_styles": {},
  "box_width": "voluptate in reprehenderit",
  "symbol_name": "amet incididunt",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "reprehenderit id amet ea"
}
```
...
```json
{
  ...
  "radius_x": "in officia quis magna et",
  "radius_y": 23414659.131289855,
  "layer": "top"
}
```
...
```json
{
  ...
  "type": "schematic_error",
  "error_type": "schematic_port_not_found",
  "message": "ex consequat anim amet esse"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "elit ea consectetur adipisicing in",
  "supplier_part_numbers": {
    "voluptate_87": [
      "dolor dolore laboris sit deserunt",
      "qui aute consequat Excepteur cupidatat",
      "laborum",
      "irure labore occaecat tempor",
      "magna quis dolor aliquip eiusmod"
    ],
    "mollit_48": [
      "anim veniam amet commodo ut",
      "tempor ut",
      "in reprehenderit"
    ],
    "quis_b": [
      ...
      "aliqua Ut cupidatat",
      "Ut cillum",
      "in anim pariatur culpa laboris"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "nostrud sunt ea",
  "model_obj_url": "velit",
  "model_stl_url": "eiusmod veniam officia in irure",
  "model_3mf_url": "cillum elit mollit sint ipsum",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "laborum veniam eiusmod aliquip do"
}
```
...
{
  "ad99": {
    "left_margin": 97714696.09974542,
    "top_margin": -59609528.72548373,
    "bottom_margin": 90121709.80257204
  },
  "Ut6": {
    "left_margin": "proident in laborum"
  },
  "ut_7ef": {
    "left_margin": 74814415.78390136
  },
  "et_d": {
    "bottom_margin": "laborum Duis consequat"
  },
  "Loremd7": {
    "left_margin": "ea nostrud elit commodo ipsum",
    "right_margin": 39712139.76788226,
    "top_margin": 64903925.67623612,
    "bottom_margin": 96015848.07812929
  }
}
```
