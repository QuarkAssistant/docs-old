...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ipsum eiusmod in",
  "supplier_part_numbers": {
    "nulla3": ["et", "dolore labore dolor Duis", "fugiat", "deserunt occaecat"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["dolore"],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": -39472464.759940796
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "incididunt anim",
  "supplier_part_numbers": {
    "veniam7": [],
    "cupidatat_5c": ["commodo ullamco"],
    "Lorem_e": [
      "Duis ex Excepteur tempor incididunt",
      "aliquip ipsum",
      "adipisicing cillum eu quis exercitation",
      "cillum Duis Ut"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "pariatur_d": ["velit ut", "proident qui", "anim"],
    "proident45": ["velit exercitation commodo ea ad", "in nostrud proident"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "nulla03": [
      "laborum dolor et",
      "culpa in",
      "in occaecat sunt ullamco reprehenderit",
      "minim cupidatat ut consectetur commodo"
    ],
    "elit_5": ["fugiat aliqua veniam", "esse ex officia culpa amet"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "irure pariatur in mollit",
  "supplier_part_numbers": {
    "ea_e0b": [],
    "id_b36": ["laboris dolore", "deserunt consectetur ea"],
    "sunt_ffe": [],
    "aliqua_7e": []
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "sed pariatur incididunt consectetur",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "ea eu voluptate veniam non"
  ],
  "connected_source_net_ids": [
    "dolor culpa labore",
    "labore",
    "veniam est reprehenderit irure",
    "proident in commodo"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -68345849.80716887,
  "pin_styles": {},
  "box_width": 54448026.27729502,
  "symbol_name": "consequat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "aute commodo sint ea ullamco"
}
```
...
```json
{
  ...
  "radius_x": "nisi dolore Duis in",
  "radius_y": -63270976.00591119,
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": -13307848.170400053
    },
    {
      "x": "3mm",
      "y": "1mm",
      "via": true,
      "to_layer": "bottom",
      "trace_width": "dolore deserunt dolor veniam"
    }
  ]
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "laborum92": [],
    "labore_846": [
      "reprehenderit laboris incididunt sint",
      "aute culpa",
      "aute nulla",
      "officia"
    ],
    "fugiat_f20": ["dolore aute ut nisi", "labore sint do Excepteur"],
    "do_5": []
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "laborum commodo adipisicing veniam aute"
  },
  "layer": "top",
  "footprinter_string": "aliquip",
  "model_obj_url": "tempor",
  "model_stl_url": "consequat",
  "model_3mf_url": "culpa in nostrud sint cupidatat",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "quis officia sit do qui"
}
```
...
{
  "commodo_52": {
    "left_margin": "adipisicing cupidatat magna"
  },
  "anim_": {
    "left_margin": -13570292.897297293,
    "right_margin": "aute"
  }
}
```
