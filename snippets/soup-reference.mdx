...
```json
{
  ...
  "name": "A1",
  "manufacturer_part_number": "nisi Lorem nostrud",
  "supplier_part_numbers": {
    "commodo_42": [
      "cupidatat aliqua sint Excepteur ea",
      "do enim veniam incididunt",
      "ad pariatur culpa in deserunt"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "exercitation in irure aliquip tempor",
  "supplier_part_numbers": {
    "dolore1_": ["labore Lorem anim ullamco"],
    "nostrudcbb": [
      "laborum quis enim ad officia",
      "velit in Excepteur enim occaecat",
      "proident adipisicing dolor nostrud"
    ],
    "commodo_6_e": [
      "minim voluptate deserunt eiusmod fugiat",
      "Duis",
    ...
    "dolore9": [
      "irure minim",
      "occaecat nisi ut fugiat non",
      "nostrud tempor laboris eiusmod deserunt"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["commodo"],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": -99549420.4697449
}
```
...
```json
{
  ...
  "name": "B1",
  "supplier_part_numbers": {
    "Lorem__": ["non deserunt", "est exercitation"],
    "inff": [],
    "esse4f": [
      "incididunt",
      "nulla aliqua consectetur do",
      "id quis veniam ut dolore",
      "elit reprehenderit incididunt"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "minim pariatur quis",
  "supplier_part_numbers": {
    "irure6": ["fugiat aliquip eu esse", "aliquip elit dolor non Ut"],
    "ipsumd": [],
    "do_d50": [],
    "nulla_c39": ["eu"]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cupidatat eiusmod minim fugiat dolore",
  "supplier_part_numbers": {
    "Utd": ["dolore do", "amet quis anim"],
    "commodo58b": ["sed"]
  }
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "cillum588": ["aliqua dolore"],
    "Ut_c1": ["aliqua", "nisi dolore et sit dolor"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "voluptate_2_": [
      ...
      "velit elit fugiat",
      "nulla",
      "cillum anim ipsum reprehenderit"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "incididunt sunt est",
  "supplier_part_numbers": {
    "ad_7": [
      "laborum aute",
      "sunt quis dolore minim",
      "in nulla",
      "enim in nostrud in"
    ],
    "ad_e3": ["laborum Lorem", "mollit consectetur ut labore"],
    "esse__4c": [
      "est",
      "proident ex",
      "veniam dolor elit sed",
      "non cupidatat anim adipisicing magna",
      "minim reprehenderit"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "supplier_part_numbers": {
    "adipisicing5d": ["et labore ea", "magna eu eiusmod Duis sed"],
    "dolor_60": ["ut laborum", "anim quis sed dolore"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_net_ids": [
    "magna tempor consequat deserunt",
    "in incididunt voluptate qui",
    "nisi in nulla ipsum",
    "occaecat eiusmod",
    "Lorem cillum ut"
  ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "box_width": "magna commodo eiusmod adipisicing"
}
```
...
```json
{
  ...
  "message": "culpa ex consectetur dolor"
}
```
...
```json
{
  ...
  "color": "in Duis laboris tempor nisi"
}
```
...
```json
{
  ...
  "radius_x": "eu magna dolore",
  "radius_y": 83544600.57476553,
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "commodoc": ["ea in pariatur", "ut elit et", "sunt do commodo"],
    "anim_8be": ["Lorem"],
    "temporc4": ["commodo minim", "proident"],
    "aute_4": [
      "Lorem laborum",
      "Lorem",
      "sint amet aliqua",
    ...
    "fugiat_9e9": [
      "nostrud ut officia non aliqua",
      "ex ea in nostrud nulla",
      "deserunt commodo in exercitation",
      "commodo consequat ea dolor quis",
      "ad irure laborum"
    ]
  }
}
...
```json
{
  ...
  "rotation": "90deg",
  "layer": "top",
  "footprinter_string": "et incididunt Duis",
  "model_obj_url": "amet commodo dolor",
  "model_stl_url": "ut",
  "model_3mf_url": "amet",
  "model_jscad": {}
}
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 95382631.5361025,
  "outer_height": -80924871.16399325,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "labore7": {
    "left_margin": "officia",
    "top_margin": "pariatur veniam ex"
  },
  "eiusmod_489": {
    "left_margin": "minim",
    "right_margin": "minim occaecat mollit",
    "top_margin": "eu aliquip",
    "bottom_margin": "sit sint qui commodo"
  }
}
```
