...
```json
{
  ...
  "ftype": "tempor laborum nisi eiusmod non",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ad laboris do",
  "supplier_part_numbers": {
    "id_6": [
      "aute",
      "occaecat minim irure commodo",
      "quis dolore ut aliquip",
      "Ut Excepteur",
      "laborum incididunt"
    ],
    "eiusmodbd": [
      "tempor aute pariatur enim",
      "amet",
      "reprehenderit dolore ut labore",
      "sunt occaecat mollit non deserunt"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["amet", "do sunt"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": 23244047.35254024
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "sit ut velit consectetur et",
  "supplier_part_numbers": {
    "laborisa67": [
    ...
    "velit__f0": [],
    "proidentb1": ["nisi consectetur aute Duis"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolore_d_": [],
    "aliquip_2": ["sit nostrud", "ad ullamco proident sunt"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "ullamco_": ["occaecat cillum eu"],
    "fugiat_1aa": ["nulla pariatur enim ea", "Ut"],
    "cillum571": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "laborum sint sit"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ut incididunt aliquip cillum",
  "supplier_part_numbers": {
    "aliqua_4": []
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "amet_0f9": [
      "proident laboris dolor tempor Ut",
      "deserunt pariatur magna reprehenderit",
      "ut minim",
      "in"
    ],
    "dolore02a": ["ex"]
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "ut_8": ["sunt commodo cillum Excepteur anim", "qui", "sit qui eu"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "Ut Excepteur et laborum deserunt",
    "esse pariatur Duis nulla tempor",
    "irure nostrud",
    "eiusmod Duis"
  ],
  "connected_source_net_ids": ["ea nostrud Lorem"]
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "culpa officia cupidatat deserunt velit"
}
```
...
```json
{
  ...
  "message": "amet ut veniam aliquip"
}
```
...
```json
{
  ...
  "message": "deserunt irure culpa elit",
...
```json
{
  ...
  "radius_x": 4761137.015377462,
  "radius_y": "consectetur",
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 15851649.335014313
    }
  ]
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "do est deserunt labore consectetur"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "nostrud in enim",
  "supplier_part_numbers": {
    "velit_73": [
      "non",
      "eu deserunt commodo",
      "nisi magna",
      "reprehenderit et ut qui eiusmod"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "model_obj_url": "Duis irure pariatur laboris",
  "model_stl_url": "sed mollit officia",
  "model_3mf_url": "minim Lorem dolor officia deserunt",
  "model_jscad": {}
}
```
...
{
  "nulla_5": {
    "left_margin": "minim aliqua nostrud officia",
    "right_margin": 8276110.265016407,
    "top_margin": 34509743.40926632,
    "bottom_margin": 45197745.00845441
  },
  "Excepteur_afd": {
    "left_margin": "eu dolor nisi Excepteur minim",
    "top_margin": "eu",
    "bottom_margin": "fugiat et"
  }
}
```
