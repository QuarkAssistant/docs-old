...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "voluptate fugiat eiusmod",
  "supplier_part_numbers": {
    "Excepteur64": ["tempor culpa laborum Ut"],
    "aliqua_a": [
      "fugiat id",
      "sed fugiat eu dolor Duis",
      "cillum aliqua ut",
      "fugiat sed non"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Excepteur proident pariatur do sint",
  "supplier_part_numbers": {
    "aute_cd": [
      "amet",
      "do labore est eiusmod ipsum",
      "ullamco dolor dolor",
      "esse ut ea",
      "ut"
    ]
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["aliqua exercitation", "nostrud esse non"],
...
```json
{
  ...
  "supplier_part_numbers": {
    "pariatur_b": [],
    "culpa_fe8": [
      "ipsum irure reprehenderit officia",
      "ut Lorem sint minim",
      "id reprehenderit dolore ut"
    ],
    "enim_8": ["laboris et enim aliqua", "cupidatat"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ex aliqua anim minim",
  "supplier_part_numbers": {
    "cupidatat4d7": ["ipsum do", "qui tempor"],
    "sit_d27": [
      "enim Excepteur velit tempor nulla",
      "minim",
      "minim culpa consectetur dolor in"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ex sed laborum dolore ut",
  "supplier_part_numbers": {
    "dolorabc": []
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "officia_a0": [],
    "tempor02": [
      "pariatur Excepteur cillum eu Ut",
      "aute et eu velit ea",
      "nulla",
      "proident"
    ]
...
```json
{
  ...
  "supplier_part_numbers": {
    "irure5": [
      "sed voluptate",
      "eu dolore adipisicing quis",
      "mollit in consequat ut"
    ],
    "ex_7": [
      "do",
      "nisi dolore magna",
      "mollit dolore amet",
      "nostrud mollit voluptate consectetur culpa"
    ],
    "voluptate_cd": ["ex", "culpa exercitation dolore"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "voluptate irure",
    "fugiat nulla",
    "proident culpa quis velit",
    "in et"
  ],
  "connected_source_net_ids": [
    "aliqua minim ipsum dolor",
    "nisi",
    "voluptate",
    "anim"
  ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "sed ut irure in nostrud",
  "pin_styles": {},
  "box_width": -36663236.2583347,
  "symbol_name": "ut laborum eu id voluptate",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "ut amet id magna aliquip",
...
```json
{
  ...
  "radius_x": 23269044.405069515,
  "radius_y": "eiusmod cupidatat ut aliquip sed",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "consequat irure non Ut",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "supplier_part_numbers": {
    "elit_89": [
      "consequat aute quis deserunt",
      "consequat occaecat",
      "in exercitation",
      "cillum tempor aliqua eiusmod",
      "laboris"
    ]
  }
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "laboris culpa qui occaecat",
  "model_obj_url": "nulla",
  "model_stl_url": "aliqua ullamco",
  "model_3mf_url": "proident laborum magna",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "fugiat veniam dolore nostrud"
}
```
...
{
  "nisi_5": {
    "bottom_margin": "commodo occaecat Ut nulla ut"
  }
}
```
