...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "enim do elit",
  "supplier_part_numbers": {
    "magna_9b_": ["esse qui aliquip", "in"],
    "sint072": [
      "ad",
      "consequat eu eiusmod",
      "esse adipisicing dolor do",
      "cillum ex dolor tempor exercitation"
    ],
    "essec": [],
    "anim_c": [
      "anim magna in esse aliquip",
      "ut culpa Excepteur elit",
      "mollit reprehenderit nulla",
      "dolor veniam ipsum minim"
    ],
    "elit9_f": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Excepteur enim fugiat sed",
  "supplier_part_numbers": {
    "dolore_": [],
    "id_4": []
  }
...
```json
{
  ...
  "member_source_group_ids": [
    "in ipsum elit",
    "adipisicing mollit amet Duis Ut",
    "ad aliqua laborum elit",
    "reprehenderit magna nulla nisi",
    "Excepteur commodo"
  ],
  "is_power": false,
  "is_ground": true,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "amet ea commodo sint qui",
  "supplier_part_numbers": {
    "sunt2c": ["Excepteur nulla ut amet", "reprehenderit"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ullamco965": ["dolore"],
    "idad": ["non fugiat", "sed qui", "magna", "dolore deserunt laborum anim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "laboris est",
  "supplier_part_numbers": {
    "in6b4": [
      "eu laborum ut",
      "voluptate dolor",
      "commodo anim officia exercitation",
      "qui"
    ]
  }
}
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "irure sunt minim dolore id",
    "amet in ea",
    "qui ullamco velit esse"
  ],
  "connected_source_net_ids": [
    "aliqua culpa sit incididunt",
    "eiusmod laboris",
    "dolor deserunt cupidatat",
    "tempor",
    "magna consectetur aliquip ut"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 68762235.23269096,
  "pin_styles": {},
  "box_width": "ullamco dolore fugiat dolor",
  "symbol_name": "ipsum quis Lorem ullamco in",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "proident eu deserunt voluptate"
}
```
...
```json
{
  ...
  "message": "nisi mollit magna id dolor"
}
```
...
```json
{
  ...
  "message": "anim ullamco labore laboris",
...
```json
{
  ...
  "radius_x": -42501202.53002217,
  "radius_y": "labore exercitation Lorem id eu",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "qui veniam eiusmod minim",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "ad6": ["id dolor quis pariatur", "nulla voluptate sed ea"],
    "occaecat5f": [
      "amet consectetur aliquip labore",
      "ut sed adipisicing irure aliqua",
      "anim est sunt voluptate in",
      "officia ex reprehenderit quis et",
      "est ut sint veniam nostrud"
    ]
  }
}
```
...
```json
{
  ...
  "rotation": "90deg",
  "model_stl_url": "adipisicing amet ipsum laborum commodo"
}
```
...
```json
{
  ...
  "y": "1mm",
  "via": false,
  "trace_width": 43808366.055185914
}
```
...
```json
{
  "amet_2": {
    ...
    "right_margin": "tempor",
    "top_margin": 72785189.5297389,
    "bottom_margin": 10967224.047596604
  }
}
```
