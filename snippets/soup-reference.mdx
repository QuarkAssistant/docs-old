...
```json
{
  ...
  "ftype": "tempor esse irure",
  "source_component_id": "source_component_1",
  "name": "T1",
  "supplier_part_numbers": {
    "anim_e": [
      "eiusmod qui minim commodo Duis",
      "amet proident aute consectetur in",
      "anim nulla esse",
      "Lorem ad magna velit nisi",
      "ad aute sed"
    ],
    "culpa_": ["tempor Excepteur amet", "reprehenderit aliqua ullamco"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "proident nulla"
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "cupidatat ad minim nostrud",
    "dolore adipisicing ad cupidatat amet",
    "quis eu sunt amet laboris",
    "dolor laborum",
    "sint"
  ],
  "is_power": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "minim elit id sint",
  "supplier_part_numbers": {
    "fugiatd28": ["commodo", "in Excepteur anim eiusmod aute"],
    "laborede8": [
      "in",
      "ut",
      "pariatur in ut ipsum",
      "aute cillum incididunt",
      "Duis sint"
    ],
    "eiusmod_ff": ["commodo sunt exercitation"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "eiusmod_241": [
      "eiusmod incididunt culpa consequat laborum",
      "ea quis nisi et do",
      "adipisicing eiusmod sint ipsum Lorem",
      "eiusmod commodo id ut cupidatat"
    ],
    "consequat_e6": ["nisi", "ut", "magna", "est laboris id ea officia", "ex"],
    "ipsum_ce_": ["sunt ad cupidatat proident"],
    "voluptate_9": []
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ullamco pariatur exercitation ipsum",
  "supplier_part_numbers": {
    "dolor_e33": [
      "ipsum",
      "ut nulla ut aute",
      "aliqua anim officia",
      "culpa sint cupidatat dolor",
      "et"
    ],
    "velit5": ["ullamco magna consequat occaecat", "Ut ea in nostrud"],
    "voluptate_1": ["in laboris Ut eu non", "dolor"],
    "est_a": ["ipsum aliquip"],
    "commodo941": ["qui et consequat"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_2b": [
      "officia nulla",
      "ut voluptate ad cillum officia",
      "Excepteur veniam anim aliqua occaecat"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "eiusmod esse in",
  "supplier_part_numbers": {
    "veniam_4": [
      "aliquip fugiat",
      "ad adipisicing",
...
```json
{
  ...
  "supplier_part_numbers": {
    "cupidatat3": ["laboris", "eiusmod fugiat irure ea et", "irure"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "dolore magna in",
  "supplier_part_numbers": {
    "velit__e": [
      "sint non laboris",
      "ut",
      "nisi cillum dolor quis consectetur"
    ],
    "officia_605": ["ad nostrud"],
    "occaecat0b": [
      "commodo culpa sit esse id",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "dolor ipsum veniam in",
  "pin_styles": {},
  "box_width": 37436947.43646437,
  "symbol_name": "aute enim voluptate",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "radius_x": -30534690.039748684,
  "radius_y": "qui anim cupidatat",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "ad occaecat voluptate adipisicing",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": "velit dolor fugiat incididunt"
    },
    {
      "x": "3mm",
      "via": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "amet in",
  "supplier_part_numbers": {
    "esse_c5": [
      "tempor",
      "deserunt dolore do",
      "est",
      "ut est Ut dolor fugiat",
      "labore in tempor ad non"
    ],
    "in_69a": [
      "incididunt cupidatat quis Lorem Excepteur",
      "adipisicing sit enim Lorem veniam"
    ],
    "nulla9": [
      "officia pariatur esse ad",
      "adipisicing",
      "reprehenderit Excepteur ex",
      "mollit commodo eu enim",
      "et proident consequat"
    ],
    "quis_4": [
      "mollit enim magna",
      "amet nisi deserunt esse et",
      "pariatur ut commodo nulla laborum",
      "amet mollit ullamco",
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "officia elit commodo nisi irure"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
  ...
  "layer": "top",
  "footprinter_string": "velit",
  "model_obj_url": "dolore",
  "model_stl_url": "culpa aute sint",
  "model_3mf_url": "elit",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "ullamco aute commodo dolore tempor"
}
```
...
{
  "in94": {
    "left_margin": "proident enim",
    "right_margin": "in labore in magna nostrud",
    "top_margin": 93934123.36424568,
    "bottom_margin": -34881318.89197006
  },
  "Duis_af": {
    "left_margin": -5243066.164845273,
    "bottom_margin": "irure"
  }
}
```
