...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "ullamco nulla ipsum sunt"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "Excepteur_3f_": [
      "voluptate ullamco magna adipisicing est",
      "voluptate est id officia",
      "Duis adipisicing cupidatat culpa Ut",
      "id qui esse incididunt adipisicing"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "exercitation in ullamco in",
    "sit eiusmod aute minim nulla",
    "labore voluptate"
  ],
  "is_power": true,
  "is_ground": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aliqua anim nulla",
  "supplier_part_numbers": {
    "voluptate69": ["consequat ad labore exercitation"],
    "dolore_a5": [
      "aliquip deserunt incididunt",
      "minim enim proident esse incididunt"
    ],
    "adc": [
      "magna elit commodo ipsum",
      "veniam dolore",
      "dolore veniam id deserunt Ut",
      "mollit laboris in",
      "anim in sint"
    ]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "irure aliquip",
  "supplier_part_numbers": {
    "ea_64": ["ex culpa dolore"],
    "est__34": [],
    "ut_2_": [],
    "consequat_7b2": [
      "sint do in quis deserunt",
      "dolore sunt sed",
      "enim aute laboris pariatur sunt",
      "ad ex sint cillum",
      "sunt"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "esse nisi",
  "supplier_part_numbers": {
    "officiaa": ["et eu officia"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "quis cupidatat in laboris",
  "supplier_part_numbers": {
    "cillum39a": [
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "do Duis consequat",
  "supplier_part_numbers": {
    "ullamco_7": [
      "sed",
      "occaecat",
      "aliqua in sint",
      "quis aute dolore nulla",
      "aliquip dolor proident fugiat ipsum"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "cillum incididunt esse ut",
  "supplier_part_numbers": {
    "eu_": [
      "exercitation",
      "et do deserunt non eiusmod",
      "minim laboris ut",
      "fugiat",
      "elit officia"
    ],
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "dolor id cillum quis",
    "dolor sint proident irure"
  ],
  "connected_source_net_ids": ["occaecat nisi", "tempor consectetur magna"]
}
```
...
```json
{
  ...
  "message": "occaecat aute irure dolore mollit"
}
```
...
```json
{
  ...
  "message": "nostrud deserunt incididunt reprehenderit",
...
```json
{
  ...
  "radius_x": 46078153.27692655,
  "radius_y": 94800510.30202207,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "adipisicing aute non consectetur",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": 63751668.089946985
    }
  ]
}
```
...
```json
{
  ...
  "color": "commodo nisi occaecat do est"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ipsum veniam consectetur nulla anim",
  "supplier_part_numbers": {
    "cillum_33": ["laboris eu consectetur", "in cillum", "Lorem sit"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "in velit",
  "model_obj_url": "aute nostrud consectetur",
  "model_stl_url": "ad deserunt officia",
  "model_3mf_url": "in proident dolore officia aliquip",
  "model_jscad": {}
}
```
...
{
  "tempor5f3": {
    "left_margin": -7388256.951630011,
    "right_margin": "eiusmod reprehenderit nulla officia",
    "top_margin": "consectetur elit minim id sed"
  }
}
```
