...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "dolore exercitation",
  "supplier_part_numbers": {
    "commodo_f07": [
      "qui",
      "esse incididunt veniam adipisicing ad",
      "fugiat",
      "ut",
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["in ea"],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 65347082.05035877
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "mollit exercitation culpa",
  "supplier_part_numbers": {
    "ut_a": ["ad eu exercitation"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "anim ea dolore dolor",
  "supplier_part_numbers": {
    "et_2": ["labore do minim deserunt nulla", "ut pariatur consequat nulla"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "mollit laboris",
  "supplier_part_numbers": {
    "velit0": [
      "nisi eiusmod qui",
      "labore esse reprehenderit",
      "officia amet velit sit",
      "esse ea irure fugiat culpa"
    ],
    "enim81": ["ad"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "voluptate officia qui pariatur",
  "supplier_part_numbers": {
    "ut235": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ex adipisicing",
  "supplier_part_numbers": {
    "ametb": ["deserunt", "ut"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "quis aliqua dolor in",
  "supplier_part_numbers": {
    "dolor_17b": [
      "do Excepteur sed commodo proident",
      "minim ea et dolore",
      "qui velit"
    ]
  },
...
```json
{
  ...
  "connected_source_port_ids": ["ex quis qui", "in ea"],
  "connected_source_net_ids": [
    "anim nostrud",
    "occaecat",
    "deserunt ullamco eu officia",
    "et in"
  ]
}
```
...
```json
{
  ...
  "message": "ex cupidatat commodo fugiat sint"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "ad laborum quis consequat"
}
```
...
```json
{
  ...
  "color": "id officia in nostrud enim"
}
```
...
```json
{
  ...
  "message": "consectetur ut consequat"
}
```
...
```json
{
  ...
  "message": "laborum elit ullamco sit pariatur",
...
```json
{
  ...
  "radius_x": -50300624.498158,
  "radius_y": "esse voluptate",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ut commodo consequat exercitation in",
  "supplier_part_numbers": {
    "ipsum_5b": [
      "ad adipisicing eu",
      "non officia veniam culpa dolor",
      "elit pariatur",
      "consectetur esse proident labore officia"
    ],
    "ullamco_307": [
      "occaecat et laboris",
      "dolore qui",
      "non laboris pariatur",
      "Ut dolore",
      "mollit"
    ],
    "consequat59": ["in", "sint", "magna enim incididunt fugiat"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "adipisicing cupidatat officia"
  },
  "layer": "top",
  "footprinter_string": "anim quis elit dolor nostrud",
  "model_obj_url": "Lorem",
  "model_stl_url": "voluptate velit amet",
  "model_3mf_url": "non enim",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -84833825.99291156,
  "outer_height": -30594585.67530991,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "irure_26": {
    "left_margin": -26370569.972971186,
    "right_margin": "proident"
  },
  "eu_46b": {
    "left_margin": "et",
    "right_margin": -52016229.831554696,
    "top_margin": "laborum sit"
  },
  "irure268": {
    "left_margin": "exercitation elit et consectetur quis",
    "right_margin": -24779022.293961495,
    "top_margin": "eu Excepteur"
  },
  "reprehenderitd6": {
    "right_margin": -5255531.627977565,
