...
```json
{
  ...
  "ftype": "enim nostrud mollit ut",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "ex do Excepteur",
  "supplier_part_numbers": {
    "suntcb_": ["enim aliquip cillum"],
    "ea_39": ["eiusmod est ut", "Excepteur sit commodo"],
    "dolore6": [
      "sed nulla cupidatat",
      "laboris fugiat reprehenderit et",
      "sit in aliqua culpa",
      "ex ut aliquip ullamco"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "amet velit laboris",
  "supplier_part_numbers": {
    "ad3": ["ex cupidatat commodo non", "id elit adipisicing"],
    "veniamb20": [
      "et consequat",
      "exercitation dolore amet minim laborum",
      "dolore ipsum ullamco velit occaecat",
      "non Ut fugiat",
      "commodo elit do deserunt mollit"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eu incididunt laboris",
  "supplier_part_numbers": {
    "sint_e6_": [],
    "consequate5c": [
      "quis ut cupidatat sit",
      "anim",
      "Excepteur culpa laborum cupidatat ullamco"
    ],
    "adipisicing6": [
      "ut Lorem eiusmod laborum",
      "ut exercitation mollit adipisicing consectetur",
      "dolore Excepteur cupidatat sint",
      "enim aliquip officia"
    ],
    "in_1": [
      "qui sit non",
      "occaecat qui mollit eiusmod",
      "aliquip cupidatat incididunt ad"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ullamco dolore"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "do minim cupidatat",
  "supplier_part_numbers": {
    "Excepteurc6": [],
    "reprehenderit_9": [
      "in officia eu deserunt",
      "Duis adipisicing eu deserunt ea",
      "nostrud irure eu dolore",
      "culpa dolore",
      "sint in amet"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "reprehenderit esse",
  "supplier_part_numbers": {
    "occaecat_5_": ["esse Excepteur"],
    "in_9b4": [
      "ea ad",
      "voluptate velit dolor occaecat quis",
      "anim fugiat",
      "commodo"
    ],
    "ullamco_43": []
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "est sint elit nulla laborum",
  "supplier_part_numbers": {
    "voluptate4": [
      "commodo deserunt mollit sed",
      "Ut dolor",
      "et qui occaecat do officia"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "veniam deserunt amet",
  "supplier_part_numbers": {
    "enim_2": ["pariatur elit non laboris", "ut magna aliqua minim labore"],
    "dolore_b": [
      "laborum dolore",
      "laborum magna sint pariatur",
      "pariatur ut officia fugiat ea",
      "consectetur"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": ["ex incididunt sit", "amet laborum"],
  "connected_source_net_ids": [
    "officia quis nisi ut",
    "ea nostrud quis elit do"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "velit Ut sit eiusmod do",
  "pin_styles": {},
  "box_width": -71925926.5933705,
  "symbol_name": "Excepteur id cupidatat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "model_obj_url": "laboris quis in",
  "model_3mf_url": "eu aliqua nisi sint exercitation",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "voluptate reprehenderit esse et sunt"
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "proident sint commodo"
}
```
...
{
  "qui_54b": {
    "left_margin": -16209474.292216659,
    "right_margin": "mollit officia fugiat tempor pariatur"
  },
  "in_f0": {
    "left_margin": "cillum Ut ipsum",
    "top_margin": "ipsum",
    "bottom_margin": -21339879.9826535
  },
  "exercitation69": {
    "left_margin": "pariatur incididunt nulla irure",
    "right_margin": 42069211.89977968,
    "top_margin": 80364366.8396368
  },
  "pariatur_34": {
    "bottom_margin": -90284192.01268277
  }
}
```
