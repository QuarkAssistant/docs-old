...
```json
{
  ...
  "supplier_part_numbers": {
    "exercitation_6": [
      "in",
      "sint dolor incididunt consequat in",
      "eiusmod laboris sit",
      "amet Lorem"
    ]
  }
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["eu sit anim labore", "dolore ex quis"],
  "is_digital_signal": true,
  "trace_width": 41649057.7619701
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "occaecat_9": ["sint magna Lorem cillum occaecat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "labore in sunt",
  "supplier_part_numbers": {
    "consectetur_7c": [
      "consequat laboris aliquip dolor nisi",
      "exercitation veniam laboris dolor",
      "non"
    ],
    "irure_a": [],
    "exercitationd7": [
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "qui enim",
  "supplier_part_numbers": {
    "adipisicing1a7": ["reprehenderit proident minim", "quis incididunt qui"],
    "enim__26": [
      "ipsum ullamco eiusmod cillum",
      "occaecat ut id dolore",
      "esse",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolore mollit voluptate",
  "supplier_part_numbers": {
    "culpa7a9": ["consectetur adipisicing esse cupidatat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "occaecat eu",
  "supplier_part_numbers": {
    "ullamco_ef0": ["ullamco"]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "minim sed consequat culpa commodo",
  "supplier_part_numbers": {
    "ullamco_34": ["mollit Duis laboris commodo", "amet esse"],
    "ut7": ["Duis et consectetur culpa"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "nisi culpa labore ipsum proident",
    "nulla cillum irure",
    "veniam laboris Lorem irure",
    "deserunt voluptate"
  ],
  "connected_source_net_ids": ["nostrud exercitation ipsum reprehenderit"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "reprehenderit magna",
  "pin_styles": {},
  "box_width": "commodo sed Excepteur nulla",
  "symbol_name": "ea tempor eiusmod",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "enim occaecat voluptate anim do"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "reprehenderit ex Lorem consequat commodo"
}
```
...
```json
{
  ...
  "color": "pariatur dolor nostrud do sit"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Excepteur exercitation",
  "supplier_part_numbers": {
    "aute1": ["dolore sunt mollit", "ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "in officia",
  "supplier_part_numbers": {
    "cupidatat_d4": [
      ...
      "voluptate est",
      "amet Ut minim est",
      "pariatur nostrud laboris sed aliqua"
    ],
    "eta3": [
      "officia esse Lorem minim proident",
      "consequat qui exercitation commodo cupidatat"
    ],
    "sitc52": [
      "officia proident voluptate",
      "nisi minim dolor ea",
      "fugiat magna commodo sunt Excepteur",
      "mollit laboris do"
    ]
  }
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "nisi incididunt",
  "model_obj_url": "dolore in pariatur enim laborum",
  "model_stl_url": "sed mollit voluptate deserunt",
  "model_3mf_url": "labore",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "est Duis cupidatat"
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "in deserunt esse aute"
}
```
...
{
  "officia07d": {
    "left_margin": 89427198.47705364,
    "right_margin": 7419750.953115091,
    "top_margin": "eu sit amet",
    "bottom_margin": 39765398.18058339
  },
  "dolore0": {
    "right_margin": 18035566.987551913,
    "top_margin": "id do nostrud esse ex",
    "bottom_margin": "in irure Excepteur commodo est"
  }
}
```
