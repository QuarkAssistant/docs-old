...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "culpa consequat pariatur sed commodo",
  "supplier_part_numbers": {
    "sit_6d": [
      "mollit",
      "sunt dolor voluptate ipsum",
      "dolore Excepteur labore proident sint"
    ],
    "fugiat_b51": [
      "labore laborum ex aliqua quis",
      "sint",
      "ut dolore",
      "id Lorem",
      "mollit"
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["non", "sunt"],
  "is_power": false,
  "is_ground": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "mollit voluptate aliqua",
  "supplier_part_numbers": {
    "aute68": [
      "aliqua",
      "veniam labore aliquip",
      "dolore velit tempor",
      "mollit labore incididunt",
      "et sit culpa quis proident"
    ]
  }
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "ullamco5": ["incididunt esse in laborum"],
    "officiad45": ["tempor irure aliquip"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "proident_d": [
      "aliqua amet sint aliquip veniam",
      "ex sed commodo",
      "sit dolor est nostrud",
      "culpa dolor"
    ],
    "voluptate_7b": [],
    "ullamcob": []
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "veniam officia",
  "supplier_part_numbers": {
    "voluptate_7c": ["Ut sint non amet"],
    "Lorem6ec": [
      "enim in cupidatat laboris irure",
      "in",
      "dolor",
      "reprehenderit",
      "do elit dolore exercitation fugiat"
    ],
    "deserunt_7": [
      "laborum",
      "nisi sed sunt eu",
      "minim ex",
      "ad eiusmod culpa consectetur quis",
      "exercitation"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "deserunt aute",
  "supplier_part_numbers": {
    "laboris_3": ["ipsum"]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "commodo Excepteur aliquip ut ullamco",
  "supplier_part_numbers": {
    "in8_": [
      "deserunt Excepteur dolore in",
      "exercitation id",
      "Lorem adipisicing"
    ]
  },
...
```json
{
  ...
  "connected_source_port_ids": ["qui", "sit", "laboris qui sed minim in"],
  "connected_source_net_ids": [
    "minim tempor quis sed adipisicing",
    "nisi",
    "dolor culpa laborum",
    "Ut velit in sit ex",
    "ad dolore"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -10810294.547338322,
  "pin_styles": {},
  "symbol_name": "Ut sit",
  "port_arrangement": {
    "left_size": 3,
...
```json
{
  ...
  "radius_x": -29924719.938654706,
  "radius_y": 15592625.835412115,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "incididunt do sed ullamco adipisicing",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "type": "schematic_error",
  "error_type": "schematic_port_not_found",
  "message": "dolore deserunt consequat"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "reprehenderit eiusmod et quis",
  "supplier_part_numbers": {
    "elit5": [
      "id Ut magna dolore",
      "anim et labore non",
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "commodo Duis proident"
  },
  "layer": "top",
  "footprinter_string": "anim consequat in veniam aute",
  "model_obj_url": "velit quis dolor",
  "model_stl_url": "dolore pariatur amet",
  "model_3mf_url": "Excepteur Duis",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "in esse et velit ipsum"
}
```
...
{
  "consequat_60a": {
    "top_margin": "pariatur est",
    "bottom_margin": -6410195.429577261
  }
}
```
