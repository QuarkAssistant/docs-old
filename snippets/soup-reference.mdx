...
```json
{
  ...
  "ftype": "culpa deserunt do dolore",
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "non consequat voluptate"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "officia Ut esse consequat",
  "supplier_part_numbers": {
    "id8b": ["Duis deserunt aliqua dolore amet", "aute nisi"],
    "eiusmodf": [
      "ipsum nisi est mollit",
      "cupidatat occaecat incididunt sit",
      "laborum",
      "adipisicing sunt"
    ],
    "fugiat_b": [
      "pariatur sunt aliquip adipisicing minim",
      "dolor voluptate mollit",
      "laborum tempor sint cillum cupidatat",
      "ad in in"
    ],
    "magna_e1a": [
      "deserunt sint velit",
      "enim in elit aute Lorem",
      "reprehenderit ad est",
      "officia proident velit non ullamco",
      "aliquip esse veniam qui"
    ],
    "Lorem_2f": [
      "magna",
      "irure sint incididunt",
      "consectetur aute",
      "sit laborum qui nulla ullamco",
      "aute"
    ]
  }
}
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["ut"],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": -27368034.646456033
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ea nisi pariatur ipsum aliqua",
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequata4": [
      "qui est dolor sit dolor",
      "ad ea",
      "amet velit enim",
      "consequat nisi dolor aute enim",
      "quis ullamco commodo"
    ],
    "sit4": [
      "consequat veniam in labore minim",
      "sint ad",
      "est sed",
      "Duis adipisicing aliqua cupidatat nulla"
    ],
    "sint6": [
      "voluptate velit occaecat dolor irure",
      "dolor enim pariatur Duis",
      "consectetur eu",
      "et ea Lorem",
      "in eu pariatur mollit"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "aliqua eu consectetur tempor",
  "supplier_part_numbers": {
    "occaecat4e": [
      "ut non",
      "quis",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "consequat commodo dolor",
  "supplier_part_numbers": {
    "aliqua_0": ["sint non consectetur culpa"],
    "deseruntd": [
      "velit",
      "sed est aliqua",
      "Lorem",
      "consequat in amet id dolor",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ullamco sint elit do",
  "supplier_part_numbers": {
    "sint_c": ["minim elit cillum"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "consequat aute",
  "supplier_part_numbers": {
    "aute_d9": [
      "laboris ad",
      "laboris ex sit",
      "cillum",
      "sit qui Excepteur tempor esse"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["culpa", "occaecat nulla in nisi"],
  "connected_source_net_ids": [
    "anim labore dolor",
    "ad ex proident culpa incididunt"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 80596942.2555941,
  "pin_styles": {},
  "box_width": "Lorem eu ad officia elit",
  "symbol_name": "aliqua",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "labore exercitation voluptate in"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "consequat adipisicing culpa in"
}
```
...
```json
{
  ...
  "message": "quis ullamco consectetur ut",
...
```json
{
  ...
  "radius_x": -10066264.641056135,
  "radius_y": "deserunt aliquip in",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "in consectetur laborum sit tempor",
  "supplier_part_numbers": {
    "auted": [
      "eiusmod enim",
      "nisi esse",
      "consequat Lorem sunt nisi",
      "adipisicing"
    ]
  }
}
...
```json
{
  ...
  "model_3mf_url": "sunt laborum quis"
}
```
...
{
  "nullaeaf": {
    "left_margin": -70306581.12605512,
    "right_margin": 5650047.943695217,
    "top_margin": "quis ea exercitation do",
    "bottom_margin": "quis est ea"
  },
  "culpa3": {
    "left_margin": 73238894.65044129,
    "right_margin": -85652675.09422374,
    "top_margin": -62409626.51276738,
    "bottom_margin": "adipisicing in Ut"
  },
  "adipisicing0": {
    "left_margin": "voluptate id",
    "right_margin": "reprehenderit",
    "top_margin": "cupidatat tempor"
  }
}
```
