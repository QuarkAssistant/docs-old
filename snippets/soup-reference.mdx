...
```json
{
  ...
  "ftype": "irure est dolor",
  "source_component_id": "source_component_1",
  "name": "I1",
  "manufacturer_part_number": "proident deserunt tempor eu id"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "velit3": [
      "dolor officia amet incididunt enim",
      "Excepteur",
      "dolore nulla esse"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eiusmod deserunt ut dolore nostrud",
  "supplier_part_numbers": {
    "cupidatat_e": ["do esse incididunt qui nostrud", "proident ullamco ex Ut"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laborum elit aute reprehenderit",
  "supplier_part_numbers": {
    "laboris_6": ["ullamco exercitation adipisicing", "dolor eu"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "labore laborum est reprehenderit",
  "supplier_part_numbers": {
    "sed_a4": []
  }
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "est dolor ullamco eu",
    "officia tempor veniam in",
    "in aute elit",
    "sit et adipisicing",
    "dolore veniam Duis"
  ],
  "connected_source_net_ids": [
    ...
    "eiusmod ex laborum",
    "minim reprehenderit elit enim ex"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "reprehenderit dolore",
  "pin_styles": {},
  "box_width": 18843930.959960133,
  "symbol_name": "id ex ad",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "ea proident adipisicing magna"
}
```
...
```json
{
  ...
  "radius_x": "dolore cupidatat ex consectetur quis",
  "radius_y": -65105600.178592525,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "amet et esse consectetur",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 47058849.649561584
    }
  ]
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ullamco id consectetur"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 14839313.514087811,
  "outer_height": 77277172.71842045,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "enim officia Duis nostrud sed"
}
```
...
{
  "dolor_af9": {
    "left_margin": -61603660.695352055,
    "right_margin": "aute aliquip officia sit deserunt",
    "top_margin": -15597953.824005723,
    "bottom_margin": 54968961.40222934
  },
  "veniam9_d": {
    "right_margin": -3560217.694718525
  }
}
```
