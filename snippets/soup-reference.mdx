...
```json
{
  ...
  "ftype": "labore ad anim laborum incididunt",
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "dolor ullamco consectetur",
  "supplier_part_numbers": {
    "ipsum9a8": [
      "incididunt aliqua enim nulla Excepteur",
      "cupidatat consequat commodo enim ut",
      "reprehenderit voluptate Lorem et Ut",
      "Ut",
      "eu do"
    ],
    "cupidatat_75": ["Lorem", "eiusmod proident enim sed laboris"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "commodo sunt non",
  "supplier_part_numbers": {
    "laborum8b": ["laborum in", "in in", "consectetur tempor elit sint"],
    "incididunt_1_6": [
      "cupidatat ut Lorem",
      "sed Lorem amet",
      "fugiat Lorem ut",
    ...
    "idb": [
      ...
      "ipsum occaecat",
      "occaecat quis sit",
      "voluptate non Lorem magna officia",
      "deserunt sed nostrud ad consequat"
    ],
    "dolore_8d": [
      "amet labore",
      "ex sint",
      "incididunt in aliquip dolore",
      "sed occaecat"
    ]
  }
}
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["sed in nisi nostrud", "non enim occaecat ut"],
  "is_power": true
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cillum eu voluptate reprehenderit tempor",
  "supplier_part_numbers": {
    "laborumb50": [],
    "cillum_b05": [
      "incididunt commodo est",
      "proident ipsum nisi",
      "sit ipsum sunt dolore",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cillum enim sit minim"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "cupidatat magna Lorem",
  "supplier_part_numbers": {
    "sed_b": [],
    "consequat8a": [
      "cillum",
...
```json
{
  ...
  "supplier_part_numbers": {
    "ex4": [
      "aliqua anim",
      "aliqua amet cupidatat tempor",
      "deserunt in",
      "anim laborum labore",
      "ad cillum nisi sunt"
    ],
    "ut4": [
      "elit aliquip veniam tempor",
      "esse",
      "consectetur sunt velit mollit nisi",
      "minim Ut",
      "velit aute proident elit dolor"
    ],
    "esse__": [
      "voluptate minim nisi dolor enim",
      "est tempor nulla ullamco",
      "ad",
      "cupidatat officia adipisicing amet",
      "sint sed laboris magna eu"
    ],
    "sunt_24b": ["tempor fugiat", "officia Excepteur", "pariatur"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "laboris_5": ["labore esse velit do exercitation"],
    "qui4b3": [
      "dolore est consequat sit non",
      "dolore eiusmod in minim ex",
      "tempor magna ea incididunt",
      "dolore proident",
      "voluptate eiusmod"
    ],
    "non_6b": [],
    "irure_ad": ["non amet Lorem ullamco laborum"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "deserunt Ut eu nisi et",
    "ullamco mollit sint deserunt",
    "labore tempor",
    "minim deserunt eiusmod eu aliqua"
  ],
  "connected_source_net_ids": ["sint"]
}
```
...
```json
{
  ...
  "radius_x": "quis",
  "radius_y": "magna dolor sunt exercitation ullamco",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "minim sed in dolore anim",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "footprinter_string": "laborum laboris dolor cillum aute",
  "model_stl_url": "in ullamco sit in",
  "model_jscad": {}
}
```
...
{
  "dolore9c": {
    "left_margin": "reprehenderit dolore dolor commodo",
    "right_margin": "laborum aliquip minim",
    "top_margin": "in cillum do",
    "bottom_margin": "eu sed voluptate officia"
  }
}
```
