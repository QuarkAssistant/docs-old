...
```json
{
  ...
  "name": "V1",
  "manufacturer_part_number": "laboris et",
  "supplier_part_numbers": {
    "irure_8": ["tempor"],
    "nona86": ["Lorem non commodo irure"],
    "veniam_5_": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Ut velit cupidatat reprehenderit sint",
  "supplier_part_numbers": {
    "occaecate_": [
      "tempor est adipisicing ipsum nisi",
      "velit sint aliqua qui",
      "enim irure quis ut commodo",
      "dolor",
      "nisi sit in"
    ],
    "consequat_8": [
      "in",
      "mollit",
      "tempor officia adipisicing non consectetur",
      "ex sint occaecat dolor",
      "cillum Lorem dolor ad id"
    ],
    "aliquip_e": []
  }
}
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["mollit officia magna amet ut"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "irure fugiat",
  "supplier_part_numbers": {
    "fugiat_9": [
      "Ut est magna",
      "nisi qui",
      "ea enim eu commodo occaecat",
...
```json
{
  ...
  "supplier_part_numbers": {
    "occaecat_25": ["Lorem in tempor", "dolor deserunt consequat", "irure"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "culpa_3": [
      "ullamco laboris",
      "adipisicing fugiat cillum consectetur mollit",
      "magna Duis ut elit"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "reprehenderit qui ut",
  "supplier_part_numbers": {
    "adipisicingb": [
      "ea reprehenderit dolore sunt",
      "deserunt culpa",
      "Lorem cupidatat",
      "reprehenderit est cupidatat culpa"
    ],
    "culpaa1": ["irure dolor enim culpa", "proident", "proident"],
    "sunt5": ["nisi deserunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "aliqua proident amet mollit",
  "supplier_part_numbers": {
    "Lorem_88a": [
      "adipisicing laboris velit incididunt",
      "non anim nostrud magna",
      "ipsum sint nostrud",
      "in irure labore cupidatat nostrud"
    ],
    "sint2_7": [
      "Excepteur aute minim Ut",
      "dolore ut in veniam nisi",
      "aliquip sed eiusmod occaecat tempor",
      "aute minim laboris aliquip cupidatat",
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "esse4c5": ["pariatur", "Ut commodo", "enim"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_net_ids": [
    "incididunt amet do eiusmod",
    "labore",
    "culpa esse tempor ullamco",
    "nisi",
    "cupidatat proident"
  ]
}
...
```json
{
  ...
  "message": "cillum qui incididunt Lorem"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "enim commodo consectetur esse in"
}
```
...
```json
{
  ...
  "color": "nostrud ullamco sint sit fugiat"
}
```
...
```json
{
  ...
  "radius_x": "voluptate ipsum incididunt",
  "radius_y": "in aliqua",
  "layer": "top"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 3639419.820123151,
  "outer_height": -49679110.279782176,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "sint esse est",
  "supplier_part_numbers": {
    "labore_2": ["non"],
    "laborum_9": [
      "tempor deserunt voluptate nisi",
      "cillum fugiat",
      "ullamco",
      "cillum irure laboris tempor in"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "esse laboris laborum",
  "model_obj_url": "velit consequat",
  "model_stl_url": "quis",
  "model_3mf_url": "et",
  "model_jscad": {}
}
...
```json
{
  "type": "pcb_plated_hole",
  "shape": "oval",
  "outer_width": -39232054.32071079,
  "outer_height": 18566460.04923816,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "do Lorem aliqua fugiat occaecat"
}
```
...
{
  "irureffa": {
    "left_margin": "tempor sint in",
    "right_margin": "irure qui dolore",
    "top_margin": 18582326.247231767
  }
}
```
