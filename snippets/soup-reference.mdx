...
```json
{
  ...
  "name": "L1",
  "manufacturer_part_number": "cillum nostrud Duis ut",
  "supplier_part_numbers": {
    "laboris36": [],
    "laboris_0f7": [
      "velit consectetur exercitation in ad",
      "eiusmod labore dolor aliquip laboris"
    ],
    "id5": ["culpa eu", "elit amet aliquip nisi Ut", "anim"],
    "Lorema": []
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["qui minim velit"],
...
```json
{
  ...
  "supplier_part_numbers": {
    "elitd": ["velit ipsum amet aute magna"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "elit cupidatat esse labore",
  "supplier_part_numbers": {
    "ullamco8f_": ["sunt cupidatat", "anim in", "occaecat anim", "eiusmod"],
    "reprehenderit1": ["est"],
    "ut48a": ["incididunt do cillum"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "et consequat deserunt",
  "supplier_part_numbers": {
    "non0": [
      "non mollit reprehenderit cupidatat laborum",
      "deserunt Lorem occaecat qui eu",
      "dolor anim aliqua"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "reprehenderit sunt eiusmod Lorem laborum",
  "supplier_part_numbers": {
    "non_6ad": ["id ad sit proident", "quis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "occaecat sint culpa",
  "supplier_part_numbers": {
    "quis_f": [
      "enim aute laboris dolor",
      "veniam consectetur velit ut cillum",
      "minim Ut"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "enim qui aute exercitation",
  "supplier_part_numbers": {
    "aliquae": [
      "occaecat Duis",
      "in non labore Excepteur nulla",
      "sunt",
      "officia"
    ],
    "laborisc7": ["sunt dolor sint sit laborum"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ad mollit",
  "supplier_part_numbers": {
    "Ut_": [
      "minim est commodo dolore",
      "laboris irure occaecat enim cupidatat",
      "amet id aliquip Duis ex",
      "consectetur magna et esse",
      "aliquip"
    ],
    "dolore_dd": ["Duis nostrud", "esse"],
    "adipisicing4": ["sit", "aliquip eiusmod officia in"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_net_ids": [
    "occaecat consectetur incididunt sed velit",
    "Duis ex est dolor"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -53184574.370143965,
  "pin_styles": {},
  "box_width": 20542927.64283949,
  "symbol_name": "dolore ullamco laboris",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "pariatur sunt ipsum Ut elit"
}
```
...
```json
{
  ...
  "message": "labore Excepteur amet anim"
}
```
...
```json
{
  ...
  "message": "exercitation tempor ipsum ex reprehenderit",
...
```json
{
  ...
  "radius_x": 49641140.85838753,
  "radius_y": -5336354.532594398,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "proident aute cupidatat",
  "supplier_part_numbers": {
    "adipisicing75": [
      "exercitation ex in nostrud nulla",
      "occaecat Duis",
      "aliquip anim magna proident dolor",
      "Ut proident",
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "culpa",
  "model_obj_url": "dolor",
  "model_stl_url": "aliquip dolore irure",
  "model_3mf_url": "dolore dolor ut ad veniam",
  "model_jscad": {}
}
```
...
{
  "dolor_2": {
    "right_margin": -38624846.54984173,
    "top_margin": "aliqua nostrud cillum Ut",
    "bottom_margin": -82995741.85096352
  }
}
```
