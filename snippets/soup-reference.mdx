...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat_e": [],
    "aute267": [
      "in eiusmod nisi nostrud",
      "sunt sed tempor quis",
      "laborum est",
      "amet eiusmod minim",
      "adipisicing"
    ]
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "ut",
    "in",
    "dolor qui consectetur in",
    "officia cillum eiusmod velit"
  ],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 55986306.09559995
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor0": ["ad laborum eiusmod exercitation incididunt", "qui"],
    "est77b": ["in esse irure nostrud voluptate", "dolor velit dolore"],
    "sit_8": ["anim sed voluptate sint est", "Excepteur culpa"],
    "magna_cc": ["mollit cupidatat dolor veniam anim", "in reprehenderit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Excepteur et aliquip ad",
  "supplier_part_numbers": {
    "eu0": [
      "aliquip",
      "irure deserunt exercitation",
      "occaecat sed pariatur",
      "dolor anim et"
    ],
    "et1": ["cillum", "do consectetur proident ut pariatur", "dolore"],
    "dolor_b": ["fugiat id irure Ut in", "nostrud", "et quis"],
    "voluptate_d": []
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aliqua ex deserunt ad",
  "supplier_part_numbers": {
    "consectetur_71": [],
    "aute_91": [
      "non sunt",
    ...
    "aute1": [
      "dolor ullamco qui Excepteur",
      "in enim ad Lorem",
      "ipsum do exercitation",
      "ut qui consectetur"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "Ut laborum cillum",
  "supplier_part_numbers": {
    "reprehenderit_b": ["aute", "officia"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_0a": [
      ...
      "tempor",
      "dolor voluptate",
      "anim aliqua et id deserunt"
    ],
    "incididunt1": [
      "irure qui officia veniam",
      "commodo Duis id nulla incididunt",
      "pariatur eiusmod ullamco amet",
      "et nostrud reprehenderit amet",
      "aliquip ad"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "irure minim ut quis dolore",
  "supplier_part_numbers": {
    "nisi__": ["magna minim"],
    "in_271": [
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "et ex quis dolor reprehenderit",
  "supplier_part_numbers": {
    "voluptateb2": ["dolor fugiat dolore sed", "velit Lorem laboris cillum et"],
    "nulla2f1": ["dolore", "consectetur", "ipsum anim"],
    "ex_ebd": ["magna sed sint Lorem", "velit occaecat dolore non voluptate"],
    "Duisd01": [
      "aute laborum",
...
```json
{
  ...
  "connected_source_net_ids": ["nostrud incididunt"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "ullamco est tempor in",
  "pin_styles": {},
  "box_width": "voluptate ad",
  "symbol_name": "esse velit",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "message": "nulla tempor magna dolor"
}
```
...
```json
{
  ...
  "radius_x": "fugiat sed veniam culpa cupidatat",
  "radius_y": "occaecat deserunt",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "reprehenderit dolor nostrud aliquip eu",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "labore pariatur tempor",
  "supplier_part_numbers": {
    "magna069": [
      "quis proident in ex commodo",
      "id aliquip minim Excepteur Ut",
      "qui elit commodo",
      "qui Duis sed nisi",
      "proident"
    ],
    "aliquipd": ["do cupidatat velit", "et"]
  }
}
```
...
```json
{
  ...
  "footprinter_string": "do Lorem qui",
  "model_stl_url": "nulla velit ullamco dolore enim",
  "model_3mf_url": "magna in exercitation"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "qui Duis Ut incididunt"
}
```
...
{
  "dolor1f": {
    "left_margin": "ut adipisicing",
    "right_margin": "eiusmod irure amet velit aliqua",
    "top_margin": -67541422.59742895,
    "bottom_margin": "dolor et veniam"
  },
  "ut6": {
    "bottom_margin": "in"
  }
