...
```json
{
  ...
  "name": "S1",
  "manufacturer_part_number": "commodo et anim",
  "supplier_part_numbers": {
    "dolor21b": ["dolor aliquip veniam", "dolore", "esse id"],
    "ut10": [
      "ullamco",
      "ipsum laboris nisi Excepteur",
      "ad dolor qui voluptate minim"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Excepteur ut ea ut",
  "supplier_part_numbers": {
    "commodoc": [
      "incididunt non",
      "labore",
      "nostrud minim",
      "dolor sed fugiat",
      "voluptate velit Duis exercitation culpa"
    ],
    "laborum06": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "in anim sed occaecat",
  "supplier_part_numbers": {
    "aliqua_d47": ["occaecat culpa", "eu Excepteur consectetur"],
    "velit_bd": ["eu", "ea reprehenderit sint", "ad et ex", "amet deserunt"],
    "add": ["aute Ut ut tempor", "magna fugiat aliqua dolor"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "ex_a": ["labore elit"],
    "aliquabd": [
      "reprehenderit laboris cupidatat occaecat fugiat",
      "veniam ex voluptate"
    ],
    "anim_360": ["sunt anim", "officia voluptate magna"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laboris fugiat",
  "supplier_part_numbers": {
    "Lorem_1": [
      "eiusmod ut sunt deserunt",
      "officia veniam Ut",
      "in dolor nostrud minim deserunt",
      "mollit dolor minim",
      "ex aliquip amet dolore nisi"
    ],
    "aute_72": ["labore nulla cupidatat"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ex_3e": ["non sit anim pariatur", "labore ea ullamco", "sit qui"],
    "ipsum_1c": ["veniam Ut", "sed velit"],
    "ea_": [
      "esse magna sit Ut",
      "Excepteur Lorem velit sed Ut",
      "voluptate deserunt aliqua",
      "dolor ipsum ea deserunt dolore"
    ],
    "et020": [
      "nisi elit Duis reprehenderit",
      "laboris dolor ipsum",
      "aute ullamco nisi tempor",
      "ut laborum ut",
      "est cillum aliqua deserunt"
    ],
    "non3": [
      "reprehenderit deserunt fugiat et irure",
      "culpa magna sed est",
      "ex Ut culpa",
      "et irure ipsum dolor dolore"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "est mollit",
  "supplier_part_numbers": {
    "nisi_06": [
      "id deserunt laborum cupidatat",
      "proident non enim",
      "eiusmod esse",
      "ex sit do amet anim"
    ],
    "reprehenderitd": [
      "in commodo sunt",
      "ullamco",
      "ut nisi deserunt mollit veniam"
    ],
    "cillum19": [
      "ullamco",
      "reprehenderit occaecat nostrud ex",
      "ipsum incididunt",
      "do est ipsum mollit"
    ],
    "ut1fd": ["veniam ut eu"]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ut cupidatat laborum nisi",
  "supplier_part_numbers": {
    "Excepteurc": ["dolore qui minim fugiat Lorem", "velit sed voluptate"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "amet elit occaecat",
    "in ullamco occaecat",
    "tempor et magna nostrud sit",
    "eiusmod aliquip non sint et",
    "officia ea nostrud labore"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "cillum ex nisi",
  "symbol_name": "adipisicing exercitation",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "radius_x": 78974894.30691847,
  "radius_y": 62855720.39990628,
  "layer": "top"
}
```
...
```json
{
  ...
  "type": "pcb_error",
  "error_type": "pcb_trace_error",
  "message": "sit pariatur veniam velit",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
  "pcb_port_ids": ["pcb_port_1", "pcb_port_2"]
...
```json
{
  ...
  "supplier_part_numbers": {
    "amet85f": ["Duis reprehenderit do ut"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "nulla sed enim cillum Ut"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -73492920.38910522,
  "outer_height": 32234140.83055319,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": 27161281.307316765
}
```
...
{
  "eiusmod_a_c": {
    "left_margin": -47054157.48925898
  },
  "deserunt_eb": {
    "left_margin": "labore qui",
    "right_margin": "minim commodo elit Duis",
    "top_margin": -41181182.8157842,
    "bottom_margin": "minim"
  },
  "deserunt_d67": {
    "left_margin": 53072560.612167,
    "right_margin": "ullamco pariatur",
    "top_margin": -65322220.615633465,
    "bottom_margin": 81782877.00796938
  },
  "sed_6": {
    "left_margin": "voluptate sint deserunt",
    "bottom_margin": 19770485.178664416
  }
}
```
