...
```json
{
  ...
  "name": "N1",
  "manufacturer_part_number": "esse labore sint"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "occaecat in officia",
...
```json
{
  ...
  "supplier_part_numbers": {
    "reprehenderit_2": [],
    "pariatur_0": [
      "aute tempor exercitation sed commodo",
      "aute cupidatat",
      "id commodo Lorem dolore",
      "laborum sint"
    ],
    "proident_34": ["laboris velit commodo Ut", "in", "incididunt pariatur"],
    "dolor_86": [
      "irure sed pariatur enim",
      "Excepteur ut anim consectetur culpa"
    ],
    "in_9": ["mollit", "amet est quis", "esse deserunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "consectetur est reprehenderit Ut ullamco",
  "supplier_part_numbers": {
    "quis_285": ["est nisi ea sunt anim"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "quis velit",
  "supplier_part_numbers": {
    "amet8": ["dolore anim", "nisi ea"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ut eu",
  "supplier_part_numbers": {
    "nisi9c": [
      "laborum consectetur pariatur",
      "Duis et Ut magna",
      "tempor consequat dolor nostrud"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "et dolore esse tempor Lorem",
  "supplier_part_numbers": {
    "velit_45": ["nulla sunt", "laborum Lorem", "ex", "veniam", "non"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "tempor nostrud",
  "supplier_part_numbers": {
    "id_08": ["et", "nisi ut in", "aliqua", "proident eiusmod tempor"],
    "dolore2": [],
    "cupidatat2e7": [
      "in",
      "et proident",
      "velit Ut",
      "exercitation officia voluptate magna in"
    ],
    "labore_0dc": ["labore nostrud anim", "ea in dolor dolor"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "pariatur consectetur ut",
  "supplier_part_numbers": {
    "labore__bf": [
      "fugiat mollit",
      "eiusmod deserunt anim veniam labore",
      "culpa irure consectetur aliqua mollit",
      "ex cillum",
      "nulla minim enim quis non"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["ullamco pariatur", "aliqua laborum"],
  "connected_source_net_ids": [
    "deserunt dolor anim cillum",
    "proident esse",
    "in ea"
  ]
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "culpa sint et ut",
  "pin_styles": {},
  "box_width": -28944075.506735742,
  "symbol_name": "in consectetur do ut cupidatat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "commodo sit aliqua cupidatat"
}
```
...
```json
{
  ...
  "message": "esse laboris voluptate id",
...
```json
{
  ...
  "radius_x": "aliqua consectetur commodo mollit enim",
  "radius_y": "dolore deserunt",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "amet Duis consectetur Ut",
  "supplier_part_numbers": {
    "incididunt29": ["sit ut commodo", "velit", "cupidatat"]
  }
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -27972585.619474843
  },
  "layer": "top",
  "footprinter_string": "sit labore aliqua dolor",
  "model_obj_url": "aliqua exercitation ad",
  "model_stl_url": "Duis pariatur dolore",
  "model_3mf_url": "pariatur dolor culpa amet labore",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -56580745.51472465,
  "outer_height": 53049440.273287386,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "labore tempor adipisicing sunt veniam"
}
```
...
```json
{
  "dolor9__": {
    "left_margin": "ullamco",
    "right_margin": "minim occaecat",
    "top_margin": "Lorem cillum"
  }
}
```
