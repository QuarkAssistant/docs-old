...
```json
{
  ...
  "name": "S1",
  "manufacturer_part_number": "veniam aute",
  "supplier_part_numbers": {
    "proidentf": [
      "aliquip adipisicing consectetur dolore sit",
      "Duis tempor consectetur est"
    ],
    "culpa_1": [],
    "Excepteur628": [
      "occaecat voluptate velit adipisicing",
      "do",
      "aute nisi tempor consectetur Duis",
      "Excepteur non",
      "Lorem cupidatat exercitation consequat magna"
    ],
    "in_9d3": [
      "culpa",
      "minim incididunt ut deserunt Excepteur",
      "consectetur ea",
      "non id dolor"
    ]
  }
...
```json
{
  ...
  "supplier_part_numbers": {
    "et__ff": [
      "nostrud quis labore",
      "reprehenderit eiusmod esse ullamco cupidatat"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "qui commodo ipsum culpa non",
  "supplier_part_numbers": {
    "dolor_a": ["officia eu"]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "sint Duis dolor cupidatat in",
  "supplier_part_numbers": {
    "culpa__a0": [
      "in anim nulla sed",
      "nisi occaecat sint",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "minim sed",
  "supplier_part_numbers": {
    "dolor_37": [
      "enim amet sint culpa",
      "sit id in aliqua anim",
      "deserunt",
      "cillum Duis deserunt",
      "non in dolore proident Duis"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "occaecat et",
  "supplier_part_numbers": {
    "sed5b5": [
      "cillum do minim sed incididunt",
      "sint adipisicing deserunt veniam in",
      "aliquip",
      "esse quis",
      "adipisicing"
    ],
    "et_1f": ["nostrud", "velit minim pariatur est"],
    "dolora_0": ["ipsum", "amet", "Duis est"],
    "minim18c": [
      "adipisicing dolore est",
      "irure",
      "exercitation mollit dolor sed commodo",
      "aute enim consectetur occaecat fugiat",
      "laboris cupidatat dolor ad reprehenderit"
    ],
    "magna_f0": []
  },
  "voltage": "5V"
...
```json
{
  ...
  "supplier_part_numbers": {
    "commodo_d_": [
      "consectetur Duis",
      "enim sit ipsum eiusmod ea",
      "in in ut velit"
    ],
    "in237": ["in est sint", "est dolor"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["sunt sed laboris"],
  "connected_source_net_ids": [
    "sed dolore Ut",
    "adipisicing tempor",
    "laborum incididunt quis est dolor",
    "dolor tempor",
    "in dolor eiusmod est consequat"
  ]
}
```
...
```json
{
  ...
  "pin_spacing": "enim",
  "pin_styles": {},
  "box_width": 42923219.74091813,
  "symbol_name": "cupidatat nostrud et ullamco",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "ullamco nulla magna tempor"
}
```
...
```json
{
  ...
  "radius_x": "incididunt",
  "radius_y": "in commodo do laboris ut",
  "layer": "top"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "Duis sed ut Lorem sunt"
}
```
...
{
  "exercitation_7c": {
    "left_margin": -89510322.52793273
  },
  "quis_7": {
    "left_margin": "laborum consequat",
    "right_margin": "deserunt fugiat consectetur quis",
    "top_margin": 31753768.243039772,
    "bottom_margin": -88158607.46504751
  }
}
```
