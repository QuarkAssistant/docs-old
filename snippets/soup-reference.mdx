...
```json
{
  ...
  "name": "N1",
  "manufacturer_part_number": "sit consectetur reprehenderit",
  "supplier_part_numbers": {
    "esse_8": [
      "officia et",
      "eu occaecat",
      "do Ut Excepteur consequat officia"
    ],
    "cillum_af": [
      "sint ullamco Excepteur consequat",
      "Excepteur",
      "proident pariatur",
      "officia non",
      "ut sunt commodo culpa"
    ],
    "ut_9": ["commodo pariatur in magna", "esse"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "deserunt_d18": [
      "minim pariatur voluptate",
      "do",
      "ex enim adipisicing labore tempor",
      "Ut quis in"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Duis ipsum",
  "supplier_part_numbers": {
    "aliqua_b": [
      "dolor proident deserunt",
      "eu in",
      "id",
      "ut laboris proident pariatur",
      "quis laborum deserunt proident"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "adipisicing eu aute id cupidatat",
  "supplier_part_numbers": {
    "et24": [
      "ea",
      "adipisicing ex amet sint tempor",
      "anim nostrud reprehenderit occaecat minim",
      "occaecat",
      "sint tempor"
    ],
    "consequat66": ["sed dolor laboris quis", "incididunt occaecat in"],
    "reprehenderite": [
      "culpa cupidatat",
      "velit sit nisi",
      "dolor ipsum ut ex labore",
      "ipsum",
      "tempor fugiat cillum dolore velit"
    ],
    "ad_42": ["aliqua laboris irure in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "sunt culpa",
  "supplier_part_numbers": {
    "in3a": ["consectetur sit laborum ex sunt"],
    "nostrud594": [
      "minim in in culpa",
      "ea ad",
      "eiusmod et",
      "officia Excepteur velit aliquip ipsum"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ut Ut id",
  "supplier_part_numbers": {
    "consequat_e": ["mollit", "labore", "nulla", "minim", "laboris"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "sint culpa tempor elit",
    "est exercitation",
    "elit laborum",
    "quis est consequat culpa",
    "minim enim sint ex"
  ],
  "connected_source_net_ids": [
    "tempor cillum culpa",
    "deserunt aliquip dolor dolor amet",
    "ut labore ullamco sint",
    "sint"
  ]
}
```
...
```json
{
  ...
  "radius_x": "et ullamco magna est id",
  "radius_y": 41559952.013777316,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "tempor dolore reprehenderit esse laborum",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "exercitation non Ut nulla occaecat"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "in et in dolore veniam",
  "supplier_part_numbers": {
    "pariaturd7": [
      "amet sint",
      "enim ut do ex",
      "anim reprehenderit incididunt dolor"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "adipisicing ullamco exercitation ea",
  "model_obj_url": "anim mollit",
  "model_stl_url": "velit dolor",
  "model_3mf_url": "quis veniam cupidatat",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "nulla eiusmod labore"
}
```
...
{
  "id__45": {
    "left_margin": -36826347.28535752,
    "right_margin": "eu",
    "top_margin": "mollit nisi",
    "bottom_margin": 85852720.17885116
  },
  "voluptate34a": {
    "bottom_margin": "quis ea aliquip deserunt consectetur"
  },
  "est_4": {
    "left_margin": "aute officia quis",
    "right_margin": -25398244.457081094,
    "top_margin": "sunt dolor culpa aliqua cupidatat",
    "bottom_margin": 13852759.119567886
  }
}
```
