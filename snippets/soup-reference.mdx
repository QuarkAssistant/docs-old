...
```json
{
  ...
  "name": "A1",
  "manufacturer_part_number": "id dolor sed",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "aliquip pariatur veniam in",
  "supplier_part_numbers": {
    "sunt_50": ["minim proident"],
    "qui92": ["Excepteur in amet sit"],
    "temporf": ["fugiat in", "sed et labore nulla"],
    "sit_6": ["elit in", "consequat aliquip nisi", "est"],
    "deserunt63": [
      "dolor consequat",
      "occaecat eiusmod anim veniam enim",
      "occaecat irure",
      "do amet cillum et ut",
      "proident qui dolore voluptate veniam"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "ipsum",
    "sunt ut esse in",
    "veniam mollit eu quis officia",
    "id"
  ],
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -42321028.275576286
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "nisi non",
  "supplier_part_numbers": {
    "cupidatat9f2": ["elit tempor cillum commodo", "et consequat ut eiusmod"],
    "consequat3__": [
      "sunt velit laborum in deserunt",
      "enim proident non Lorem in",
      "anim irure aliqua labore"
    ],
    "veniam_9": [
      "adipisicing esse est",
      "aute",
      "amet consectetur eiusmod pariatur"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "esse_1d_": [
      "consequat Duis dolore commodo veniam",
      "ullamco sit id culpa dolore",
      "ad qui",
      "esse fugiat",
      "laboris"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "Excepteur irure"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "magna consequat dolore eiusmod",
  "supplier_part_numbers": {
    "in0": [
      "dolore ea",
      "laborum ad id anim",
      "voluptate Duis",
      "nisi ipsum consectetur adipisicing",
...
```json
{
  ...
  "connected_source_port_ids": [
    "labore",
    "enim",
    "reprehenderit in fugiat eu",
    "dolore ad Lorem nulla dolore",
  ...
  "connected_source_net_ids": [
    ...
    "officia amet esse",
    "aliquip",
    "in aliqua Ut irure non",
    "laborum sit nisi reprehenderit in"
  ]
}
```
...
```json
{
  ...
  "radius_x": -13539486.909336194,
  "radius_y": 7996044.720295712,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "pariatur consectetur ad et ullamco",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "dolor reprehenderit laboris id"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "tempor4": ["et ut consequat culpa reprehenderit"],
    "aliquip990": ["sunt occaecat sed eiusmod non"],
    "dolore_7": [
      "culpa mollit quis ea",
      "laboris aute esse id",
      "exercitation esse Excepteur consectetur eu",
      "aliquip dolore",
      "culpa eu"
    ]
  }
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "cillum aliquip",
  "model_obj_url": "minim mollit consectetur dolor tempor",
  "model_stl_url": "in aliquip sunt",
  "model_3mf_url": "sit aute elit veniam quis",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -69125368.0102176,
  "outer_height": 56296929.424214065,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "aliqua Excepteur Lorem Ut"
}
```
...
{
  "labore_c": {
    "right_margin": "deserunt anim",
    "top_margin": -73298860.69104554
  },
  "consectetur_ce": {
    "top_margin": 98825151.1608634
  },
  "ut_9": {
    "left_margin": "culpa occaecat dolor laborum",
    "right_margin": -83059320.06205273,
    "top_margin": "cupidatat in Lorem"
  }
}
```
