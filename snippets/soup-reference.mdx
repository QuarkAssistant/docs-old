...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "ea dolor pariatur"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "nisi dolore nulla",
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["laboris magna voluptate in"],
  "is_power": false,
  "is_ground": false,
  "is_analog_signal": true,
  "trace_width": -96035742.9180259
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "laborum dolor sit mollit do",
  "supplier_part_numbers": {
    "aliquaa": [
      "occaecat Excepteur officia dolor qui",
      "laborum",
      "elit minim ex"
    ],
    "quis_c": [
      "elit non enim nostrud sit",
      "labore eiusmod culpa",
      "ea consectetur cillum"
    ],
    "nulla_5e": ["cillum", "nostrud quis aute tempor nisi"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "elit exercitation anim",
  "supplier_part_numbers": {
    "dolord": ["ex adipisicing voluptate Ut"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "adipisicing_": [
      "aliqua et occaecat dolore",
      "nulla proident deserunt quis qui"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ad labore pariatur elit nisi"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "tempor qui",
  "supplier_part_numbers": {
    "aliquip_a4": []
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "inc7": ["minim dolor", "deserunt est ipsum laboris"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "Utd5": [
      "exercitation adipisicing nisi deserunt",
      "culpa ut",
      "id exercitation nisi"
    ],
    "ut971": [
      "voluptate ut esse",
      "sunt Duis esse ullamco tempor",
...
```json
{
  ...
  "connected_source_net_ids": ["tempor"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "cillum eiusmod irure",
  "pin_styles": {},
  "box_width": 25920392.12826723,
  "symbol_name": "occaecat ea in",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "est consectetur reprehenderit nostrud"
}
```
...
```json
{
  ...
  "radius_x": -99150153.96754132,
  "radius_y": "nisi adipisicing et",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "et do quis consectetur ad",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "do proident aute in consequat",
  "supplier_part_numbers": {
    "consecteturd": [
      "irure anim in mollit sint",
      "Duis commodo fugiat laborum dolore",
      "sint",
      "ea ullamco consectetur"
    ],
    "esse_f": ["cillum ut aliqua dolor enim"],
    "consequatd43": [
      "ipsum in dolore",
      "Excepteur sint veniam dolore aliqua",
      "irure exercitation pariatur commodo et",
      "ad",
      "et ex Lorem"
    ],
    "mollite6c": ["nostrud sunt esse occaecat", "fugiat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "sunt Lorem magna pariatur eu",
  "supplier_part_numbers": {
    "non90a": ["dolore amet proident ipsum"],
    "consectetur_8": [
      "velit cillum aute",
      "Duis aliqua consequat",
      "ex incididunt ullamco culpa"
    ],
    "incididunt27": [
      "proident in esse ullamco",
      "aliqua voluptate",
      "in est irure elit"
    ],
    "in6": []
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": 16679800.154073328
  },
  "layer": "top",
  "model_obj_url": "laboris",
  "model_stl_url": "elit et labore in",
  "model_3mf_url": "nostrud occaecat eu ad",
  "model_jscad": {}
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "laboris dolor amet veniam velit"
}
```
...
{
  "ut_878": {
    "left_margin": -90305416.53526689,
    "right_margin": 88648822.41722837,
    "top_margin": 16110870.05744265,
    "bottom_margin": 7203664.2349253595
  },
  "reprehenderit_a76": {
    "left_margin": "velit magna consectetur cillum"
  },
  "Excepteur_6": {
    "right_margin": "aute ullamco",
    "top_margin": "velit",
    "bottom_margin": "velit irure sunt enim"
  },
  "inf57": {
    "right_margin": "commodo Duis",
    "bottom_margin": -73896937.81889558
  },
  "fugiat0": {
    "left_margin": "esse ut dolore",
    "top_margin": -28805743.56096348,
    "bottom_margin": 14419995.41383487
  }
}
```
