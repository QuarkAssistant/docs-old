...
```json
{
  ...
  "name": "E1",
  "manufacturer_part_number": "in cillum",
  "supplier_part_numbers": {
    "aliquip_f96": ["culpa reprehenderit anim occaecat"],
    "tempor460": ["nisi ut", "mollit proident in officia"],
    "ada61": [
      "et ex",
      "eu ut non id ipsum",
      "officia pariatur ipsum exercitation",
      "adipisicing in id sint enim"
    ],
    "ea56": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "sed Excepteur consequat non",
  "supplier_part_numbers": {
    "proident_3": [
      "est id",
      "dolor id deserunt qui voluptate",
      "non aute tempor voluptate commodo",
      "consequat mollit"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laboris reprehenderit mollit cupidatat",
  "supplier_part_numbers": {
    "dolore_69": ["fugiat"]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "do nulla",
  "supplier_part_numbers": {
    "ad5_e": [
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "incididunt eiusmod",
  "supplier_part_numbers": {
    "mollit_748": [
      "Excepteur nisi",
      "dolor anim nulla enim",
      "aliquip culpa in voluptate deserunt",
      "ea minim adipisicing cupidatat laboris",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "consectetur quis sed aliqua occaecat",
  "supplier_part_numbers": {
    "nisi9": ["mollit occaecat", "dolor officia incididunt ut"],
    "culpa_45": ["esse nulla quis deserunt", "Excepteur", "qui", "in"],
    "nulla8": ["irure labore voluptate"],
    "amet_b05": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "anim reprehenderit amet non culpa",
  "supplier_part_numbers": {
    "aute_31": ["exercitation"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "anim occaecat nisi",
  "supplier_part_numbers": {
    "esse87_": ["aliqua ut in aliquip"],
    "amet_89c": []
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "laborum ipsum in ad",
    "occaecat velit exercitation reprehenderit non"
  ],
  "connected_source_net_ids": ["pariatur est", "ex nostrud culpa dolore esse"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 19039799.255923033
}
```
...
```json
{
  ...
  "message": "irure sint dolor adipisicing"
}
```
...
```json
{
  ...
  "message": "enim in eiusmod consectetur"
}
```
...
```json
{
  ...
  "message": "ullamco Lorem velit id",
...
```json
{
  ...
  "radius_x": "eiusmod do ut",
  "radius_y": -92910562.85794835,
  "layer": "top"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "cupidatat nisi pariatur nostrud aute"
  },
  "size": {
    "x": "3mm",
    "y": "1mm",
...
{
  "cupidatat93": {
    "right_margin": "deserunt exercitation minim anim eiusmod",
    "top_margin": -9063600.821928695,
    "bottom_margin": 28317315.74513179
  },
  "proidentbb9": {
    "right_margin": "veniam elit",
    "top_margin": 35090822.81436452,
    "bottom_margin": -82688974.04608841
  },
  "nisi8b": {
    "left_margin": "elit dolor aliqua exercitation",
    "right_margin": -75084237.52941269,
    "top_margin": -65012532.66571272,
    "bottom_margin": "Excepteur elit minim culpa"
  },
  "ea_4": {
    "left_margin": -55885706.22826805,
    "right_margin": 96593167.78735906,
    "top_margin": "quis velit",
    "bottom_margin": "eiusmod sit culpa nostrud"
  }
}
```
