...
```json
{
  ...
  "ftype": "Ut occaecat quis esse veniam",
  ...
  "supplier_part_numbers": {
    "occaecat_d2": [
      "ut dolor",
      "sunt",
      "minim adipisicing exercitation dolor Duis",
      "occaecat exercitation laborum do ut"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "sunt aute id nostrud"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Duis cillum proident",
  "supplier_part_numbers": {
    "enim__0": [],
    "aliquip0": ["dolore cupidatat aliqua"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "dolor elit in",
  "supplier_part_numbers": {
    "dolore7d": ["incididunt", "et nostrud incididunt", "id"],
    "ad_03": []
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "Lorem officia",
  "supplier_part_numbers": {
    "reprehenderit_65": []
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": ["velit amet", "enim minim ex fugiat ad"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "aute dolore dolor",
  "pin_styles": {},
  "box_width": -91267594.23808664,
  "symbol_name": "sed"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "amet id laboris qui consectetur"
}
```
...
```json
{
  ...
  "color": "aute aliqua laborum ex anim"
}
```
...
```json
{
  ...
  "message": "in anim mollit sunt magna"
}
```
...
```json
{
  ...
  "radius_x": 79559744.38332239,
  "radius_y": -5479022.186669052,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "est ex aliquip dolore",
  "supplier_part_numbers": {
    "anim_2a": [
      "deserunt eu cillum ea nisi",
      "aute ea eiusmod Duis officia",
      "Ut deserunt",
      "qui",
      "dolor"
    ],
    "nisi_01": [
      "ad aliquip et",
      "aute Lorem sunt voluptate quis",
      "id aliquip",
      "id ut"
    ],
    "adipisicing9": ["do sunt", "sint ea Excepteur esse", "irure dolore"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolore_c": [
      "officia dolor laboris ex",
      "fugiat in voluptate",
      "aliquip in laborum veniam sed"
    ]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "quis",
  "model_obj_url": "id anim exercitation",
  "model_stl_url": "deserunt magna sunt ad",
  "model_3mf_url": "in velit culpa voluptate minim",
  "model_jscad": {}
}
```
...
```json
{
  "consectetur_ff": {},
  "ullamco_234": {
    "left_margin": "Lorem consequat pariatur Ut cupidatat",
    "top_margin": "quis anim nulla aute",
    "bottom_margin": -3417204.4370625317
  }
}
```
