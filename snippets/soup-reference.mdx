...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "deserunt sed Ut"
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "reprehenderit",
    "nulla commodo elit adipisicing cupidatat",
    "elit enim ea",
    "ipsum occaecat quis amet",
    "occaecat et"
  ],
  "is_power": false,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 27907471.37832898
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ea_c": ["sint fugiat", "commodo eiusmod exercitation", "sint"],
    "quis7": [
      "qui dolor",
      "sed commodo occaecat Excepteur",
      "adipisicing sit elit eiusmod sunt",
      "id ipsum",
      "in enim amet quis nisi"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "quis Ut nulla dolor",
  "supplier_part_numbers": {
    "ad__": ["irure fugiat culpa laborum", "culpa Lorem eiusmod"],
    "dolord9": ["quis amet do nulla fugiat", "id pariatur nulla elit"],
    "sitc": ["deserunt nostrud in dolore", "in dolore est", "dolor"],
    "aliqua235": [
      "tempor ut dolore exercitation",
      "fugiat eiusmod eu incididunt",
      "amet ut tempor"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "nostrud cillum nisi",
  "supplier_part_numbers": {
    "elit9": ["ad"],
    "veniama5": [
      "ipsum",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "magna aliquip aliqua mollit",
  "supplier_part_numbers": {
    "anim_a9": [
      "elit mollit Lorem tempor",
      "pariatur cupidatat sint occaecat culpa"
    ],
    "non98": ["ea nisi in", "voluptate dolor cillum minim labore"],
    "aute_b7": ["adipisicing", "anim deserunt et adipisicing elit"],
    "occaecat5": []
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "etde": [
      "in irure sunt",
      "pariatur irure cillum in nulla",
      "esse ipsum sed culpa"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "labore ut anim",
    "nulla do exercitation sit",
    "dolor proident voluptate",
    "nisi"
  ],
  "connected_source_net_ids": ["Duis adipisicing nulla", "dolor sint"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "elit culpa Ut",
  "symbol_name": "irure sed non labore",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "ullamco exercitation ut ex cupidatat"
}
```
...
```json
{
  ...
  "message": "nostrud sed cupidatat est Duis",
  ...
  "route": [
    {
      ...
      "y": "1mm",
      "via": false,
      "trace_width": "fugiat elit do sed"
    },
    {
      "x": "3mm",
      "y": "1mm",
      "via": true,
      "trace_width": "eu aliquip Ut"
    }
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "magna quis Excepteur",
  "supplier_part_numbers": {
    "et_2": ["in ad", "exercitation irure"],
    "dolor_3": [],
    "sit_a": [
      "reprehenderit",
      "reprehenderit culpa adipisicing aliquip",
      "sed esse aliqua amet sunt",
      "quis Duis voluptate laboris ad"
    ],
    "anim_6fa": ["exercitation id", "Excepteur cillum ad sit"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "laboris",
  "model_obj_url": "labore dolor velit",
  "model_stl_url": "nostrud ut",
  "model_3mf_url": "exercitation elit minim",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "sunt qui ullamco Lorem pariatur"
}
```
...
{
  "culpa6b0": {
    "left_margin": "Lorem ullamco",
    "right_margin": "non nostrud consectetur",
    "top_margin": -22017346.341426164,
    "bottom_margin": "laboris mollit"
  },
  "ut_4": {
    "left_margin": "exercitation nulla",
    "top_margin": "in Ut aliqua incididunt irure"
  },
  "sint_4": {
    "left_margin": "ullamco sed aute nisi"
  },
  "magna6_": {
    "left_margin": -15245952.777150556,
    "right_margin": -67314342.44068062,
    "top_margin": "aute incididunt"
  }
}
```
