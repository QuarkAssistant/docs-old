...
```json
{
  ...
  "supplier_part_numbers": {
    "dolore_9a5": [
      "irure ad",
      "minim dolore dolore mollit",
      "aute in dolor ipsum",
      "do ut"
    ],
    "quis294": [
      "ex reprehenderit veniam voluptate",
      "cillum",
      "reprehenderit ad eu eiusmod proident",
      "occaecat id cupidatat do"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "dolor magna eu consectetur",
  "supplier_part_numbers": {
    "dolor_0": ["enim", "nulla", "dolore", "sit"],
    "deserunt49": [
      "in",
      "consectetur",
      "laboris",
      "qui ipsum voluptate Excepteur adipisicing",
      "exercitation sint proident nostrud"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "fugiat id nisi",
  "supplier_part_numbers": {
    "pariatur_dd": ["velit adipisicing voluptate cupidatat dolore"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "occaecat_b4": [
      "dolor anim eiusmod deserunt elit",
      "Ut dolore ad dolor sunt"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "consectetur dolore",
  "supplier_part_numbers": {
    "commodo_f0": [
      "pariatur",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ipsum ad consectetur aliquip reprehenderit",
  "supplier_part_numbers": {
    "in4_": [
      "deserunt amet aliqua labore",
      "in non dolore dolor nostrud",
      "pariatur cillum aliqua eu reprehenderit"
    ],
    "in90": ["esse Ut minim aute irure"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "voluptate sed ea",
  "supplier_part_numbers": {
    "veniam_20": [],
    "aliqua_e": [
      "exercitation in amet commodo in",
      "dolor",
      "in mollit ut",
      "ullamco occaecat qui nulla eu"
    ],
    "ut_9e6": ["culpa Ut", "mollit fugiat"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "cillum_8d4": [
      ...
      "ut non",
      "ullamco id laboris cupidatat",
      "occaecat est reprehenderit anim adipisicing"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_net_ids": [
    "ea nulla",
    "irure elit ut in",
    "fugiat incididunt Excepteur et eu",
    "consectetur nulla dolore nostrud"
  ]
}
```
...
```json
{
  ...
  "radius_x": -23473548.95758684,
  "radius_y": 95016292.44335598,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "officia elit adipisicing quis velit",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": -27830913.146474227
    }
  ]
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ut__ce": [
      ...
      "minim dolore dolor eu ex",
      "aute Lorem in laboris"
    ],
    "proident239": [
      "magna aliqua tempor consectetur enim",
      "deserunt sed occaecat minim",
      "officia eu Duis sit",
      "nostrud Ut"
    ]
  }
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "consectetur voluptate consequat"
  }
}
```
...
{
  "Lorem_e9d": {
    "right_margin": "officia anim cupidatat",
    "top_margin": "consectetur ea tempor commodo magna",
    "bottom_margin": "est elit ad dolor"
  },
  "eaab6": {
    "left_margin": "amet velit in qui",
    "right_margin": "Lorem et laboris ex aliqua",
    "bottom_margin": "pariatur est nisi"
  },
  "ex4b": {
    "left_margin": "ex ullamco dolor",
    "right_margin": -36755604.970482245,
    "top_margin": "commodo ea qui Duis"
  }
}
```
