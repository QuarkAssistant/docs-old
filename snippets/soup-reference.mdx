...
```json
{
  ...
  "supplier_part_numbers": {
    "consectetur5d": [
      "aliqua est enim cupidatat",
      "Excepteur velit non dolor voluptate",
      "in",
      "occaecat aute minim dolor exercitation"
    ],
    "qui_1a": ["labore laborum voluptate irure"]
  }
}
```
...
```json
{
  ...
  "is_power": false,
  "trace_width": -31263388.026805356
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "est id",
  "supplier_part_numbers": {
    "incididunt_9c": [
      "quis anim occaecat",
      "cillum adipisicing dolor officia fugiat",
      "quis",
      "laboris",
      "labore amet fugiat non"
    ],
    "et_e86": [],
    "ad_d4d": [
      "non officia",
      "et amet",
      "fugiat labore elit eiusmod",
      "eiusmod",
      "magna anim adipisicing aliqua sint"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "irure velit aliqua",
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "officia dolor",
  "supplier_part_numbers": {
    "incididunt1": ["Lorem Excepteur quis occaecat"]
  }
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "dolorf": ["aliquip", "minim in aliquip"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "aute ad",
  "supplier_part_numbers": {
    "in7": ["laboris", "sint"],
    "eiusmod03_": [
      "fugiat sed adipisicing et",
      "anim laboris id",
      "occaecat quis dolore esse",
      "incididunt in et dolor consequat",
      "dolore reprehenderit in Excepteur mollit"
    ],
    "officia_d": [],
    "dolor_e54": ["qui est consequat"],
    "mollit5f": [
      "cillum mollit id elit",
      "quis qui Duis dolore aliqua",
      "occaecat commodo tempor pariatur nostrud",
      "mollit labore ullamco eiusmod commodo"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "do velit",
  "supplier_part_numbers": {
    "do_d9": ["qui in", "esse dolore fugiat", "veniam eu"],
    "et_8": [
      "sit Lorem cillum dolor qui",
      "eiusmod",
      "irure tempor elit",
      "ipsum velit minim amet reprehenderit"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_net_ids": [
    "adipisicing dolore tempor magna",
    "ut nostrud velit",
    "laborum",
    "ad officia",
    "pariatur ea cupidatat eiusmod laboris"
  ]
}
```
...
```json
{
  ...
  "message": "dolor nostrud nisi occaecat"
}
```
...
```json
{
  ...
  "message": "dolor eiusmod consequat Excepteur voluptate"
}
```
...
```json
{
  ...
  "message": "consectetur Duis officia in enim",
...
```json
{
  ...
  "radius_x": "pariatur eiusmod sit dolor",
  "radius_y": "do",
  "layer": "top"
}
```
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "ullamco adipisicing occaecat dolor culpa"
    },
    {
      "to_layer": "bottom"
    },
    {
      "x": "3mm",
      "y": "1mm",
      "trace_width": "ullamco quis proident dolore sint"
    }
  ]
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "sint sit ex Lorem proident"
  },
  "footprinter_string": "est veniam"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "fugiat deserunt ut"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "nostrud aute Ut exercitation"
}
```
...
{
  "in_1": {
    "left_margin": "tempor consectetur",
    "right_margin": "eiusmod",
    "top_margin": 83317668.03335509
  },
  "deserunt_0": {
    "left_margin": "reprehenderit",
    "right_margin": -67230767.60048339
  }
}
```
