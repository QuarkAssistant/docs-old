...
```json
{
  ...
  "supplier_part_numbers": {
    "culpa1": ["aliqua pariatur nisi dolore", "consequat sed ullamco"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "enim_68": ["est dolor exercitation", "id", "fugiat elit"],
    "incididunt_": ["eiusmod dolore"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "mollit",
    "sit",
    "laborum commodo Lorem pariatur",
    "occaecat",
    "quis velit"
  ],
  "is_power": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "est Excepteur",
  "supplier_part_numbers": {
    "commodo9": ["id"],
    "quis2": [],
    "id_f": [
      "elit magna sint ipsum nulla",
      "ullamco aliquip elit in",
      "tempor nisi",
      "officia ea aute Lorem"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "in_a": ["mollit elit nostrud adipisicing cupidatat", "pariatur fugiat"],
    "ut56": [
      "incididunt",
      "culpa",
      "sit in Ut id",
      "laborum Lorem adipisicing reprehenderit"
    ],
    "officia_1": ["id proident", "in velit", "occaecat"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "magna ipsum eiusmod",
  "supplier_part_numbers": {
    "ut61": [
      "exercitation mollit eu ut",
      "labore",
      "dolor ipsum",
      "adipisicing minim"
    ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "aliquip laboris eiusmod",
  "supplier_part_numbers": {
    "quiaa": [
      "reprehenderit quis dolore dolor",
      "cupidatat",
      "culpa tempor eu",
      "nulla in et velit ipsum",
      "labore"
    ],
    "eubf": [
      "culpa nulla ut adipisicing",
      "aliqua",
      "enim pariatur ut id",
      "enim"
    ],
    "voluptatea7": [
      "in",
      "in exercitation",
      "minim officia exercitation incididunt",
      "veniam mollit velit magna"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sunt_5": [],
    "id_2": [
      "pariatur mollit sed incididunt anim",
      "veniam minim sint voluptate quis",
      "ea dolor amet exercitation Excepteur",
      "dolor amet Excepteur exercitation"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ex do veniam pariatur",
  "supplier_part_numbers": {
    "minim_7d1": [
      "enim exercitation cillum",
      "qui incididunt occaecat laborum",
      "cupidatat",
      "in",
      "ullamco deserunt Lorem"
    ],
    "exercitation9": ["sunt nisi in deserunt ad", "laboris", "exercitation"],
    "mollita": ["exercitation fugiat anim", "commodo ut cupidatat"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_net_ids": ["pariatur occaecat"]
}
```
...
```json
{
  ...
  "message": "consectetur amet dolor ullamco"
}
```
...
```json
{
  ...
  "message": "nostrud in irure Excepteur sint"
}
```
...
```json
{
  ...
  "radius_x": 1298524.5157628953,
  "radius_y": 32482184.785850346,
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": -15820242.047276437
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "type": "pcb_error",
  "error_type": "pcb_placement_error",
  "message": "laborum consectetur ea eu"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "eu cillum non cupidatat consectetur",
  "supplier_part_numbers": {
    "eu7_": ["nostrud adipisicing eu in occaecat"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "model_stl_url": "dolore Excepteur voluptate",
  "model_3mf_url": "aliqua est incididunt voluptate Excepteur",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "voluptate Excepteur dolor est aliquip"
}
```
...
{
  "nulla26": {
    "left_margin": "officia do proident ad non",
    "right_margin": "in enim ipsum",
    "top_margin": -53712953.4190524,
    "bottom_margin": 80023894.21491939
  },
  "ipsum_0": {}
}
```
