...
```json
{
  ...
  "name": "P1",
  "manufacturer_part_number": "fugiat commodo nulla aute",
  "supplier_part_numbers": {
    "eu_b": [],
    "non_5ad": ["reprehenderit labore laborum voluptate"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ex et",
  "supplier_part_numbers": {
    "proidentbc4": [
      "labore enim",
      "ex Duis sed proident",
      "officia commodo adipisicing culpa",
      "ex veniam"
    ],
    "velit482": ["nisi eu elit reprehenderit", "occaecat esse exercitation"],
    "dolore_fd": ["cupidatat minim", "consectetur incididunt in elit consequat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "eiusmod consequat non ut",
  "supplier_part_numbers": {
    "inb2": [
      "dolore est sit occaecat",
      "non occaecat sunt ipsum",
      "sed in id Ut labore",
      "in id irure",
      "veniam occaecat quis irure"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "non Lorem esse adipisicing",
  "supplier_part_numbers": {
    "essee": [
      "ea et sint ut consequat",
      "dolor amet",
      "quis exercitation",
      "adipisicing id",
      "Excepteur"
    ],
    "cillum1a_": ["eu", "irure", "in", "tempor enim sit cupidatat", "eiusmod"],
    "eiusmod_c4f": [],
    "ad___": [
      "amet nulla tempor laboris",
      "Ut occaecat fugiat esse",
      "proident tempor",
      "in culpa commodo",
      "nisi ullamco"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "commodo non ad amet",
  "supplier_part_numbers": {
    "id_92_": [
      "in consequat",
      "esse cillum in",
      "velit enim dolore fugiat",
      "qui sint do reprehenderit"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "eiusmod_c0c": [
      "commodo enim velit consequat adipisicing",
      "sint",
      "consectetur labore sint Lorem"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolorea": [
      "officia culpa et elit",
      "officia deserunt labore qui",
      "laboris nostrud anim ea nisi",
      "Lorem ex ullamco labore"
    ],
    "sint451": ["ut ut", "do", "tempor cillum"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "exercitation occaecat",
  "supplier_part_numbers": {
    "adipisicing_7": ["tempor voluptate minim incididunt"],
    "Loremc1": [
      "amet",
      "eiusmod nulla proident fugiat",
      "laborum nulla culpa elit amet"
    ],
    "id4": ["laborum laboris velit", "nisi", "proident", "veniam"],
    "inf4a": [
      "amet tempor esse eu",
      "in ullamco id",
      "eu tempor",
      "cupidatat ipsum mollit occaecat",
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "Duis_3": ["id", "sit pariatur anim quis sed"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "qui sunt in laborum",
  "pin_styles": {},
  "box_width": 73856581.60368887,
  "symbol_name": "Lorem non anim cupidatat"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "id veniam occaecat Lorem"
}
```
...
```json
{
  ...
  "radius_x": "labore veniam non aute incididunt",
  "radius_y": "velit voluptate",
  "layer": "top"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 39996011.22776869,
  "outer_height": 58788947.03417191,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "supplier_part_numbers": {
    "ex5": ["ut nostrud ex proident", "enim dolor quis sed aliquip", "ad", "eu"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "laboris reprehenderit",
  "model_obj_url": "Excepteur ut incididunt est anim",
  "model_stl_url": "voluptate Duis",
  "model_3mf_url": "deserunt mollit non id",
  "model_jscad": {}
}
```
...
```json
{
  "type": "pcb_plated_hole",
  "shape": "pill",
  "outer_width": -19275272.828779414,
  "outer_height": 92612115.63074255,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "in91f": {
    "left_margin": "eiusmod Duis minim adipisicing",
    "right_margin": "laborum ut Duis commodo ullamco",
    "top_margin": 91800808.0140186,
    "bottom_margin": -75878663.39972523
  }
}
```
