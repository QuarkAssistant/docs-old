...
```json
{
  ...
  "ftype": "dolor sit culpa sunt",
  "source_component_id": "source_component_1",
  "name": "D1",
  "supplier_part_numbers": {
    "dolore86": [
      "amet eu reprehenderit qui velit",
      "dolor enim laborum eiusmod",
      "amet et ea labore occaecat",
      "in dolor ipsum irure",
      "sint nulla Lorem"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "labore ea elit ut",
  "supplier_part_numbers": {
    "Lorembe": ["do", "ut reprehenderit ipsum id ex", "incididunt fugiat est"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["sed magna"],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": -38544598.117434956
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "qui quis sit",
  "supplier_part_numbers": {
    "ex7": [
      "laboris fugiat enim",
      "ullamco in ut aute ea",
      "aliqua esse eu fugiat occaecat",
      "fugiat cillum nostrud est"
    ],
    "esse47": ["nulla id", "sit pariatur", "culpa"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "deserunt et",
  "supplier_part_numbers": {
    "tempor_06b": [
      "aliquip pariatur mollit ea",
      "ut quis id",
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "do_37d": ["officia et dolor", "culpa", "eiusmod"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolore incididunt laboris",
  "supplier_part_numbers": {
    "commodo4a": ["dolore ut ut", "consequat qui dolore elit"],
    "ullamco_d27": [
      "dolore",
      "eiusmod et veniam",
      "do est",
      "non aliquip nisi reprehenderit magna"
    ],
    "minim_b": [],
    "in82": ["Excepteur cupidatat", "nulla eu sunt Lorem", "commodo"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "elit labore aute",
  "supplier_part_numbers": {
    "amet__": [
      "aliquip dolore consectetur culpa id",
      "eiusmod sint ea et",
      "in",
      "in anim",
      "deserunt"
...
```json
{
  ...
  "supplier_part_numbers": {
    "animd": [
      "nostrud Excepteur est dolor",
      "ex eiusmod ea magna",
      "tempor ullamco mollit esse anim",
      "enim"
    ],
    "estcb": ["Lorem velit magna nostrud", "in consequat ex", "sit"],
    "ullamcoab": ["labore", "elit ad deserunt"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -83225957.87030202,
  "box_width": "proident dolor cupidatat fugiat in",
  "symbol_name": "ipsum qui",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "mollit dolor dolore non sunt"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "anim exercitation non nostrud dolor"
}
```
...
```json
{
  ...
  "radius_x": "labore cillum",
  "radius_y": 72921648.75334075,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "adipisicing cupidatat mollit",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "sed amet elit minim"
    },
    {
      "x": "3mm",
      "via": true,
...
```json
{
  ...
  "supplier_part_numbers": {
    "mollit_5": [
      "eu ut Duis",
      "occaecat Lorem",
      "Duis in et sed magna",
      "esse est"
    ],
    "exe1": ["irure", "non nisi magna Duis eiusmod", "enim non ex"],
    "in2_": [
      "sint laboris",
      "ad cillum Excepteur dolor",
      "pariatur",
      "incididunt",
      "in ut Duis"
    ]
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -26433005.963556692
  },
  "layer": "top",
  "footprinter_string": "ea pariatur deserunt esse eu",
  "model_obj_url": "et consectetur",
  "model_stl_url": "et elit",
  "model_3mf_url": "ad deserunt"
}
```
...
{
  "nulla_6e": {
    "left_margin": "Excepteur pariatur consequat irure",
    "right_margin": 99414611.62690902
  }
}
```
