...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "id aliqua sint amet",
  "supplier_part_numbers": {
    "sunt_44": ["ut in sunt aliquip"],
    "adb_": ["Lorem exercitation nostrud magna Excepteur", "nulla officia ut"],
    "aliquip613": ["reprehenderit", "Ut elit reprehenderit", "ipsum"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "labore do fugiat",
    "cupidatat laborum laboris labore",
    "aliqua culpa",
    "nisi deserunt",
...
```json
{
  ...
  "supplier_part_numbers": {
    "Excepteur_1a5": [
      "mollit in cillum officia voluptate",
      "tempor dolor proident",
      "cupidatat",
      "tempor deserunt minim",
      "et consectetur tempor id"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "labore1": ["fugiat", "minim Excepteur culpa", "fugiat", "ut"],
    "non_42c": ["adipisicing sed commodo"],
    "temporad": [
      "irure incididunt nisi",
      "nisi in veniam pariatur reprehenderit"
    ],
    "proident_8a": ["veniam incididunt", "id pariatur"],
    "deserunt_7cd": ["anim laborum minim", "consectetur ad"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolorf8e": [
      "dolore consectetur",
      "laboris",
      "ullamco non cupidatat sed aliquip"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "Lorem esse sunt",
  "supplier_part_numbers": {
    "anim_f": [
      "nisi ex est eu",
      "nostrud adipisicing",
...
```json
{
  ...
  "connected_source_port_ids": [
    "veniam dolore",
    "magna ipsum enim",
    "reprehenderit et labore do",
    "Lorem Duis anim in Excepteur",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "nostrud reprehenderit veniam",
  "pin_styles": {},
  "box_width": -2494069.330842614,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "radius_x": -60659654.9597747,
  "radius_y": "sint officia nisi commodo",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "exercitation est fugiat deserunt mollit",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "et ullamco sit",
  "model_obj_url": "dolor qui",
  "model_stl_url": "qui eiusmod laborum proident in",
  "model_3mf_url": "exercitation ut est in Lorem",
  "model_jscad": {}
}
```
...
{
  "Ut7e": {
    "left_margin": -45587584.68438486,
    "right_margin": -71639382.2032244,
    "top_margin": "et"
  },
  "dolore_4c": {
    "left_margin": "voluptate",
    "top_margin": "ipsum adipisicing cupidatat",
    "bottom_margin": "consectetur Excepteur Lorem ut"
  }
}
```
