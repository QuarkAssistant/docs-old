...
```json
{
  ...
  "name": "L1",
  "manufacturer_part_number": "ut sunt eiusmod officia",
  "supplier_part_numbers": {
    "reprehenderit6": [
      "minim deserunt ex Excepteur",
      "dolore ex Duis aliquip",
      "Ut"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "cillum in voluptate",
  "supplier_part_numbers": {
    "sint_6": [
      "in in velit amet magna",
      "officia tempor Duis",
      "mollit incididunt"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "anim ea ullamco irure laborum",
  "supplier_part_numbers": {
    "occaecat8_3": [],
    "qui_472": [],
    "elit_6b3": ["non veniam", "nulla", "magna nostrud"],
    "elit7": ["incididunt", "aute culpa", "cillum"],
    "voluptate_39": ["officia dolor", "quis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "quis ad laborum",
  "supplier_part_numbers": {
    "mollitc_": [
      "ex sunt minim in",
      "ad voluptate et Ut",
...
```json
{
  ...
  "supplier_part_numbers": {
    "in3d": ["ea", "Ut cillum pariatur incididunt labore", "dolor do eiusmod"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "et reprehenderit aute"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ex_8_": ["Duis ipsum pariatur", "cillum aute dolor"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ut incididunt",
  "supplier_part_numbers": {
    "Ut6": [
      "fugiat aliqua",
      "esse enim qui sint",
      "reprehenderit occaecat culpa consectetur exercitation",
      "minim laboris dolor occaecat",
      "proident do qui"
    ],
    "fugiat60": [
      "magna qui cillum sint et",
      "occaecat",
      "amet Ut anim mollit dolore",
      "aute sint",
      "ea qui sed laboris aute"
    ],
    "exercitation7": [
      "incididunt ut eu",
      "dolor",
      "incididunt nostrud voluptate commodo",
      "dolor id",
      "id"
    ]
  },
...
```json
{
  ...
  "connected_source_port_ids": ["eiusmod ullamco est"],
  "connected_source_net_ids": [
    "tempor",
    "velit in magna enim",
    "non exercitation proident pariatur",
    "sunt pariatur"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 76518882.38885894,
  "pin_styles": {},
  "box_width": 88346961.03790241,
  "symbol_name": "tempor velit laboris",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "officia sunt dolor minim dolore"
}
```
...
```json
{
  ...
  "message": "sit reprehenderit ex fugiat"
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "Ut_714": ["qui sint Excepteur", "fugiat nulla qui irure do"],
    "tempor719": ["laboris aliquip minim"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "cillum laborum qui",
  "model_obj_url": "dolor mollit",
  "model_stl_url": "ea sunt Lorem",
  "model_3mf_url": "velit magna veniam",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "pariatur commodo sunt sed adipisicing"
}
```
...
```json
{
  ...
  "y": "1mm",
  "to_layer": "bottom",
  "trace_width": 37923964.908032864
}
```
...
{
  "dolor4": {
    "left_margin": "mollit deserunt amet in",
    "right_margin": -45230936.07836803,
    "top_margin": -58929900.22072025
  },
  "labore_71": {
    "left_margin": -75931797.25640114,
    "right_margin": "aliquip dolor Ut",
    "top_margin": -97500404.20453456,
    "bottom_margin": "sed cupidatat proident minim"
  },
  "eiusmod_2": {
    "left_margin": "cillum ex anim dolor nisi",
    "top_margin": 67809402.929898
  }
}
```
