...
```json
{
  ...
  "ftype": "voluptate veniam ex aliqua enim",
  "source_component_id": "source_component_1",
  "name": "V1",
  "manufacturer_part_number": "eu dolor in",
  "supplier_part_numbers": {
    "in96e": ["pariatur", "in minim"],
    "proidenta": ["nulla aliqua sunt", "labore quis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ut consectetur deserunt amet est",
  "supplier_part_numbers": {
    "sunt_f2": ["dolor et reprehenderit"],
    "sitf0": ["pariatur Lorem", "deserunt"],
    "ex60d": ["labore amet ex irure qui", "cupidatat"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "exercitation est ipsum consectetur minim",
    "sit ullamco minim ut ut",
    "ullamco",
    "tempor fugiat"
  ],
  "is_power": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ullamco eu",
  "supplier_part_numbers": {
    "commodo68_": [
      "laboris quis sunt minim Excepteur",
      "Ut laboris",
      "nisi proident"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ex exercitation minim do",
  "supplier_part_numbers": {
    "id9": []
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "minim quis et cupidatat"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "nisi eu",
  "supplier_part_numbers": {
    "non__": ["amet ad fugiat sed"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ipsum ea ex Duis consectetur",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "proident et Lorem",
  "supplier_part_numbers": {
    "nulla75": [
      "ad id non",
      "dolore reprehenderit dolor cupidatat",
      "in nisi amet"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "route": [],
  "stroke_width": "0.1mm",
  "color": "adipisicing sunt laborum nisi tempor"
}
```
...
```json
{
  ...
  "text": "Hello, World!",
  "layer": "top",
  "color": "eiusmod consectetur reprehenderit dolore voluptate"
}
```
...
```json
{
  ...
  "message": "exercitation irure consequat Lorem sunt"
}
```
...
```json
{
  ...
  "message": "nostrud enim reprehenderit occaecat ipsum",
...
```json
{
  ...
  "radius_x": "dolor in commodo qui magna",
  "radius_y": "voluptate cillum",
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 75955420.60082835
    },
    {
      "x": "3mm",
      "y": "1mm",
      "to_layer": "bottom",
      "trace_width": "esse dolore aliquip reprehenderit"
    },
    {
      "x": "3mm",
      "via": true,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "aliqua laborum ea",
  "supplier_part_numbers": {
    "amet7": ["qui in id dolore irure", "anim dolore"],
    "Excepteur6": [
      "ut dolore elit sit ut",
      "in eu reprehenderit ea",
      "cillum",
      "mollit aliqua"
    ]
  }
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "Lorem nulla sit labore aute",
  "model_3mf_url": "magna esse officia"
}
```
...
{
  "tempor_9": {
    "left_margin": "amet voluptate in",
    "right_margin": -79435147.71081515
  }
}
```
