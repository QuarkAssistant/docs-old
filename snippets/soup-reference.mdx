...
```json
{
  ...
  "supplier_part_numbers": {
    "incididuntd2b": ["est officia consectetur in", "labore ut commodo"],
    "in_c": ["sint eiusmod esse"],
    "exercitation9": ["enim in"],
    "irure907": [
      "in ex ut id labore",
      "ad anim",
      "quis dolor anim ullamco ut",
      "consequat",
      "do Excepteur in quis"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["pariatur amet eu"],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 76519058.9155944
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "sit occaecat",
  "supplier_part_numbers": {
    "veniam5fd": [],
    "ut_9b8": [
      "anim ex labore sunt",
      "ad quis deserunt",
      "sed aute cillum anim ex",
      "id Excepteur minim"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "exercitation ea quis",
  "supplier_part_numbers": {
    "ut3": ["sint exercitation ut dolor sit", "Ut eu"],
    "adipisicingff": [
      "voluptate",
      "aliqua dolor reprehenderit ut ullamco",
      "anim laborum esse fugiat"
    ],
    "elit_6": [
      "amet eu sint veniam quis",
      "proident quis est sed Duis",
      "cupidatat dolor commodo velit incididunt"
    ],
    "sintd9": [
      "aliqua laborum",
      "enim nisi in officia proident",
      "adipisicing eu id do"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "et_2": [],
    "Excepteurfe": ["ex", "deserunt ad eiusmod eu", "Lorem est sint labore"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "exercitation Excepteur adipisicing incididunt",
  "supplier_part_numbers": {
    "ex47f": ["velit dolore ut laborum aliqua"],
    "aliquip_4": [],
    "officia_d2": ["nostrud enim consectetur fugiat"],
    "enim_110": [
      "tempor ullamco quis cupidatat",
      "occaecat cillum do eu velit",
      "sunt ea sed cillum",
      "do adipisicing",
      "officia dolore ut"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "cupidatat elit sint",
  "supplier_part_numbers": {
    "ex_d": ["nostrud", "minim nisi", "officia nulla do"],
    "tempor3d": [
      "voluptate commodo",
      "mollit amet cillum aliquip in",
      "incididunt consectetur quis occaecat"
    ],
    "eu_83f": [
      "dolore ex cupidatat veniam exercitation",
      "sunt minim anim cupidatat laboris",
      "in incididunt nostrud",
      "minim aliquip"
    ],
    "elit34": ["magna laboris", "adipisicing"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "non quis",
  "pin_styles": {},
  "box_width": "voluptate",
  "symbol_name": "consequat magna",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "ipsum amet incididunt ut"
}
```
...
```json
{
  ...
  "message": "occaecat deserunt consequat dolor dolor",
...
```json
{
  ...
  "supplier_part_numbers": {
    "enim_8d9": ["ea laboris nostrud dolore do", "sed"],
    "aliquip17": ["amet", "laboris Ut ut ullamco", "aute", "non et aliquip"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "aute qui in laboris nostrud",
  "model_obj_url": "mollit consequat Ut ex in"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "culpa officia anim nisi ut"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 10380462.971894428,
  "outer_height": 52925953.44288781,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "sed_3a": {
    "left_margin": 70852832.28979224,
    "right_margin": "velit quis ad",
    "top_margin": "qui",
    "bottom_margin": -68053076.06925327
  },
  "sint20": {
    "left_margin": "sit",
    "right_margin": -33187335.05963616,
    "top_margin": "nostrud exercitation dolor dolore id"
  },
  "minim_9": {
    "left_margin": "adipisicing irure non reprehenderit",
    "top_margin": 54405565.02950126,
    "bottom_margin": 16781871.27380775
  }
}
```
