...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "mollit dolore",
  "supplier_part_numbers": {
    "irure5c": ["nisi ut sint"],
    "sunt_0e7": [
      "tempor",
      "ut sed",
      "occaecat Excepteur aliqua in",
      "Duis anim",
      "reprehenderit eu enim nostrud veniam"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "in cupidatat",
    "commodo",
    "ad veniam laboris Ut",
    "quis culpa",
    "ad aliquip qui proident"
  ],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 18469242.77603747
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sed eu"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "et aute in Duis",
  "supplier_part_numbers": {
    "ada": [
      "nisi veniam sint magna aute",
      "in labore",
      "nisi irure dolore",
      "quis adipisicing ea",
      "proident officia dolore et commodo"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "minimb_5": [
      "ullamco sed non cillum",
      "in nulla aliqua ea",
      "aute pariatur occaecat laboris"
    ],
    "dolorf9": [],
    "laboris_9": [
      "labore",
      "incididunt consequat sunt",
      "Lorem anim magna aute ex"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "nostrud culpa",
  "supplier_part_numbers": {
    "mollit1a5": ["cillum pariatur culpa nisi labore", "exercitation dolor sed"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "quid11": [
      "irure tempor do",
      "est ullamco cupidatat sint incididunt",
      "dolore fugiat mollit enim nostrud",
      "tempor dolore est nostrud"
    ],
    "non_34": [
      "eiusmod esse ad occaecat",
      "pariatur non Duis",
      "sit pariatur",
      "sint elit deserunt fugiat est"
    ],
    "sitf": [
      "aliquip",
      "in pariatur",
...
```json
{
  ...
  "connected_source_port_ids": [
    "sunt Ut veniam dolore ullamco",
    "tempor velit quis"
  ],
  "connected_source_net_ids": ["eu", "do laboris"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "aliqua tempor laborum aute",
  "pin_styles": {},
  "box_width": 76429312.86722767,
  "symbol_name": "in",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "Excepteur consectetur est"
}
```
...
```json
{
  ...
  "radius_x": "pariatur nulla qui aute consectetur",
  "radius_y": -49816260.01966468,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "ut esse consectetur dolor irure",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": -13518309.098278984
  },
  "footprinter_string": "dolor Ut ut",
  "model_obj_url": "in minim dolor",
  "model_stl_url": "exercitation",
  "model_3mf_url": "anim cupidatat voluptate",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "anim_3": [
      "quis ex proident",
      "voluptate magna",
      "magna proident sit adipisicing tempor",
      "in eiusmod est"
    ],
    "dolore624": [
      "esse est exercitation et adipisicing",
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "consectetur Lorem et mollit labore"
  },
  "rotation": "90deg",
  "layer": "top",
  "footprinter_string": "ut cupidatat",
  "model_3mf_url": "deserunt tempor elit et Excepteur",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 3827925.388632998,
  "outer_height": 5603059.672739133,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "eu_1a": {
    "left_margin": "qui adipisicing reprehenderit eiusmod",
    "right_margin": -39073170.826677695,
    "top_margin": "adipisicing sit velit",
    "bottom_margin": 89112367.51360634
  },
  "qui_5": {
    "left_margin": "Duis minim veniam sit anim",
    "right_margin": -27742775.69606909,
    "top_margin": "dolor ea in nisi",
    "bottom_margin": 36438525.86014366
  }
}
```
