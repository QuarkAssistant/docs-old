...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "irure enim nulla ea",
  "supplier_part_numbers": {
    "nisi37": [
      "labore officia quis ad esse",
      "commodo ullamco et",
      "commodo dolor nulla eiusmod",
      "ut",
      "laborum"
    ],
    "reprehenderit_2": [
      "sunt magna minim",
      "in do aute deserunt proident",
      "fugiat et",
    ...
    "magnaf": [
      ...
      "sed nisi sint ex",
      "exercitation",
      "ex esse culpa in sed"
    ],
    "tempor5c": ["aute mollit velit Excepteur culpa", "consequat"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "labore4": [
      "nulla commodo",
      "eu velit culpa consequat in",
      "ut ad enim dolore"
    ],
    "voluptate_2": ["Ut", "adipisicing", "ad dolor"],
    "proident193": ["incididunt ut cupidatat dolore", "dolore dolor ea cillum"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "proident dolor",
  "supplier_part_numbers": {
    "reprehenderit_b": ["exercitation deserunt sed magna voluptate"],
    "in_242": ["exercitation dolore"],
    "Lorem_9": [
      "in aliqua anim occaecat ipsum",
      "sit deserunt consectetur officia",
      "occaecat aute dolor consectetur ipsum",
      "Excepteur"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "laboris consequat exercitation in commodo",
  "supplier_part_numbers": {
    "magna9": [],
    "consectetur3": [
      "commodo",
      "tempor fugiat",
      "laborum aliqua quis proident",
      "Duis dolore consectetur in proident",
      "Lorem aliqua ut voluptate"
    ],
    "dolor2c": [
      "in cillum",
      "sunt occaecat velit sint",
      "aliquip anim pariatur veniam Excepteur",
      "quis sed ad"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "anim ut pariatur dolor",
  "supplier_part_numbers": {
    "mollit_251": [
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ea dolore sint",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "deserunt minim ex pariatur",
  "pin_styles": {},
  "box_width": "velit in cupidatat non nulla",
  "symbol_name": "incididunt proident",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "irure aute elit laboris anim"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "officia aute consectetur"
}
```
...
```json
{
  ...
  "color": "amet proident consectetur"
}
```
...
```json
{
  ...
  "message": "officia do consequat in elit",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "radius_x": 93347942.96546894,
  "radius_y": -82149284.10520709,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "occaecat Ut Excepteur in",
  "supplier_part_numbers": {
    "adipisicing4": ["cillum et"]
  }
}
```
...
```json
{
  ...
  "footprinter_string": "in mollit ullamco esse",
  "model_obj_url": "sit do elit"
}
```
...
{
  "ut_489": {
    "left_margin": -10160922.401144385,
    "right_margin": "Excepteur",
    "bottom_margin": -70989024.42578888
  },
  "ullamco_803": {
    "left_margin": "anim adipisicing fugiat nulla occaecat",
    "top_margin": -83595388.88279197,
    "bottom_margin": "voluptate consectetur"
  }
}
```
