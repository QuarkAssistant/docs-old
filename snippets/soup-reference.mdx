...
```json
{
  ...
  "name": "I1",
  "manufacturer_part_number": "quis occaecat",
  "supplier_part_numbers": {
    "velit6": ["do cillum ut eiusmod ullamco"],
    "aliquip08": ["deserunt", "ullamco amet Duis labore elit", "non enim magna"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ad ex",
  "supplier_part_numbers": {
    "commodo_7c": [],
    "ut1f7": [
      "culpa esse proident aliqua irure",
      "sint in",
      "ut pariatur et esse"
    ],
    "sedd": ["exercitation id nostrud quis ipsum"],
    "sed_4db": ["Lorem et ex laborum proident"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ut deserunt laborum non do",
  "supplier_part_numbers": {
    "eiusmodb42": [
      "ut occaecat magna sed",
      "culpa et nostrud pariatur",
      "sit dolor Ut ex"
    ],
    "id_5": ["incididunt est exercitation", "elit est", "ut"],
    "exercitation_4": [
      "ut laboris cupidatat voluptate",
      "exercitation dolor deserunt aliqua amet",
      "velit cillum aliquip aute fugiat"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "deserunt adipisicing cillum in dolore",
  "supplier_part_numbers": {
    "dolore_dc9": ["consequat ut"],
    "voluptate_1f": [
      "reprehenderit tempor Duis in laboris",
      "ea ullamco sit enim eu"
    ],
    "in_1": [
      "magna mollit aliqua consequat amet",
      "minim",
      "Lorem",
      "id cupidatat laborum occaecat Ut",
      "reprehenderit"
    ],
    "adipisicing597": [
      "sunt",
      "nostrud qui ullamco Duis",
      "id in pariatur voluptate",
      "irure nulla ex sit qui"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "eu_bd": [
      "ex esse Lorem veniam ad",
      "deserunt",
      "ex minim ea exercitation amet",
      "commodo in"
    ],
    "sedac": ["eiusmod ullamco", "laboris"],
    "anim_fbc": ["non", "eu", "aute ex quis in commodo"],
    "Lorem_4": ["aliqua cillum", "sed"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["dolore"],
  "connected_source_net_ids": [
    "labore voluptate cupidatat",
    "esse id labore in eiusmod",
    "occaecat laboris cupidatat",
    "nisi magna deserunt elit"
  ]
}
```
...
```json
{
  ...
  "message": "id laborum exercitation aute"
}
```
...
```json
{
  ...
  "radius_x": "proident sint cupidatat Ut",
  "radius_y": 64143085.565794736,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "reprehenderit non mollit",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": "ut enim ullamco quis"
    }
  ]
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": 1710086.7282812297
  },
  "footprinter_string": "in pariatur et tempor laborum",
  "model_obj_url": "culpa occaecat ut",
  "model_stl_url": "nostrud",
  "model_3mf_url": "esse laborum ut",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "anim_56b": [
      "aliquip id",
      "occaecat sed mollit deserunt",
      "culpa sint Ut Duis ut",
      "Lorem nisi consequat dolor",
      "cillum esse culpa laborum adipisicing"
    ]
  }
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -13176046.931401193
  },
  "layer": "top",
  "footprinter_string": "id",
  "model_obj_url": "consequat",
  "model_stl_url": "elit ut",
  "model_3mf_url": "ad in nostrud irure",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": 11465354.092898875
}
```
...
{
  "sit_e0": {
    "left_margin": 56588016.8041406,
    "right_margin": 65778438.28729254,
    "top_margin": 90189523.36534306
  }
}
```
