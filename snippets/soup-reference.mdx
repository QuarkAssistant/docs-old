...
```json
{
  ...
  "ftype": "aute qui exercitation consectetur pariatur",
  "source_component_id": "source_component_1",
  "name": "A1",
  "manufacturer_part_number": "aute esse",
  "supplier_part_numbers": {
    "Excepteur_b": [
      "nostrud ipsum",
      "incididunt",
      "culpa",
      "anim dolor nulla sunt nostrud",
      "tempor voluptate cillum"
    ],
    "adipisicing885": ["Lorem dolore", "nisi sint"],
    "sedae": ["cupidatat non", "nostrud dolore laboris Duis sit"],
    "adipisicing_2": ["culpa nisi", "incididunt consequat anim"],
    "euc2c": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "mollit nisi veniam fugiat laboris",
  "supplier_part_numbers": {
    "velit_88": [
      "Lorem dolor nostrud",
      "dolore sit proident esse",
      "amet exercitation tempor dolore"
    ],
    "ad423": [
      "pariatur tempor amet exercitation adipisicing",
      "deserunt occaecat"
    ],
    "quis_b": [
      "amet mollit",
      "pariatur irure Excepteur in cillum",
      "ut dolore eiusmod",
      "esse"
    ],
    "esse_c": ["aliquip", "irure tempor sed minim Ut"],
    "sedd1": []
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "veniam velit adipisicing non Lorem",
    "sint commodo deserunt reprehenderit culpa",
    "veniam amet fugiat"
  ],
  "trace_width": -86893325.23984304
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat_13b": ["Lorem"],
    "dolor35": [
      "pariatur ipsum elit reprehenderit consequat",
      "dolore",
      "amet Duis",
      "in eu velit in et",
      "Excepteur Lorem sint ipsum"
    ],
    "ex_c": [
      "dolor deserunt",
      "proident consectetur",
      "sed",
      "ea consectetur cupidatat incididunt officia"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "veniam in sit"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "anim sed sunt cupidatat labore",
  "supplier_part_numbers": {
    "exercitationa": [
      "veniam aliquip do Duis",
      "ut",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "laborum tempor ea",
  "supplier_part_numbers": {
    "veniam982": ["pariatur est sint sit"],
    "eiusmodb": ["velit occaecat", "dolore in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "quis esse magna do voluptate",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "consectetur sunt nisi",
  "supplier_part_numbers": {
    "uta": ["in irure eiusmod velit", "velit sed ullamco Duis"],
    "ut9f": [
      "in ut id nostrud consectetur",
      "anim Ut",
      "cillum Duis qui laboris"
    ],
    "magna_20c": ["Duis Ut non", "culpa"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "in velit dolore commodo aliquip",
    "ex ad",
    "officia ipsum adipisicing",
    "id",
    "aliquip ad culpa et dolore"
  ],
  "connected_source_net_ids": ["anim enim eu", "ut dolor eu"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 99060483.05478525,
  "pin_styles": {},
  "box_width": 5292352.008401886,
  "symbol_name": "pariatur sit cupidatat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "Excepteur cillum cupidatat"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "in et adipisicing aliqua laborum",
  "pin_styles": {},
  "box_width": "cupidatat sit officia in",
  "symbol_name": "mollit",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "supplier_part_numbers": {
    "irure_ee": [],
    "dolore_028": ["cupidatat occaecat officia", "fugiat aute", "id est"],
    "elit_c61": ["ad dolor occaecat dolor aute"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "tempor esse exercitation velit"
  },
  "rotation": "90deg",
  "footprinter_string": "anim commodo voluptate",
  "model_obj_url": "ipsum officia consectetur sit",
  "model_stl_url": "qui adipisicing esse",
  "model_3mf_url": "veniam anim sed"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 25934880.686033472,
  "outer_height": -23559377.295898855,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "y": "1mm",
  "to_layer": "bottom",
  "trace_width": "ut Excepteur dolor eu deserunt"
}
```
...
{
  "do_d49": {
    "left_margin": 27375266.65699251,
    "right_margin": 8430693.279097483,
    "top_margin": "quis",
    "bottom_margin": "cillum adipisicing Excepteur ipsum reprehenderit"
  }
}
```
