...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "labore proident esse cupidatat ipsum",
  "supplier_part_numbers": {
    "id_": ["consectetur aliquip exercitation minim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "deserunt minim in eiusmod sed"
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["dolore", "cupidatat dolore"],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": 30226588.404428646
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ea in sint tempor deserunt",
  "supplier_part_numbers": {
    "Loremeb": ["incididunt esse eiusmod in", "sit voluptate Lorem"],
    "est_5": ["in", "ea deserunt dolor", "deserunt enim laborum nulla"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "pariatur elit do veniam",
  "supplier_part_numbers": {
    "quif8e": [],
    "sit_4_4": ["minim", "consectetur voluptate", "veniam Ut ipsum"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolor irure proident sed Lorem",
  "supplier_part_numbers": {
    "in_e3a": [
      "amet",
      "do amet nostrud sint",
      "amet sit",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolore ad nostrud amet ut",
  "supplier_part_numbers": {
    "Excepteur_8": [
      "irure Excepteur proident veniam",
      "enim qui",
      "adipisicing Duis irure esse dolor",
      "in",
      "Lorem laborum ex ad magna"
    ],
    "laborumfa": [],
    "fugiat_1eb": ["quis qui laborum"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "fugiat ea",
  "supplier_part_numbers": {
    "nullab": []
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "incididunt eu nostrud",
  "supplier_part_numbers": {
    "consequat_46": [
      "elit culpa do cupidatat",
      "sunt non nostrud fugiat Lorem",
      "id tempor",
      "tempor nostrud quis"
    ]
  },
...
```json
{
  ...
  "connected_source_port_ids": [
    "est",
    "voluptate labore adipisicing esse anim"
  ],
  "connected_source_net_ids": [
    "anim",
    "ad laborum Ut ex aute",
    "incididunt pariatur veniam Lorem"
  ]
}
```
...
```json
{
  ...
  "message": "in dolor quis proident sit"
}
```
...
```json
{
  ...
  "model_3mf_url": "nostrud minim exercitation dolore veniam"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "incididunt id ullamco"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "amet nulla do dolore cupidatat"
}
```
...
{
  "sede4a": {
    "left_margin": 50414803.58858523,
    "right_margin": 48544134.77514279,
    "top_margin": 91262903.7318806,
    "bottom_margin": "eu in ipsum labore"
  },
  "minim524": {
    "top_margin": 43892632.31321746
  },
  "ut_568": {
    "left_margin": "elit consequat magna culpa pariatur",
    "top_margin": 92891475.72127306,
    "bottom_margin": 66394150.71673769
  }
}
```
