...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ipsum culpa cillum",
  "supplier_part_numbers": {
    "et4": [
      "elit incididunt",
      "consequat officia",
      "Excepteur amet et exercitation cillum"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "anim_5": [
      "in",
      "officia dolore laboris aliquip",
      "eiusmod mollit officia culpa in"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "aute veniam",
  "supplier_part_numbers": {
    "nostrud_859": [
      "ea anim",
      "Lorem labore id esse",
      "minim officia veniam proident",
      "occaecat dolore"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "minim_b": [
      "dolore dolore",
      "adipisicing pariatur laborum deserunt",
      "cillum in consectetur ipsum",
      "sit Excepteur exercitation ipsum"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ea et anim veniam elit",
  "supplier_part_numbers": {
    "velit_a_": [],
    "sint662": ["minim reprehenderit"],
    "consectetur4": [
      "in laborum",
      "et est occaecat dolore",
      "Lorem voluptate",
      "Duis esse"
    ]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "dolor in consequat nisi",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["id irure", "incididunt ullamco sed"],
  "connected_source_net_ids": ["labore quis dolor velit"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -24528671.36213568,
  "pin_styles": {},
  "box_width": "sunt commodo",
  "symbol_name": "in adipisicing consequat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "eiusmod dolor consectetur Duis"
}
```
...
```json
{
  ...
  "radius_x": -97085715.04460739,
  "radius_y": "laborum amet qui",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "quis reprehenderit labore",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "labore elit ullamco"
  },
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -37672550.108055525
  },
  "footprinter_string": "commodo non nulla",
  "model_obj_url": "ut Ut",
  "model_3mf_url": "sed irure",
  "model_jscad": {}
}
```
...
{
  "eiusmod_b5": {
    "left_margin": -73493239.83782291,
    "right_margin": "cillum sunt aliqua nulla",
    "top_margin": "dolor sint aute Duis"
  }
}
```
