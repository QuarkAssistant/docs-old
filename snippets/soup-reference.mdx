...
```json
{
  ...
  "ftype": "dolor tempor ex ad",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ad Ut",
  "supplier_part_numbers": {
    "dolore_e9": ["anim dolor"],
    "sunt9e": [
      "Ut adipisicing Excepteur commodo sit",
      "fugiat adipisicing",
      "dolore tempor commodo in aliqua"
    ],
    "anim_b74": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ad ut ut cupidatat et",
  "supplier_part_numbers": {
    "elit6": ["dolore ex", "Ut", "sint enim nisi non incididunt"],
    "ex_b73": []
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["commodo laborum Ut est enim", "voluptate"],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 77583589.63793531
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "officia consequat amet aliqua",
  "supplier_part_numbers": {
    "ex_42": ["Ut veniam nisi", "exercitation nulla quis enim", "id veniam"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "voluptate_23a": [
      "laborum enim",
      "ex aliqua tempor exercitation magna",
      "sunt",
      "aliquip ea",
      "nisi"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "sit et laborum aliquip eu",
  "supplier_part_numbers": {
    "eu796": ["eu anim"],
    "utda": [],
    "ine29": ["qui", "veniam"],
    "dolor_73": [
      "nulla minim proident ut exercitation",
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_dd": [
      "officia voluptate",
      "consequat voluptate cillum exercitation nisi"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "minim reprehenderit",
  "supplier_part_numbers": {
    "tempor3": [
      "sed non cupidatat",
      "deserunt velit est nostrud",
      "enim sint dolore incididunt",
      "enim",
      "veniam"
    ]
  },
...
```json
{
  ...
  "connected_source_port_ids": ["mollit", "est ut velit", "elit"],
  "connected_source_net_ids": ["tempor mollit adipisicing", "minim magna"]
}
```
...
```json
{
  ...
  "color": "quis voluptate irure ea cillum"
}
```
...
```json
{
  ...
  "message": "officia sed enim Excepteur",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolor ullamco cupidatat",
  "supplier_part_numbers": {
    "magna_80": [
      "ea cupidatat aliqua Duis",
      "et consectetur mollit cupidatat esse",
      "dolor voluptate",
      "commodo ipsum"
    ]
  }
...
```json
{
  ...
  "layer": "top",
  "model_stl_url": "reprehenderit",
  "model_3mf_url": "esse sint ut ex culpa",
  "model_jscad": {}
}
```
...
```json
{
  "type": "pcb_plated_hole",
  "shape": "oval",
  "outer_width": 6446029.878628641,
  "outer_height": -75208815.07064873,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "dolor_5": {
    "left_margin": -63881528.955695674,
    "right_margin": "qui amet",
    "top_margin": "eiusmod",
    "bottom_margin": "sit elit"
  },
  "dolor_46": {
    "left_margin": -43905402.367878966,
    "top_margin": "consequat aliquip aute veniam",
    "bottom_margin": "proident"
  },
  "ex_7c": {
    "left_margin": "proident culpa aliqua nulla",
    "right_margin": 10421659.129059345,
    "top_margin": -35506045.88822686,
    "bottom_margin": -38737133.887636155
  }
}
```
