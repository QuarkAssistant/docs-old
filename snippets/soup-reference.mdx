...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "exercitation laborum do Ut dolore",
  "supplier_part_numbers": {
    "officia_d": [
      "et",
      "occaecat proident Ut Excepteur",
      "consequat aliqua adipisicing",
      "et velit cupidatat eu"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["nisi culpa dolor"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": -64215714.73876635
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "nondf": [],
    "dolor1_8": [
      "sunt esse minim Excepteur dolor",
      "fugiat qui sunt aute",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolor sit veniam enim amet",
  "supplier_part_numbers": {
    "dolor918": [],
    "velit_3": ["aute sit", "pariatur aute enim amet dolor", "Ut"],
    "fugiat_2": ["id"],
    "consequat_532": ["consectetur Ut et anim sit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "id consectetur",
  "supplier_part_numbers": {
    "dolored": [
      "non ullamco ex magna veniam",
      "ad amet cillum nisi culpa",
      "velit veniam quis",
      "proident ea voluptate deserunt ad",
      "ipsum nisi adipisicing dolore"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ad sit commodo occaecat",
  "supplier_part_numbers": {
    "nostrud4": [
      "esse labore elit sint",
      "reprehenderit consequat ipsum nostrud",
      "deserunt elit dolore laboris",
      "nostrud tempor"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "irure2_c": [
      "non in eiusmod",
      "in commodo pariatur aliquip",
      "sint",
      "in amet",
      "occaecat"
    ],
    "ipsum_5": [
      "elit dolor laboris Lorem",
      "tempor commodo Lorem",
      "sit qui ut dolore dolore"
    ],
    "Lorem9e7": ["sunt culpa est aute cillum"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "tempor do minim aliquip deserunt",
  "supplier_part_numbers": {
    "laborum_5": [
      "Excepteur adipisicing consequat consectetur enim",
      "pariatur ullamco dolore esse mollit",
      "reprehenderit eu ullamco",
      "ipsum",
      "minim eu"
    ],
    "culpa_5": ["consequat irure", "dolore mollit Excepteur non"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["ad ea in", "ullamco reprehenderit"],
  "connected_source_net_ids": ["ad"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "nulla quis laboris esse do",
  "pin_styles": {},
  "box_width": "proident adipisicing voluptate",
  "symbol_name": "anim minim",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "message": "do commodo adipisicing tempor"
}
```
...
```json
{
  ...
  "text": "Hello, World!",
  "layer": "top",
  "color": "Ut cupidatat proident ea"
}
```
...
```json
{
  ...
  "message": "occaecat proident Lorem aliqua"
}
```
...
```json
{
  ...
  "radius_x": 54686230.06616244,
  "radius_y": 31494083.89090067,
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 13177676.310740292
    }
  ]
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "Excepteur_5f6": [
      "laborum",
      "sunt magna anim dolor eiusmod",
      "occaecat adipisicing aliquip elit",
      "reprehenderit dolor deserunt cupidatat",
      "aute esse"
    ]
  }
}
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": -33181060.779030956
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "laboris est adipisicing culpa nostrud"
  },
  "layer": "top",
  "footprinter_string": "cillum sed",
  "model_obj_url": "dolor reprehenderit veniam in occaecat",
  "model_stl_url": "tempor",
  "model_3mf_url": "nulla do ea Ut anim",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 71611263.74811494,
  "outer_height": -22613233.655259848,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "commodoeeb": {
    "left_margin": -59269776.8408823,
    "right_margin": "elit labore sed in occaecat",
    "top_margin": 8996764.726546407,
    "bottom_margin": "Excepteur est velit ad"
  },
  "eu_36": {
    "left_margin": -25437979.665308356,
    "right_margin": "mollit sint dolore veniam",
    "top_margin": -52815904.26593348,
    "bottom_margin": "eu"
  },
  "cillum4d": {
    "left_margin": "Lorem ullamco nostrud anim",
    "right_margin": -65829669.921015024,
    "top_margin": "cupidatat reprehenderit",
    "bottom_margin": "velit Ut"
  },
  "enim__f": {
    "left_margin": 50415174.85919064,
    "right_margin": 78521320.76766258,
    "top_margin": -75097389.41688621,
    "bottom_margin": 45313791.59639579
  }
}
```
