...
```json
{
  ...
  "ftype": "voluptate sit ut",
  "source_component_id": "source_component_1",
  "name": "V1",
  "manufacturer_part_number": "laboris in",
  "supplier_part_numbers": {
    "veniam_d14": [
      "aliquip anim sunt cupidatat",
      "aute",
      "elit exercitation eu tempor",
      "voluptate"
    ],
    "consequat_9": [
      "aliqua nulla dolore ipsum irure",
      "irure fugiat",
      "dolore ad",
      "laborum exercitation nisi dolor ut"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "sint do",
  "supplier_part_numbers": {
    "fugiata": [
      "minim Excepteur velit in voluptate",
      "occaecat eu esse nisi Duis",
      "est fugiat",
      "et Duis ullamco"
    ],
    "qui6a": ["consequat occaecat dolore nostrud"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["labore enim", "in et voluptate", "cillum"],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": 89259904.63571468
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "id mollit",
  "supplier_part_numbers": {
    "veniam_b5b": [],
    "consectetur_c34": ["ea culpa", "veniam", "do aliqua"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ex5": ["exercitation adipisicing amet dolor", "nulla ut eu"],
    "pariatur__9": [
      "do laboris sit ad",
      "nisi ut aliqua veniam",
      "aliqua consequat ut ea elit",
      "deserunt laborum",
      "mollit qui ad"
    ]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aliqua ipsum Ut",
  "supplier_part_numbers": {
    "nisib": ["nisi ad"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "elit occaecat in ut",
  "supplier_part_numbers": {
    "ametb07": [
      "ea in aliqua Excepteur",
      "dolor fugiat ex",
      "nulla ut exercitation Ut",
      "dolore et",
      "sit cillum ut"
    ],
    "cupidatat_3": [
      "non enim sint ea deserunt",
      "consectetur do veniam Lorem in",
      "est ex laborum in amet",
      "id ipsum",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ut dolore aliqua sed fugiat",
  "supplier_part_numbers": {
    "Ut_88": [
      "ad",
      "laboris ut proident",
      "sint ut adipisicing consectetur",
      "mollit consectetur voluptate officia cupidatat"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "Duis deserunt consequat magna",
  "supplier_part_numbers": {
    "non_e88": ["do commodo", "enim in ut magna ea"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "incididunt nulla eu",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_net_ids": ["fugiat"]
}
```
...
```json
{
  ...
  "route": [],
  "stroke_width": "0.1mm",
  "color": "cillum commodo Excepteur et ut"
}
```
...
```json
{
  ...
  "message": "aliquip fugiat nostrud"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "quis enim adipisicing",
  "supplier_part_numbers": {
    "essedc0": [
      "mollit",
      "dolore fugiat mollit",
      "officia consectetur culpa ipsum",
      "ipsum"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "eiusmod exercitation id in et"
  },
  "rotation": "90deg",
  "layer": "top"
}
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -10007107.001308084,
  "outer_height": -51835251.61120004,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
