...
```json
{
  ...
  "ftype": "Excepteur anim esse officia et",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "nulla culpa",
  "supplier_part_numbers": {
    "velit8": ["dolore ex enim ut incididunt", "adipisicing Ut sunt aute"],
    "laborum6": ["in laboris labore", "mollit ullamco", "ad ullamco"],
    "elit_8": [
      "id",
      "sed aliqua sunt voluptate Duis",
      "esse reprehenderit aliqua quis velit",
      "dolor ut"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "dolore non eu",
  "supplier_part_numbers": {
    "Duis_9": ["commodo enim et"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["occaecat dolore", "ad enim"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 92198033.64230216
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "consectetur incididunt voluptate in",
  "supplier_part_numbers": {
    "doc4": ["in", "officia enim culpa"],
    "eiusmod6": ["Duis anim exercitation incididunt ad", "voluptate minim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "adipisicing Lorem",
  "supplier_part_numbers": {
    "Ut__fd": ["sit ut elit do anim", "sunt", "Lorem id", "dolore aute esse"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolore pariatur occaecat",
  "supplier_part_numbers": {
    "magnab6": ["Lorem deserunt id", "pariatur dolor et"],
    "voluptate_90": ["nulla"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ut consequat cupidatat elit consectetur",
  "supplier_part_numbers": {
    "reprehenderit_ba": ["aliqua in", "adipisicing Excepteur elit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "minim irure proident aliqua ipsum",
  "supplier_part_numbers": {
    "Lorem57": [
      "culpa aliqua Ut sint",
      "incididunt ea aliquip",
      "minim enim reprehenderit veniam",
      "nulla cillum esse fugiat do"
    ],
    "cillum_75": []
  }
}
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "in53": ["est Lorem nisi officia"],
    "quisef6": [
      "ipsum Excepteur id Duis",
      "aliqua amet Excepteur exercitation nisi",
      "velit in proident",
      "laborum",
      "consectetur sed veniam est aute"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "mollit id non",
  "supplier_part_numbers": {
    "officia_e": [],
    "dolor_6c": [
      "et esse ad",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 15368177.57585749,
  "pin_styles": {},
  "box_width": -43876554.992211856,
  "symbol_name": "nisi dolor",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "amet aliqua voluptate consectetur",
...
```json
{
  ...
  "radius_x": 2289623.3316902965,
  "radius_y": 68288301.44738004,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "velit non sit id consectetur",
  "supplier_part_numbers": {
    "dod": [
      "deserunt",
      "culpa et mollit Ut",
      "aliquip occaecat fugiat",
      "cupidatat reprehenderit in tempor nisi",
      "veniam"
    ],
    "sed__": ["aliqua in ut sit dolore"],
    "et4f2": ["nostrud ad in", "velit dolor", "labore laboris sit ullamco"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "ut est culpa in",
  "model_obj_url": "Duis fugiat occaecat do",
  "model_stl_url": "in incididunt in nulla",
  "model_3mf_url": "ipsum",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -86518017.4784673,
  "outer_height": 430302.54724016786,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "qui3": {
    "left_margin": 21814548.83423157,
    "right_margin": -32682799.698531806,
    "top_margin": 28441863.104514197,
    "bottom_margin": 71153945.57233036
  },
  "labore_6": {
    "left_margin": "dolore incididunt id",
    "top_margin": "reprehenderit nulla",
    "bottom_margin": "aute in"
  }
}
```
