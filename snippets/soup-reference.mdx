...
```json
{
  ...
  "ftype": "exercitation tempor quis pariatur in",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "Excepteur cillum",
  "supplier_part_numbers": {
    "quis_0": [
      "dolor sint aute exercitation fugiat",
      "consequat velit fugiat dolore minim"
    ],
    "in66": ["est", "est", "magna"]
  }
}
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "proidentab6": ["do velit cupidatat est"],
    "non_71": ["labore esse officia"],
    "nullad2": []
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "tempor laboris",
    "magna quis mollit",
    "aliqua est cillum nulla occaecat",
    "ea amet Excepteur reprehenderit nostrud"
  ],
  "is_power": true,
  "is_ground": true,
  "is_analog_signal": true,
  "trace_width": -2483287.6019320637
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "elit dolore consectetur commodo",
  "supplier_part_numbers": {
    "irure_0e6": ["non sunt nulla culpa Excepteur"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Duis in culpa ad irure",
  "supplier_part_numbers": {
    "culpa_d2f": [
      "labore",
      "dolore deserunt qui",
      "reprehenderit quis adipisicing ea",
      "ullamco eu dolor"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "reprehenderit ut nulla elit ex",
  "supplier_part_numbers": {
    "sed_e3": [
      "nisi amet nulla eu",
      "aute do ipsum ad nisi",
      "reprehenderit in laborum sunt"
    ],
    "mollit_a": [
      "elit Ut deserunt quis Lorem",
      "officia Excepteur cillum proident aute",
      "occaecat",
      "consectetur qui dolor cupidatat"
    ],
    "voluptatedd4": ["sed eiusmod"]
  }
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["ipsum dolor", "laborum nisi amet"],
  "connected_source_net_ids": ["ut in occaecat ex cillum"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -88846186.81590481,
  "pin_styles": {},
  "box_width": "culpa ullamco non deserunt",
  "symbol_name": "exercitation amet",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "Duis incididunt sunt eu laboris"
}
```
...
```json
{
  ...
  "message": "laboris magna pariatur amet",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "in ut sit",
  "supplier_part_numbers": {
    "eaa": ["anim reprehenderit quis aute exercitation"],
    "aliqua2": [
      "velit",
      "voluptate quis mollit nulla",
      "in sint Lorem",
      "ex ipsum cupidatat proident"
    ]
  }
}
```
...
```json
{
  ...
  "rotation": "90deg",
  "layer": "top",
  "footprinter_string": "occaecat dolore",
  "model_obj_url": "labore proident nulla occaecat amet",
  "model_stl_url": "cillum",
  "model_3mf_url": "officia fugiat sunt exercitation",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "deserunt irure elit Lorem"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 6824184.418278724,
  "outer_height": -52096948.131922714,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "non aute aliquip in qui"
}
```
...
{
  "sed6e": {
    "left_margin": "ut est Ut enim",
    "right_margin": "laboris dolor adipisicing officia labore",
    "top_margin": "in pariatur incididunt cillum",
    "bottom_margin": "dolore cupidatat incididunt voluptate"
  },
  "cillum_dab": {
    "left_margin": -32827870.299317226,
    "right_margin": 54112248.584341615
  },
  "dolor_323": {
    "left_margin": "aute",
    "right_margin": -27077330.120193914,
    "top_margin": "fugiat laborum aliqua"
  }
}
```
