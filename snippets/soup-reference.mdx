...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["occaecat"],
  "is_power": false,
  "is_digital_signal": true,
  "trace_width": -78936580.34658992
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sed8": ["ut", "ex ea ad Ut eu", "exercitation", "quis in sunt do anim"],
    "quis_9": [
      "velit Ut dolore",
      "ut aliqua ut magna quis",
      "reprehenderit officia nostrud magna incididunt"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in Excepteur voluptate nisi sint",
  "supplier_part_numbers": {
    "ine62": ["eu eiusmod voluptate nisi consectetur"],
    "nisi_3f8": [
      "consequat nisi proident",
      "cupidatat sunt enim aliqua",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "laboris Ut"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "tempor_25": ["nulla deserunt ipsum id"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "ullamco eu sunt in in",
    "laboris nisi aliqua quis veniam",
    "non"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 79653862.85640746,
  "pin_styles": {},
  "box_width": -6175832.94004263,
  "symbol_name": "Lorem in officia",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "commodo non aute sit ut"
}
```
...
```json
{
  ...
  "color": "dolore laboris nisi sint ipsum"
}
```
...
```json
{
  ...
  "message": "id esse Excepteur quis"
}
```
...
```json
{
  ...
  "radius_x": -58692288.65031708,
  "radius_y": "ea fugiat sunt",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "amet Duis anim id commodo",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": -21574179.778836027
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "velit tempor mollit in cupidatat",
  "supplier_part_numbers": {
    "et_8ed": [
      "proident occaecat eu aute",
      "cillum mollit laboris",
      "labore",
      "ut voluptate",
      "id qui adipisicing sunt"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "deserunt pariatur",
  "supplier_part_numbers": {
    "dolore_05": ["ullamco aliqua occaecat"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "esse incididunt laborum",
  "model_obj_url": "non aliquip",
  "model_stl_url": "reprehenderit velit",
  "model_3mf_url": "eu nulla adipisicing dolor",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ea nulla officia qui"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -87405053.07394959,
  "outer_height": -21052470.89506443,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "sed_1_": {
    "right_margin": "dolore sit",
    "bottom_margin": "commodo est nulla mollit id"
  }
}
```
