...
```json
{
  ...
  "name": "N1",
  "manufacturer_part_number": "officia qui",
  "supplier_part_numbers": {
    "officia_ad1": ["quis reprehenderit"],
    "laboris_9": ["deserunt dolor dolor", "nostrud eiusmod mollit fugiat"],
    "Duis_86": ["pariatur", "aliquip cupidatat ea"],
    "sed7ff": [
      "sit ea ullamco dolor velit",
      "dolore",
      "proident mollit laborum dolore",
      "est consequat"
    ],
    "ut_02": []
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ea nulla commodo sunt",
  "supplier_part_numbers": {
    "sint_51_": ["sint elit consectetur ut"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "culpa occaecat nisi incididunt",
    "in magna ex",
    "ea",
    "consequat culpa qui"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "dolor occaecat ut quis",
  "supplier_part_numbers": {
    "incididuntc0": ["occaecat laborum pariatur do"],
    "dolore6": [
      "in non aute",
      "deserunt fugiat laboris ad est",
      "ea sed consequat ad",
      "aute",
      "aute reprehenderit Lorem aliqua"
    ],
    "aliquip__0": [],
    "dolore_080": [
      "tempor adipisicing reprehenderit cillum",
      "sit pariatur ullamco elit",
      "aliquip exercitation in nostrud",
      "eiusmod aliqua"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "quis ipsum commodo anim eiusmod",
  "supplier_part_numbers": {
    "voluptate_d": ["est nulla"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "in dolor nulla Lorem non",
  "supplier_part_numbers": {
    "inf54": [
      "proident et ipsum est",
      "reprehenderit fugiat et amet Duis",
      "sint nisi ut",
      "mollit",
      "irure ea veniam"
    ],
    "quis_4": ["culpa cupidatat in in do", "veniam tempor ut"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "in sunt nostrud enim tempor",
  "supplier_part_numbers": {
    "minim2": []
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "ut eiusmod cillum nulla",
    "id dolor",
    "proident pariatur Ut deserunt"
  ],
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "cillum Duis incididunt commodo"
}
```
...
```json
{
  ...
  "message": "ipsum voluptate est velit"
}
```
...
```json
{
  ...
  "radius_x": -53853530.07072227,
  "radius_y": -60079937.61999963,
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "id cupidatat culpa"
    },
    {
      "x": "3mm",
      "via": true,
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "est nulla esse mollit et"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "laborum ad",
  "supplier_part_numbers": {
    "enim_5df": [
      "deserunt nisi aliqua consectetur",
      "officia Lorem eu amet",
      "enim",
      "id pariatur ut voluptate fugiat"
    ],
    "elit_3": [
      "pariatur mollit",
      "velit irure Lorem",
      "fugiat ut",
      "dolore consequat Duis incididunt laboris",
      "amet in culpa"
    ]
  }
}
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "et in velit laboris"
  },
  "model_obj_url": "veniam cupidatat dolore minim",
  "model_stl_url": "laborum",
  "model_3mf_url": "et",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ut sunt dolor adipisicing qui"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 90287006.44269666,
  "outer_height": 73731453.87472376,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "y": "1mm",
  "via": false,
  "trace_width": "laborum exercitation eu Ut dolor"
}
```
