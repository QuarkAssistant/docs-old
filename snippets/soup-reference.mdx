...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor05a": [
      ...
      "exercitation enim adipisicing laboris",
      "in consequat",
      "magna pariatur enim in nostrud"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "dolore consequat laboris esse",
  "supplier_part_numbers": {
    "voluptate5": [
      "deserunt Excepteur culpa officia",
      "commodo exercitation velit ut laborum",
      "dolore",
      "enim nulla dolor pariatur ad",
      "pariatur in cupidatat"
    ],
    "laboris471": [
      "elit nostrud eiusmod Excepteur laborum",
      "anim in veniam",
      "sit"
    ],
    "Lorem_77d": [
      "proident sunt",
      "ut consectetur cillum aute laboris",
      "laborum enim",
      "adipisicing deserunt"
    ],
    "velit5e": [
      "dolor Excepteur in consequat eiusmod",
      "sed mollit ullamco ut",
      "Excepteur Duis laborum est",
      "id ipsum minim cupidatat"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["Duis", "nisi non sit ex id"],
  "is_power": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "proident Ut cillum tempor",
  "supplier_part_numbers": {
    "ut7f": [
      "Ut dolore incididunt aute",
      "dolore aliqua Duis tempor esse",
      "mollit eiusmod dolore et",
      "id sed veniam dolore voluptate"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "esse_c": ["eu voluptate in nostrud", "in cupidatat"],
    "incididunt_3": ["ad"],
    "eu_32a": [
      "sed laboris sit ullamco",
      "sint mollit",
      "cillum ut anim ex dolore"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Lorem incididunt cupidatat aliquip culpa",
  "supplier_part_numbers": {
    "laborisa": [
      "laborum amet fugiat culpa",
      "ullamco sunt",
      "fugiat Ut dolor"
    ],
    "ea_9f3": [
      "anim",
      "in",
      "ex cupidatat aliqua ad",
      "et tempor adipisicing aliqua nisi",
      "dolor in laborum est"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "dolore elit pariatur Ut",
  "supplier_part_numbers": {
    "elit_b29": [
      "commodo deserunt irure pariatur",
      "velit",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "Duis do quis ex",
  "supplier_part_numbers": {
    "amet2a0": [
      "est occaecat anim Excepteur nisi",
      "consequat nostrud officia"
    ],
    "nostrud9": [
      "eiusmod tempor pariatur laborum",
      "et tempor officia voluptate",
      "nulla",
      "id aliquip"
    ],
    "minimf_": ["eu ea", "eu", "nisi non dolor"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["labore aliqua"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "consequat in consectetur laborum",
  "pin_styles": {},
  "box_width": "adipisicing eiusmod id",
  "symbol_name": "reprehenderit voluptate quis proident Excepteur",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "ut ipsum occaecat irure"
}
```
...
```json
{
  ...
  "message": "nostrud sint occaecat fugiat",
...
```json
{
  ...
  "radius_x": 18222316.823463023,
  "radius_y": "anim enim id",
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "adipisicing veniam sint ad Ut"
    }
  ]
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "fugiat2e": ["elit officia in aute", "reprehenderit"],
    "incididuntd": ["minim", "eu amet"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -31436944.208408013,
  "outer_height": 98470373.3697072,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "fugiat_bd6": {
    "left_margin": 44721218.0998615,
    "right_margin": -5581041.226986632,
    "top_margin": "voluptate",
    "bottom_margin": -94698081.34048274
  },
  "ipsum_a_": {
    "top_margin": 32964327.836429104
  },
  "anim24": {
    "left_margin": -7953261.459849909,
    "right_margin": "sunt",
    "top_margin": 40380883.731643915,
    "bottom_margin": "voluptate ex esse"
  },
  "adipisicinga7e": {
    "left_margin": "aute amet qui aliquip in",
    "top_margin": -42201140.47357013
  }
}
```
