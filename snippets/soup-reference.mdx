...
```json
{
  ...
  "ftype": "amet mollit labore irure reprehenderit",
  "source_component_id": "source_component_1",
  "name": "A1",
  "manufacturer_part_number": "est enim tempor sint sed",
  "supplier_part_numbers": {
    "laborum2e5": [
      "anim ad Ut velit",
      "anim",
      "dolor Excepteur nulla",
      "Excepteur dolor qui quis",
      "ut Duis nostrud ullamco dolore"
    ],
    "velit0": [
      "commodo et elit mollit Duis",
      "sed pariatur reprehenderit in proident",
      "adipisicing sit exercitation",
      "irure et minim anim exercitation",
      "aute dolor deserunt"
    ],
    "adf": [
      "dolore fugiat sed mollit ut",
      "voluptate veniam",
      "labore sunt ut non Ut",
      "cillum"
    ],
    "amet_d": []
  }
...
```json
{
  ...
  "member_source_group_ids": [
    "ut",
    "id magna cupidatat officia pariatur",
    "amet aliquip",
    "nulla sint",
    "minim qui"
  ],
  ...
  "trace_width": 7207311.9766715765
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "dolore nulla cupidatat",
  "supplier_part_numbers": {
    "pariatur_67": ["mollit"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "magna aliqua",
  "supplier_part_numbers": {
    "nonbe": ["dolore elit ipsum"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "reprehenderit_5": [
      "ut aliquip minim magna voluptate",
      "exercitation aliqua non"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "connected_source_port_ids": ["aliqua veniam", "eu in"],
  "connected_source_net_ids": ["sed Lorem"]
}
```
...
```json
{
  ...
  "message": "tempor ea amet anim voluptate"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "cillum deserunt dolore consequat quis"
}
```
...
```json
{
  ...
  "radius_x": "culpa reprehenderit elit",
  "radius_y": "ex qui Duis magna",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "adipisicing ipsum",
  "supplier_part_numbers": {
    "ad_3": [
      "dolore ut",
      "ad ipsum magna adipisicing ullamco",
      "eu anim",
      "incididunt dolore quis proident Ut",
      "non Duis pariatur Lorem"
    ],
    "sint_7cb": [
      "sint ut aute sit eu",
      "aliquip consectetur aute nostrud irure",
      "qui consectetur incididunt nisi",
      "anim enim sed id",
      "sit Lorem voluptate"
    ]
  },
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "irure quis ut dolor laboris",
  "model_obj_url": "veniam ullamco",
  "model_stl_url": "proident veniam sit",
  "model_3mf_url": "magna ea in id ullamco",
  "model_jscad": {}
}
```
...
{
  "fugiat_7_": {
    "left_margin": -51153919.36158309,
    "bottom_margin": -7733660.94030714
  },
  "consectetur43": {
    "left_margin": 21159788.910869136,
    "right_margin": "laborum occaecat eiusmod dolore",
    "bottom_margin": "est proident sit esse occaecat"
  }
}
```
