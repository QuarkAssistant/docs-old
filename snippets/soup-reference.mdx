...
```json
{
  ...
  "name": "I1",
  "manufacturer_part_number": "in ex cupidatat",
  "supplier_part_numbers": {
    "quis3": [
      "adipisicing",
      "anim ea",
      "aliquip exercitation",
      "quis nisi voluptate in occaecat",
      "non enim deserunt occaecat"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ipsum quis ad",
  "supplier_part_numbers": {
    "labore124": [
      "ut dolor",
      "fugiat incididunt exercitation ut",
      "proident deserunt ipsum"
    ],
    "culpa_231": ["irure mollit fugiat esse"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "in",
    "est aliqua nulla",
    "ea Excepteur ipsum sunt reprehenderit",
    "dolore Lorem est pariatur veniam",
    "in deserunt"
  ],
  "is_power": true,
  "is_ground": true,
...
```json
{
  ...
  "supplier_part_numbers": {
    "Excepteur_1": [
      "pariatur nisi",
      "officia aliqua voluptate eiusmod",
      "consectetur velit in"
    ],
    "mollit5c": [
      "deserunt Ut tempor",
      "enim irure officia exercitation tempor",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "fugiat cupidatat et",
  "supplier_part_numbers": {
    "ea_3_6": [
      "nisi esse dolore eu est",
      "consectetur nisi in do",
      "labore",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "id pariatur esse enim",
  "supplier_part_numbers": {
    "et__": ["exercitation ut ipsum dolor", "Excepteur consequat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "laborum labore commodo occaecat Lorem",
  "supplier_part_numbers": {
    "do0fa": [
      "id consectetur laboris fugiat",
      "aliqua non officia exercitation",
      "voluptate",
      "in",
      "labore amet Ut ullamco et"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ea_13": ["dolor occaecat sunt fugiat dolor", "amet"],
    "enim5": ["minim dolor incididunt", "in nostrud"]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "Lorem365": ["dolore", "et sint Lorem dolor non", "occaecat eu", "nulla"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ad_e": [
      "proident aute occaecat sit",
      "dolor dolor",
      "id eu sit ea",
      "quis deserunt",
      "Lorem ad aute labore"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_net_ids": [
    "veniam Lorem deserunt aute velit",
    "tempor ad et exercitation",
    "culpa Lorem minim veniam",
    "Duis"
  ]
}
```
...
```json
{
  ...
  "pin_styles": {
    "sitc59": {
      "left_margin": "sed proident",
      "right_margin": "minim exercitation do",
      "top_margin": "sit amet non",
      "bottom_margin": "Excepteur eiusmod sunt quis nisi"
    },
    "occaecatc": {
      "left_margin": "et exercitation",
      "right_margin": -82185294.54485433,
      "top_margin": "ut",
      "bottom_margin": -32644517.12755561
    },
    "sed_f90": {
      "right_margin": 48284456.36271876,
      "top_margin": "in qui ea cillum laborum",
      "bottom_margin": "fugiat non"
    },
    "eiusmodd9": {
      "left_margin": "ipsum consectetur",
      "right_margin": "exercitation Ut",
      "top_margin": -34441154.91948634,
      "bottom_margin": "dolore sint fugiat est"
    }
  },
  "symbol_name": "laboris ut officia exercitation",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "message": "laboris commodo ut tempor mollit"
}
```
...
```json
{
  ...
  "message": "magna voluptate sint cupidatat"
}
```
...
```json
{
  ...
  "message": "cillum elit enim ea dolore",
...
```json
{
  ...
  "radius_x": -83687963.7228297,
  "radius_y": "dolor labore aute aliqua Lorem",
  "layer": "top"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "anim dolore",
  "model_obj_url": "adipisicing dolor sint pariatur eu",
  "model_stl_url": "fugiat adipisicing anim",
  "model_3mf_url": "est adipisicing sed",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ea dolor amet sint sit"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -93275940.48414186,
  "outer_height": 68665913.1716226,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "ut_c": {
    "bottom_margin": -36353011.764610834
  }
}
```
