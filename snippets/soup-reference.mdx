...
```json
{
  ...
  "ftype": "incididunt veniam est sit",
  "source_component_id": "source_component_1",
  "name": "I1",
  "manufacturer_part_number": "sit in",
  "supplier_part_numbers": {
    "eaf": ["ex aliquip in nostrud"],
    "amet_9": [
      "officia occaecat anim in sit",
      "dolore in qui commodo non",
      "labore tempor",
      "ut in do"
    ],
    "minim6": ["ipsum esse ad proident tempor", "do qui ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "tempor incididunt esse eu",
  "supplier_part_numbers": {
    "ut17": [
      "sed incididunt adipisicing proident in",
...
```json
{
  ...
  "trace_width": -64516975.309957035
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "voluptate17_": [
      "deserunt ut qui",
      "est tempor aliquip qui Ut",
      "in laborum sit"
    ],
    "consecteturd57": ["reprehenderit tempor id"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Lorem laborum amet",
  "supplier_part_numbers": {
    "occaecat_ff5": [
      "nostrud magna consequat ullamco in",
      "ullamco reprehenderit et cupidatat nisi"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "est reprehenderit qui sit",
  "supplier_part_numbers": {
    "in_7": [
    ...
    "dolore02": [
      "ex sunt nostrud enim",
      "magna veniam ullamco",
      "sed",
      "ea eiusmod in reprehenderit Ut",
      "minim Duis eu tempor"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "eu sunt est",
  "supplier_part_numbers": {
    "anim78e": [
      "dolore ullamco",
      "Ut culpa veniam",
...
```json
{
  ...
  "connected_source_port_ids": ["nostrud aliquip ex commodo"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "labore tempor",
  "pin_styles": {},
  "box_width": -61817346.51447637,
  "symbol_name": "amet",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "radius_x": "quis ex voluptate dolore",
  "radius_y": -37358058.479503155,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "Lorem nostrud consectetur reprehenderit",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "y": "1mm",
      "via": true,
      "trace_width": -87681545.82151309
    },
    {
      "x": "3mm",
      "y": "1mm",
      "trace_width": -92147400.96039122
    }
  ]
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "magna_6": [
      "amet anim",
      "qui dolor sunt occaecat",
      "qui esse exercitation",
      "ullamco anim aliquip veniam officia",
      "pariatur laborum"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "velit quis occaecat proident cupidatat",
  "model_obj_url": "ullamco consequat reprehenderit irure",
  "model_stl_url": "Duis culpa",
  "model_3mf_url": "aliquip enim adipisicing",
  "model_jscad": {}
}
```
...
{
  "do_f18": {
    "left_margin": "reprehenderit in",
    "right_margin": "velit proident quis",
    "top_margin": 7102269.119471669
  },
  "ea_8a3": {
    "left_margin": "sed deserunt"
  }
}
```
