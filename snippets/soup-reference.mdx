...
```json
{
  ...
  "ftype": "incididunt Excepteur Duis",
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["nostrud", "culpa ad Duis"],
  "is_power": false,
  "is_ground": true,
  "is_analog_signal": true,
  "trace_width": 39693729.28067076
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "laboris dolor voluptate Lorem"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "officia consequat",
  "supplier_part_numbers": {
    "incididunt_8": [],
    "eu3": [
      "qui ut exercitation dolor",
      "ipsum ullamco eu",
      "labore laborum id Excepteur nulla",
      "ad",
      "aliquip mollit est dolore voluptate"
    ],
    "est5": [
      "ipsum ullamco aliqua",
      "nisi pariatur",
      "amet ipsum exercitation laborum irure",
      "mollit eu"
    ],
    "utdc": ["ea nisi cupidatat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "id do deserunt et",
  "supplier_part_numbers": {
    "Duis0b1": [
      "ut deserunt in",
      "aute enim fugiat cupidatat",
      "in",
      "cupidatat"
    ],
    "Ut_46": []
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "amet nostrud sunt in est",
  "supplier_part_numbers": {
    "velit_": [
      "Duis cupidatat",
      "eu dolore est exercitation tempor",
      "nulla velit"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "dolore ut",
  "supplier_part_numbers": {
    "sunt2bd": ["commodo do ea Lorem"],
    "laborisfc": ["ex tempor Ut veniam magna", "adipisicing laboris"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "irure12": ["esse aliquip nostrud veniam sint", "deserunt ullamco"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["est sunt incididunt ullamco"],
  "connected_source_net_ids": [
    "consectetur anim pariatur occaecat",
    "commodo non dolor cupidatat"
  ]
}
```
...
```json
{
  ...
  "message": "incididunt sint cupidatat dolore"
}
```
...
```json
{
  ...
  "message": "ea magna veniam eiusmod",
...
```json
{
  ...
  "radius_x": 19009563.159802884,
  "radius_y": -31913677.44738373,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "veniam cillum sed"
}
```
...
```json
{
  ...
  "model_obj_url": "sed officia Excepteur ad",
  "model_stl_url": "nostrud velit Ut Duis irure",
  "model_3mf_url": "laboris",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "non pariatur ut quis aliquip"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "minim irure dolore reprehenderit laborum"
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": -54102723.179282196
}
```
...
{
  "laboris_a6b": {
    "left_margin": "qui veniam ex adipisicing",
    "right_margin": "nisi ad id quis et"
  }
}
```
