...
```json
{
  ...
  "name": "S1",
  "manufacturer_part_number": "veniam consectetur nisi"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "fugiat velit nisi",
  "supplier_part_numbers": {
    "amet256": ["velit elit eiusmod officia laborum", "occaecat", "deserunt"],
    "eiusmod_": [],
    "commodo_78a": [],
    "eu8d1": ["dolore cupidatat", "elit dolor"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "labore aute fugiat pariatur",
    "tempor Ut adipisicing"
  ],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": false,
  "trace_width": 7002746.453374222
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "tempor eiusmod consectetur nisi consequat",
  "supplier_part_numbers": {
    "deserunt039": [
      "elit sunt nostrud",
      "et sunt incididunt",
      "pariatur culpa cupidatat incididunt"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eu Duis quis Excepteur",
  "supplier_part_numbers": {
    "eiusmod_e7e": ["cillum aliqua"],
    "id_09": ["eiusmod mollit commodo consequat"],
    "ut_a6d": []
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laborum consectetur ad",
  "supplier_part_numbers": {
    "in76": ["et dolor in velit", "Ut sit esse"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "est non",
  "supplier_part_numbers": {
    "deserunt_9c": ["anim consequat", "aute cupidatat elit labore do"],
    "estd7": ["elit nostrud incididunt in Ut", "ipsum id magna"],
    "nulla78": [
      "in exercitation",
      "dolore",
      "ullamco pariatur sit ad",
      "in et nulla mollit dolore"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "cupidatat laboris",
  "supplier_part_numbers": {
    "nulla04": [],
    "aliquac2": ["occaecat quis"],
    "in0d": [
      "velit ut",
      "culpa deserunt amet",
      "sed consequat proident aliquip eiusmod",
      "commodo",
      "culpa magna dolor"
    ]
  }
...
```json
{
  ...
  "connected_source_port_ids": [
    "pariatur deserunt qui Lorem",
    "enim ut ad qui consequat",
    "sed in incididunt ut irure"
  ],
  "connected_source_net_ids": ["labore cillum", "dolore"]
}
```
...
```json
{
  ...
  "pin_spacing": "mollit",
  "pin_styles": {},
  "box_width": 76410115.21245891,
  "symbol_name": "esse veniam",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "laborum aliqua voluptate tempor mollit"
}
```
...
```json
{
  ...
  "radius_x": -14767937.580174401,
  "radius_y": -92318396.84236105,
  "layer": "top"
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": -58657825.856579885
}
```
...
{
  "dolor_08": {
    "left_margin": -57303944.260032624,
    "top_margin": "eu aute"
  },
  "exercitation__": {
    "left_margin": "ea Excepteur ex sunt",
    "right_margin": "adipisicing labore enim eiusmod"
  },
  "magna_9": {
    "bottom_margin": "qui dolor consequat"
  },
  "dolore_79b": {
    "left_margin": -90118063.71946496,
    "right_margin": -7802782.262473956,
    "top_margin": "mollit anim",
    "bottom_margin": 9851558.005623579
  }
}
```
