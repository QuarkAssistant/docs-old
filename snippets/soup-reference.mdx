...
```json
{
  ...
  "ftype": "eiusmod cupidatat ut in voluptate",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "pariatur reprehenderit",
  "supplier_part_numbers": {
    "ipsum24": [],
    "Excepteur8f": ["velit sunt sint laborum est", "aliquip"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "eu proident",
  "supplier_part_numbers": {
    "tempora": ["culpa nisi", "enim officia", "officia dolor veniam"],
    "velit2ab": [
      "ipsum culpa dolore",
      "occaecat labore",
      "dolor elit irure",
    ...
    "eu_ab7": [
      ...
      "consequat voluptate officia in",
      "ea fugiat elit nisi Excepteur",
      "ex deserunt quis"
    ],
    "enim4a_": ["ipsum aliqua voluptate"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "nostrud",
    "nostrud reprehenderit sed",
    "esse ut commodo consectetur",
    "eu"
  ],
  "is_power": false,
  "is_ground": true,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "Ut do dolor dolore",
  "supplier_part_numbers": {
    "adc": ["dolor incididunt cillum"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "adipisicing aute velit",
  "supplier_part_numbers": {
    "amet__c8": [],
    "ex290": []
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "adipisicing5": [
      "eiusmod in dolor nostrud",
      "aute ipsum in occaecat Ut",
      "qui commodo reprehenderit dolor"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "fugiat in adipisicing",
  "supplier_part_numbers": {
    "dolor364": ["Excepteur dolore do", "nostrud culpa", "labore amet"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "eiusmod quis laboris ea ut",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["do", "labore", "Lorem qui sit sed eiusmod"],
  "connected_source_net_ids": ["pariatur"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -88381295.9685755,
  "pin_styles": {},
  "box_width": -99063234.89509612,
  "symbol_name": "quis",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "voluptate laboris id occaecat minim"
}
```
...
```json
{
  ...
  "color": "fugiat sed dolor irure ut"
}
```
...
```json
{
  ...
  "radius_x": "Ut consectetur est minim",
  "radius_y": -8243438.025835112,
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "velit aute dolor cillum ex"
    }
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "sint amet culpa ut sunt",
  "supplier_part_numbers": {
    "cupidatat469": [
      "officia ea sit reprehenderit",
      "non laboris amet",
      "cillum dolore in labore",
      "aliqua cillum qui ut"
    ]
  }
}
```
...
```json
{
  ...
  "footprinter_string": "nisi in consequat",
  "model_obj_url": "adipisicing in labore deserunt"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "exercitation fugiat"
}
```
...
{
  "fugiate6": {
    "left_margin": -26927203.151355743,
    "right_margin": "ex proident dolor eiusmod enim",
    "top_margin": "in velit id",
    "bottom_margin": 61746716.20924541
  },
  "nisi4a3": {
    "left_margin": "reprehenderit et",
    "right_margin": "pariatur consequat ea",
    "top_margin": "nulla nisi"
  }
}
```
