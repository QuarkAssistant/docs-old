...
```json
{
  ...
  "ftype": "dolor reprehenderit anim Duis",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "enim officia nulla",
  "supplier_part_numbers": {
    "officia_b80": ["anim Duis dolor esse in"],
    "Lorem2": ["id officia dolore sit"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "elit proident sunt reprehenderit voluptate",
    "minim ipsum",
    "nulla sed id"
  ],
  "is_ground": false,
  "trace_width": -8980405.653308317
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "sed officia in anim ea",
  "supplier_part_numbers": {
    "aute_6": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ipsum id",
  "supplier_part_numbers": {
    "id_cf": ["dolore sint", "ea in sed ut"],
    "animf4d": [
      "sint laboris",
      "consectetur id commodo anim Lorem",
      "aute cillum ad"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "proident nisi",
  "supplier_part_numbers": {
    "veniam_73a": ["minim ullamco ea"],
    "Duis32": [
      "tempor",
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat_43a": [
      "ullamco veniam est ex",
      "dolore ut",
      "officia irure laborum minim sit"
    ],
    "eiusmodfa": [
      "magna cupidatat esse qui labore",
      "in amet culpa",
      "velit pariatur in quis"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "cupidatat deserunt ipsum"
}
```
...
```json
{
  ...
  "radius_x": 76127790.1464895,
  "radius_y": -78787794.05259788,
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sit9e8": [
      "in dolore ad incididunt ullamco",
      "nostrud consectetur proident non"
    ],
    "ead1": ["in enim ullamco incididunt dolor", "nisi", "sunt", "sed"],
    "nulla8bb": ["ex ut enim pariatur ullamco", "enim pariatur commodo"],
    "reprehenderit_4": [
      "Lorem in velit reprehenderit incididunt",
      "do Lorem dolore ut",
      "Ut",
      "veniam laboris",
      "pariatur"
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "magna incididunt dolore ea consectetur"
}
```
...
```json
{
  ...
  "y": "1mm",
  "to_layer": "bottom",
  "trace_width": "aliquip minim commodo elit"
}
```
...
{
  "irure_6d6": {
    "left_margin": -97492986.91903095,
    "right_margin": 25592758.536900908,
    "top_margin": "ut Duis dolor ipsum et",
    "bottom_margin": "amet"
  }
}
```
