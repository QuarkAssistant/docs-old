...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "elit ad",
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "officia commodo",
    "Excepteur",
    "ipsum culpa deserunt consequat aliqua"
  ],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": -45972182.54113629
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ex sunt et dolore",
  "supplier_part_numbers": {
    "pariatur_1": [],
    "fugiat_321": [
      "qui est officia eiusmod labore",
      "commodo",
      "sed magna minim",
      "cillum ea consectetur Ut"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sunt laboris officia proident eiusmod",
  "supplier_part_numbers": {
    "consequata4_": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "cillum in aute ullamco",
  "supplier_part_numbers": {
    "ipsum934": ["quis", "cillum in", "eiusmod cupidatat qui amet deserunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "laboris proident deserunt magna",
  "supplier_part_numbers": {
    "est5": [
      "nisi commodo non",
      "magna",
      "pariatur elit sit magna",
      "adipisicing amet do laborum",
      "in"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "esse in",
  "supplier_part_numbers": {
    "ipsum_fe": [
      "et amet enim",
      "non quis minim exercitation veniam",
      "reprehenderit est",
      "nisi anim nostrud ad"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "cupidatat officia aute",
  "supplier_part_numbers": {
    "qui742": [
      "enim id ad magna nulla",
      "adipisicing",
      "consequat ex aute tempor fugiat",
      "laboris irure officia et"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_net_ids": ["ad sint"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "Ut et laborum non deserunt",
  "pin_styles": {},
  "box_width": -55109340.28349181,
  "symbol_name": "ullamco quis adipisicing ipsum",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "officia in minim dolore velit"
}
```
...
```json
{
  ...
  "radius_x": "quis proident sint eiusmod ullamco",
  "radius_y": "consectetur anim id",
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "reprehenderitf4d": [
      "labore adipisicing Ut sit Lorem",
      "Excepteur aute eu reprehenderit consequat"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "minim amet ex",
  "model_stl_url": "nisi nostrud",
  "model_3mf_url": "minim sunt non ea occaecat"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "cupidatat consequat"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -96564696.98886831,
  "outer_height": 88445835.08849978,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "cillum ullamco labore Duis pariatur"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "trace_width": "nostrud pariatur anim in"
}
```
...
```json
{
  "nond52": {},
  "laborise": {
    "left_margin": "anim nisi",
    "right_margin": -27827908.422869503
  },
  "ea_8": {
    "left_margin": 71717274.68347001,
    "right_margin": -73932826.88807115,
    "bottom_margin": "enim cupidatat"
  },
  "est_958": {
    "right_margin": "commodo esse labore ex ut"
  },
  "in_9df": {
    "left_margin": "in"
  }
