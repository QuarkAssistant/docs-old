...
```json
{
  ...
  "ftype": "sint dolore esse amet",
  "source_component_id": "source_component_1",
  "name": "S1",
  "manufacturer_part_number": "dolor tempor",
  "supplier_part_numbers": {
    "aute_8b": ["labore nostrud"],
    "laborum_e": ["dolor aliquip in", "ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "id quis in culpa",
  "supplier_part_numbers": {
    "elit__1": [
      "veniam enim",
      "consectetur est ullamco eiusmod",
      "labore incididunt dolor",
      "velit Ut eiusmod"
    ]
  }
}
...
```json
{
  ...
  "member_source_group_ids": [
    "consectetur exercitation aliqua amet velit",
    "in consequat cupidatat magna Excepteur",
    "cillum aliqua sit Duis reprehenderit",
    "amet sed esse consequat adipisicing",
    "elit esse sunt exercitation labore"
  ],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": -1745831.0752661377
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "laborum qui sed",
  "supplier_part_numbers": {
    "veniam_92": ["pariatur aliquip dolor non"],
    "non_3": [],
    "pariatur_7a": ["enim pariatur elit"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolore07_": [
      "ut adipisicing",
      "in incididunt fugiat ad ut",
      "esse",
      "cupidatat id non ut laboris",
      "in enim"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "nisi Excepteur non aute",
  "supplier_part_numbers": {
    "in_8_": ["amet deserunt", "adipisicing"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "reprehenderit_1": [],
    "suntde": ["anim laborum occaecat dolor"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "mollit_26": ["in nisi in velit dolore"],
    "exercitationb0": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "pariatur commodo",
  "supplier_part_numbers": {
    "eiusmod40c": ["cillum anim nulla", "ut aliqua ad", "Ut laborum"],
    "ea4": [
      "dolore sunt",
      "proident quis incididunt",
      "tempor qui ea Lorem eiusmod",
      "enim in mollit",
      "irure"
    ]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "do proident",
  "supplier_part_numbers": {
    "dolor363": [
      "ex Ut laborum veniam",
      "aliquip",
      "sint fugiat",
      "consequat esse do ea",
      "cillum eu sit reprehenderit mollit"
    ],
    "mollit_86": [
      "quis",
      "amet fugiat",
      "sit commodo",
      "Excepteur consectetur et cillum"
    ],
    "exercitation_3": ["magna qui aliqua cupidatat"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "quis aliquip dolore",
    "veniam aliquip et sit eiusmod",
    "aliquip adipisicing Duis eiusmod in",
    "aliqua"
  ],
  "connected_source_net_ids": [
    "proident magna minim sit quis",
    "in sunt enim reprehenderit",
    "qui ipsum in elit labore",
    "nisi consequat eu",
    "cupidatat culpa"
  ]
}
...
```json
{
  ...
  "pin_spacing": "sed in",
  "pin_styles": {},
  "box_width": "adipisicing dolor nulla voluptate elit",
  "symbol_name": "in cupidatat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "esse consectetur cillum tempor",
...
```json
{
  ...
  "radius_x": "laboris reprehenderit consequat sunt dolore",
  "radius_y": -64000405.74231119,
  "layer": "top"
}
```
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": "fugiat mollit culpa pariatur"
    }
  ]
}
```
...
```json
{
  ...
  "type": "pcb_error",
  "error_type": "pcb_port_not_matched_error",
  "message": "in irure minim officia ut",
  "pcb_component_ids": ["pcb_component_1"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolore eu mollit",
  "supplier_part_numbers": {
    "sit_15": [
      "eu aute",
      "dolor ad sunt ea proident",
      "magna labore",
      "minim Excepteur Ut"
    ],
    "officia47": [
      "Duis reprehenderit",
      "sunt ad esse",
      "pariatur enim commodo incididunt qui",
      "ad",
      "qui et amet dolor culpa"
    ],
    "Lorem_6": [],
    "elit_cb": ["elit", "occaecat ullamco non", "quis ut id in dolore"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": 22047824.958872303
  },
  "footprinter_string": "nostrud ut do ut mollit",
  "model_stl_url": "aute"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "sunt amet laboris magna nostrud"
}
```
...
{
  "dolore0e3": {
    "left_margin": "irure dolor commodo",
    "right_margin": "commodo voluptate eiusmod Lorem",
    "top_margin": "incididunt nisi dolor",
    "bottom_margin": "qui elit veniam deserunt eiusmod"
  }
}
```
