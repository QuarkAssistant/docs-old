...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "incididunt sit",
  "supplier_part_numbers": {
    "et175": [
      "ut irure ex consequat Excepteur",
      "ullamco ut",
      "reprehenderit aute laborum mollit ut",
      "Excepteur",
      "exercitation tempor sed voluptate enim"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "ad aute ipsum dolor",
    "fugiat commodo eiusmod non ex",
    "velit esse consequat dolore ullamco",
    "Ut",
    "qui magna ipsum proident quis"
  ],
  "is_ground": true,
  "is_digital_signal": true,
  "trace_width": -48181737.453664295
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "nostrud deserunt Lorem",
  "supplier_part_numbers": {
    "qui73d": [
      "adipisicing labore est veniam qui",
      "eiusmod in nisi dolor",
      "sit deserunt"
    ],
    "tempor_2a": ["do labore in", "nulla cupidatat", "elit dolore eu"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "aliqua942": [],
    "ullamco_2a": ["magna ullamco qui in"],
    "sint7_": ["consequat sint"],
    "laboris044": ["occaecat"],
    "id_": [
      "Excepteur officia et",
      "irure",
      "consequat ullamco fugiat incididunt cupidatat"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "reprehenderit fugiat aute",
  "supplier_part_numbers": {
    "irure5": ["ad", "pariatur", "nulla velit est ut sunt"],
    "reprehenderit204": [],
    "fugiat_0": ["tempor labore"],
    "ut_39d": ["mollit proident irure Lorem esse", "in magna officia do"],
    "idd": ["in", "dolore mollit", "veniam non", "nostrud id", "aliquip et"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "proident aute",
  "supplier_part_numbers": {
    "ad_7": [
      "Excepteur consequat",
      "velit sed",
      "id aliqua cupidatat aliquip",
      "dolore consequat exercitation consectetur"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "non ea est",
  "supplier_part_numbers": {
    "sunt_fc": ["ut ex ut Excepteur in", "consectetur"],
    "sint0": [
      "eu cillum anim amet voluptate",
      "fugiat",
      "id proident adipisicing",
      "fugiat labore sint",
      "quis dolor nostrud id Ut"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "culpa minim",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "amet occaecat id ut deserunt",
    "Duis veniam",
    "aliquip irure in"
  ],
  "connected_source_net_ids": ["Ut consectetur fugiat et nulla", "aute nisi"]
}
```
...
```json
{
  ...
  "message": "pariatur dolore id ex Ut",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": "mollit amet fugiat laborum"
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  ...
  "connected_source_net_ids": [
    "non",
    "elit aute laborum",
    "laborum et dolore laboris incididunt",
    "dolore sed et Lorem",
    "aliquip"
  ]
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "eiusmod nostrud in",
  "supplier_part_numbers": {
    "Utdfb": [
      "exercitation et",
      "adipisicing",
      "amet commodo",
      "adipisicing in Excepteur amet",
      "Lorem anim consectetur voluptate"
    ]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "reprehenderit",
  "model_stl_url": "pariatur ut dolore cillum deserunt",
  "model_jscad": {}
}
```
...
{
  "in_2e": {
    "left_margin": "sit ut fugiat quis labore",
    "right_margin": -4088939.3690220416,
    "top_margin": "labore ut qui culpa",
    "bottom_margin": 88412504.91663742
  },
  "anim_2bd": {
    "right_margin": -64572961.31507495,
    "top_margin": -41608935.183791384,
    "bottom_margin": -46703373.14147615
  },
  "anim_31": {
    "left_margin": "et sunt",
    "right_margin": "occaecat Ut sed cupidatat",
    "top_margin": "id ullamco dolor aute"
  }
}
```
