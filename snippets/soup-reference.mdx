...
```json
{
  ...
  "name": "U1",
  "manufacturer_part_number": "Duis sint cupidatat elit pariatur",
  "supplier_part_numbers": {
    "labore_0f0": ["nisi mollit", "voluptate Ut ut sit in", "dolor aliquip et"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "ullamco enim",
    "sed amet magna dolor aliqua",
    "officia et dolor esse tempor",
    "ipsum cillum"
  ],
  "is_power": false,
  "is_ground": false,
  ...
  "trace_width": -49207206.178689055
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "do labore adipisicing amet",
  "supplier_part_numbers": {
    "sed_4": [],
    "id6": ["Lorem Ut", "est irure et dolor sed"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "quis74": ["in enim sed", "aliqua tempor dolore esse", "ut velit irure"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ut8": [
      "culpa irure elit laborum",
      "veniam consectetur enim",
      "Excepteur fugiat",
      "nulla veniam"
    ],
    "Duisa": [
      "reprehenderit sint veniam nulla dolore",
      "veniam consectetur",
      "sed esse"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "proident labore",
  "supplier_part_numbers": {
    "euc": ["in dolor Ut labore velit"],
    "eiusmod_30a": ["Lorem quis Duis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "do pariatur in",
  "supplier_part_numbers": {
    "esse_71e": [
      "exercitation sed velit sit culpa",
      "adipisicing Excepteur incididunt proident",
      "sint et"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ut velit eiusmod laboris ipsum",
  "supplier_part_numbers": {
    "in_212": [
      "nostrud occaecat laborum laboris",
      "ad dolore deserunt",
      "eiusmod sunt",
      "dolore nostrud"
    ],
    "nostrud_": ["esse nisi sed non aute"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "deserunt6": [
      "minim velit ea consectetur",
      "veniam minim ullamco",
      "ipsum"
    ],
    "nisi_": ["sint consequat in tempor"],
    "Lorem9f": [
      "Excepteur sunt minim occaecat Duis",
      "do deserunt qui ut incididunt",
      "nostrud magna sunt",
      "cupidatat dolore deserunt Excepteur",
      "ea culpa"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "dolore",
    "officia",
    "in qui minim veniam aute",
    "aliqua ad"
  ],
  "connected_source_net_ids": ["magna Excepteur veniam aliqua sed"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 39751859.592304766,
  "pin_styles": {},
  "box_width": "qui occaecat",
  "symbol_name": "nisi minim ea",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "consectetur dolore irure aute enim"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": "consectetur elit aute minim"
    },
    {
      "x": "3mm"
    },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "quis laborum adipisicing consequat",
  "supplier_part_numbers": {
    "adipisicing_1": [
      "magna quis amet",
      "laborum exercitation deserunt aliquip anim"
    ],
    "consequatd": [],
    "exercitation_30": ["sed dolor veniam", "minim"],
    "ad_770": ["ut", "est adipisicing sunt"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "incididunt ex minim",
  "supplier_part_numbers": {
    "enim_11": [
      "cillum ullamco sunt proident",
      "quis",
      "commodo ut enim consequat",
      "nulla quis dolore do Ut"
    ],
    "ullamco2": ["sed Excepteur Duis consequat", "laboris esse"],
    "cupidatat_571": ["proident enim sed"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "occaecat amet cupidatat et"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": 44095596.166112036
  },
  "model_3mf_url": "cillum aliquip laboris"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -6380173.707706675,
  "outer_height": 4088052.8721236587,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "doloreb4": {
    "left_margin": -83597687.54571189,
    "right_margin": -91827305.26733059,
    "top_margin": -43923548.09461425
  }
}
```
