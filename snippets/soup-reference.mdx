...
```json
{
  ...
  "name": "N1",
  "manufacturer_part_number": "laboris dolore in voluptate"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "aliquip aliqua Ut",
  "supplier_part_numbers": {
    "pariatur_": [
      "velit labore",
      "Ut cupidatat",
      "reprehenderit cillum sed",
      "velit",
      "Excepteur anim sunt reprehenderit"
    ],
    "in_c0e": ["sit", "aliquip nulla"],
    "non009": [
      "adipisicing amet laborum cupidatat",
      "sunt quis ipsum cillum est",
      "qui cillum voluptate",
      "proident quis sed ullamco irure"
    ],
    "Duisd25": ["esse mollit", "nostrud amet aute dolore in"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "labore aliquip aute",
    "nisi velit ut",
    "quis aute sit officia reprehenderit",
    "ut"
  ],
  "is_ground": false
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "quisd": ["ea culpa minim aute dolore", "adipisicing"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ut_c": [
      "quis",
      "ut et",
      "quis minim adipisicing occaecat laboris",
      "fugiat pariatur consequat",
      "dolor voluptate ut"
    ],
    "sed_9": [
      "Duis exercitation et",
      "in Duis consectetur consequat",
      "elit veniam exercitation",
      "mollit enim cillum et veniam",
      "id minim ut"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolor nostrud tempor adipisicing consequat",
  "supplier_part_numbers": {
    "do8": [],
    "adipisicing161": [
      "incididunt",
      ...
      "nisi laborum",
      "veniam dolore ea",
      "commodo elit adipisicing laborum exercitation"
    ],
    "labore_4_7": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "laborum officia mollit in elit",
  "supplier_part_numbers": {
    "fugiat_2e5": ["mollit labore"],
    "dobea": []
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "ut ullamco labore anim",
    "sed elit ut",
    "officia occaecat laboris minim",
    "ad",
    "tempor aute ullamco in"
  ],
...
```json
{
  ...
  "radius_x": 47921673.82469815,
  "radius_y": -77546110.70962638,
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "cillum_24c": [
      "culpa exercitation pariatur enim in",
      "proident ut",
      "in",
      "dolor sed"
    ]
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": 17880309.795314446
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -21112123.104570597
  },
  "layer": "top",
  "footprinter_string": "ullamco amet enim proident",
  "model_obj_url": "nostrud",
  "model_stl_url": "ad",
  "model_3mf_url": "id mollit elit ex do",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "dolore elit incididunt fugiat"
}
```
...
{
  "enim3a_": {
    "left_margin": "deserunt laboris culpa",
    "right_margin": 22007305.638499945,
    "top_margin": "laboris officia quis elit exercitation",
    "bottom_margin": 32372064.91300024
  },
  "aliquip_015": {
    "left_margin": -96827679.70585093,
    "bottom_margin": "ut magna laboris sint"
  },
  "ullamco_2": {
    "left_margin": "ad Ut reprehenderit in proident"
  },
  "Utd7": {
    "left_margin": "velit ut occaecat",
    "right_margin": -67284215.27052441,
    "top_margin": "velit in labore"
  },
  "ipsumdb_": {
    "left_margin": "commodo Ut",
    "right_margin": -77164382.7213012,
    "bottom_margin": 20876767.187807977
  }
}
```
