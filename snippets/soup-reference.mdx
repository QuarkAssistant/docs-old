...
```json
{
  ...
  "ftype": "sunt Excepteur",
  "source_component_id": "source_component_1",
  "name": "S1",
  "manufacturer_part_number": "nostrud labore est fugiat officia",
  "supplier_part_numbers": {
    "nulla99": [
      "dolore in ea",
      "ex aliqua consequat Lorem voluptate",
      "tempor",
      "voluptate exercitation quis officia"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "amet tempor elit consequat cupidatat",
  "supplier_part_numbers": {
    "dolor__": [
      "in aute fugiat ex sit",
      "ullamco ad",
      "cupidatat aliquip commodo fugiat",
      "deserunt officia voluptate veniam ex"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "cillum Excepteur irure ipsum eu"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "fugiat voluptate sunt minim ex",
  "supplier_part_numbers": {
    "nisie": [
      "sit et dolor",
      "aute nulla ut ea",
      "anim sit deserunt laborum sed"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "anim commodo",
  "supplier_part_numbers": {
    "reprehenderit_533": [
      "ut in proident",
      "cillum reprehenderit qui Lorem quis",
      "Lorem sint reprehenderit",
      "quis aute Lorem ad sint"
    ]
  }
}
```
...
```json
{
  ...
  "name": "D1",
  "supplier_part_numbers": {
    "velitdc3": ["esse minim", "irure in incididunt"],
    "inb9": [
      "qui ad eiusmod",
      "nisi non dolor irure cupidatat",
      "elit",
      "est nulla anim do"
    ],
    "occaecat_a88": ["dolore occaecat", "incididunt eiusmod ex ullamco"],
    "mollit18": ["sunt ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "consequat in irure dolore dolor",
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["ut", "culpa non", "minim aliquip"],
  "connected_source_net_ids": [
    "in cupidatat minim ad",
    "sunt Duis nulla dolore",
    "occaecat consequat nostrud",
    "cillum dolore",
    "culpa officia tempor dolore sunt"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "ea aliquip anim ut minim",
  "pin_styles": {},
  "box_width": 48223200.79316339,
  "symbol_name": "aliquip do laborum",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "eiusmod cillum Excepteur incididunt"
}
```
...
```json
{
  ...
  "radius_x": "qui",
  "radius_y": "voluptate consequat officia ad",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "velit consequat ex est",
  "supplier_part_numbers": {
    "estb": ["cupidatat"]
  },
  "resistance": "1k"
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "culpa laborum officia quis"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -76783860.61055674,
  "outer_height": 31165522.641481668,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "deserunt enim ipsum adipisicing in"
}
```
...
```json
{
  "anim6f": {
    "left_margin": "et",
    "right_margin": "ut ex",
    "top_margin": 25796643.80296433,
    "bottom_margin": -15174572.718397617
  },
  "elit5_": {
    "left_margin": "labore laborum consequat",
    "right_margin": "qui eu deserunt",
    "bottom_margin": "deserunt sit proident eu"
  }
}
```
