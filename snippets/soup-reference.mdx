...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ipsum tempor sint cillum est",
  "supplier_part_numbers": {
    "enim_139": ["Lorem aliqua in officia ipsum"],
    "Duis87": ["consequat", "est sint ex", "elit laborum minim"],
    "nostrudc74": ["sint eu cupidatat", "minim"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "nulla minim do in reprehenderit",
    "culpa sit",
    "magna labore elit ut",
    "Excepteur ullamco culpa dolore adipisicing"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eu incididunt fugiat sit in",
  "supplier_part_numbers": {
    "ea43": [
      "mollit nostrud id velit",
      "nostrud quis",
      "consequat tempor aute non"
    ],
    "aute_b36": ["consequat"]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "nulla_0eb": [
      ...
      "et officia reprehenderit aute fugiat",
      "anim consectetur aute cupidatat eu",
      "ullamco laboris est"
    ],
    "aute_8": ["qui ea dolor voluptate fugiat", "mollit", "dolor"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "doloreee": [
      "cupidatat elit eu dolor",
      "adipisicing aute officia irure dolor"
    ],
    "nullaed": ["aute ad ipsum", "dolor id", "qui fugiat est"]
  }
}
```
...
```json
{
  ...
  "connected_source_net_ids": ["reprehenderit eu Lorem elit"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "id amet dolore consequat",
  "pin_styles": {},
  "box_width": 21940021.663510963,
  "symbol_name": "ipsum sed consequat Excepteur",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "deserunt ad aute occaecat"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "ipsum dolor pariatur qui"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "exercitation id culpa anim qui"
  },
  "layer": "top",
  "footprinter_string": "elit irure non",
  "model_stl_url": "adipisicing veniam Ut incididunt consectetur",
  "model_jscad": {}
}
```
...
{
  "Duis_e3": {
    "left_margin": "veniam tempor",
    "top_margin": "incididunt aute",
    "bottom_margin": "in esse Excepteur"
  },
  "laborum_48": {
    "left_margin": -38516929.82646586,
    "right_margin": 74185380.19573969
  }
}
```
