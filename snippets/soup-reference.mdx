...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ad in incididunt",
  "supplier_part_numbers": {
    "sunt_5e": [
      "consequat dolore non nisi",
      "culpa ea sit",
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["do consequat in dolor", "in ad"],
  "is_power": false,
  "is_ground": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "dolor cillum sit enim ex",
  "supplier_part_numbers": {
    "Duis1": [
      "mollit",
      "dolore reprehenderit sit",
      "deserunt irure mollit laborum ad",
      "tempor pariatur sed"
    ],
    "et49": ["anim aliquip ex", "minim nulla", "velit nulla eiusmod"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "est_29": ["sunt eiusmod", "Duis", "cupidatat", "et"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "officia Ut sunt amet",
  "supplier_part_numbers": {
    "do9": [
      "ullamco velit",
      "velit fugiat in",
      "in dolor ipsum pariatur laboris",
      "et"
    ],
    "sit2f1": [
      "aute dolor veniam",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "deserunt tempor pariatur est sint",
  "supplier_part_numbers": {
    "pariatur510": ["et non dolore", "aute Lorem non nostrud"],
    "exc7f": [
      "laborum laboris aliqua elit Duis",
      "nulla",
      "dolor aliqua in aliquip est",
      "sit"
    ],
    "sitb": [
      "cupidatat ullamco eiusmod",
      "veniam sunt fugiat pariatur proident",
      "in dolor est sint"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ea amet sit aliqua",
  "supplier_part_numbers": {
    "elit7c2": ["incididunt Lorem minim exercitation"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "quis5f5": [
      ...
      "voluptate sunt ullamco",
      "mollit cillum ullamco et",
      "ut est",
      "elit consectetur minim incididunt sed"
    ],
    "enim_8d": ["consectetur", "fugiat", "non ex elit id"],
    "nostrud6a7": ["occaecat aliqua deserunt", "irure qui laboris labore"],
    "nostrud_9ad": [
      "do fugiat ipsum quis",
      "Lorem et minim fugiat non",
      "labore dolor non"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "sint id cillum",
    "qui",
    "sit incididunt ullamco nulla",
    "aliqua consequat amet"
  ],
  "connected_source_net_ids": [
    "mollit Lorem deserunt",
    "nostrud",
    "consequat exercitation commodo ex",
    "ut",
    "minim nulla esse"
  ]
}
...
```json
{
  ...
  "schematic_component_id": "schematic_component_1",
  "pin_styles": {},
  "box_width": "sint dolor ut dolore",
  "symbol_name": "sunt proident ut"
}
```
...
```json
{
  ...
  "route": [],
  "stroke_width": "0.1mm",
  "color": "pariatur consequat sint dolor"
}
```
...
```json
{
  ...
  "message": "magna sunt in laboris mollit"
}
```
...
```json
{
  ...
  "radius_x": "voluptate Excepteur reprehenderit occaecat deserunt",
  "radius_y": "exercitation aliquip",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "proident Excepteur minim ex",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "et dolore mollit magna",
  "supplier_part_numbers": {
    "aliquip0c": [],
    "nisi_329": ["eu deserunt irure"],
    "in_63_": ["eu", "velit aliqua dolore enim dolor", "ea Ut dolore ullamco"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "proident dolore cupidatat veniam dolor",
  "model_stl_url": "quis exercitation sint ut sunt",
  "model_3mf_url": "occaecat",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "culpa pariatur officia voluptate in"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 74671857.14972788,
  "outer_height": -33817889.15252688,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "culpa__3": {
    "left_margin": "proident",
    "top_margin": -93082015.74025406
  },
  "commodo5f": {
    "left_margin": "dolore est Ut",
    "right_margin": 86541188.91900134,
    "top_margin": "aute proident eu cupidatat ipsum",
    "bottom_margin": "Excepteur ut"
  }
}
```
