...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "deserunt nostrud est ut",
  "supplier_part_numbers": {
    "cillum_c3b": ["eiusmod culpa consectetur elit", "ut est in aliqua sit"],
    "ad_9": []
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["ullamco eiusmod est"],
  "is_ground": true,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "pariatur exercitation ut nostrud deserunt",
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "aliquip234": ["nisi adipisicing dolore aliqua", "do ad fugiat"],
    "consequatae": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "voluptate qui mollit aliqua",
  "supplier_part_numbers": {
    "sunt_a0": [
      "cupidatat non elit nisi",
      "dolore exercitation qui in",
      "ipsum ea ex cupidatat sed"
    ],
    "Excepteur_d": ["nisi pariatur nulla in quis", "magna nulla enim nostrud"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "exc": [
      "ex ipsum proident nostrud ullamco",
      "non",
      "proident pariatur dolore officia quis",
      "ut veniam ex sed",
      "consequat ut occaecat dolore"
    ],
    "cillum24": [
      "magna est",
      "magna est eu",
      "ullamco dolore amet",
      "ad adipisicing et velit"
    ],
    "ad_9": ["do", "ut cupidatat in reprehenderit", "incididunt aliquip"],
    "aliquip_f2": ["ullamco labore", "aliqua enim ullamco"],
    "sed_c": [
      "sit voluptate",
      "proident id laboris fugiat",
      "anim fugiat",
      "dolor Excepteur Ut cupidatat est",
      "elit ut"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "aliquip34": ["ex sunt exercitation deserunt ea", "do ut nulla"],
    "elit_": ["nostrud esse"],
    "aute_58": []
  },
  "voltage": "5V"
...
```json
{
  ...
  "supplier_part_numbers": {
    "sint_5f5": ["qui consequat incididunt aute", "pariatur minim"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["in consequat"],
  "connected_source_net_ids": ["anim", "minim tempor elit"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 91679191.56850496,
  "pin_styles": {},
  "box_width": -9820317.204932973,
  "symbol_name": "id",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "qui fugiat amet dolore"
}
```
...
```json
{
  ...
  "message": "pariatur dolore Excepteur ullamco",
...
```json
{
  ...
  "radius_x": "deserunt occaecat do nisi",
  "radius_y": -77450265.64219764,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in ad consectetur Ut",
  "supplier_part_numbers": {
    "doloreecf": []
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "in sit voluptate",
  "supplier_part_numbers": {
    "dolor2": [
      "incididunt veniam sint sunt laborum",
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "reprehenderit cupidatat quis proident esse"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
  ...
  "model_obj_url": "Duis sed ad enim eu",
  "model_stl_url": "ex Duis aliquip sint",
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "proident ex Excepteur"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -12912443.711121842,
  "outer_height": -75490449.26353648,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "minim_2": {
    "right_margin": -77379630.68403047,
    "top_margin": "aliquip sint qui",
    "bottom_margin": "incididunt Duis"
  },
  "laborum_9b": {
    "left_margin": "incididunt ipsum laborum et voluptate",
    "right_margin": 97328425.30129924,
    "top_margin": -74568555.67505096,
    "bottom_margin": -84637623.2711514
  },
  "in_": {
    "left_margin": 10598987.870625049,
    "right_margin": "aliqua mollit",
    "top_margin": "dolore Lorem commodo",
    "bottom_margin": -21622252.985188514
  }
}
```
