...
```json
{
  ...
  "ftype": "est aliqua irure ex",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "aliquip nisi",
...
```json
{
  ...
  "trace_width": 27581675.008958623
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "cillum in deserunt",
  "supplier_part_numbers": {
    "Lorem__41": ["esse incididunt est eiusmod", "id laborum proident"],
    "nisi_78b": [
    ...
    "culpa__4": [
      ...
      "reprehenderit ut",
      "in",
      "eiusmod non est enim aliquip"
    ],
    "dolor_ff": [
      "adipisicing eiusmod deserunt nisi in",
      "ut esse culpa anim",
      "elit",
      "ad",
      "veniam tempor do occaecat"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_3": [
      "nisi consectetur consequat mollit et",
      "ullamco sit ea aliqua",
      "in incididunt minim",
      "elit nulla laborum",
      "commodo aute"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolore dolor aliqua nisi",
  "supplier_part_numbers": {
    "dolore_acf": ["ullamco aliqua adipisicing sit elit", "Ut consequat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "labore minim anim consequat dolore",
  "supplier_part_numbers": {
    "consectetura9d": ["elit minim eiusmod mollit", "labore"],
    "Lorem4": ["ipsum aute", "ad deserunt sit", "nulla est ullamco"],
    "laborumbd9": ["in", "quis veniam", "tempor", "adipisicing"],
    "qui6": ["officia irure"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "magna ipsum laboris fugiat",
  "supplier_part_numbers": {
    "amet_4": ["consectetur et ipsum non", "dolore Lorem Excepteur sint"],
    "eiusmod_106": [],
    "mollit2": ["dolor amet eu"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "qui nisi sunt elit non",
  "supplier_part_numbers": {
    "fugiat_a": ["cupidatat officia veniam laborum pariatur", "magna est in"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "laborum_35": [
      "qui esse eiusmod",
      "sint ullamco in aute",
      "qui elit",
      "aliqua laboris Ut commodo"
    ],
    "id0d": [],
    "id_f": ["velit Lorem proident"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "et Duis dolore adipisicing fugiat",
    "minim",
    "consequat id esse"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -79966225.2824158,
  "pin_styles": {},
  "box_width": -67733162.40024924,
  "symbol_name": "sunt eiusmod culpa cupidatat amet",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "occaecat est sed eiusmod"
}
```
...
```json
{
  ...
  "message": "proident consectetur labore dolor",
...
```json
{
  ...
  "radius_x": "veniam ex et commodo",
  "radius_y": "laboris eiusmod ullamco do",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "magna elit adipisicing Duis Excepteur",
  "supplier_part_numbers": {
    "eu_8": [
      "ullamco sed quis in",
      "tempor cillum do",
      "dolor quis enim veniam"
    ],
    "magnab49": ["cillum"],
    "fugiatba": [
      "mollit",
      "in non",
      "ipsum qui tempor reprehenderit",
      "exercitation fugiat eiusmod nostrud",
      "culpa"
    ]
  }
}
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "labore commodo nulla consectetur"
  },
  "layer": "top",
  "footprinter_string": "nostrud proident nulla ipsum",
  "model_obj_url": "pariatur nulla ex nostrud",
  "model_stl_url": "incididunt sit culpa officia",
  "model_3mf_url": "ullamco velit dolore",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 60612282.75958982,
  "outer_height": 98018647.87658623,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "ullamco_5c": {
    "left_margin": "irure cillum",
    "right_margin": "aliqua veniam",
    "top_margin": -94065588.3582874,
    "bottom_margin": -61363580.00740114
  }
}
```
