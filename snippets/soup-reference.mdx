...
```json
{
  ...
  "name": "D1",
  "manufacturer_part_number": "sunt culpa quis exercitation",
  "supplier_part_numbers": {
    "nisi__d": [
      "nulla id",
      "Lorem consequat dolor irure",
      "aliqua consectetur",
...
```json
{
  ...
  "supplier_part_numbers": {
    "adipisicing_0cc": ["dolor officia"],
    "aute_11": ["Excepteur ipsum"],
    "nulla_e9e": ["qui", "nostrud ea elit", "in", "qui minim ut", "quis culpa"],
    "in_ad1": ["ut"],
    "labore__8": []
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "nulla_d4": [
      "ipsum",
      "in enim mollit nostrud proident",
      "veniam",
      "fugiat ex anim labore",
      "amet Excepteur quis"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eiusmod reprehenderit quis cupidatat nulla"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "aliquip elit qui",
  "supplier_part_numbers": {
    "officiae5": ["Duis", "qui", "ex mollit", "ex consectetur id"],
    "labore_b3": [
      "labore proident exercitation ea",
      "reprehenderit",
      "adipisicing ad est incididunt"
    ],
    "magnabe5": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolor aute cillum",
  "supplier_part_numbers": {
    "aliquae67": [
      "veniam amet ea do",
      "labore velit in",
      "in mollit irure sed pariatur",
      "culpa Ut deserunt veniam",
      "Duis ex sed in ipsum"
    ],
    "do_8c": [
      "Duis laboris irure",
      "sunt",
      "dolore",
      "adipisicing reprehenderit proident ex eu",
      "magna"
    ],
    "pariatur1d": []
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "cillum consequat",
  "supplier_part_numbers": {
    "sed_6": []
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_net_ids": [
    "in laborum adipisicing eiusmod id",
    "elit",
    "sed in dolor cupidatat cillum"
  ]
}
```
...
```json
{
  ...
  "color": "anim cupidatat Duis veniam"
}
```
...
```json
{
  ...
  "message": "pariatur dolore Lorem in Ut"
}
```
...
```json
{
  ...
  "radius_x": 33353725.84565164,
  "radius_y": "reprehenderit nulla enim adipisicing dolor",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "do voluptate commodo",
  "supplier_part_numbers": {
    "fugiatbb8": [
      "sint",
      "id culpa nisi aute enim",
      "id",
      "dolor eiusmod",
      "ut in aliqua ex"
    ]
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "Lorem commodo sed cillum qui"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 70357898.544408,
  "outer_height": 6442249.752252266,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "proident3": {
    "left_margin": -56918763.95848121,
    "right_margin": -99733977.47317772,
    "top_margin": -21435101.842701167,
    "bottom_margin": "reprehenderit"
  },
  "enim_abf": {
    "left_margin": 6996707.976482645,
    "top_margin": 32233731.07795231,
    "bottom_margin": "dolor officia"
  }
}
```
