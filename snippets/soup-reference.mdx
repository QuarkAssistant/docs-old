...
```json
{
  ...
  "name": "A1",
  "manufacturer_part_number": "occaecat aliqua consequat irure incididunt",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "minim cupidatat ut",
  "supplier_part_numbers": {
    "Ut_8": [
      "laboris",
      "cillum ad in",
      "fugiat ut ipsum incididunt dolore",
      "proident dolore ut est et",
      "non sit id ut do"
    ],
    "do12": [
      "aute ad deserunt magna",
      "sunt sint non cillum",
      "aliqua dolore ad",
      "est ipsum mollit",
      "Ut aute Lorem"
    ]
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["dolore cupidatat aliqua nisi occaecat"],
  "is_digital_signal": false,
  "trace_width": 91796394.51852384
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "consequat pariatur",
  "supplier_part_numbers": {
    "irure_1a8": ["laboris velit", "pariatur ut tempor"],
    "ex__": [
      "esse minim laborum dolore",
      "officia aliqua qui",
      "dolore labore reprehenderit"
    ],
    "cupidatat_e": ["cillum", "id deserunt", "eiusmod amet voluptate"],
    "doloref4": ["proident officia velit consectetur"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "minim tempor sunt",
  "supplier_part_numbers": {
    "deseruntab2": []
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "supplier_part_numbers": {
    "in_ff1": [
      "mollit dolor qui",
      "consequat est dolore reprehenderit consectetur",
      "laboris tempor dolor",
      "deserunt",
      "nostrud id aute laborum et"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "cupidatat amet Ut aliquip",
  "supplier_part_numbers": {
    "autec": ["cupidatat sunt proident ex occaecat"],
    "quie4": [
      "dolore ad",
      "nisi dolor eu aliqua",
      "labore elit nisi",
      "occaecat enim eiusmod nostrud consequat",
      "culpa"
    ],
    "occaecatb6": [
      "consectetur amet",
      ...
      "laborum",
      "reprehenderit in eiusmod pariatur dolor"
    ],
    "proident6": ["Ut in veniam magna anim"],
    "consequat9": ["nisi Lorem"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "laboris Lorem adipisicing",
  "supplier_part_numbers": {
    "officia989": [
      "mollit adipisicing commodo eu officia",
      "amet Lorem veniam in"
    ],
    "ut_a7a": ["sed Excepteur Duis qui", "occaecat est Ut"],
    "ameted8": ["ex non veniam pariatur"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "exercitation laborum nisi ipsum",
  "supplier_part_numbers": {
    "do_f": ["consectetur", "Lorem", "culpa", "fugiat irure"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_net_ids": ["incididunt adipisicing nisi Excepteur et"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "amet in proident",
  "pin_styles": {},
  "box_width": "Ut elit proident occaecat",
  "symbol_name": "ut",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "cupidatat occaecat ullamco"
}
```
...
```json
{
  ...
  "color": "amet voluptate ipsum tempor"
}
```
...
```json
{
  ...
  "message": "ea sunt nulla est ullamco"
}
```
...
```json
{
  ...
  "message": "aute ipsum dolore nulla",
...
```json
{
  ...
  "radius_x": "Duis incididunt consequat",
  "radius_y": 88800908.94548523,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "anim proident minim consequat quis",
  "supplier_part_numbers": {
    "sint__f3": ["Excepteur", "Ut dolore", "aute ipsum ad occaecat ut"]
  }
}
```
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -27449894.778709367
  },
  "layer": "top",
  "footprinter_string": "in",
  "model_obj_url": "deserunt",
  "model_stl_url": "reprehenderit eu",
  "model_3mf_url": "nulla sunt commodo ullamco"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -3830034.3671441525,
  "outer_height": 66025193.51952538,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "incididunt Ut ad nostrud Lorem"
}
```
...
{
  "reprehenderit_5cb": {
    "left_margin": 96883334.28441694,
    "right_margin": "sed voluptate",
    "top_margin": 41910885.639431596,
    "bottom_margin": -38195606.44095001
  },
  "proident_": {}
}
```
