...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "amet do laborum enim ex",
  "supplier_part_numbers": {
    "cillum_5": ["consequat", "et in", "cillum veniam deserunt quis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "reprehenderit ex non",
  "supplier_part_numbers": {
    "Duis7": []
  }
}
...
```json
{
  ...
  "member_source_group_ids": [
    "commodo aliquip ut nostrud",
    "Ut",
    "cillum in nisi ea"
  ],
  "is_ground": false,
  "trace_width": 94705284.12461084
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "nisi non id ullamco eu",
  "supplier_part_numbers": {
    "Duis4": ["consequat"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aliqua et laborum dolore in",
  "supplier_part_numbers": {
    "veniam9_1": [],
    "consequat_e5_": ["pariatur mollit tempor"],
    "qui62": []
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "culpa Duis velit fugiat Excepteur",
  "supplier_part_numbers": {
    "animbe": ["reprehenderit Ut sint pariatur"],
    "ina9b": ["ea est"],
    "in4": ["ut velit", "elit dolor", "pariatur", "laborum"],
    "minim645": ["dolor enim aliqua", "deserunt do incididunt"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "elit sunt sint",
  "supplier_part_numbers": {
    "dolore_4": [
      "voluptate nostrud velit eiusmod",
      "velit nisi adipisicing",
      "sint Ut",
      "commodo sunt in tempor Ut"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "reprehenderit Duis",
  "supplier_part_numbers": {
    "Ut_1": ["Lorem pariatur consequat exercitation"],
    "site33": ["fugiat Ut et", "in aliqua"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "cupidatat pariatur nulla officia nostrud",
  "supplier_part_numbers": {
    "esse_d0e": ["adipisicing ut in labore enim", "minim officia dolor id"],
    "deserunt6": ["sed irure cupidatat proident"],
    "voluptatef": [],
    "eiusmod__4": ["nisi voluptate veniam sed aliqua", "Duis", "ex"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "et sint enim aute magna",
  "supplier_part_numbers": {
    "nostrud_d0f": [],
    "commodod7f": [
      "sit veniam ipsum",
      "dolor nulla non irure",
      "fugiat",
      "magna ut labore",
      "consequat"
    ],
    "sunt8fa": [
      "officia dolor nisi eu",
      "veniam",
      "consequat",
      "incididunt consequat consectetur ipsum et",
      "ad in"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_net_ids": [
    "non voluptate aliquip in",
    "mollit dolore",
    "aliquip id enim",
    "commodo non ea amet est"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "dolor nisi fugiat",
  "pin_styles": {},
  "symbol_name": "proident laborum irure",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "sed consequat eu irure reprehenderit"
}
```
...
```json
{
  ...
  "color": "Ut qui ullamco veniam voluptate"
}
```
...
```json
{
  ...
  "radius_x": "Duis consectetur magna",
  "radius_y": 9402600.107218891,
  "layer": "top"
}
```
...
```json
{
  ...
  "type": "schematic_error",
  "error_type": "schematic_port_not_found",
  "message": "ut aute commodo pariatur"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "est ut do ipsum et",
  "supplier_part_numbers": {
    "occaecat_3": [
      "Duis",
      "magna Excepteur",
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "dolor voluptate sint"
  },
  "layer": "top",
  "model_3mf_url": "deserunt voluptate laboris ullamco consequat",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 79010219.30177423,
  "outer_height": 31289622.316638216,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "enim_85f": {
    "left_margin": -74228305.01258111,
    "right_margin": "nulla esse",
    "top_margin": "eiusmod anim sunt"
  }
}
```
