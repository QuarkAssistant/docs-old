...
```json
{
  ...
  "ftype": "officia reprehenderit ad incididunt dolore",
  ...
  "supplier_part_numbers": {
    "proident_c4": [
      "elit eu",
      "Lorem proident in reprehenderit deserunt",
      "do",
      "ex amet Lorem",
      "dolore"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "in Ut ipsum elit do",
  "supplier_part_numbers": {
    "aute_03b": ["ullamco Ut", "et sunt", "exercitation", "non", "do et ut"],
    "consequat_ab5": ["ullamco"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["est", "dolor", "dolor", "ea in occaecat"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "fugiat Ut aliqua laboris",
  "supplier_part_numbers": {
    "reprehenderit__54": [
      "eiusmod et nulla aute",
      "do occaecat",
      "quis elit sit aliqua labore"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "nisi cillum ea sunt",
  "supplier_part_numbers": {
    "irureab": ["sunt occaecat", "quis id sint"],
    "reprehenderit_4": [
      "nostrud velit aliqua",
      "ad",
      "dolor",
      "ut anim Ut magna amet",
      "Ut id"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eiusmod sed",
  "supplier_part_numbers": {
    "ea_34": [
      "incididunt culpa sed ut",
      "consectetur sed",
      "aliqua pariatur cupidatat qui",
...
```json
{
  ...
  "supplier_part_numbers": {
    "aute6bb": [
      ...
      "sunt laboris ea",
      "enim",
      "ut ipsum id magna incididunt",
      "aliqua ea in aliquip eiusmod"
    ],
    "do_3d": [
      "cillum do",
      "esse Duis adipisicing occaecat ut",
      "non dolore Lorem aliquip",
      "deserunt aliquip incididunt consectetur irure"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ut mollit elit amet",
  "supplier_part_numbers": {
    "veniam_2": [
      "sed",
      "labore sit dolore",
      "quis ipsum esse do",
      "esse velit commodo sint",
      "aute quis mollit Excepteur et"
    ],
    "laboris_d": ["veniam pariatur eu culpa irure", "amet fugiat qui"],
    "et_ac": [
      "id",
      "est tempor",
      "voluptate in culpa dolore do",
      "Lorem labore veniam"
    ],
    "ea_1": [
      "qui voluptate",
      "exercitation",
      "id irure labore ad",
      "consequat aliqua labore amet"
    ],
    "ipsum57": ["officia in ut ex"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "culpa8b6": [
      "cupidatat proident",
      "veniam officia aute incididunt cillum",
      "quis minim ipsum ea elit",
      "anim",
      "ipsum amet ad adipisicing aute"
    ],
    "enimc1d": ["ut eiusmod dolor qui occaecat", "eu dolor mollit"],
    "Duis_79b": [],
    "in_cd8": ["qui fugiat consectetur est", "anim exercitation ex", "labore"],
    "proident_f": ["pariatur cupidatat Lorem voluptate"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "aliqua culpa quis",
  "supplier_part_numbers": {
    "sedde0": ["mollit minim tempor eu"],
    "aliqua_fb2": [
      "laboris",
      "adipisicing",
      "qui consectetur",
      "nulla",
      "do Duis exercitation minim ex"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "minim occaecat Ut commodo amet",
    "quis ipsum exercitation",
    "magna cillum",
    "velit"
  ],
  "connected_source_net_ids": ["cillum officia", "ex"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "laborum ut dolore est sed",
  "pin_styles": {},
  "box_width": "cillum ad nisi"
}
```
...
```json
{
  ...
  "message": "est nostrud ipsum esse"
}
```
...
```json
{
  ...
  "radius_x": "in laboris voluptate esse reprehenderit",
  "radius_y": "eu sunt magna consequat voluptate",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "Ut enim laboris voluptate",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "radius_x": "sed fugiat ex",
  "radius_y": "enim esse occaecat",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "elit Duis ipsum anim ut",
  "supplier_part_numbers": {
    "ex_308": [
      "nisi enim nostrud consequat",
      "ut voluptate",
      "eu occaecat in",
      "ut est anim amet labore",
      "fugiat occaecat"
    ],
    "eacd4": [],
    "reprehenderit353": [
      "do Lorem dolore consectetur sit",
      "dolore",
      "sed sit qui ad",
      "dolor"
    ]
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "fugiat quis mollit"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 67069370.21650466,
  "outer_height": -1602949.7446403652,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "elit_770": {
    "left_margin": "eiusmod tempor velit labore",
    "right_margin": "enim",
    "top_margin": 85270213.40323377,
    "bottom_margin": "do"
  }
}
```
