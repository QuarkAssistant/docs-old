...
```json
{
  ...
  "ftype": "sint dolore adipisicing ex",
  "source_component_id": "source_component_1",
  "name": "S1",
  "manufacturer_part_number": "nostrud labore",
  "supplier_part_numbers": {
    "exercitation353": [],
    "laboris_b0": [
      "elit sit aute ut laborum",
      "Excepteur labore ex",
      "officia deserunt cillum velit commodo",
      "dolor",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "laborum Duis qui",
  "supplier_part_numbers": {
    "Ut_4aa": ["ad aliquip eu", "dolore"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["reprehenderit ea sit", "ullamco magna ex culpa"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": 349911.84241995215
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "dolor aute aliquip",
  "supplier_part_numbers": {
    "consequat_fb": [
      "nulla non consectetur fugiat",
      "do officia ut qui",
      "voluptate id sunt ut nulla"
    ],
    "adipisicing_ec": [
      "in veniam magna laborum ut",
      "amet magna labore",
      "eu",
      "ipsum incididunt ut voluptate sint",
      "ex"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "qui_9": [
      "velit commodo non in",
      "elit esse",
      "nisi deserunt labore Excepteur"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ea et",
  "supplier_part_numbers": {
    "in_f1b": [],
    "sed_f5": [],
    "in_c": [
      "incididunt eu dolor",
      "magna ullamco occaecat",
      "nisi",
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "quis_0": ["culpa id exercitation"],
    "Duisa6": ["eu ad occaecat commodo", "et cillum", "quis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "sit veniam labore minim magna",
  "supplier_part_numbers": {
    "eiusmod_2": [],
    "id_51": ["Duis", "nisi enim dolor voluptate irure", "ut adipisicing ut id"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "quis proident cillum laboris aliquip",
  "supplier_part_numbers": {
    "occaecat__": ["aliquip sed Lorem in quis", "aliquip"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["non", "velit consectetur sed"],
  "connected_source_net_ids": [
    "do qui nulla dolore commodo",
    "cillum",
    "in aliquip cupidatat in"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "dolore sed",
  "pin_styles": {},
  "box_width": 64345647.188357234,
  "symbol_name": "in enim Lorem minim",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "radius_x": -44020473.06119625,
  "radius_y": 27262838.605574876,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "nostrud nulla ut aliqua esse",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "laborum nisi",
  "supplier_part_numbers": {
    "Ut_9": ["in cupidatat voluptate", "et"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "cillum",
  "model_obj_url": "nulla amet Excepteur",
  "model_stl_url": "commodo magna sint aliquip eiusmod",
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "eu ex laborum labore in"
}
```
...
{
  "sed_a": {
    "left_margin": -59418647.05330131,
    "right_margin": 98610102.19503185,
    "top_margin": 74142544.1487756
  }
}
```
