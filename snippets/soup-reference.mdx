...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "aliquip sed Duis ea",
  "supplier_part_numbers": {
    "et_9": [
      "est sint laboris",
      "in id elit adipisicing",
      "aute ipsum",
      "Excepteur Lorem est sunt"
    ],
    "laborum_e": [
      "ullamco tempor Duis magna",
      "proident voluptate labore in deserunt",
      "ut qui culpa pariatur",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "minim id Lorem",
  "supplier_part_numbers": {
    "ea919": ["sit aute", "quis aliqua elit id enim", "in magna", "Duis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "anim ipsum elit",
  "supplier_part_numbers": {
    "Lorem_33": ["amet id laborum non", "officia", "Lorem"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in consectetur veniam ex",
  "supplier_part_numbers": {
    "dolore_a": ["adipisicing commodo dolore nisi ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ut fugiat laborum anim elit"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "amet ex",
  "supplier_part_numbers": {
    "elit_0_": [],
    "sunt2f0": ["ut Duis non", "dolore enim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "tempor dolore",
  "supplier_part_numbers": {
    "sint__e": ["non", "reprehenderit elit"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "do ipsum",
  "supplier_part_numbers": {
    "voluptate_36": []
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "ex fugiat",
    "reprehenderit minim dolor sit",
    "pariatur dolore fugiat",
    "irure aute ea pariatur"
  ],
  "connected_source_net_ids": ["ad", "do aliqua dolore"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 44552460.84799126,
  "pin_styles": {},
  "box_width": -40978409.424143836,
  "symbol_name": "enim eu veniam velit id",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "ut do veniam deserunt labore"
}
```
...
```json
{
  ...
  "message": "anim sint exercitation"
}
```
...
```json
{
  ...
  "message": "Excepteur velit nulla in enim",
...
```json
{
  ...
  "message": "nisi ullamco aliquip officia adipisicing",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": 31592690.613791645
    },
    {
      "x": "3mm",
      "y": "1mm",
...
```json
{
  "type": "source_trace",
  "source_trace_id": "source_trace_1",
  "connected_source_port_ids": ["in", "nostrud"],
  "connected_source_net_ids": [
    "deserunt veniam",
    "tempor deserunt exercitation",
    "ut in minim",
    "aliquip sunt officia veniam"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "qui adipisicing laborum ut"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "adipisicing sunt deserunt reprehenderit est"
  },
  "layer": "top",
  "model_obj_url": "magna dolore dolor",
  "model_stl_url": "Excepteur elit",
  "model_3mf_url": "in quis consectetur esse",
  "model_jscad": {}
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "fugiat eiusmod est incididunt"
}
```
...
{
  "culpaa2": {
    "left_margin": "mollit velit",
    "top_margin": "consectetur"
  },
  "adipisicing_d": {
    "left_margin": -40153065.09669609,
    "right_margin": "adipisicing aliqua",
    "bottom_margin": "in Lorem cillum occaecat ad"
  },
  "anim6": {
    "top_margin": 33634928.3430597
  },
  "velitc_": {
    "left_margin": "deserunt ut",
    "right_margin": "nostrud ex dolore ut in"
  }
}
```
