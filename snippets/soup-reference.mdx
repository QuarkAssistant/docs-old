...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "culpa ex ut incididunt officia",
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "magnaad3": [
      "ea eu dolore sed",
      "in exercitation",
      "incididunt Excepteur reprehenderit do",
      "velit"
    ]
  }
}
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["fugiat"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": -96436968.64654072
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "mollit54f": [
      ...
      "sint incididunt",
      "Lorem",
      "ea laboris nulla sed deserunt"
    ],
    "Ut8": ["in fugiat Ut commodo enim", "dolore ullamco laboris"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "qui do",
  "supplier_part_numbers": {
    "ullamco_f0c": [
      "est in mollit non",
      "anim ullamco laborum id minim",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laborum dolor anim Duis do"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "tempor sunt reprehenderit",
  "supplier_part_numbers": {
    "Excepteur_4": [
      "culpa proident deserunt dolor",
      "dolore in commodo esse deserunt",
      "dolore",
      "in magna ex pariatur Ut",
      "quis incididunt ea"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "dolore tempor dolor ut dolore",
  "supplier_part_numbers": {
    "culpa9": [
      "aute ut laboris amet occaecat",
      "ut enim ullamco",
      "in elit",
      "exercitation amet aliquip"
    ],
    "qui_348": ["cupidatat proident", "laborum nostrud", "mollit ex dolor"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["qui et sit Lorem"],
  "connected_source_net_ids": [
    "elit cupidatat tempor exercitation",
    "adipisicing cupidatat do",
    "in non anim sit aliquip",
    "non",
    "labore"
  ]
}
...
```json
{
  ...
  "pin_styles": {
    "velit_88": {
      "left_margin": 16057207.087337226,
      "right_margin": -70082964.6666219,
      "top_margin": -67448999.41132534,
      "bottom_margin": "sint ad commodo dolore"
    },
    "sint_883": {
      "left_margin": "aliqua in cillum deserunt est"
    },
    "dolor_b5a": {
      "left_margin": -23921469.810600013
    }
  },
  "box_width": 46520335.53054467,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "Duis incididunt adipisicing"
}
```
...
```json
{
  ...
  "message": "pariatur ullamco Excepteur in"
}
```
...
```json
{
  ...
  "message": "nostrud aliquip mollit",
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": -16339891.579791427
    }
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "amet dolore do",
  "supplier_part_numbers": {
    "dolorebe": ["nulla do", "esse"],
    "voluptate_0": []
  }
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "quis cillum anim minim in"
}
```
...
{
  "in_2_": {
    "left_margin": "in voluptate adipisicing laboris",
    "right_margin": 86464017.60709277,
    "top_margin": "occaecat ut mollit",
    "bottom_margin": "in voluptate occaecat qui ex"
  },
  "reprehenderit_52": {
    "left_margin": "dolore in quis culpa",
    "right_margin": "Duis",
    "top_margin": "mollit aliqua ex incididunt in",
    "bottom_margin": "nulla"
  }
}
```
