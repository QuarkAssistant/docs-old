...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "veniam ullamco",
  "supplier_part_numbers": {
    "reprehenderit_4": [
      "Lorem minim ad commodo nisi",
      "dolore officia aliquip",
      "Lorem sed aliquip ad"
    ],
    "aute7a": ["laborum", "elit esse dolor Ut"],
    "mollit_1": ["ipsum culpa anim dolor cillum"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sint_c": ["tempor", "eu eiusmod est Lorem Duis"],
    "nostrudd_4": ["Ut ut consectetur eiusmod"],
    "cupidatat6_": ["veniam", "cupidatat laboris minim"],
    "irure__19": ["et exercitation non consequat eu", "nulla laborum minim"],
    "adipisicing8": [
      "veniam non",
      "exercitation magna sunt ea",
      "reprehenderit deserunt nisi dolor magna",
      "cillum reprehenderit do",
      "velit sit culpa aute"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "non elit eiusmod",
  "supplier_part_numbers": {
    "Ut_56": ["et ipsum dolore", "Lorem ut sint"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "esse consequat deserunt proident dolore",
  "supplier_part_numbers": {
    "in_6_": []
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "et_51": [
      "sint minim occaecat",
      "aliquip mollit Lorem proident minim",
      "ea velit sit culpa",
      "nostrud do"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "irure mollit non Ut ipsum",
  "supplier_part_numbers": {
    "incididunt_3": [],
    "exercitation4ea": [
      "pariatur magna mollit elit",
      "deserunt proident in",
      "consequat ad reprehenderit est",
      "nisi veniam incididunt proident"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "veniam_5_": ["Ut ullamco", "id", "fugiat occaecat ex", "nisi fugiat"],
    "dolord43": ["exercitation"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "non ullamco",
  "supplier_part_numbers": {
    "sit_7": [
      "labore nostrud dolor",
      "amet",
      "dolore adipisicing ut anim",
      "nisi",
      "irure ex in Lorem"
    ]
  },
...
```json
{
  ...
  "connected_source_port_ids": [
    "ex sint est nisi",
    "voluptate sit esse cupidatat",
    "adipisicing non ea veniam"
  ],
  "connected_source_net_ids": [
    "eiusmod est",
    "reprehenderit minim cillum incididunt dolor"
  ]
}
```
...
```json
{
  ...
  "color": "elit aliquip enim in anim"
}
```
...
```json
{
  ...
  "message": "ut consequat incididunt nulla",
...
```json
{
  ...
  "message": "dolore amet minim aliquip nostrud",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "nisi dolore laborum eiusmod",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "supplier_part_numbers": {
    "quisa": [
      "irure ullamco dolore ut officia",
      "in eiusmod non quis culpa",
      "cupidatat",
      "adipisicing"
    ],
    "aute26": ["exercitation nisi ut", "id eu in sit", "nisi cillum laboris"]
  }
}
```
...
```json
{
  ...
  "rotation": "90deg",
  "layer": "top",
  "model_obj_url": "esse sed id",
  "model_stl_url": "mollit deserunt fugiat reprehenderit",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "est cillum dolore ex"
}
```
...
{
  "dolore76": {
    "left_margin": "ea velit minim adipisicing",
    "top_margin": 51715516.722085565
  }
}
```
