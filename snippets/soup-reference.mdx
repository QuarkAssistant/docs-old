...
```json
{
  ...
  "ftype": "mollit in et deserunt consectetur",
  "source_component_id": "source_component_1",
  "name": "M1",
  "manufacturer_part_number": "nostrud Lorem",
  "supplier_part_numbers": {
    "sunt_13b": ["Ut Excepteur esse cillum culpa", "deserunt sint", "eu"],
    "aliquip_04": [
      "cupidatat enim aute exercitation",
      "fugiat ipsum sit irure sunt"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "do ex",
  "supplier_part_numbers": {
    "labore4": [
      "laboris non mollit sit qui",
      "labore dolore elit",
      "ex labore ad",
      "Ut velit"
    ],
    "qui_f0": [
      ...
      "ex",
      "reprehenderit enim",
      "mollit quis in ea adipisicing",
      "cillum consequat culpa et enim"
    ],
    "proidentc1b": ["veniam ex ad sit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "minim elit",
  "supplier_part_numbers": {
    "proidentfe": ["anim", "ex", "nostrud ex anim sunt quis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "est ullamco Duis veniam",
  "supplier_part_numbers": {
    "labore_0d3": []
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "supplier_part_numbers": {
    "fugiat_1": [
      "minim laboris enim exercitation mollit",
      "occaecat ut tempor est magna",
      "qui sit non elit Ut"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 19240704.08385195,
  "pin_styles": {},
  "box_width": -32672970.275566414,
  "symbol_name": "laboris ut id",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "mollit cupidatat elit proident enim"
}
```
...
```json
{
  ...
  "message": "incididunt quis ullamco dolor aliqua",
...
```json
{
  ...
  "radius_x": "sed aliquip quis consequat",
  "radius_y": -34125316.24657147,
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": "adipisicing sit magna tempor quis"
    }
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "anim cillum voluptate Excepteur",
  "supplier_part_numbers": {
    "est_7e": [
      "cillum reprehenderit officia in",
      "et ut",
      "anim",
      "amet sit est"
    ]
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "velit sunt est mollit"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -70714259.2130234,
  "outer_height": 95560344.33922487,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "trace_width": 30711498.242670342
}
```
