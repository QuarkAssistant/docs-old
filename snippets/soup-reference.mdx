...
```json
{
  ...
  "name": "A1",
  "manufacturer_part_number": "nulla labore commodo laborum",
  "supplier_part_numbers": {
    "minim_a5e": ["ut pariatur mollit reprehenderit aute", "veniam aliqua ea"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "velit_cd": ["exercitation nisi"],
    "aliqua_13": [
      "nisi adipisicing exercitation elit dolor",
      "dolor dolore velit in",
      "laboris"
    ]
  }
}
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["pariatur ipsum in nulla irure"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "adipisicing tempor Duis",
  "supplier_part_numbers": {
    "adipisicing1c5": ["dolore est", "sed officia laboris", "consequat ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laborum eu",
  "supplier_part_numbers": {
    "pariatur3": [],
    "proident06b": ["aute nulla ea in", "et ipsum"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aliqua quis irure tempor",
  "supplier_part_numbers": {
    "ullamco1c": [],
    "Ut_bd": ["commodo amet ullamco dolore"],
    "temporae5": ["non proident sunt", "ex sed in", "sed"],
    "enimce7": [
      "qui",
      "sint adipisicing Excepteur ipsum",
      "dolor",
      "sint incididunt nostrud",
      "ut magna et incididunt sit"
    ],
    "Ut_afe": [
      "Lorem commodo id culpa consequat",
      "ullamco dolor nulla",
      "commodo esse occaecat ipsum est",
      "ad dolore officia dolor nulla"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "consequat est",
  "supplier_part_numbers": {
    "nisi_a0e": ["nostrud culpa non"],
    "proident_e1": ["laboris ea"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolore Excepteur eiusmod veniam qui",
  "supplier_part_numbers": {
    "pariatur47": [
      "nostrud magna voluptate",
      "in dolore elit",
      "adipisicing in"
    ],
    "ullamco642": ["ex", "adipisicing dolore"],
    "Ut2": [
      "minim aute",
      "magna Duis in",
      "Duis dolor voluptate sunt mollit",
      "esse",
      "cillum nostrud et in"
    ],
    "adipisicing_1b": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ex voluptate pariatur adipisicing",
  "supplier_part_numbers": {
    "velitb": []
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ex amet minim",
  "supplier_part_numbers": {
    "cillumd": ["enim", "consequat amet labore", "sunt", "ullamco"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "dolore dolore elit occaecat cupidatat",
    "ut labore consequat dolor fugiat",
    "labore non exercitation deserunt id"
  ],
  "connected_source_net_ids": ["dolore", "cupidatat proident in"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -54726741.74671695,
  "symbol_name": "in nulla laborum officia Duis",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "pariatur proident cupidatat et"
}
```
...
```json
{
  ...
  "radius_x": -14483917.647332594,
  "radius_y": 46716547.738791734,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -65334532.25240482,
  "pin_styles": {},
  "box_width": "in aliqua",
  "symbol_name": "tempor velit dolore in ipsum"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "Excepteur dolore",
  "supplier_part_numbers": {
    "laboris_d77": [
      "aute sint officia",
      "quis minim enim",
      "ut sit ad occaecat ipsum",
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "aliquip dolore",
  "model_obj_url": "elit et anim eu",
  "model_stl_url": "labore ut commodo",
  "model_3mf_url": "Lorem id do incididunt velit",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "deserunt quis eu proident"
}
```
...
{
  "Ut_4": {
    "left_margin": "ea Excepteur voluptate ipsum officia",
    "right_margin": "ad",
    "top_margin": "incididunt Ut consequat",
    "bottom_margin": "adipisicing in Excepteur qui"
  }
}
```
