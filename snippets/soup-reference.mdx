...
```json
{
  ...
  "name": "O1",
  "manufacturer_part_number": "pariatur magna laborum non dolore",
  "supplier_part_numbers": {
    "dolor32c": ["ut dolore", "aliqua"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "fugiat ut exercitation in dolore",
  "supplier_part_numbers": {
    "id_8": [
      "enim cupidatat",
      "culpa",
      "consectetur",
      "pariatur reprehenderit magna in"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "consequat incididunt in pariatur",
    "consectetur tempor voluptate est"
  ],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": false,
  "trace_width": 217128.5849582851
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "mollit dolor pariatur",
  "supplier_part_numbers": {
    "culpa_d": ["id culpa", "dolore officia", "consequat non cillum"],
    "est_5": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in eiusmod ea occaecat",
  "supplier_part_numbers": {
    "ex_3": ["voluptate est mollit Lorem", "sed proident Lorem pariatur"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ut__6": ["ea", "in laborum veniam non fugiat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "laboris in et adipisicing est",
  "supplier_part_numbers": {
    "reprehenderit91": [
      "dolor nisi",
      "ut esse ex sed nisi",
...
```json
{
  ...
  "manufacturer_part_number": "ex",
  "supplier_part_numbers": {
    "exercitation_4": ["et", "consequat occaecat in elit", "veniam"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "dolore consectetur ut",
  "supplier_part_numbers": {
    "commodo_4": ["nostrud consequat"],
    "nisi_b15": [
      "occaecat fugiat",
      "velit incididunt aliqua",
      "culpa pariatur fugiat"
    ],
    "nisi_7": [
      "irure esse sint mollit",
      "fugiat proident sed pariatur incididunt",
      "voluptate non esse"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "name": "R1",
  "supplier_part_numbers": {
    "Duis703": ["nisi cillum", "aliqua", "ullamco adipisicing velit"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    ...
    "Lorem quis ut aliqua",
    "laboris esse",
    "laboris enim et do esse"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 23684175.692532077,
  "pin_styles": {},
  "box_width": 99535025.69352275,
  "symbol_name": "ad nisi proident",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "proident nostrud in commodo voluptate"
}
```
...
```json
{
  ...
  "message": "dolore Lorem proident in commodo"
}
```
...
```json
{
  ...
  "radius_x": 49757727.3152419,
  "radius_y": -25345103.94974366,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "in ad aliqua"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "cupidatat minim nostrud Duis",
  "supplier_part_numbers": {
    "exercitation_3": [
      "pariatur reprehenderit officia",
      "cupidatat sed id incididunt",
      "non aute magna Excepteur sed"
    ],
    "nostrud_5b": [
      "fugiat occaecat dolore velit",
      "cillum",
      "consequat in sit reprehenderit aliquip"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": 42260713.817014694
  },
  "footprinter_string": "consectetur ullamco"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "Lorem id laboris aliqua amet"
}
```
...
{
  "veniam005": {
    "left_margin": 79627839.1732006,
    "right_margin": 54376521.14716789,
    "bottom_margin": "ad ut est elit"
  }
}
```
