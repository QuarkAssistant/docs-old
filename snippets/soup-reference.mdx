...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "commodo sit voluptate"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "sed elit in commodo",
  "supplier_part_numbers": {
    "pariatur6": [
      "nulla ipsum aliqua",
      "minim tempor ullamco elit Excepteur",
      "veniam dolore sed",
      "labore laborum dolore",
      "dolor irure qui cupidatat in"
    ],
    "veniam4": ["est dolore", "ex in culpa Excepteur"],
    "labore_5d": ["dolore Excepteur"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ex sit",
  "supplier_part_numbers": {
    "tempor_9": [
      "do",
      "pariatur cupidatat",
      "sint ut elit",
      "in incididunt enim Ut laborum",
      "ea tempor consectetur incididunt"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "velit qui",
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "id minim quis officia",
  "supplier_part_numbers": {
    "aliquip749": ["officia sit", "sint eiusmod", "ut"],
    "sit_541": [
      "reprehenderit",
      "laboris nostrud",
      "aute sit aliqua incididunt"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "irure labore sit pariatur adipisicing",
  "supplier_part_numbers": {
    "incididunt_b": ["fugiat", "enim dolore sunt"],
    "mollit_8c": [
      "pariatur incididunt deserunt non",
      "Duis sint enim",
      "velit irure",
      "minim ea enim laboris",
      "Duis"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "dolore eiusmod cillum"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ullamco6_": ["reprehenderit cillum sed amet", "incididunt"],
    "id9a": ["et cillum", "reprehenderit occaecat labore"],
    "do_8ce": [
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ea in Ut ex nulla",
  "supplier_part_numbers": {
    "mollit_f_4": [
      "ad eu occaecat",
      "aliquip",
      "ipsum eiusmod sed minim",
      "ullamco do"
    ],
    "est6": [
      "dolore pariatur enim dolore eu",
      "sint ea non qui",
      "sit commodo elit ut",
      "proident ea dolor",
      "cupidatat anim"
    ...
    "cupidatat9ad": [
      "quis sit Lorem officia anim",
      "ad Ut eiusmod",
      "Lorem quis Excepteur culpa",
      "nulla Lorem"
    ],
    "veniam_81": [
      "officia voluptate cupidatat exercitation aliquip",
      "esse officia",
      "nisi magna dolor exercitation",
      "proident deserunt laborum esse"
    ],
    "elit_41f": [
      "eu",
      "ut",
      "reprehenderit aliqua cillum mollit ut",
      "Lorem sunt laborum officia nostrud"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "exercitation laborum nulla nisi",
    "Duis dolore in sunt nisi",
    "veniam ut aliquip et",
    "ullamco nisi in commodo Excepteur",
    "sunt fugiat deserunt quis"
  ],
  "connected_source_net_ids": [
    "elit ut cillum ipsum",
    "cupidatat in anim eiusmod"
  ]
}
```
...
```json
{
  ...
  "color": "laboris ex consequat dolor exercitation"
}
```
...
```json
{
  ...
  "radius_x": "minim cupidatat dolore",
  "radius_y": -42018282.83074924,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "tempor irure"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ea_2": ["laborum consequat", "deserunt"],
    "culpa_c": [
      "consectetur Duis eiusmod ex",
      "amet Ut aliqua reprehenderit",
      "nisi",
      "mollit",
      "voluptate Duis"
    ]
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "sint quis ullamco velit labore",
  "model_obj_url": "dolor Lorem pariatur",
  "model_stl_url": "deserunt aliquip cupidatat id non",
  "model_3mf_url": "officia incididunt occaecat",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "aliquip fugiat aute ex do"
}
```
...
```json
{
  ...
  "y": "1mm",
  "to_layer": "bottom",
  "trace_width": "mollit velit tempor"
}
```
...
{
  "laboris_82": {
    "left_margin": -45142836.10094334,
    "right_margin": 17724473.86039646,
    "top_margin": "nostrud ad in ipsum",
    "bottom_margin": "in"
  }
}
```
