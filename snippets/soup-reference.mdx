...
```json
{
  ...
  "ftype": "ex ipsum nulla est Lorem",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "ullamco esse veniam aute qui",
  "supplier_part_numbers": {
    "ea_1": ["culpa ex incididunt ad", "laboris magna dolor ipsum aliquip"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["nisi deserunt id fugiat"],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 74919280.5397917
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_187": ["ipsum in aliquip"],
    "in073": ["ad ex anim nisi aliqua", "laborum mollit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sunt ut elit",
  "supplier_part_numbers": {
    "dolore_5": ["sit ullamco cillum ea est", "adipisicing dolore"],
    "culpa_74": [
      "mollit sunt dolore quis et",
      "voluptate cillum magna officia laborum"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eu ex",
  "supplier_part_numbers": {
    "dolor1": ["in deserunt", "non", "id"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "Excepteur1cd": ["consequat", "ipsum", "labore do dolor Duis occaecat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "mollit dolore sed",
  "supplier_part_numbers": {
    "nisi_30d": [
      "culpa nulla Lorem",
    ...
    "in1ae": [
      "nisi ea",
      "ex fugiat culpa",
      "minim ullamco ut in voluptate",
      "cupidatat"
    ],
    "essee": [
      "consectetur ut",
      "aute enim tempor consequat id",
      "laboris dolore nulla in",
      "reprehenderit",
      "ea in esse in dolore"
    ],
    "mollit_e4": [
      "ex consectetur et",
      "minim tempor Lorem in consectetur",
      "do",
      "cupidatat sunt Excepteur reprehenderit et",
      "culpa quis sunt officia"
    ],
    "doloreb01": [
      "in fugiat officia dolor",
      "aliquip nisi reprehenderit",
      "Lorem esse officia",
      "Ut ut enim adipisicing",
      "eu officia laboris mollit"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": ["laborum sed do aliqua nisi"],
  "connected_source_net_ids": [
    "Lorem enim aute qui",
    "Ut sunt eu occaecat anim"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -26654163.962628454,
  "box_width": -51099683.52167309,
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "Excepteur cupidatat esse do"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "reprehenderit dolor mollit"
}
```
...
```json
{
  ...
  "color": "Lorem commodo in voluptate"
}
```
...
```json
{
  ...
  "radius_x": "laborum laboris voluptate dolore cupidatat",
  "radius_y": "sit commodo pariatur laboris dolor",
  "layer": "top"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "laboris in Duis",
  "model_obj_url": "minim in esse laborum",
  "model_stl_url": "est id",
  "model_3mf_url": "Excepteur reprehenderit qui adipisicing",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ad proident exercitation ullamco"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -94080577.29365402,
  "outer_height": 47385966.755200714,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "eu_5ab": {
    "left_margin": "aliquip in deserunt Excepteur consequat",
    "right_margin": "dolore sed",
    "top_margin": "fugiat exercitation consectetur"
  },
  "ullamco4": {
    "left_margin": "esse in do",
    "right_margin": -37188146.66497492,
    "top_margin": 57047207.02889338,
    "bottom_margin": "anim Lorem aliquip sint in"
  },
  "ad_39": {
    "left_margin": "ipsum deserunt reprehenderit"
  }
}
```
