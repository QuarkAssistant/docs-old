...
```json
{
  ...
  "ftype": "ut nulla id laboris",
  "source_component_id": "source_component_1",
  "name": "U1",
  "manufacturer_part_number": "cupidatat anim Excepteur",
  "supplier_part_numbers": {
    "etec": ["ea commodo Excepteur", "eu voluptate irure", "est non"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["voluptate laboris", "Ut magna"],
  "is_ground": true
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "qui aliquip esse laboris",
  "supplier_part_numbers": {
    "eu_4ec": ["est eiusmod commodo sed"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "aliquip mollit",
  "supplier_part_numbers": {
    "tempor_9ba": ["reprehenderit"],
    "dolore03": ["eu", "non enim", "qui Lorem eiusmod", "magna quis", "commodo"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "et ipsum Duis",
  "supplier_part_numbers": {
    "autef": [
      "in proident",
      "do ad",
      "incididunt consequat dolore sed",
      "amet",
      "fugiat sit"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ut deserunt adipisicing",
  "supplier_part_numbers": {
    "ut_551": ["in dolore culpa pariatur", "proident"],
    "minim_": [
      "dolore velit quis",
      "elit",
      "officia occaecat tempor ex culpa",
      "minim non nisi ea"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "sit reprehenderit aliqua ullamco",
  "supplier_part_numbers": {
    "ullamco_de": ["incididunt irure ullamco sed"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "velit cillum",
  "supplier_part_numbers": {
    "occaecat_711": ["est nulla"],
    "consecteturf": []
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "sit8": [],
    "ex_d40": ["aliquip irure tempor nostrud cillum"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "labore nisi nulla Lorem irure",
    "exercitation dolore dolor magna minim"
  ],
  "connected_source_net_ids": [
    "mollit est consequat",
    "qui occaecat sed Lorem ex"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 62790363.41805893,
  "pin_styles": {},
  "box_width": 72357846.83894399,
  "symbol_name": "elit ut",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "radius_x": "ullamco est dolore ut nostrud",
  "radius_y": "Lorem veniam deserunt enim",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "do in exercitation incididunt",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "in laboris mollit sed",
  "supplier_part_numbers": {
    "dolor0cb": [
      "Duis consequat cillum ad",
      "dolor",
      "sunt ea in dolor nostrud",
      "Lorem minim ullamco ut",
      "anim Ut laborum"
    ],
    "fugiat_4ed": ["aliqua ullamco id sit"],
    "veniam_32": [
      "minim aliqua nulla",
      "nisi velit dolor qui",
      "non",
      "labore consectetur tempor officia non"
    ],
    "velit7": ["ex reprehenderit proident Lorem", "enim ut est"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "ea commodo",
  "model_obj_url": "ea incididunt",
  "model_stl_url": "culpa",
  "model_3mf_url": "anim voluptate",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "deserunt eiusmod laborum"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 93721736.88697675,
  "outer_height": -90223722.09778924,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "consectetur_5": {
    "left_margin": -93791701.95216621,
    "top_margin": "sed labore magna reprehenderit cillum",
    "bottom_margin": -30608646.420116514
  },
  "aliquip020": {
    "left_margin": 13609659.621740848
  },
  "aliquip2": {}
}
```
