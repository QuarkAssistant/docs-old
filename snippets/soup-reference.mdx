...
```json
{
  ...
  "name": "U1",
  "manufacturer_part_number": "dolor enim aliquip laboris",
  "supplier_part_numbers": {
    "temporf7": ["fugiat veniam"],
    "ut1": [
      "ea ad ut",
      "reprehenderit Lorem voluptate",
      "occaecat aliquip",
      "occaecat in non adipisicing aute"
    ],
    "magna_af": [
      "veniam labore ex exercitation",
      "ut voluptate in aliquip ea",
      "in sit nostrud ipsum",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ea culpa dolor",
  "supplier_part_numbers": {
    "cillum_a": []
  }
}
...
```json
{
  ...
  "member_source_group_ids": [
    "amet anim veniam laboris ut",
    "reprehenderit anim tempor laboris in",
    "ex",
    "est ut proident nulla",
    "minim pariatur sit dolore"
  ],
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": -79906912.76020572
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "voluptate aliqua dolor Ut",
  "supplier_part_numbers": {
    "culpab": [
      "irure deserunt laborum fugiat",
      "labore sunt laboris",
      "minim in voluptate"
    ],
    "sunt_5_d": ["pariatur laboris commodo mollit cupidatat", "veniam eiusmod"]
  }
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "nostrud0": ["labore", "nisi aute exercitation veniam"],
    "consequat7d": ["Duis"],
    "magnab42": ["dolore nulla Ut amet", "magna non dolore"],
    "ex_bfc": [
      "in ea dolor",
      "ipsum enim",
      "et officia in",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "tempor deserunt irure aliqua laborum",
  "supplier_part_numbers": {
    "proidentae": ["sit ad velit minim laborum"],
    "esse_3b2": ["amet pariatur", "fugiat culpa"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "reprehenderit dolor Excepteur aliquip et",
  "supplier_part_numbers": {
    "amet_b_d": ["commodo aliqua", "laboris sit ea ex", "aliqua"]
  }
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["dolor", "dolor incididunt"],
  "connected_source_net_ids": ["dolore dolor"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "symbol_name": "dolore incididunt anim"
}
```
...
```json
{
  ...
  "message": "qui nulla consectetur ullamco reprehenderit"
}
```
...
```json
{
  ...
  "message": "adipisicing nulla exercitation amet laborum"
}
```
...
```json
{
  ...
  "radius_x": "Duis ut fugiat Lorem culpa",
  "radius_y": -26587128.382913724,
  "layer": "top"
}
```
...
```json
{
  ...
  "route": [
    ...
    },
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 14794267.363265634
    },
    {
      "x": "3mm",
      "y": "1mm",
      "via": true,
      "to_layer": "bottom",
      "trace_width": 48498718.611091495
    },
    {
      "x": "3mm",
      "via": true,
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "aute Excepteur nostrud qui cillum"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 59969669.31185362,
  "outer_height": -26967507.83402857,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "et_17": {
    "right_margin": 62215867.45374453,
    "top_margin": "do adipisicing eiusmod cupidatat officia",
    "bottom_margin": 73393436.62629521
  }
}
```
