...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "consequat in aliqua Excepteur",
  "supplier_part_numbers": {
    "sed604": [
      "cupidatat ipsum est qui",
      "nostrud ullamco aliquip ex",
      "in proident dolor laborum irure",
      "dolor"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "fugiat voluptate dolore anim",
  "supplier_part_numbers": {
    "culpa_d": [
      "velit laboris veniam cupidatat reprehenderit",
      "mollit laboris"
    ],
    "dolore_a": []
  }
...
```json
{
  ...
  "trace_width": 19689045.857494622
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "labore deserunt",
  "supplier_part_numbers": {
    "laborisf0b": [
      "voluptate in esse aliquip",
      "consequat esse consectetur laboris Lorem",
      "laborum ea"
    ],
    "dolore_e9": ["aliquip", "anim fugiat", "do veniam et"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ex ipsum reprehenderit",
  "supplier_part_numbers": {
    "dolore_7": ["sed qui anim et laborum", "et"],
    "ex4": ["deserunt voluptate", "ullamco", "magna"],
    "ut090": ["in deserunt sit", "ullamco adipisicing labore Excepteur anim"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "est Duis aliqua mollit anim",
  "supplier_part_numbers": {
    "doa2": [
      "laborum exercitation ea",
      "dolore qui",
      "consectetur adipisicing Lorem in qui",
      "in"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "tempor ad laborum",
  "supplier_part_numbers": {
    "laboree": [],
    "irured": ["velit"]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "box_width": -132885.00880466402,
  "symbol_name": "sunt sed",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "consectetur minim pariatur Excepteur aute"
}
```
...
```json
{
  ...
  "color": "elit proident non dolor Lorem"
}
```
...
```json
{
  ...
  "radius_x": 66196043.802749574,
  "radius_y": -26888082.687847793,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "reprehenderit ipsum eu",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "dolor magna",
  "supplier_part_numbers": {
    "culpa7": ["consectetur voluptate"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "nulla voluptate ex proident dolor"
}
```
...
{
  "nond8a": {
    "left_margin": "eu cillum irure",
    "right_margin": 89344034.34020814,
    "top_margin": -39141576.26429149,
    "bottom_margin": 76884252.15876299
  },
  "aute2": {
    "left_margin": "do dolor occaecat mollit ea",
    "right_margin": "proident do elit consectetur",
    "top_margin": "amet"
  },
  "enim_6": {
    "left_margin": "aute cupidatat",
    "right_margin": -62827621.285069756,
    "top_margin": "laboris consequat non deserunt sit",
    "bottom_margin": -38782030.960405976
  }
}
```
