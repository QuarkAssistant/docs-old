...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "dolore laboris",
  "supplier_part_numbers": {
    "laboris_a": [
      "aliquip proident Lorem",
      "Excepteur fugiat dolore amet in",
      "ex dolor"
    ]
  }
}
...
```json
{
  ...
  "member_source_group_ids": [
    "non commodo laborum",
    "aute nisi proident elit Excepteur",
    "labore ipsum elit",
    "ea aliquip"
  ],
  "is_analog_signal": true,
  "trace_width": 14655663.080581188
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "sint ipsum",
  "supplier_part_numbers": {
    "voluptate_e6": ["proident reprehenderit officia"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ad dolor sunt exercitation sit",
  "supplier_part_numbers": {
    "proident32": ["dolore"]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolore2": [
      "adipisicing tempor esse deserunt amet",
      "enim Ut eu",
      "in quis irure ullamco",
      "in sed sunt quis in",
      "dolor esse"
    ],
    "ipsum_b": ["ad eu dolor velit do", "anim consequat dolor esse dolore"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "eu595": ["exercitation"],
    "consequat__": ["tempor consectetur", "in", "ipsum eu", "consequat ut"],
    "deseruntabc": ["cupidatat ut"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "consectetur cillum",
  "supplier_part_numbers": {
    "labore_719": ["Ut reprehenderit"],
    "ametd6e": ["elit Ut aute dolore", "Duis et mollit", "esse"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "dolor tempor in",
    "quis magna deserunt dolore qui",
    "et eu consequat eiusmod"
  ],
  "connected_source_net_ids": [
    "sunt tempor velit et ea",
    "commodo",
    "ut dolor labore ea ad",
    "dolor in ad qui labore"
  ]
}
```
...
```json
{
  ...
  "schematic_component_id": "schematic_component_1",
  "pin_styles": {},
  "box_width": "culpa proident aliquip et",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "radius_x": "in irure fugiat",
  "radius_y": 39223831.7335107,
  "layer": "top"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "veniam est pariatur Ut enim"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "deserunt consequat in",
  "supplier_part_numbers": {
    "esse5_": [
      "veniam anim elit aliquip commodo",
      "laborum",
      "ea dolor aliqua in"
    ],
    "ullamco8": [
      "Excepteur aliquip amet commodo",
      "ipsum Lorem incididunt",
      "sunt laborum enim laboris eiusmod",
      "labore culpa veniam est aliquip",
      "irure"
    ],
    "labore_9ef": ["sit qui est", "commodo"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": 19418285.668853223
  },
  "footprinter_string": "dolore laboris eiusmod et eu",
  "model_obj_url": "Ut eu qui",
  "model_stl_url": "ex nostrud irure dolor exercitation",
  "model_3mf_url": "et amet",
  "model_jscad": {}
}
```
...
{
  "ex_9": {
    "left_margin": -5111856.445462063,
    "top_margin": "elit quis",
    "bottom_margin": "nulla sint voluptate"
  }
}
```
