...
```json
{
  ...
  "ftype": "fugiat adipisicing",
  "source_component_id": "source_component_1",
  "name": "F1",
  "manufacturer_part_number": "id tempor ullamco laboris dolore",
  "supplier_part_numbers": {
    "cupidatat_ad_": ["sed", "in", "cupidatat", "laborum pariatur id"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "enim anim",
  "supplier_part_numbers": {
    "incididunt_ec": [],
    "voluptate_6": [
      "mollit",
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["consectetur incididunt ex aute ullamco"],
  "is_analog_signal": false,
  "trace_width": 66654545.59950042
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "voluptate aliqua eiusmod",
  "supplier_part_numbers": {
    "elita": ["mollit laboris dolore aliquip"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "aute2": ["exercitation qui", "sunt fugiat ullamco"],
    "labore77": []
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "in aliqua ex velit magna",
  "supplier_part_numbers": {
    "enim_f": ["laborum ex officia et culpa"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "anim occaecat mollit fugiat",
  "supplier_part_numbers": {
    "non_365": [
      "elit consequat est",
      "occaecat exercitation amet",
      "minim magna pariatur in",
      "proident Lorem fugiat",
      "in occaecat tempor ad"
    ],
    "ut_9": ["Duis anim deserunt ipsum"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "pariatur nulla",
  "supplier_part_numbers": {
    "animbf": [
      "cillum non sunt officia labore",
      "ipsum adipisicing Lorem in consectetur",
      "dolore",
      "in ut",
      "qui"
    ],
    "consequat_ac": [
      ...
      "labore",
      "in commodo cillum enim aliquip"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "inee1": ["consectetur do nulla"],
    "ex751": [
      "voluptate quis ullamco deserunt mollit",
      "laboris pariatur ea",
      "minim incididunt adipisicing",
      "velit minim consectetur"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "aute sint",
  "supplier_part_numbers": {
    "ea_8d": [
      "nostrud anim dolore id",
      "consectetur do nostrud",
      "non ullamco reprehenderit ea",
      "dolor ut do pariatur qui"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_net_ids": [
    "veniam in aliqua laboris",
    "est",
    "dolor labore et adipisicing elit",
    "tempor dolore ut"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 2474766.2046108246,
  "pin_styles": {},
  "box_width": "ipsum consectetur sit in pariatur",
  "symbol_name": "ad anim",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "color": "est elit consectetur nisi Duis"
}
```
...
```json
{
  ...
  "radius_x": -85283767.97837725,
  "radius_y": "quis minim mollit dolore adipisicing",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "ipsum Excepteur labore Duis",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 26798065.908666268
    },
    {
      "x": "3mm",
      "via": true,
...
```json
{
  ...
  "supplier_part_numbers": {
    "sint_e6": ["veniam", "eiusmod", "ullamco dolore"],
    "ea_eb4": ["ipsum voluptate"]
  }
}
```
...
```json
{
  ...
  "rotation": "90deg",
  "model_obj_url": "dolor nulla",
  "model_stl_url": "ad",
  "model_3mf_url": "dolor ad",
  "model_jscad": {}
}
```
...
{
  "amet_f1c": {
    "left_margin": "Duis deserunt"
  },
  "ipsum5ca": {
    "left_margin": 16040396.757702917,
    "right_margin": 10415927.938583598,
    "top_margin": "exercitation Ut labore in",
    "bottom_margin": -58516068.21999473
  },
  "tempor_d1": {
    "left_margin": "sit dolore",
    "right_margin": "tempor exercitation anim id dolor",
    "top_margin": "voluptate",
    "bottom_margin": -47764083.223169476
  },
  "Lorem96": {}
}
```
