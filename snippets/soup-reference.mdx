...
```json
{
  ...
  "name": "C1",
  "manufacturer_part_number": "amet aliquip dolor laborum dolore"
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    ...
    "voluptate",
    "et",
    "ullamco sit consectetur velit enim",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "laboris ut tempor commodo irure",
  "supplier_part_numbers": {
    "labore_511": [
      "voluptate Lorem",
      "Duis ipsum minim officia aute",
      "voluptate deserunt elit et",
      "ut ea enim amet commodo",
      "dolor irure"
    ],
    "consequat5f": ["in amet do", "aute"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cillum consequat magna labore",
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "aliqua7c": ["qui ut in pariatur do"],
    "aliqua_a": ["consectetur Lorem", "nulla aliqua elit", "exercitation"],
    "tempor5c": [
      "minim laboris",
      "pariatur consectetur incididunt mollit dolore"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "amet voluptate adipisicing dolor",
  "supplier_part_numbers": {
    "adipisicing_0a4": [
      "deserunt quis",
      "dolore officia Lorem Excepteur pariatur",
      "incididunt consectetur"
    ],
    "et3": ["magna reprehenderit Excepteur qui", "id"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "et dolor ullamco",
  "supplier_part_numbers": {
    "sit0": [
      ...
      "non Ut",
      "et",
      "voluptate aliquip magna id ipsum"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "aute sed deserunt id et",
  "supplier_part_numbers": {
    "dolore_8": ["irure do incididunt veniam exercitation"],
    "reprehenderit_1": ["irure", "ipsum", "dolore sed exercitation cillum"],
    "Excepteur_0a": [
      "eu Duis aute ut culpa",
      "commodo aliquip laborum cupidatat eu",
      "irure in"
    ],
    "enimb85": ["Ut amet in minim", "ex pariatur", "minim consectetur"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ipsum_462": [
      ...
      "aute",
      "eu et ut fugiat",
      "anim fugiat consequat pariatur aliquip"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "et id",
    "eiusmod enim anim aliquip",
    "sint",
    "minim Ut esse"
  ],
  "connected_source_net_ids": [
    "reprehenderit ut velit sed mollit",
    "dolor id dolore"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 34595470.07524231,
  "box_width": 84067743.87312734,
  "symbol_name": "consectetur",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "radius_x": 97948394.54070869,
  "radius_y": "minim dolor commodo in",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "enim esse eiusmod magna",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "aliquip dolor fugiat ut Excepteur"
}
```
...
```json
{
  ...
  "layer": "top",
  "model_obj_url": "dolore laborum nostrud magna velit",
  "model_3mf_url": "ipsum quis mollit",
  "model_jscad": {}
}
```
...
{
  "dolor_f81": {
    "left_margin": "elit in anim",
    "right_margin": 49064889.05033094
  }
}
```
