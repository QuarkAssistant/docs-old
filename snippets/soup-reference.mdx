...
```json
{
  ...
  "supplier_part_numbers": {
    "pariatur_bb": [
      "proident Excepteur",
      "nulla ex",
      "proident commodo velit",
      "dolor commodo cillum"
    ],
    "amet_e9": ["dolore", "quis dolore proident"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "nulla velit tempor",
  "supplier_part_numbers": {
    "et5": ["elit sed minim sit", "commodo ullamco sit", "laboris", "ut"],
    "dolor_eb7": ["nulla mollit", "minim et consequat"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "tempor",
    "proident",
    "labore eiusmod cupidatat",
    "sit sint fugiat veniam",
    "est quis laborum commodo officia"
  ],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": -14948793.922367185
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "labore aute exercitation in id",
  "supplier_part_numbers": {
    "ullamco_63_": [
      "anim",
      "exercitation Lorem id dolor",
      "eu dolor incididunt",
      "ea sint Lorem"
    ]
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "eiusmod_76": ["tempor", "non dolor reprehenderit deserunt laborum"],
    "consequat_8_f": [
      "pariatur",
      "nulla eu qui cillum aliqua",
      "cillum cupidatat occaecat amet qui",
      "ullamco do"
    ],
    "occaecat_7": [
      "dolor cillum",
      "eiusmod do Excepteur aliqua",
      "elit dolor laboris cupidatat nostrud",
      "nostrud culpa ex elit dolore",
      "consequat tempor"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ut incididunt laboris aliquip sed",
  "supplier_part_numbers": {
    "cupidatatb": [
      "magna consectetur id in",
      "ullamco deserunt proident",
      "non cupidatat ipsum sint ea",
      "dolor sunt",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "elit in",
  "supplier_part_numbers": {
    "dolorebf": [],
    "ex_66": ["velit", "consectetur Excepteur qui", "quis esse ullamco"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["irure aute in", "aliquip dolore"],
  "connected_source_net_ids": ["labore sed deserunt proident"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "nisi consectetur",
  "pin_styles": {},
  "box_width": -18345896.236115918,
  "symbol_name": "in minim adipisicing in incididunt",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "consectetur velit sed officia"
}
```
...
```json
{
  ...
  "radius_x": 15922809.725311682,
  "radius_y": -90607898.41607186,
  "layer": "top"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "dolor laboris pariatur elit incididunt"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
  ...
  "layer": "top",
  "footprinter_string": "labore cupidatat",
  "model_obj_url": "esse dolore consequat",
  "model_stl_url": "commodo Duis ipsum",
  "model_3mf_url": "pariatur culpa mollit fugiat",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "officia magna eiusmod"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "veniam sed tempor esse laboris"
}
```
...
```json
{
  ...
  "y": "1mm",
  "to_layer": "bottom",
  "trace_width": "deserunt tempor sunt"
}
```
...
{
  "Lorem_69f": {
    "top_margin": "anim ea qui veniam tempor",
    "bottom_margin": -99592437.42866182
  },
  "elit_f3d": {
    "left_margin": -3768289.804924369,
    "right_margin": -57292183.58822665,
    "top_margin": -98473051.47426066,
    "bottom_margin": 26289013.75372012
  }
}
```
