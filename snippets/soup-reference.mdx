...
```json
{
  ...
  "ftype": "ea nostrud nulla",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "amet do ut irure sint"
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["labore", "laboris"],
  "is_power": false,
  "is_ground": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "minim laboris aliqua Excepteur aliquip",
  "supplier_part_numbers": {
    "sit_bf": [
      "laborum veniam minim irure dolore",
      "reprehenderit non",
      "cillum Excepteur ea Ut do",
      "mollit ipsum in"
    ],
    "fugiat_ec": [
      "irure eu dolor aliquip",
      "veniam do aliquip",
      "ipsum ullamco sed et ad",
      "laborum aute Excepteur in qui",
      "laborum reprehenderit"
    ],
    "quis_d": ["ea eiusmod est", "irure"],
    "ut_98": ["sed proident eu dolore Duis", "commodo sit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "exercitation pariatur sit cupidatat elit",
  "supplier_part_numbers": {
    "eiusmodd": [
      "voluptate sed dolor minim quis",
      "occaecat culpa quis",
      "esse enim eu amet",
      "ad"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sunt incididunt adipisicing tempor reprehenderit",
  "supplier_part_numbers": {
    "esse01": ["Ut voluptate elit", "non ullamco"],
    "in_6ae": [],
    "Lorem_437": [
      "laborum labore ea in",
      "dolore in esse",
      "irure dolore culpa ea"
    ],
    "nulla_6": ["officia ipsum et ut Duis", "do dolore ex"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ut_7e3": [
      "minim",
      "irure in est eiusmod sit",
      "elit nisi",
      "qui in laboris",
      "eu laboris fugiat in"
    ],
    "Lorem_1": [],
    "minim_435": ["irure velit sunt amet Ut"],
    "utd": ["dolor tempor"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ipsum fugiat amet veniam",
  "supplier_part_numbers": {
    "do_c76": [
      "aliquip adipisicing aliqua qui ut",
      "ea sint deserunt enim magna",
      "Lorem",
      "in occaecat aliquip Excepteur",
      "ea sit nostrud nulla proident"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "connected_source_net_ids": [
    "Lorem nisi magna",
    "exercitation eiusmod non sed",
    "sit ex incididunt Duis",
    "non aliqua ut exercitation elit"
  ]
}
```
...
```json
{
  ...
  "schematic_component_id": "schematic_component_1",
  "pin_styles": {},
  "box_width": "tempor est culpa",
  "symbol_name": "in fugiat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "laborum laboris consequat cupidatat Excepteur"
}
```
...
```json
{
  ...
  "message": "qui non officia laboris minim"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "qui ut ipsum ea elit",
  "supplier_part_numbers": {
    "adipisicing_2": [
      "eu nulla veniam",
      "aute magna proident voluptate",
      "esse cupidatat reprehenderit",
      "pariatur elit"
    ],
    "in_a9": ["officia in ex ad", "nisi ipsum anim Duis exercitation"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": -44248723.983283475
  },
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "irure laborum ex aliqua"
  },
  "layer": "top",
  "footprinter_string": "dolor sed Excepteur elit eu",
  "model_obj_url": "labore culpa minim voluptate irure",
  "model_stl_url": "sed et in tempor incididunt",
  "model_3mf_url": "consequat in dolor culpa",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 61758168.35699734,
  "outer_height": -3854759.3721477687,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
