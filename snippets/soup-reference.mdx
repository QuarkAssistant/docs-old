...
```json
{
  ...
  "name": "A1",
  "manufacturer_part_number": "officia Excepteur sunt sit dolore",
  "supplier_part_numbers": {
    "ametc3a": [
      "consectetur",
      "voluptate Ut ex fugiat",
      "nisi pariatur",
      "est adipisicing anim dolore"
    ],
    "magna8": [
      "qui dolor Ut est irure",
      "in esse mollit",
      "in minim dolor",
      "in",
      "dolor"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Excepteur incididunt",
  "supplier_part_numbers": {
    "Excepteur_8": [
      "velit",
      "occaecat adipisicing laborum minim",
      "irure laboris esse et cupidatat",
      "nisi ex qui eiusmod Lorem",
      "ut irure et aute in"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "ex sit est voluptate",
  "supplier_part_numbers": {
    "indc": [],
    "fugiat_7": [
      "elit aliquip qui in tempor",
      "aliqua minim ut proident",
      "et"
    ],
    "cillum_52": [
      "labore",
      "Lorem",
      "cillum incididunt",
      "exercitation tempor commodo dolore",
      "mollit id non reprehenderit ea"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ut amet",
  "supplier_part_numbers": {
    "sed__": ["cillum anim nisi"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "labore_8a6": [
      "ullamco elit id aliqua exercitation",
      "ut",
      "sed sunt exercitation",
      "do id irure"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "sed deserunt anim",
  "supplier_part_numbers": {
    "in_a5": [
      "aliquip velit minim",
      "pariatur mollit",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "mollit esse occaecat tempor",
  "supplier_part_numbers": {
    "est__8": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "tempor aute nostrud",
  "supplier_part_numbers": {
    "eu_9": [
      "laborum in aliqua",
      "id elit ut est",
      "quis minim cupidatat labore",
...
```json
{
  ...
  "connected_source_net_ids": ["dolore nostrud reprehenderit ut"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 24265210.831730857,
  "pin_styles": {},
  "symbol_name": "id voluptate velit",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
    "3": "OUT"
...
```json
{
  ...
  "message": "Duis qui magna aliquip nulla",
...
```json
{
  ...
  "radius_x": 20496994.4073126,
  "radius_y": "dolor dolore",
  "layer": "top"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 27800821.141495153,
  "outer_height": 329077.4538243562,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "supplier_part_numbers": {
    "elit_dbb": ["laborum id sed in occaecat"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "ut eu",
  "model_obj_url": "ea dolore ad",
  "model_stl_url": "veniam irure laborum Ut nulla",
  "model_3mf_url": "aliqua in culpa",
  "model_jscad": {}
}
```
