...
```json
{
  ...
  "ftype": "quis dolor anim in",
  "source_component_id": "source_component_1",
  "name": "Q1",
  "manufacturer_part_number": "esse cupidatat nisi sed",
  "supplier_part_numbers": {
    "pariaturba": [
      "elit aliquip",
      "Duis",
      "fugiat incididunt ullamco",
      "ullamco qui sunt"
    ],
    "veniam1": [
      "culpa cillum ullamco",
      "laborum quis Duis Excepteur labore",
      "ipsum"
    ],
    "aliquip5": []
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "quis eiusmod ullamco",
  "supplier_part_numbers": {
    "anim_b": ["sit esse velit"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["incididunt Lorem cupidatat ad non"],
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -80562012.30919231
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sunt_3": [],
    "enim_1": [
      "Duis eu consectetur ipsum",
      "Duis proident nisi",
      "mollit Lorem"
    ],
    "tempor0": ["id velit aute", "et nisi mollit laborum"],
    "irure_0e": ["officia Lorem", "dolor", "voluptate irure in officia"]
  }
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "Ut_b03": ["minim pariatur in qui"],
    "adipisicing_f12": ["veniam sunt dolor commodo Lorem"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "enima": [
      "adipisicing ea sit dolore",
      "ad",
      "cillum id do",
      "in",
      "id in voluptate reprehenderit quis"
    ],
    "aliquip_1e7": [
      "laboris",
      "qui",
      "irure Duis in ea consectetur",
      "enim officia cupidatat",
      "nulla officia adipisicing esse irure"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ut fugiat",
  "supplier_part_numbers": {
    "laboris_5e0": ["ad elit", "esse nulla id dolore nostrud"],
    "ipsum_8": ["consequat nisi", "et", "adipisicing esse ullamco"],
    "dolor9c": [
      "aliquip et est",
      "tempor sunt ipsum deserunt Ut",
      "adipisicing",
      "incididunt"
    ],
    "ullamco87": ["Ut minim cillum"],
    "dolor7": ["minim", "cillum ad", "et minim laboris Duis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "magna enim ullamco voluptate",
  "supplier_part_numbers": {
    "ipsum88d": [
      "veniam ut pariatur",
      "velit consequat est",
      "veniam reprehenderit in velit",
      "est",
      "incididunt consequat occaecat laborum aliquip"
    ],
    "ex_5_": [
      "qui culpa sint labore magna",
      "consequat",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "consectetur ipsum anim",
  "supplier_part_numbers": {
    "dob": [
      "fugiat do elit labore ut",
      "nulla proident anim in ut",
      "dolore qui sit ullamco"
    ],
    "quis__4": ["cupidatat ipsum aliquip occaecat"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "consectetur commodo ipsum in magna",
    "ut sunt in",
    "laboris"
  ],
  "connected_source_net_ids": ["occaecat eu aliqua Duis"]
}
```
...
```json
{
  ...
  "pin_styles": {
    "sunt_7b1": {
      "left_margin": -17059217.863395035,
      "right_margin": "tempor sunt",
      "top_margin": -29310205.965385944,
      "bottom_margin": "velit Excepteur qui non"
    },
    "id_b1b": {
      "left_margin": -60721164.44763535,
      "top_margin": "minim consequat"
    }
  },
  "port_arrangement": {
    "left_size": 3,
...
```json
{
  ...
  "message": "esse ipsum consectetur elit in"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "ullamco veniam ipsum laboris adipisicing"
}
```
...
```json
{
  ...
  "radius_x": -42433538.143475056,
  "radius_y": 69318319.04272744,
  "layer": "top"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "esse do tempor minim in"
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": "nisi sint qui Excepteur"
  },
  "layer": "top",
  "footprinter_string": "commodo culpa dolore non aute",
  "model_obj_url": "ex pariatur reprehenderit irure nostrud",
  "model_stl_url": "irure culpa",
  "model_3mf_url": "nostrud Lorem ullamco minim",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -53593640.96986327,
  "outer_height": 72881494.83612326,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "quis qui esse id in"
}
```
...
{
  "adipisicing_d73": {
    "right_margin": 92249368.06041887
  },
  "eu_8d": {
    "left_margin": "Ut sunt dolor elit officia",
    "right_margin": 43759452.39775017,
    "bottom_margin": 42948520.711532354
  }
}
```
