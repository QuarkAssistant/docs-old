...
```json
{
  ...
  "ftype": "non proident ut aliquip minim",
  "source_component_id": "source_component_1",
  "name": "N1",
  "manufacturer_part_number": "occaecat sint",
  "supplier_part_numbers": {
    "velitea7": [
      "magna cillum pariatur mollit",
      "irure incididunt",
      "veniam",
      "ut"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "incididunt dolore exercitation",
  "supplier_part_numbers": {
    "aliqua_8b2": [
      "consequat non dolore",
      "culpa mollit anim ex",
      "qui aliquip velit Excepteur irure"
    ],
    "reprehenderit_5": ["incididunt nostrud esse"],
    "ipsum_8d1": ["Lorem Ut sunt elit", "ut"],
    "proident_b": ["deserunt amet et", "est voluptate dolore labore"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "sit cupidatat amet ullamco",
    "in",
    "in consectetur cillum",
    "nostrud ipsum et exercitation anim",
    "quis sed in"
  ],
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 97750266.05813596
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "reprehenderit sunt consectetur ad enim",
  "supplier_part_numbers": {
    "deserunt411": [
      "est do",
      "culpa aute adipisicing aliquip",
      "voluptate Lorem",
      "laboris dolore",
      "magna dolor anim"
    ],
    "occaecat_3": [
      "ex sed nisi",
      "esse eu ullamco anim nulla",
      "sed in deserunt sit cillum",
      "Duis"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ut irure quis",
  "supplier_part_numbers": {
    "essedc7": []
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sed Duis amet ut sint",
  "supplier_part_numbers": {
    "mollit_a": [
      "tempor",
      "velit est labore ex",
      "esse dolor ex",
      "veniam occaecat magna incididunt"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "consectetur officia ipsum Duis commodo",
  "supplier_part_numbers": {
    "ut_4f": ["qui", "non ea", "pariatur dolor in ipsum in", "est", "aliqua"],
    "cupidatat_a6": [
      "mollit irure dolore",
      "aliqua pariatur ex est",
      "irure aliqua ex fugiat",
      "in dolore Excepteur ex adipisicing"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sintf": [
      ...
      "incididunt nisi dolore voluptate officia"
    ],
    "dolor03": [],
    "enim_9": [
      "id fugiat quis Excepteur irure",
      "occaecat incididunt culpa deserunt non"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "commodod": ["anim", "eu sint est", "ullamco voluptate sint amet"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_net_ids": [
    "tempor",
    "labore aute deserunt minim",
    "consectetur Lorem exercitation sit",
    "magna ex ea tempor officia"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "sunt occaecat",
  "pin_styles": {},
  "box_width": 12253426.083357692,
  "symbol_name": "aliquip",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "pariatur consectetur dolore"
}
```
...
```json
{
  ...
  "radius_x": "fugiat nisi",
  "radius_y": 14248381.236210689,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "cupidatat sint dolor",
  "supplier_part_numbers": {
    "deserunt9e1": [
      "culpa ea in dolor",
      "mollit Excepteur",
      "labore ad in id officia"
    ],
    "elit2c4": ["nisi", "culpa Lorem", "sint deserunt ut ullamco laboris"],
    "labore_cff": ["enim ex", "cillum in qui", "Duis Excepteur"],
    "in_f": ["proident Duis"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "nisi Lorem sed anim ut",
  "model_obj_url": "dolor eu",
  "model_stl_url": "tempor",
  "model_3mf_url": "esse et sed minim ut",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "Duis magna pariatur"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -85315468.87089676,
  "outer_height": -71612006.80501123,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "in896": {
    "left_margin": -13760093.596505836,
    "right_margin": 10778674.688499063,
    "top_margin": "sint occaecat ut",
    "bottom_margin": "aliqua"
  }
}
```
