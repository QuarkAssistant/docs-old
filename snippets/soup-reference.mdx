...
```json
{
  ...
  "ftype": "dolore esse dolor ullamco culpa",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "tempor aute ea dolor",
  "supplier_part_numbers": {
    "eu_7": ["reprehenderit in", "laboris ad"],
    "consecteturf7b": []
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["adipisicing magna labore qui", "cillum"],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -81586755.88235039
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "elit voluptate laboris eiusmod et"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "incididunt ut dolore velit consequat",
  "supplier_part_numbers": {
    "id_e2f": [
      "ipsum eu cillum irure",
      "incididunt",
      "in exercitation officia"
    ],
    "proident0": ["do eu"],
    "esse_4": [
      "anim sint laboris tempor dolore",
      "enim fugiat aliqua",
      "id anim occaecat incididunt",
      "dolore dolor"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "dolore_7": ["culpa eiusmod"],
    "eu_9": [
      "est enim adipisicing in non",
      "consectetur ut cupidatat",
      "voluptate ipsum veniam"
    ],
    "laboris_8": [
      "ullamco laborum pariatur officia ut",
      "eu",
      "elit aliquip laborum",
      "sint"
    ],
    "velit_3": ["nulla consequat fugiat", "ex in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "nulla voluptate ut ullamco exercitation"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "nisi quis elit anim",
  "supplier_part_numbers": {
    "culpa63": [
      "sed et enim",
      "esse sed consequat",
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_3fc": [
      "culpa",
      "mollit quis ut deserunt pariatur",
      "quis dolor",
      "voluptate dolore do anim"
    ],
    "ut2db": ["exercitation", "in et Lorem sed", "qui ex esse"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_net_ids": [
    "consequat occaecat culpa aliquip",
    "anim proident mollit nostrud deserunt",
    "laboris adipisicing",
    "eu"
  ]
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "Excepteur",
  "pin_styles": {},
  "box_width": "Ut aliquip occaecat",
  "symbol_name": "do ut id proident exercitation",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "dolore sunt est incididunt qui"
}
```
...
```json
{
  ...
  "message": "aute ipsum commodo fugiat amet",
...
```json
{
  ...
  "radius_x": -97860521.21381718,
  "radius_y": "cillum adipisicing irure",
  "layer": "top"
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "dolore_af2": ["veniam voluptate", "exercitation"],
    "commodo_beb": ["proident in reprehenderit"]
  }
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 16434586.610155359,
  "outer_height": 52633133.77750522,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "fugiat ad cupidatat aute dolore"
}
```
