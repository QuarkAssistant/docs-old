...
```json
{
  ...
  "supplier_part_numbers": {
    "tempor__52": ["quis magna fugiat eu dolore", "ut amet ex esse"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolor occaecat in",
  "supplier_part_numbers": {
    "in_c": [],
    "in_f0": ["nostrud", "nisi quis culpa Ut aliqua"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "id commodo dolore Excepteur quis",
  "supplier_part_numbers": {
    "exercitation_711": ["ipsum irure ut ut", "aute sunt magna", "non"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "minim consectetur",
  "supplier_part_numbers": {
    "reprehenderit_796": [
      "proident cupidatat aliqua",
      "sint in dolore sed laborum",
      "tempor ea",
      "proident incididunt cupidatat officia",
      "Duis"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "nulla4": ["veniam minim Ut", "Lorem sunt"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "pariatur Lorem in voluptate tempor",
  "supplier_part_numbers": {
    "sint_e5": [
      "nulla laboris minim quis",
      "id Ut irure cillum",
      "eu minim",
      "proident labore Lorem fugiat",
      "esse ut dolor anim"
    ],
    "ipsum_c1e": ["consectetur"],
    "irure_c49": [
      "in tempor dolore mollit",
      "ad voluptate commodo eiusmod esse"
    ],
    "ullamco_398": [
      "incididunt dolore amet",
      "occaecat incididunt",
      "in dolor eiusmod labore ut",
      "ullamco aliquip dolore commodo ex",
      "non"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_net_ids": [
    "ut elit veniam in",
    "velit commodo consectetur Excepteur aliqua",
    "deserunt Lorem nisi"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -38200940.68886175,
  "pin_styles": {},
  "box_width": 2317833.221783474,
  "symbol_name": "proident voluptate",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": 27805402.186621502
    },
    {
      "x": "3mm",
      "y": "1mm",
      "via": true,
      "to_layer": "bottom",
      "trace_width": "ea non do consectetur minim"
    },
    {
      "x": "3mm",
      "y": "1mm",
      "via": true,
      "to_layer": "bottom",
      "trace_width": "reprehenderit laboris aliqua sint"
    },
    {
      "x": "3mm",
      "via": false,
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -88108068.05542266,
  "outer_height": -12299921.262397006,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "Excepteur_b9": {},
  "ut562": {
    "left_margin": "dolor id anim in proident",
    "right_margin": "ea exercitation elit",
    "top_margin": 53132861.83628568,
    "bottom_margin": "laborum adipisicing in"
  },
  "in873": {
    "left_margin": -86171504.72124262,
    "right_margin": "eu eiusmod",
    "top_margin": -98932818.6741039,
    "bottom_margin": "nostrud ipsum dolore"
  },
  "nisi_8": {
    "left_margin": "velit minim",
    "top_margin": 52017212.0989005,
    "bottom_margin": "velit occaecat ad pariatur minim"
  }
}
```
