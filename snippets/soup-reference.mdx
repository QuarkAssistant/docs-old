...
```json
{
  ...
  "member_source_group_ids": [
    "laborum nostrud enim Lorem",
    "Lorem dolor",
    "eu mollit velit nulla sint",
    "consequat tempor do eiusmod"
  ],
  "is_power": false,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": true,
  "trace_width": 12805319.027030572
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "do ipsum laborum ut",
  "supplier_part_numbers": {
    "irure981": ["adipisicing"],
    "mollita6": ["commodo velit ut", "aliqua laboris in in in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "irure anim enim officia",
  "supplier_part_numbers": {
    "labore__": ["id", "id", "dolore et nisi"],
    "nisiaf": ["dolor", "nostrud in laboris"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "eiusmod velit"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "sit_ad": ["elit esse", "occaecat consequat"],
    "minim_4d": [],
    "cillum_763": ["minim cupidatat in Excepteur", "ad sint enim qui velit"],
    "commodo6_0": [],
    "eu5a": ["tempor occaecat sit commodo mollit", "consequat dolor ea do"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "in reprehenderit dolor non est",
  "supplier_part_numbers": {
    "sint_113": [],
    "cillum3": [
      "enim occaecat",
      "aliquip irure",
      "nostrud proident fugiat ullamco occaecat",
      "dolore Excepteur"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "sunt_e": [
      "Excepteur exercitation irure eiusmod",
      "eu sunt",
      "in officia qui quis esse",
      "commodo esse"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "laborum anim in dolore",
    "veniam",
    "ullamco veniam laboris"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 33981912.398478016,
  "pin_styles": {},
  "box_width": -87642481.60920851,
  "symbol_name": "pariatur",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "Lorem sunt velit in incididunt"
}
```
...
```json
{
  ...
  "message": "id tempor anim aute ad",
...
```json
{
  ...
  "radius_x": 93105127.90137526,
  "radius_y": -44108389.75586931,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "laborum ex",
  "supplier_part_numbers": {
    "culpa_82": []
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "non ut id",
  "supplier_part_numbers": {
    "culpa2": [
      "amet veniam",
      "elit magna",
      "consequat aliquip laborum mollit Ut",
      "dolor cillum in",
      "Excepteur mollit nostrud"
    ],
    "enim744": ["anim aliquip ea id", "esse"],
    "non_": [
      "ut",
      "incididunt minim nostrud dolor",
      "exercitation amet",
      "est laborum et non quis",
      "consectetur"
    ]
  }
}
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "qui est voluptate sint dolor"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "voluptate eiusmod cillum enim"
}
```
...
{
  "pariatur_ce": {
    "right_margin": 97864624.02462712,
    "bottom_margin": "Ut magna"
  },
  "voluptate172": {
    "top_margin": "sunt ut eiusmod quis esse"
  },
  "aute9": {}
}
```
