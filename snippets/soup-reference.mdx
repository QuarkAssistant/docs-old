...
```json
{
  ...
  "name": "I1",
  "manufacturer_part_number": "ipsum nisi id quis in",
  "supplier_part_numbers": {
    "consequatb05": ["aliqua sunt dolor"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "exercitation cillum",
  "supplier_part_numbers": {
    "officia_23": [
      "reprehenderit amet laborum id dolor",
      "deserunt id est amet fugiat",
      "sint Lorem amet Duis",
      "reprehenderit deserunt laboris",
      "aute in"
    ]
  }
}
...
```json
{
  ...
  "member_source_group_ids": [
    "sit id",
    "officia quis aute",
    "aliquip qui labore in",
    "commodo do deserunt irure pariatur"
  ],
  "is_power": false,
  "is_ground": false,
  "is_analog_signal": true,
  "trace_width": -12206732.717731535
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "nulla labore velit exercitation ad",
  "supplier_part_numbers": {
    "proidentda": ["nisi", "dolore", "occaecat minim non consectetur"],
    "velit_d6": [
      "deserunt eu ut laboris dolore",
      "pariatur cillum",
      "proident tempor elit Lorem",
      "dolore laborum esse cillum sed"
    ],
    "magna_fb": [
      "exercitation eiusmod",
      "magna dolor dolore in ea",
      "adipisicing irure aute elit sunt",
      "minim aliqua in quis pariatur",
      "fugiat do eiusmod"
    ],
    "adipisicing_5": ["aliquip dolor ex"],
    "ullamcoc5": [
      "nostrud",
      "nostrud deserunt aliqua ipsum ea",
      "amet magna",
      "sit ut eu quis"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "anim pariatur",
  "supplier_part_numbers": {
    "adipisicing9": [],
    "qui4": [],
    "Ut1": []
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "non qui in",
  "supplier_part_numbers": {
    "eufb": [
      "consectetur incididunt",
      "sint tempor in laborum reprehenderit",
      "sed pariatur in Ut",
      "ad irure aute quis incididunt",
      "do"
    ],
    "veniam0": ["adipisicing irure in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "fugiat in ipsum exercitation",
  "supplier_part_numbers": {
    "ea_d7": ["id", "non Duis nulla ipsum", "esse sint deserunt"],
    "cillume": ["occaecat", "cupidatat Ut culpa qui", "aute dolore nulla in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ex voluptate dolore in sunt",
  "supplier_part_numbers": {
    "nulla5d": [
      "ad adipisicing fugiat ut",
      "tempor occaecat reprehenderit minim",
      "velit"
    ],
    "est05": ["quis consectetur voluptate labore", "ea", "laborum labore"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "et reprehenderit elit labore",
  "supplier_part_numbers": {
    "esse70d": ["nulla velit"],
    "labore_1": ["aute laborum Excepteur cillum"],
    "reprehenderitc8": ["proident", "quis in"],
    "do88b": []
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "cillum_9d": [
      "laborum in dolor consequat non",
      "officia laboris",
      "in enim est eiusmod"
    ]
  },
...
```json
{
  ...
  "connected_source_port_ids": ["dolor ut pariatur"],
  "connected_source_net_ids": ["elit fugiat", "laborum tempor"]
}
```
...
```json
{
  ...
  "message": "ad ipsum labore Excepteur culpa"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "esse_e": ["magna voluptate exercitation", "culpa laborum do proident"]
  }
}
```
...
```json
{
  ...
  "model_obj_url": "amet elit consectetur tempor reprehenderit",
  "model_stl_url": "eiusmod aliquip ad",
  "model_3mf_url": "non aliqua",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "proident id consectetur et velit"
}
```
...
{
  "quis_a": {
    "right_margin": "ea aliquip Excepteur ex ad",
    "top_margin": 74713665.35817769
  },
  "qui_5a": {
    "left_margin": 82358534.90873483,
    "right_margin": "sit Lorem officia in aliquip",
    "bottom_margin": "cillum aliqua"
  }
}
```
