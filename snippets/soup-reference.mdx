...
```json
{
  ...
  "ftype": "dolor veniam elit cupidatat quis",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "eu officia incididunt voluptate adipisicing",
  "supplier_part_numbers": {
    "occaecat_d58": ["ad tempor", "velit Ut Excepteur"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "Ut08e": ["sint", "commodo", "culpa Ut tempor ut adipisicing"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["ea occaecat", "laborum"],
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": 60550491.72244394
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "velit Ut fugiat ut mollit",
  "supplier_part_numbers": {
    "sit_704": [
      "occaecat et do",
      "in deserunt ut",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolor mollit labore dolor",
  "supplier_part_numbers": {
    "fugiat_2": [
      "non eiusmod Ut",
      "aute deserunt veniam",
      "reprehenderit amet eiusmod sunt",
      "officia Lorem",
      "id"
    ]
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "velitc7": ["sit aute nisi tempor", "aliquip sunt do dolore"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ut Duis ea in occaecat",
  "supplier_part_numbers": {
    "ad529": ["ipsum in Duis", "Excepteur Lorem"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ipsum nostrud quis",
  "supplier_part_numbers": {
    "veniam_1": [
      "anim aliqua veniam dolor",
...
```json
{
  ...
  "connected_source_port_ids": ["veniam nulla est"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 87218135.63840413,
  "pin_styles": {},
  "box_width": "dolore tempor",
  "symbol_name": "dolore sit tempor ad",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "consectetur nostrud nisi sit tempor"
}
```
...
```json
{
  ...
  "color": "consequat in sed commodo sit"
}
```
...
```json
{
  ...
  "radius_x": "laborum dolor Duis voluptate Excepteur",
  "radius_y": "in",
  "layer": "top"
}
```
  ...
  "route": [
    {
      ...
      "via": true,
      "to_layer": "bottom",
      "trace_width": 15824649.231423393
    },
    {
      "x": "3mm",
      "via": true,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "Ut consectetur do est",
  "supplier_part_numbers": {
    "sint0": [
      "adipisicing cillum minim officia",
      "Lorem culpa est laboris qui",
      "ea ut adipisicing eiusmod",
      "culpa in qui tempor"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "amet in consequat",
  "supplier_part_numbers": {
    "sint434": ["commodo dolore ut deserunt ex"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "Lorem reprehenderit",
  "model_obj_url": "dolore laboris sint mollit est",
  "model_stl_url": "consequat",
  "model_3mf_url": "consequat dolor",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "aute adipisicing tempor"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 49669788.61918086,
  "outer_height": 23156476.25790742,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "eu aliquip do exercitation laboris"
}
```
...
{
  "labore_35f": {
    "left_margin": "esse minim",
    "right_margin": -10507929.967379898,
    "bottom_margin": -17809202.363680005
  }
}
```
