...
```json
{
  ...
  "ftype": "deserunt consequat mollit sit ut",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "nisi",
  "supplier_part_numbers": {
    "aliquip_8": [
      "sit sed tempor in commodo",
      "eiusmod mollit id consectetur",
      "irure consectetur non minim Duis",
      "incididunt"
    ],
    "dolore93e": [
      "ut magna fugiat Lorem id",
      "labore aute adipisicing",
      "ipsum ut aliqua"
    ],
    "exercitation_3f_": [
      "reprehenderit id Lorem",
      "minim labore",
...
```json
{
  ...
  "supplier_part_numbers": {
    "enim_26": [
      "nostrud officia nulla fugiat",
      "commodo sed laboris",
      "aute nisi sunt eu sint",
      "mollit consectetur magna",
      "consequat proident adipisicing cupidatat"
    ],
    "non54": [
      "Ut esse non est exercitation",
      "est labore",
      "laborum enim sunt",
      "ut ad aute"
    ]
...
```json
{
  ...
  "member_source_group_ids": [
    "id eu voluptate dolore cillum",
    "exercitation officia do amet id",
    "nisi",
    "labore ullamco",
    "officia laborum est aliquip"
  ],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": 150168.11148624122
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "elit pariatur qui",
  "supplier_part_numbers": {
    "irure__b7": [
      "proident deserunt pariatur dolore amet",
      "officia dolor ipsum",
      "non officia laborum pariatur exercitation",
      "deserunt qui reprehenderit sint",
      "voluptate irure aliquip"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "commodo ea velit ad",
  "supplier_part_numbers": {
    "incididunt5": ["sit", "cillum qui"],
    "fugiat0_": [
      "commodo nulla",
      "ipsum commodo consectetur reprehenderit cupidatat",
      "id consectetur Ut"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "cupidatat ut veniam enim",
  "supplier_part_numbers": {
    "enim_9e5": ["enim Lorem veniam", "Excepteur in cillum"],
    "in56": [
      "sint",
      "minim",
      "reprehenderit cillum irure ullamco",
      "dolore enim sunt id commodo"
    ],
    "velit6": [
      "dolor",
      "exercitation dolore occaecat",
      "sed minim sint et reprehenderit",
      "est eiusmod elit"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "esse incididunt Excepteur",
  "supplier_part_numbers": {
    "eiusmod_b85": []
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "nisi Excepteur minim commodo",
  "supplier_part_numbers": {
    "nostrud0": ["mollit ipsum culpa nisi anim"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_net_ids": ["ea mollit", "velit", "culpa"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": 79240416.31471848,
  "pin_styles": {},
  "box_width": "consequat incididunt deserunt sint non",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  }
...
```json
{
  ...
  "message": "commodo sed veniam aliquip"
}
```
...
```json
{
  ...
  "radius_x": 55830768.02164361,
  "radius_y": 12072152.015240118,
  "layer": "top"
}
```
...
```json
{
  ...
  "type": "pcb_error",
  "error_type": "pcb_trace_error",
  "message": "do labore aliquip officia",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
  "pcb_port_ids": ["pcb_port_1", "pcb_port_2"]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "nisi occaecat",
  "supplier_part_numbers": {
    "minimd": ["veniam anim laboris", "ipsum aliqua"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": 45378438.568068266
  },
  "layer": "top",
  "footprinter_string": "voluptate non",
  "model_obj_url": "cupidatat Excepteur ut dolore",
  "model_3mf_url": "minim",
  "model_jscad": {}
}
```
...
{
  "iruree": {
    "left_margin": -34177320.70757711,
    "right_margin": "dolor"
  },
  "laboris_e03": {
    "left_margin": -31267871.2310396,
    "top_margin": -74702072.82576422
  }
}
```
