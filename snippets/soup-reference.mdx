...
```json
{
  ...
  "ftype": "deserunt cupidatat labore laborum",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "velit Duis pariatur fugiat",
  "supplier_part_numbers": {
    "officia259": [
      "id nulla sint",
      "nostrud qui eiusmod sint",
      "aute dolore minim",
      "mollit aute reprehenderit commodo veniam"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "voluptate adipisicing proident",
  "supplier_part_numbers": {
    "aliqua_3_": ["quis ut proident irure", "in Excepteur"],
    "ullamco_bcd": ["veniam minim", "eiusmod", "sint"],
    "esse1": [],
    "dolor_25a": [
      "occaecat eu",
      "ipsum officia pariatur",
      "Ut voluptate commodo sit",
      "tempor aliquip",
      "velit dolore"
    ],
    "ipsum_12": [
      "minim magna laboris sit laborum",
      "nisi laborum aute est et",
      "id laborum sit",
      "qui consectetur ut velit",
      "nostrud laboris incididunt dolore dolor"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "aliquip reprehenderit",
  "supplier_part_numbers": {
    "ex_3a6": [
      "tempor",
      "in in dolore nisi",
      "minim non culpa",
      "ullamco nisi velit in magna"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "pariatur fugiat et culpa",
  "supplier_part_numbers": {
    "exercitation_ff": ["commodo est"],
    "ut5": [
      "occaecat",
      "pariatur",
      "dolore sit irure elit commodo",
      "nostrud nulla aute id"
    ]
  },
  "capacitance": "1uF"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "velit deserunt eiusmod quis qui",
  "supplier_part_numbers": {
    "in_77": ["pariatur consectetur Duis"],
    "etf7e": ["id aliquip esse quis", "enim"],
    "officia_b1": [
      "incididunt voluptate est",
      "velit",
      "nulla esse reprehenderit est",
...
```json
{
  ...
  "name": "G1",
  "supplier_part_numbers": {
    "deseruntc": ["laboris in nulla ut deserunt", "consequat"]
  }
}
```
...
```json
{
  ...
  "name": "P1",
  "supplier_part_numbers": {
    "anim__79": ["dolor", "aliqua Lorem", "aliqua enim ad do"],
    "fugiat00": ["do est"],
    "officia_b7": [
      "voluptate Duis eiusmod",
      "eu",
      "id dolore do",
      "incididunt consequat reprehenderit voluptate",
      "est officia aliquip"
    ],
    "reprehenderit_d0": ["laboris Duis", "commodo in Excepteur incididunt"],
    "sed_e": ["nulla", "ex sint velit", "sit"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "proident ex",
  "supplier_part_numbers": {
    "elitb5": [
      "voluptate Duis anim",
      "sunt dolore quis",
      "pariatur cupidatat elit occaecat",
...
```json
{
  ...
  "connected_source_port_ids": [
    "sed incididunt Excepteur esse laboris",
    "nostrud incididunt est ea",
    "Ut nostrud",
    "sint veniam exercitation amet"
  ],
  "connected_source_net_ids": ["esse sunt tempor est"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "quis aliquip officia mollit exercitation",
  "pin_styles": {},
  "box_width": 15317847.601278827,
  "symbol_name": "qui",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "message": "aliqua aute nulla occaecat"
}
```
...
```json
{
  ...
  "message": "commodo voluptate in dolore",
...
```json
{
  ...
  "radius_x": "incididunt tempor",
  "radius_y": "aliqua velit reprehenderit dolor minim",
  "layer": "top"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -67784281.75350983,
  "outer_height": -35722602.90244143,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "velit quis et fugiat Ut"
}
```
...
```json
{
  ...
  "model_obj_url": "veniam aliquip qui in nulla"
}
```
...
```json
{
  "type": "pcb_plated_hole",
  "shape": "oval",
  "outer_width": 45700476.546141654,
  "outer_height": -35634450.32973327,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "ea nisi pariatur laborum exercitation"
}
```
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": "nisi mollit officia"
}
```
...
{
  "etf6": {
    "left_margin": -1622028.1459839046,
    "right_margin": "consectetur",
    "top_margin": 22190007.10506931
  }
}
```
