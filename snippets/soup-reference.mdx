...
```json
{
  ...
  "name": "O1",
  "manufacturer_part_number": "in reprehenderit est aliquip",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "elit fugiat aliquip velit",
  "supplier_part_numbers": {
    "fugiat61": [
      "Duis cupidatat",
      "occaecat eiusmod pariatur",
      "minim commodo et Ut",
      "ea anim labore exercitation dolore"
    ],
    "Lorem8": ["eiusmod elit ex", "ut aliqua sed"],
    "incididunt58d": ["consequat Lorem", "anim cillum est"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "est sint commodo pariatur voluptate",
  "supplier_part_numbers": {
    "utd_8": ["consequat culpa laboris"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "qui nisi dolor do laborum",
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "officia pariatur cillum",
  "supplier_part_numbers": {
    "suntd": [
      "sint",
      "dolor cupidatat",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "incididunt irure amet sit",
  "supplier_part_numbers": {
    "quisf": ["irure ut dolor", "sit do velit", "sunt officia sed"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "dolore proident",
  "supplier_part_numbers": {
    "enim_9f": [
      "dolor do aute elit Ut",
      "velit sunt enim ullamco cupidatat",
      "dolor",
      "ipsum voluptate"
    ]
  },
...
```json
{
  ...
  "connected_source_net_ids": [
    "velit cupidatat dolor in",
    "reprehenderit",
    "laboris do labore commodo minim",
    "exercitation eiusmod ut reprehenderit dolore",
    "pariatur exercitation aliquip Ut"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -94034132.44299243,
  "pin_styles": {},
  "box_width": -43716986.4485512,
  "symbol_name": "magna ut eu qui",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "anim ullamco ut laborum"
}
```
...
```json
{
  ...
  "message": "ipsum voluptate do commodo aliqua",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "irure mollit voluptate ea in",
  "supplier_part_numbers": {
    "pariatur96a": ["in dolore dolore irure"],
    "eiusmod_b5": ["quis irure", "Ut id cillum ea"],
    "quis_84b": [
      "incididunt in culpa",
      "fugiat Duis cupidatat occaecat sit",
      "sint sed Ut ex in",
      "non sint id"
    ],
    "pariatur_9d": ["voluptate sit aliquip"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "Excepteur ipsum minim aliquip elit"
  },
  "size": {
    "x": "3mm",
    "y": "1mm",
  ...
  "layer": "top",
  "footprinter_string": "fugiat et Duis",
  "model_obj_url": "in dolore consectetur culpa anim",
  "model_stl_url": "nostrud officia elit",
  "model_3mf_url": "voluptate deserunt cupidatat"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "deserunt Ut eiusmod anim"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -68334388.50523783,
  "outer_height": 40231965.30225471,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "voluptate_3c6": {
    "left_margin": "quis nostrud dolore Duis",
    "right_margin": -60585831.11877627,
    "top_margin": "nulla enim velit",
    "bottom_margin": -9695194.3770812
  },
  "ut_0": {
    "left_margin": -28715494.335608363,
    "right_margin": "sunt",
    "bottom_margin": "ipsum sit nulla"
  }
}
```
