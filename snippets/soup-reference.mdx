...
```json
{
  ...
  "ftype": "consequat dolore mollit",
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "consequat",
  "supplier_part_numbers": {
    "non_8": [],
    "et4": ["sed", "do fugiat nulla exercitation", "ut in nisi Ut"],
    "dolore6e": [],
    "laborume": ["irure id deserunt aliquip proident"],
    "minim_2": ["culpa voluptate"]
  }
}
```
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "veniam_2": ["Excepteur ex tempor nostrud ullamco"],
    "consecteturf2": [
      "proident aliqua",
      "mollit",
      "minim do proident",
    ...
    "nona8": [
      "anim ipsum do",
      "aute",
      "id irure do incididunt anim",
      "deserunt proident occaecat reprehenderit quis"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["in sunt"],
...
```json
{
  ...
  "supplier_part_numbers": {
    "commodod": ["nisi ipsum dolor", "cupidatat dolore elit officia"],
    "laborea": [
      "aliquip voluptate nulla labore aute",
      "sit dolore Duis ipsum incididunt",
      "sit Excepteur",
      "ad esse"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ullamco nostrud velit quis id",
  "supplier_part_numbers": {
    "incididunt0": ["nulla occaecat Duis", "proident tempor"],
    "proident_b5": [
      "reprehenderit commodo amet adipisicing",
      "sint eiusmod est qui",
      "qui exercitation mollit",
      "exercitation labore ipsum",
      "dolore"
    ],
    "aliqua8": []
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sint qui cillum",
  "supplier_part_numbers": {
    "voluptate77": ["sit pariatur"],
    "Duis8d": [
      "et voluptate",
      "sed ut dolore ullamco",
      "commodo amet dolor consequat nisi",
      "Excepteur amet laboris proident reprehenderit",
      "sunt amet"
    ],
    "id3": [
      "dolore labore voluptate amet",
      "cillum laborum consectetur est consequat",
      "exercitation ipsum",
      "pariatur eu nisi proident"
    ],
    "est_9b": [
      "eu laboris adipisicing aute voluptate",
      "dolore sed",
      "anim velit laboris Excepteur",
      "nulla tempor sunt"
    ],
    "adipisicinge": ["ad officia fugiat ex dolor", "magna irure nisi commodo"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "exercitation8": ["ex dolore", "et ut nostrud", "tempor ex in", "velit"],
    "laborum_9": [
      "irure consequat est culpa",
      "dolore Duis est",
      "consectetur sunt adipisicing",
      "aliqua nostrud"
    ],
    "sed_c2": ["ullamco officia in ut", "exercitation commodo aliqua"],
    "sit_3a": [
      "adipisicing laboris qui",
      "cupidatat adipisicing esse",
      "eiusmod",
      "sit sed",
      "do Duis occaecat nulla dolor"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "irure tempor",
  "supplier_part_numbers": {
    "amet96": ["fugiat in"],
    "et5e": ["esse in aliquip"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "connected_source_net_ids": [
    "aliquip Ut aliqua nostrud ut",
    "minim elit",
    "id enim cupidatat",
    "Excepteur laboris minim do magna"
  ]
}
```
...
```json
{
  ...
  "pin_spacing": "et",
  "pin_styles": {},
  "box_width": -27230177.575925067,
  "symbol_name": "ea fugiat laboris officia",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "enim sit aute consequat"
}
```
...
```json
{
  ...
  "message": "laborum occaecat nulla",
...
```json
{
  ...
  "message": "in nulla magna dolor in",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "dolore occaecat sint velit"
    }
  ]
}
```
...
```json
{
  ...
  "source_trace_id": "source_trace_1",
  "connected_source_port_ids": [],
  "connected_source_net_ids": ["tempor ut ut"]
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "cillum dolor incididunt",
  "model_obj_url": "culpa sed",
  "model_stl_url": "minim",
  "model_3mf_url": "nulla qui do occaecat nisi",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "sed commodo enim ea"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -16285902.5779742,
  "outer_height": -17608062.08434759,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
