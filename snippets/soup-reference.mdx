...
```json
{
  ...
  "name": "A1",
  "manufacturer_part_number": "veniam nulla adipisicing officia",
  "supplier_part_numbers": {
    "aute84": [
      "aliquip Duis proident qui minim",
      "in officia cupidatat nulla",
      "veniam cupidatat voluptate quis est",
      "adipisicing in sunt",
      "voluptate enim"
    ],
    "pariatur_a6a": ["officia magna qui", "aliqua culpa", "ad"],
    "sunt__": ["fugiat deserunt", "Lorem cupidatat et"],
    "proident_2e1": [
      "proident in sunt est",
      "aliquip amet nostrud",
      "anim officia est ex cupidatat",
      "aliquip",
      "occaecat"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "voluptate ullamco Excepteur in sit",
  "supplier_part_numbers": {
    "eiusmod90f": ["pariatur magna nulla", "magna in dolore"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["magna sit", "dolor Duis aute"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": 93108619.89397258
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "exercitation qui",
  "supplier_part_numbers": {
    "cillum88d": [
      "Lorem anim",
      "id adipisicing Ut",
      "ea",
      "eiusmod deserunt aliqua anim ea",
      "in tempor nulla"
    ],
    "consectetur_c7": ["dolor et deserunt commodo", "fugiat pariatur ex est"],
    "nostrud_84": ["ea sint enim", "minim cillum magna aliqua ullamco", "dolor"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sunt ad Ut",
  "supplier_part_numbers": {
    "nisia": []
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "consequat in aliquip incididunt in",
  "supplier_part_numbers": {
    "voluptate_e0": [
      "dolor Lorem sunt",
      "deserunt fugiat ad in veniam",
      "reprehenderit anim",
      "sed nisi"
    ]
  }
...
```json
{
  ...
  "supplier_part_numbers": {
    "consectetur2": ["occaecat", "consectetur amet"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "in nisi dolore consectetur sunt",
  "supplier_part_numbers": {
    "labore_d3": ["nulla labore veniam quis aliquip"],
    "mollit46": [
    ...
    "adipisicing4": [
      "culpa labore voluptate mollit",
      "laboris velit ipsum incididunt laborum"
    ],
    "proident_0d9": [
      "magna aliqua in minim consectetur",
      "Duis aliquip non pariatur fugiat",
      "in ipsum dolor",
      "commodo quis mollit",
      "mollit eu"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "laboris enim",
  "supplier_part_numbers": {
    "fugiat_6": ["aliquip quis", "eiusmod do id anim ipsum"],
    "fugiat_893": ["dolore", "occaecat officia"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["qui"],
  "connected_source_net_ids": [
    "et est",
    "in quis ullamco",
    "nisi incididunt velit laboris",
    "in"
  ]
}
```
...
```json
{
  ...
  "schematic_component_id": "schematic_component_1",
  "pin_styles": {},
  "box_width": "magna ex in minim enim"
}
```
...
```json
{
  ...
  "route": [],
  "stroke_width": "0.1mm",
  "color": "do dolor Duis dolor mollit"
}
```
...
```json
{
  ...
  "text": "Hello, World!",
  "layer": "top",
  "color": "fugiat id enim reprehenderit cupidatat"
}
```
...
```json
{
  ...
  "radius_x": 69742405.50608513,
  "radius_y": -38188303.352369644,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "elit sit in nulla officia",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sit fugiat",
  "supplier_part_numbers": {
    "est_e": [],
    "occaecat13e": []
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "cillum aliquip labore in tempor",
  "supplier_part_numbers": {
    "consequat_5": []
  },
  "resistance": "1k"
...
```json
{
  ...
  "model_obj_url": "exercitation id sed elit ex",
  "model_stl_url": "qui",
  "model_3mf_url": "dolore cillum ut culpa officia",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "dolor ex dolore velit"
}
```
...
{
  "dolora": {
    "left_margin": 73886665.32664964,
    "right_margin": "velit ex officia id dolore",
    "top_margin": "amet"
  },
  "adipisicing9": {
    "top_margin": -94842822.40719652,
    "bottom_margin": 41206123.24404967
  },
  "sit_0": {
    "left_margin": "ullamco reprehenderit aute",
    "right_margin": "Ut adipisicing aliqua aliquip",
    "top_margin": "eiusmod nulla in est culpa",
    "bottom_margin": -85964532.7255465
  }
}
```
