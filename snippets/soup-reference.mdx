...
```json
{
  ...
  "supplier_part_numbers": {
    "sunt_479": ["sint sed do", "nulla est voluptate quis amet"],
    "esse1_": ["Duis do ullamco incididunt", "consequat sed"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "dolor aliquip ipsum sunt",
  "supplier_part_numbers": {
    "culpa37": [
      "pariatur ullamco officia mollit sunt",
      "sint dolor in deserunt",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ullamco ea officia",
  "supplier_part_numbers": {
    "nonad": [
      "Ut laboris",
      "fugiat ut",
      "officia",
      "esse nostrud commodo ut voluptate",
      "quis voluptate"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "do2": [
      "in",
      "cupidatat qui laboris enim magna",
      "consectetur aliquip consequat ad Lorem",
      "amet Lorem",
      "culpa Duis ad id velit"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "adipisicing minim",
  "supplier_part_numbers": {
    "ut8": ["aliqua Lorem laborum veniam mollit"],
    "commodo_2": ["esse sed officia amet qui"],
    "aliqua206": [
      "anim sed qui",
      "dolor mollit est consectetur",
      "quis sit",
      "Lorem aliquip dolor amet"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "mollit qui reprehenderit amet",
  "supplier_part_numbers": {
    "elit_f": [
      "sed minim ullamco ipsum",
      "in",
      "cupidatat ea laborum ad consectetur",
      "minim sit culpa dolor"
    ],
    "qui42e": [
      "dolor labore anim reprehenderit velit",
      "sit dolore quis occaecat irure",
      "qui sint labore",
      "tempor incididunt anim",
      "proident Duis non ut"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "connected_source_net_ids": [
    ...
    "ad proident in reprehenderit ut",
    "reprehenderit ea",
    "elit"
  ]
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -83223267.59211789,
  "pin_styles": {},
  "box_width": "exercitation",
  "symbol_name": "exercitation esse quis velit",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "magna consectetur enim"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ipsum ut Excepteur dolor officia",
  "supplier_part_numbers": {
    "enim_99": ["ut"],
    "dolor_29": ["voluptate ipsum", "culpa exercitation in cillum consectetur"],
    "non_c_4": [
      "tempor",
      "nulla irure",
      "enim consequat aute",
    ...
    "etf1": ["magna fugiat occaecat proident"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "dolor enim veniam dolor",
  "supplier_part_numbers": {
    "officia_8": [],
    "nulla_0": [
      "amet exercitation do",
      "dolore exercitation ullamco nostrud tempor",
      "laborum in sit ad",
      "dolor ipsum in Duis sed"
    ],
    "nullae42": ["ipsum", "incididunt", "aliquip", "aliqua mollit", "ea"],
    "velit3a9": [
      "elit ex Lorem Duis cupidatat",
      "cupidatat consectetur aliqua dolore amet",
      "adipisicing nostrud proident est",
      "dolore",
      "ullamco aute eu adipisicing"
    ],
    "pariatur_8af": [
      "est dolor ea tempor ex",
      "dolor laboris",
      "irure nisi magna voluptate",
      "dolore",
      "quis Duis"
    ]
  },
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": "culpa dolor sit Duis aliquip"
  },
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 21801954.2967764,
  "outer_height": -99911207.34900752,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "commodo0": {
    "left_margin": 38518371.09603843,
    "right_margin": -14975466.335122615,
    "top_margin": -71634843.45003423
  },
  "ipsum_6": {
    "left_margin": 54297938.93421891,
    "right_margin": "labore incididunt reprehenderit",
    "top_margin": "nulla fugiat velit magna"
  },
  "sint_b37": {
    "bottom_margin": "magna mollit fugiat dolor"
  }
}
```
