...
```json
{
  ...
  "supplier_part_numbers": {
    "nostrud4": ["commodo aliquip laborum consequat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "incididunt dolore cillum sint",
  "supplier_part_numbers": {
    "ut__6b": [
      "veniam cillum ut mollit non",
      "ullamco",
      "adipisicing ad aliquip laboris Excepteur",
      "exercitation nisi"
    ],
    "officia__12": [
      "cillum",
    ...
    "incididuntbeb": [
      "non minim ex Lorem",
      "non",
      "aute elit sit ad cupidatat"
    ],
    "autea": ["pariatur elit"],
    "seda03": ["eu Lorem eiusmod laborum proident", "et"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["ea Duis occaecat", "pariatur fugiat aliquip"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "tempor laborum et cupidatat culpa",
  "supplier_part_numbers": {
    "nisi7f": [
      "aliquip ut ea Duis reprehenderit",
      "nisi dolor qui",
      "veniam consectetur nulla in",
      "Lorem Ut adipisicing",
      "in"
    ],
    "veniam_b": [],
    "exercitation_897": ["pariatur", "laboris dolore", "sunt", "in nostrud ut"],
    "Excepteur2": ["dolor", "et in enim eiusmod reprehenderit", "ipsum nulla"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sunt ea",
  "supplier_part_numbers": {
    "ullamco_0_": ["consequat ipsum Ut"],
    "tempor_1": ["qui sed nisi do dolor", "proident pariatur cupidatat do"],
    "dolore_7ec": ["sed est Lorem ut"],
    "aute__e7": [
      "adipisicing ut do",
      "consectetur",
      "officia ut pariatur",
      "in commodo ut consequat",
      "labore"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ullamco et pariatur"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "laborum Lorem"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "elit eiusmod nostrud nisi est",
  "supplier_part_numbers": {
    "qui_15": []
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "consequat8": ["ut", "nulla", "dolor id anim", "sit commodo"],
    "enimf62": ["consequat Ut eu", "adipisicing nostrud"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "Excepteur quis aliqua",
  "supplier_part_numbers": {
    "nisi_d3": [
      "anim ipsum ut et",
      "sunt cillum",
      "ad pariatur Lorem",
      "Lorem irure incididunt mollit proident",
      "tempor"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "message": "Excepteur culpa elit enim"
}
```
...
```json
{
  ...
  "radius_x": "veniam esse labore do laboris",
  "radius_y": -81406097.4627246,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "Lorem ex cillum officia",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "radius_x": "sunt consectetur in dolor",
  "radius_y": -32192002.378151312,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "veniam proident voluptate",
  "supplier_part_numbers": {
    "exercitation_d": [
      "qui adipisicing nulla labore aliquip",
      "ipsum qui",
      "in Lorem",
      "est nostrud consequat esse",
      "cillum laboris ea mollit pariatur"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "model_obj_url": "tempor in do aute in",
  "model_3mf_url": "cupidatat proident in cillum",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -20182900.5942979,
  "outer_height": 80862842.43304619,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "Duis commodo pariatur laboris"
}
```
...
{
  "ut84": {
    "left_margin": 39184766.55106354,
    "right_margin": -2621711.4306120574,
    "top_margin": "adipisicing sunt exercitation laboris sed"
  },
  "cupidatatda": {
    "left_margin": 68628492.46135578,
    "right_margin": -11348098.425869808,
    "top_margin": 73265918.69582981,
    "bottom_margin": -36574696.10501462
  },
  "nostrud_51": {
    "left_margin": "ut fugiat",
    "right_margin": "Lorem laboris exercitation velit",
    "top_margin": "ullamco qui",
    "bottom_margin": 30915848.588557675
  },
  "ullamco_2": {
    "right_margin": -45398596.01107357,
    "top_margin": "mollit dolor enim aliqua in",
    "bottom_margin": "aliquip"
  }
}
```
