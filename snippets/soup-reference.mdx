...
```json
{
  ...
  "trace_width": -2382821.2909025997
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "velit est reprehenderit dolor laborum",
  "supplier_part_numbers": {
    "amet8f": [
      "dolor",
      "incididunt eu dolor ut dolor",
      "culpa consectetur elit",
      "proident Duis elit minim",
      "qui in nisi minim"
    ]
  }
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "exercitation_79": [
      "sed irure nostrud fugiat pariatur",
      "ut in",
      "laboris consequat sunt",
      "anim laborum",
      "magna velit"
    ],
    "tempord4": [],
    "dolore_729": ["et", "reprehenderit esse", "anim irure"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "Ut ea sunt id",
  "supplier_part_numbers": {
    "autec7": [
      "exercitation dolore veniam aliquip nulla",
      "id",
      "voluptate ut dolor laborum deserunt",
      "labore",
      "in exercitation ex cupidatat deserunt"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "et proident",
  "supplier_part_numbers": {
    "ipsum7": ["qui cillum commodo Lorem", "laborum esse ut"],
    "anima": [
      "voluptate",
      "eiusmod dolore reprehenderit mollit sed",
      "velit",
      "id adipisicing cupidatat veniam",
      "aliqua"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "dolore deserunt cillum elit irure",
  "supplier_part_numbers": {
    "eu_0": [
      "et culpa dolor laborum cillum",
      "ad reprehenderit deserunt magna amet",
      "reprehenderit amet"
    ],
    "qui2c3": []
  },
...
```json
{
  ...
  "connected_source_port_ids": ["ea"],
  "connected_source_net_ids": ["veniam deserunt consequat"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -85018663.70581311,
  "pin_styles": {},
  "box_width": 12909806.33096148,
  "symbol_name": "aute Ut",
  "port_labels": {
    "1": "VCC",
    "2": "GND",
...
```json
{
  ...
  "message": "eiusmod in cupidatat ullamco"
}
```
...
```json
{
  ...
  "radius_x": -98877291.29709224,
  "radius_y": "proident sunt aliqua ad",
  "layer": "top"
}
```
...
```json
{
  ...
  "route": [
    ...
    },
    {
      "x": "3mm",
      "y": "1mm",
      "trace_width": "sint pariatur nisi ullamco elit"
    }
  ]
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "Duis eiusmod dolore sint commodo"
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "sunt",
  "model_obj_url": "qui ex non occaecat",
  "model_stl_url": "dolore",
  "model_3mf_url": "irure cillum",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -40927010.739322476,
  "outer_height": -52964725.76932887,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": -15347171.350805193
}
```
...
{
  "in18": {
    "left_margin": "amet qui ea",
    "right_margin": "laboris ut",
    "top_margin": "laboris consectetur",
    "bottom_margin": "esse"
  },
  "ullamco650": {
    "left_margin": 68353261.32442164,
    "right_margin": -40985867.811590016,
    "top_margin": -11371857.743275136,
    "bottom_margin": "esse cupidatat anim sint"
  },
  "labore_6_": {
    "left_margin": "do ut",
    "right_margin": 39931488.38529086,
    "top_margin": 88054483.39178962,
    "bottom_margin": 94460719.18517834
  },
  "reprehenderit_1c3": {
    "left_margin": 84259572.36423108,
    "right_margin": 53084894.7186259,
    "top_margin": -66649430.728415295,
    "bottom_margin": "amet in ad"
  }
}
```
