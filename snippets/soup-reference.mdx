...
```json
{
  ...
  "ftype": "ea tempor reprehenderit",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "in est voluptate Excepteur ipsum",
  "supplier_part_numbers": {
    ...
    "ipsum3": [
      ...
      "enim qui",
      "fugiat et dolore",
      "esse dolore culpa Ut"
    ],
    "culpa8d": ["exercitation fugiat", "adipisicing", "do", "consectetur"],
    "consequat_b": [
      "in",
      "ea anim ex reprehenderit",
      "nostrud ut",
      "ipsum Excepteur exercitation ex aliquip",
      "velit ea ipsum aute exercitation"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "deserunt incididunt aliquip ex quis",
  "supplier_part_numbers": {
    "ex_14": []
  }
}
...
```json
{
  ...
  "trace_width": 66035335.379599184
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "inde": ["sunt est anim", "cupidatat", "ullamco culpa quis magna Duis"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "proident deserunt cillum",
  "supplier_part_numbers": {
    "ex_2": ["commodo in exercitation qui velit", "laboris mollit in", "amet"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Duis in et",
  "supplier_part_numbers": {
    "enim_6ca": ["dolor velit", "sit"],
    "sint_ac": [
      "nostrud in ut in mollit",
      "voluptate minim",
      "ad dolor ex dolor",
      "fugiat in dolore irure"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "ea est quis",
  "supplier_part_numbers": {
    "eiusmod_ad": [
      "veniam in dolor",
      "elit Lorem amet incididunt ut",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "qui Ut laborum aliqua tempor",
  "supplier_part_numbers": {
    "animf": [
      "Lorem tempor nulla",
      "fugiat mollit laborum",
      "dolore exercitation qui laborum"
    ],
    "culpa040": [
      "in",
      "pariatur irure ipsum nostrud",
      "consectetur officia dolore proident nulla",
      "anim Excepteur est sit",
      "ut sint sed"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "sint Ut deserunt magna",
  "supplier_part_numbers": {
    "nisi2": [
      "ipsum sint voluptate",
      "do aute pariatur Excepteur consectetur",
      "et"
    ],
    "Duis3": [
      "adipisicing laborum aute consectetur ad",
      "commodo incididunt consectetur laborum irure",
      "Lorem",
...
```json
{
  ...
  "connected_source_port_ids": ["do aliquip Excepteur Lorem"],
  "connected_source_net_ids": [
    "voluptate reprehenderit ullamco adipisicing",
    "ipsum dolore irure velit",
    "sint consequat in",
    "deserunt laborum"
  ]
}
...
```json
{
  ...
  "schematic_component_id": "schematic_component_1",
  "pin_styles": {},
  "symbol_name": "cupidatat nisi ipsum"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "sit sunt reprehenderit mollit veniam"
}
```
...
```json
{
  ...
  "color": "in eiusmod cupidatat dolore"
}
```
...
```json
{
  ...
  "radius_x": -69666063.50585884,
  "radius_y": -12334215.587945834,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "labore nostrud Excepteur",
  "supplier_part_numbers": {
    "cupidatat_27": [
      "in aliquip magna id",
      "sit",
    ...
    "consecteturc3": [
      "proident labore incididunt mollit",
      "commodo cupidatat amet ex",
      "eiusmod dolore mollit elit ipsum"
    ],
    "sint_8b_": []
  }
}
...
```json
{
  ...
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": 13864844.941071078
  },
  "layer": "top",
  "footprinter_string": "commodo",
  "model_obj_url": "ut proident enim consectetur voluptate",
  "model_stl_url": "dolor dolore dolore",
  "model_3mf_url": "exercitation dolor in ex Duis",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "exercitation dolor ut laborum"
}
```
...
```json
{
  ...
  "outer_height": 23734413.556462735,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "non3": {
    "left_margin": "sit laborum aute incididunt officia",
    "right_margin": 15455587.63466674
  },
  "labore_d4a": {
    "left_margin": "incididunt dolor dolore Excepteur",
    "right_margin": 2817378.3104794174
  },
  "labore_1b": {
    "left_margin": "id",
    "right_margin": -11057208.16521889,
    "bottom_margin": -34771635.51274352
  },
  "aliquacdf": {
    "left_margin": "culpa consectetur magna",
    "right_margin": "sed ut do dolore",
    "bottom_margin": "esse qui incididunt"
  }
}
```
