...
```json
{
  ...
  "name": "I1",
  "manufacturer_part_number": "ipsum tempor"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "laboris8": [
      "officia nostrud deserunt non nulla",
      "fugiat anim laborum",
      "ea proident",
      "ut quis"
    ],
    ...
    "reprehenderitd3": [
      ...
      "cupidatat",
      "est",
      "Duis voluptate proident consequat"
    ]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["consequat et ad", "mollit fugiat proident"],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": false,
  "is_analog_signal": false,
  "trace_width": -38665927.05966896
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "Ut in occaecat Duis",
  "supplier_part_numbers": {
    "ex_a5": ["sed anim dolor"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "sint elit",
  "supplier_part_numbers": {
    "voluptatebe0": ["in aliqua in sit", "do in labore ipsum non", "amet"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "laborum ea ut",
  "supplier_part_numbers": {
    "qui_16": ["consequat cillum Duis adipisicing occaecat"],
    "pariatur6": [
      "Excepteur in Duis exercitation nostrud",
      "nulla voluptate",
      "sed tempor amet velit sint"
    ],
    "sint__d9": ["veniam", "Ut dolore reprehenderit amet"],
    "laboris7": [
      "Lorem ad velit id",
      "velit adipisicing proident et veniam",
      "pariatur",
      "mollit Duis ea aliqua"
    ],
    "cupidatat_c": ["ut ea irure aute cupidatat", "ut deserunt in"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "nostrud_": ["laboris", "nulla mollit exercitation in nisi"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    ...
    "anim_b7": ["non", "officia occaecat sed ea ullamco"],
    "labore_5e": ["amet mollit nisi", "dolor"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "aliquip occaecat",
  "supplier_part_numbers": {
    "mollit53": [
      "ipsum et quis eu",
      "nisi fugiat cupidatat incididunt",
      "culpa mollit do minim"
    ],
    "veniam_0ec": [
      "reprehenderit",
      "elit sunt eu ut mollit",
      "fugiat commodo quis magna laboris"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "sit_249": ["dolore velit magna elit sit", "voluptate Ut incididunt in"],
    "qui87b": ["consectetur ipsum eu", "velit veniam qui dolore"],
    "sed_c_6": ["exercitation tempor ad", "non ipsum fugiat velit"],
    "sed61f": ["ex", "dolore ad", "dolore ea", "quis"],
    "quis_d8a": ["voluptate pariatur Ut sunt fugiat"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": [
    "esse dolore nostrud commodo proident",
    "culpa",
    "esse anim consectetur cupidatat eu",
    "culpa labore",
    "in do id ex"
  ],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "non anim quis reprehenderit adipisicing",
  "pin_styles": {},
  "box_width": -94138319.70289202,
  "symbol_name": "in pariatur qui elit",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "dolor laboris laborum irure amet"
}
```
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": "voluptate est Lorem"
    }
  ]
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "etc28": ["commodo nisi"],
    "voluptate_3": ["dolor sit", "culpa non"],
    "Uta74": []
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "magna sit tempor adipisicing sunt",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": 54250764.247054815
  },
  "rotation": "90deg",
  "size": {
    "x": "3mm",
    "y": "1mm",
    "z": -31053531.360000536
  },
  "footprinter_string": "dolor tempor",
  "model_obj_url": "sunt est esse sed",
  "model_stl_url": "ipsum",
  "model_3mf_url": "exercitation amet ex voluptate",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "laboris dolore proident"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 540706.6247475296,
  "outer_height": 33954742.25184889,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  "do_6": {},
  "ut_f2b": {
    "left_margin": -59845568.13076623,
    "right_margin": "enim anim sunt qui sint"
  }
}
```
