...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "in cillum culpa ipsum",
  "supplier_part_numbers": {
    "ina": [
      "nisi in minim Lorem",
      "mollit eiusmod ea dolor tempor",
      "et",
      "tempor sed nostrud voluptate",
      "voluptate magna et"
    ],
    "exercitation_95": [
      "quis magna deserunt aliqua pariatur",
      "reprehenderit",
      "fugiat aliquip veniam do Lorem",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "aliquip nostrud ipsum occaecat"
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "ex_0": ["id", "velit dolor magna", "irure ut cillum", "cupidatat ea sed"],
    "quis_fa4": [],
    "enimf": [
      "adipisicing Ut proident",
      "est",
      "consequat",
      "consectetur ipsum velit fugiat",
      "voluptate Excepteur"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolore9": ["sint sed dolore"],
    "aliquip749": ["sunt eu et mollit nisi"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "tempor sint ut reprehenderit quis",
  "supplier_part_numbers": {
    "dolore_f": [
      "Ut consectetur dolor voluptate ut",
      "in",
      "amet",
      "in mollit qui"
    ]
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "laboris incididunt nulla do in",
  "supplier_part_numbers": {
    "eiusmod6_": [],
    "voluptatec": ["dolore"]
  }
...
```json
{
  ...
  "supplier_part_numbers": {
    "Lorem89c": ["aute eiusmod ex ut nostrud"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "nulla cillum velit",
  "supplier_part_numbers": {
    "minim755": [
      "aliquip adipisicing officia in",
      "irure laborum pariatur",
      "est aliqua labore commodo",
      "magna anim"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_net_ids": [
    "occaecat proident incididunt ipsum laborum",
    "cillum aute nostrud exercitation laboris",
    "dolor pariatur incididunt Excepteur",
    "adipisicing incididunt non consectetur"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -12407023.243562505,
  "pin_styles": {},
  "box_width": "dolore aliquip esse",
  "symbol_name": "commodo officia",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "Excepteur non dolore ut commodo"
}
```
...
```json
{
  ...
  "message": "deserunt labore dolore aliquip"
}
```
...
```json
{
  ...
  "radius_x": "irure est amet ex sunt",
  "radius_y": "ut occaecat ullamco labore Excepteur",
  "layer": "top"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolorf": [],
    "est6": [
      "esse culpa exercitation pariatur velit",
      "dolore reprehenderit occaecat laborum",
      "Duis sit"
    ]
  },
  "resistance": "1k"
...
{
  "esseb": {
    "left_margin": -74687852.35074642,
    "top_margin": -16191320.477877274
  }
}
```
