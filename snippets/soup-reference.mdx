...
```json
{
  ...
  "ftype": "in laboris est occaecat",
  "source_component_id": "source_component_1",
  "name": "I1",
  "manufacturer_part_number": "do",
  "supplier_part_numbers": {
    "exercitation_b": [
      "Ut eu exercitation ullamco",
      "ipsum",
      "reprehenderit Ut",
      "laboris",
      "elit occaecat"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "proident amet aute irure dolore",
  "supplier_part_numbers": {
    "Excepteur03_": [
      "labore in",
      "sunt eiusmod minim magna",
      "nisi dolore veniam mollit"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "occaecat",
    "occaecat consectetur cupidatat sed",
    "do",
    "dolore culpa Ut",
    "quis dolor aliqua do mollit"
  ],
  "is_power": false,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 54261986.06944558
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "deserunt et nisi",
  "supplier_part_numbers": {
    "sunt_9": [
      "magna Lorem laboris proident voluptate",
      "consequat amet dolor eu",
      "deserunt eiusmod non enim",
      "magna consectetur Ut"
    ],
    "exercitation_d1": ["velit do", "in esse dolor"],
    "Ut0": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "dolor aute",
  "supplier_part_numbers": {
    "minim_4__": [
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "officia reprehenderit Lorem veniam dolor",
  "supplier_part_numbers": {
    "Excepteur_66": [],
    "ada17": ["adipisicing"],
    "minimfe": [
      "incididunt dolor",
      "Excepteur pariatur aliquip eiusmod mollit",
      "deserunt",
      "adipisicing",
      "eu in esse quis aliquip"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "occaecat sint ullamco",
  "supplier_part_numbers": {
    "minim_032": ["ea", "irure aliquip"],
    "dolored": ["culpa quis proident", "proident voluptate", "do"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "pariatur deserunt nostrud",
  "supplier_part_numbers": {
    "irure_a": ["incididunt ea aliquip nulla consequat"],
    "commodob6": [
      "nostrud elit Duis esse amet",
      "nisi quis Lorem elit",
      "voluptate magna",
      "in officia culpa consequat esse",
      "sunt irure fugiat consequat"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ea id",
  "supplier_part_numbers": {
    "enim3": ["veniam magna"],
    "dolore_cd5": [
      "sunt nisi in Lorem magna",
      "Lorem Duis magna",
      "Duis qui dolore consequat in"
    ],
    "nulla__65": []
  },
  "resistance": "1k"
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "enim reprehenderit id amet ullamco"
}
```
...
```json
{
  ...
  "color": "esse Excepteur magna dolor Duis"
}
```
...
```json
{
  ...
  "radius_x": "ex eu veniam in laborum",
  "radius_y": "voluptate pariatur",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "veniam aliquip dolore in Lorem",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "minim eiusmod sit",
  "supplier_part_numbers": {
    "sedd21": ["dolore", "non sed in occaecat esse"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "officia deserunt in",
  "supplier_part_numbers": {
    "ullamco_ff1": [],
    "esse_4": ["id"],
    "proident6c": ["cupidatat"],
    "minim_54": ["Excepteur est"]
  }
}
```
...
```json
{
  ...
  "position": {
    "x": "3mm",
    "y": "1mm",
    "z": -46017650.190215684
  },
  "model_obj_url": "consectetur ea ipsum aliqua cupidatat"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -92488795.85833904,
  "outer_height": -31488511.317843005,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "in3": {
    "left_margin": "adipisicing aute culpa esse exercitation",
    "right_margin": 82531441.22240776,
    "top_margin": "aute culpa",
    "bottom_margin": "enim qui fugiat exercitation ullamco"
  },
  "dolor_a": {
    "left_margin": "id occaecat ullamco laborum"
  },
  "labore_497": {
    "left_margin": -14883869.027466893,
    "right_margin": 99158652.07382631
  }
}
```
