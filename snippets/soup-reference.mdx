...
```json
{
  ...
  "ftype": "voluptate culpa occaecat Duis",
  "source_component_id": "source_component_1",
  "name": "V1",
  "manufacturer_part_number": "eiusmod deserunt",
  "supplier_part_numbers": {
    "laborum03a": [
      "reprehenderit dolor ullamco ut",
      "tempor eu est dolore Lorem",
      "fugiat",
      "non sint culpa",
      "id deserunt reprehenderit Excepteur ut"
    ],
    "amet_e2": [
      "dolor fugiat adipisicing ad",
      "dolor Excepteur sint dolore",
      "deserunt in",
      "dolore eiusmod Ut do"
    ]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "pariatur eiusmod ullamco commodo",
    "adipisicing",
    "fugiat Lorem qui cupidatat do",
    "anim dolore elit nulla",
    "et"
  ],
  "is_ground": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "adipisicing aliquip ad laboris dolore",
  "supplier_part_numbers": {
    "eiusmod_f": ["tempor"]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "elit Duis",
  "supplier_part_numbers": {
    "et_c": ["in", "proident cupidatat", "incididunt proident cillum"],
    "ullamco_e": [
      "veniam do ut ea",
      "voluptate est",
      "aute consequat et aliqua ut",
      "voluptate"
    ],
    "sede": [],
    "Lorem_da4": ["veniam voluptate culpa"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "deserunt tempor cupidatat"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "commodo ex enim dolore Excepteur",
  "supplier_part_numbers": {
    "commodo_8": [
      "fugiat dolore non in irure",
      "magna aute irure commodo occaecat",
      "sint ut aliquip dolor in",
      "incididunt ex sint sunt"
    ],
    "consectetur0f1": [],
    "adipisicing_6": ["qui aliqua commodo"],
    "autee74": ["velit proident"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "eiusmod esse",
  "supplier_part_numbers": {
    "voluptate_c2f": [],
    "magna76": ["sit reprehenderit amet Ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ea adipisicing do",
  "supplier_part_numbers": {
    "aute72a": [
      "sint mollit ullamco et cupidatat",
      "nostrud",
      "proident officia esse aliqua",
      "est voluptate",
      "ipsum"
    ]
  },
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ut veniam quis proident",
  "supplier_part_numbers": {
    "ullamco_26_": [
      "ipsum sed est",
      "elit eu pariatur",
      "id irure elit adipisicing",
      "dolore irure",
      "adipisicing est"
    ]
  },
...
```json
{
  ...
  "connected_source_port_ids": [
    "nisi aliqua mollit",
    "incididunt occaecat nostrud tempor cillum",
    "deserunt"
  ],
  "connected_source_net_ids": ["eu"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -72713306.22465909,
  "pin_styles": {},
  "box_width": 37709346.19846451,
  "symbol_name": "magna commodo",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "voluptate enim ut ad veniam"
}
```
...
```json
{
  ...
  "message": "commodo exercitation Excepteur velit ut",
...
```json
{
  ...
  "radius_x": 71870623.1012403,
  "radius_y": "id reprehenderit aliquip tempor Excepteur",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "sunt ut nulla ad irure",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "est cillum ea do",
  "supplier_part_numbers": {
    "fugiat_5": ["sed laborum reprehenderit culpa consequat"],
    "ullamco__f8": []
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "amet in",
  "model_obj_url": "tempor et culpa",
  "model_stl_url": "pariatur Lorem id magna deserunt",
  "model_3mf_url": "eu Excepteur consequat est minim",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "consectetur minim cillum occaecat"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": -27119815.908162042,
  "outer_height": -63229281.77460154,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "eu_a0": {
    "left_margin": 76667850.77328146,
    "top_margin": -68323658.64728409,
    "bottom_margin": 346830.873935163
  }
}
```
