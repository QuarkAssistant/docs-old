...
```json
{
  ...
  "ftype": "nisi anim et Ut do",
  "source_component_id": "source_component_1",
  "name": "N1",
  "manufacturer_part_number": "minim incididunt est laboris irure",
  "supplier_part_numbers": {
    "id_39": ["in", "culpa officia fugiat", "ut sed anim"],
    "qui_5f": [
      "ut minim qui consequat Lorem",
      "sed reprehenderit adipisicing fugiat consectetur",
      "dolore non deserunt Ut officia",
      "voluptate reprehenderit ut",
      "esse ea commodo Lorem"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "minim aute ut ut",
  "supplier_part_numbers": {
    "consequat__": [
      "officia anim",
      "do",
      "elit sunt sed do voluptate",
      "sit in proident"
    ],
    "labore_f4": [
      "consectetur",
      "ut in",
      "elit aliquip anim dolor",
      "enim ullamco"
    ],
    "velit8": [
      "eu Duis anim",
    ...
    "in__5c": [
      "Lorem reprehenderit non voluptate sit",
      "commodo voluptate non in labore"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "consectetur eiusmod fugiat"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "Lorem Duis ad est anim",
  "supplier_part_numbers": {
    "sint_da": ["nulla in dolor"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "ullamco in quis",
  "supplier_part_numbers": {
    "occaecat_f1": [
      "magna dolore",
      "et laboris exercitation deserunt",
      "pariatur est laborum nulla"
    ],
    "ine": [
      "anim irure Ut non",
      "veniam in in",
    ...
    "ea_009": ["et exercitation laboris adipisicing"],
    "aliqua_6_9": ["elit in irure incididunt", "magna"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "ullamco sit elit nulla consectetur",
  "supplier_part_numbers": {
    "exercitationeac": [
      "veniam",
      "laboris",
      "esse quis Excepteur ex sint",
      "qui nostrud sint irure id"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "ullamco eiusmod deserunt",
  "supplier_part_numbers": {
    "ipsumef": ["eiusmod exercitation", "est qui"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "est dolore ut eiusmod",
  "resistance": "1k"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "incididunt dolor labore cupidatat velit",
  "pin_styles": {},
  "box_width": 96181592.5641731,
  "symbol_name": "esse cupidatat irure in aute",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "radius_x": -3691240.6772483736,
  "radius_y": "est fugiat elit consequat dolor",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "aliquip magna voluptate reprehenderit",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
  ...
  "route": [
    {
      ...
      "via": false,
      "to_layer": "bottom",
      "trace_width": 37681258.086613566
    },
    {
      "x": "3mm",
      "to_layer": "bottom"
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "tempor culpa",
  "model_obj_url": "commodo do proident reprehenderit",
  "model_stl_url": "nostrud sit aliquip"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "nulla ea et mollit"
}
```
...
{
  "Excepteur1": {
    "right_margin": "elit aliqua nostrud fugiat",
    "top_margin": "mollit amet eu occaecat do"
  }
}
```
