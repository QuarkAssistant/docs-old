...
```json
{
  ...
  "ftype": "occaecat dolor",
  "source_component_id": "source_component_1",
  "name": "O1",
  "manufacturer_part_number": "est exercitation deserunt Ut",
  "supplier_part_numbers": {
    "ut_f": [
      "velit ea aute aliqua veniam",
      "labore Lorem exercitation eu anim",
      "aliquip",
      "incididunt dolore sunt ad"
    ],
    "veniam_e": ["eu ullamco sit dolor", "mollit officia velit"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "dolor_d0d": [
      ...
      "ullamco ipsum fugiat reprehenderit",
      "Excepteur",
      "ut voluptate dolore incididunt sint"
    ],
    "Ute": ["exercitation mollit fugiat ea", "irure ex officia"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "veniam1_2": ["eu elit Lorem"],
    "laboruma": [
      "cupidatat consectetur est enim mollit",
      "dolore ex",
      "aute ex",
      "eu esse in Lorem"
    ],
    ...
    "consectetur_8": [
      "ex ea consequat non reprehenderit",
      "occaecat irure consequat quis ex",
      "ea ut aute Lorem proident",
      "aliqua elit irure dolore ullamco",
      "ex cupidatat in"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "enim amet voluptate Ut",
  "supplier_part_numbers": {
    "veniam_0f": ["cillum", "nisi Ut"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "culpa dolore incididunt",
  "supplier_part_numbers": {
    "sit05b": ["sint labore Excepteur eiusmod consequat"],
    "veniamaa": [
      "culpa eiusmod Lorem dolor quis",
      "dolor amet deserunt",
      "cillum sed occaecat id nostrud"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "eu ipsum",
  "supplier_part_numbers": {
    "aliquae0": ["Duis", "eu esse cupidatat", "et Duis ea quis", "incididunt"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "radius_x": 7620552.141395852,
  "radius_y": "sunt ex qui",
  "layer": "top"
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "velit consectetur",
    "ea veniam sint adipisicing velit"
  ],
  "is_power": false,
  "is_analog_signal": false,
  "trace_width": 42037810.285146415
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "sint Duis",
  "supplier_part_numbers": {
    "laboreb": ["aliqua quis ut Duis"],
    "laborum_b": ["in in sint Ut non", "laborum magna proident eu sint"],
    "quid6": [
      "labore officia eiusmod anim",
      "ex consequat reprehenderit sed culpa"
    ]
  }
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": 61229260.61186099,
  "outer_height": -43337428.363637984,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "labore11": {
    "left_margin": 64202665.54064667,
    "right_margin": 96783990.58946368,
    "top_margin": -24578302.515235245,
    "bottom_margin": "adipisicing sunt ullamco aliquip"
  },
  "ut_a": {
    "left_margin": -58988970.45633786,
    "right_margin": 66072989.62055537,
    "bottom_margin": "sint ut"
  },
  "velitda": {
    "left_margin": 68771785.61268121,
    "right_margin": "non",
    "top_margin": "exercitation Excepteur non aliqua",
    "bottom_margin": -6268319.048555121
  }
}
```
