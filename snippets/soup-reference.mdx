...
```json
{
  ...
  "name": "N1",
  "manufacturer_part_number": "consectetur sit",
  "supplier_part_numbers": {
    "ad_2c": ["laborum ad", "aute cupidatat occaecat"],
    "proident_528": ["in"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "veniam qui anim eu",
  "supplier_part_numbers": {
    "minim___": [
      "sunt do fugiat",
      "laboris quis incididunt nostrud cillum",
      "ex ullamco dolore sunt in",
      "labore est qui Ut"
    ],
    "cillum611": []
  }
...
```json
{
  ...
  "member_source_group_ids": [
    "officia voluptate dolor et",
    "veniam Lorem amet commodo quis",
    "Excepteur qui",
    "cillum ipsum"
  ],
  "is_power": false,
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "nostrud enim exercitation ut minim",
  "supplier_part_numbers": {
    "adipisicing_9": ["sit", "magna", "fugiat id"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "eiusmod_1": [
      ...
      "id consequat ut",
      "officia Excepteur sed esse elit",
      "nisi in sunt tempor"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "nisi dolore",
  "supplier_part_numbers": {
    "anim9": [],
    "aliquip_dfa": [
      "anim",
      ...
      "aute",
      "ut labore",
      "ullamco sed laborum dolore sit"
    ],
    "cupidatatc": [],
    "dolored": ["irure", "sed", "ut culpa officia magna", "labore officia"],
    "quib42": []
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "dolore dolor Ut esse nisi",
  "supplier_part_numbers": {
    "idf1": ["proident nulla"]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "nulla do",
  "supplier_part_numbers": {
    "culpa_27c": ["cupidatat", "ex amet culpa"],
    "consequat343": [
      "consectetur irure non cupidatat elit",
      "amet veniam",
      "officia",
      "id aute",
      "commodo et"
    ...
    "reprehenderit_719": [
      "Excepteur adipisicing et deserunt",
...
```json
{
  ...
  "connected_source_port_ids": ["et sed quis", "ullamco irure culpa"],
...
```json
{
  ...
  "message": "deserunt nulla dolore proident"
}
```
...
```json
{
  ...
  "color": "amet aliquip cillum adipisicing"
}
```
...
```json
{
  ...
  "message": "consectetur minim Duis fugiat"
}
```
...
```json
{
  ...
  "radius_x": -45201147.14413084,
  "radius_y": 51465944.67883313,
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "mollit qui nisi laboris sit",
  "supplier_part_numbers": {
    "exac7": [
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "Excepteur elit nisi commodo"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "culpa id proident consectetur sed"
}
```
...
{
  "irure_44": {
    "left_margin": "veniam minim Duis sed ea",
    "right_margin": "eu eiusmod dolor cillum incididunt",
    "top_margin": "laborum elit ullamco"
  },
  "non_": {
    "left_margin": "irure",
    "right_margin": "cupidatat in in dolor ut",
    "top_margin": "aute id quis mollit",
    "bottom_margin": "incididunt do qui"
  },
  "aute9": {
    "left_margin": "ullamco culpa",
    "right_margin": "ea dolor",
    "top_margin": 58017399.4420293,
    "bottom_margin": "irure reprehenderit velit aliquip quis"
  }
}
```
