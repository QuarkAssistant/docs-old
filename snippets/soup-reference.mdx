...
```json
{
  ...
  "name": "A1",
  "manufacturer_part_number": "sed dolore velit amet",
  "supplier_part_numbers": {
    "dolord": [
      "enim esse consequat",
      "ipsum id occaecat nulla",
      "elit",
      "velit",
      "ad aliquip"
    ],
    ...
    "exercitation_2": [
      "elit consequat enim",
      "est ipsum dolore id enim",
      "esse ut est"
    ],
    "aute_3": ["magna in aliqua culpa"]
  }
}
```
...
```json
{
  ...
  "member_source_group_ids": [
    "laborum ex ullamco consectetur",
    "amet",
    "laborum deserunt tempor do"
  ],
  "is_ground": false,
  "is_analog_signal": false,
  "trace_width": 67885517.8924528
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "aliquip sunt sed"
}
```
...
```json
{
  ...
  "name": "C1",
  "supplier_part_numbers": {
    "Excepteur_d": ["enim proident nisi", "anim ea cupidatat officia"],
    "Lorem1": ["occaecat", "dolore anim cupidatat"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "culpabd": [
      "est enim sunt amet",
      "laboris cillum occaecat laborum",
      "proident tempor",
      "id pariatur quis",
      "incididunt cupidatat et sit pariatur"
    ]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "Excepteur_dd": [
      "consequat officia fugiat consectetur reprehenderit",
      "amet laborum elit ea",
      "pariatur quis nisi consequat reprehenderit",
      "magna",
      "minim"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "esse Duis labore dolore est",
  "supplier_part_numbers": {
    "dolorbb": ["labore qui ipsum", "labore ad", "proident", "ut"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "in ipsum est aliquip",
  "supplier_part_numbers": {
    "inb0": ["voluptate aute", "laboris", "eiusmod irure amet"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["dolore", "est", "enim"],
...
```json
{
  ...
  "message": "dolor aute aliquip elit adipisicing"
}
```
...
```json
{
  ...
  "radius_x": 85224550.62843144,
  "radius_y": -61294932.29604583,
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "sint consectetur reprehenderit adipisicing",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "est_7": ["consectetur sed Ut est voluptate"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "veniam adipisicing",
  "supplier_part_numbers": {
    "esse1": [
      "mollit veniam",
      "in nostrud adipisicing",
      "dolor enim non Ut laboris",
      "elit"
    ]
  }
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "non est",
  "model_obj_url": "et",
  "model_stl_url": "sed enim Excepteur eu",
  "model_3mf_url": "quis non elit ullamco",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "laborum consectetur Ut tempor velit"
}
```
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 75250889.1879377,
  "outer_height": 37710703.22688073,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
{
  "occaecat_ff5": {
    "right_margin": "Lorem mollit",
    "top_margin": 91042527.8268143,
    "bottom_margin": -90520800.2373668
  },
  "ullamco8a": {
    "left_margin": 88439116.91239527,
    "right_margin": -12067626.74604334
  },
  "ipsum9": {
    "left_margin": 46537474.35712165,
    "right_margin": "incididunt et consectetur",
    "top_margin": 25886098.834550887,
    "bottom_margin": -98215452.65804428
  },
  "qui5": {
    "left_margin": 56908431.81310609,
    "right_margin": "dolore",
    "top_margin": -79777441.21266066,
    "bottom_margin": "laborum sint occaecat"
  }
}
```
