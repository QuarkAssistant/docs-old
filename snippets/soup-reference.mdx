...
```json
{
  ...
  "ftype": "do exercitation in tempor quis",
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "sit est",
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "anim minim",
  "supplier_part_numbers": {
    "ea_31": [
      "ad quis consectetur Duis fugiat",
      "dolor",
      "deserunt dolor",
      "aute"
    ],
    "quis9_c": ["quis irure qui Excepteur fugiat", "magna"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "culpa tempor irure",
  "supplier_part_numbers": {
    "tempor2": [
      "veniam mollit dolore ad",
      "labore occaecat nisi amet",
      "voluptate ipsum"
    ]
  }
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "veniam Excepteur in fugiat",
  "supplier_part_numbers": {
    "veniam3": ["ut reprehenderit irure"],
    "magna9_4": ["sed tempor qui", "sed in in ea", "cupidatat"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "deserunt ipsum enim",
  "supplier_part_numbers": {
    "esse_29d": [
      "laboris aute",
      "non est consequat tempor",
      "in elit enim do",
      "Lorem do reprehenderit est",
      "deserunt aliquip"
    ],
    "fugiat_8d": [
      "fugiat est elit irure magna",
      "ullamco laboris nisi Ut",
      "dolore laboris",
      "pariatur fugiat ea"
    ],
    "eiusmod_98": [
      "Excepteur ullamco tempor Duis sed",
      "amet incididunt id adipisicing cillum",
      "do est",
      "ut elit Ut",
      "in Duis dolor"
    ],
    "dolor_1da": [
      "dolore eu tempor dolor",
      "nulla",
      "tempor dolor et mollit ad",
      "fugiat aliqua nisi non enim"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "sint dolore non",
  "supplier_part_numbers": {
    "in_b0": ["irure aliquip in"]
  },
  "resistance": "1k"
}
```
...
```json
{
  ...
  "connected_source_port_ids": ["esse quis", "sed dolore", "in labore irure"],
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "non nostrud fugiat esse labore",
  "pin_styles": {},
  "box_width": -74372134.88613836,
  "symbol_name": "ipsum",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "non sint laboris quis",
  "supplier_part_numbers": {
    "dolore_7": ["in cillum", "in", "veniam", "pariatur"],
    "ut_9_8": ["dolor laborum dolore laboris"],
    "ipsum_a7a": ["amet cillum mollit", "do voluptate culpa id"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "consectetur minim eu tempor",
  "supplier_part_numbers": {
    "nond1": [
      "cupidatat elit",
      "eu deserunt non in consectetur",
      "eiusmod",
      "quis tempor sit Duis adipisicing"
    ],
    "eiusmod_e": [
      "qui in anim dolore Excepteur",
      "est do proident pariatur",
      "labore"
    ]
  },
  "capacitance": "1uF"
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "occaecat sit est in",
  "model_obj_url": "tempor veniam mollit in Excepteur",
  "model_stl_url": "incididunt velit dolore",
  "model_3mf_url": "et magna laboris in incididunt",
  "model_jscad": {}
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "magna anim exercitation laboris"
}
```
...
{
  "dolor_fe8": {
    "left_margin": "sunt nulla laboris",
    "right_margin": 4235898.501205921,
    "top_margin": -74672760.28604117,
    "bottom_margin": "eu ut enim quis Ut"
  }
}
```
