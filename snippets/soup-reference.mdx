...
```json
{
  ...
  "ftype": "ipsum velit ut est ad",
  "source_component_id": "source_component_1",
  "name": "I1",
  "manufacturer_part_number": "consequat esse",
  "supplier_part_numbers": {
    "in_c2": ["Duis", "esse officia ad", "adipisicing ad sit laboris veniam"],
    "adipisicing_aba": [
      "cupidatat fugiat est Excepteur",
      "dolor adipisicing ut amet",
      "ea",
      "eu amet",
      "sint"
    ]
...
```json
{
  ...
  "name": "L1",
  "supplier_part_numbers": {
    "cillum_e0c": ["proident id non", "Ut velit id do"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "Duis officia",
  "supplier_part_numbers": {
    "non958": [
      "adipisicing",
      "do non dolore esse culpa",
      "dolor exercitation",
      "ipsum",
      "consequat ea qui ut ex"
    ],
    "esse_1e": ["labore voluptate dolore adipisicing cupidatat"],
    "reprehenderit11": [
      "labore reprehenderit nostrud quis",
      "in consequat qui exercitation incididunt"
    ],
    "cupidatate05": ["quis", "consectetur consequat", "in voluptate", "labore"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ut_042": [
      "tempor anim do veniam ut",
      "sit in",
      "magna amet non",
      "ipsum velit esse et laborum"
    ],
    "dolor1": [
      "ad",
      "ex labore qui incididunt",
      "labore quis dolor laborum",
      "pariatur sunt",
      "amet exercitation"
    ]
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "fugiat3a": ["nulla exercitation eu", "pariatur"],
    "cillum3": ["aliquip ut", "sunt ut cupidatat eu"],
    "voluptate2": ["eiusmod deserunt amet pariatur", "anim", "in tempor"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "non_9": ["laboris", "incididunt", "do fugiat minim ipsum"],
    "deserunt_a": [
      "amet commodo laborum exercitation officia",
      "voluptate",
      "do dolore",
      "et ut dolore"
    ],
    "commodo91a": [],
    "sed24": [],
    "deserunt5": ["sunt aute", "ea", "in nulla"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "proident nisi velit",
  "supplier_part_numbers": {
    "doa": ["exercitation est sit", "amet consequat Lorem"]
  },
  "voltage": "5V"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "esse sit deserunt nostrud magna",
  "supplier_part_numbers": {
    "reprehenderit45_": [
      "amet ipsum quis",
      "ea",
      "dolor incididunt ad in minim",
      "Ut"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "connected_source_port_ids": [
    "occaecat dolor",
    "Excepteur",
    "commodo tempor voluptate nisi sit",
    "non"
  ],
  "connected_source_net_ids": ["sint esse laboris", "tempor ut mollit"]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -80298102.79146367,
  "pin_styles": {},
  "box_width": 76527702.44385043,
  "symbol_name": "consectetur dolore id dolor",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "dolore nostrud culpa ex"
}
```
...
```json
{
  ...
  "route": [],
  "stroke_width": "0.1mm",
  "color": "non voluptate fugiat consequat"
}
```
...
```json
{
  ...
  "message": "cupidatat deserunt nostrud",
  "pcb_trace_id": "pcb_trace_1",
  "source_trace_id": "source_trace_1",
  "pcb_component_ids": ["pcb_component_1"],
...
```json
{
  ...
  "shape": "pill",
  "outer_width": 43167194.96604344,
  "outer_height": -78388659.14085144,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "supplier_part_numbers": {
    "laboris_841": [
      "elit laborum in adipisicing aliqua",
      "fugiat veniam quis",
      "officia commodo qui",
      "magna"
    ],
...
```json
{
  ...
  "model_obj_url": "nulla do reprehenderit consectetur in",
  "model_stl_url": "sed ex",
  "model_3mf_url": "occaecat aliqua"
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ad nisi consequat anim laborum"
}
```
...
```json
{
  "x": "3mm",
  "y": "1mm",
  "z": "reprehenderit elit voluptate velit minim"
}
```
...
{
  "culpa_6": {
    "left_margin": 16003756.080214202
  },
  "enim21": {
    "left_margin": "ad ut nostrud labore",
    "right_margin": -90915976.67739606,
    "top_margin": -50851163.88195887,
    "bottom_margin": "aliquip labore consequat ut"
  },
  "veniam3": {
    "right_margin": 39736877.699021935,
    "top_margin": "fugiat",
    "bottom_margin": 75230768.6573329
  },
  "commodo_96d": {
    "left_margin": "non",
    "right_margin": 19536092.927463815,
    "top_margin": -78945056.16629867,
    "bottom_margin": 29803454.139450565
  }
}
```
