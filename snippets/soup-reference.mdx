...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "ea ut sed cupidatat",
  "supplier_part_numbers": {
    "reprehenderitd3": ["tempor"],
    "docfd": [
      "irure",
      "amet aliquip et nisi",
      "est deserunt incididunt",
      "eu ut"
    ],
    "non38f": ["in laboris ex"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["laborum dolore"],
  "is_power": true,
  "is_ground": false,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": -8396191.17899844
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "velit elit culpa quis ad"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "et voluptate",
  "supplier_part_numbers": {
    "enim6": ["pariatur proident sit"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "pariatur aliqua",
  "supplier_part_numbers": {
    "dolore_47": ["in ad eu aliquip dolor"]
  }
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "ut7": ["ea labore ullamco quis", "deserunt sed ea labore", "ipsum cillum"],
    "dolore3bd": []
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "supplier_part_numbers": {
    "consecteturd": [
      "consequat",
      "Excepteur",
      "dolore esse qui exercitation minim",
      "nisi esse Duis"
    ]
  },
  "resistance": "1k"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "sit adipisicing Duis ipsum",
  "pin_styles": {},
  "box_width": 39370651.1785613,
  "symbol_name": "elit mollit Lorem cupidatat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "radius_x": "qui enim ad officia",
  "radius_y": "minim dolore aliqua",
  "layer": "top"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "L1",
  "manufacturer_part_number": "fugiat veniam",
  "supplier_part_numbers": {
    "amet_7": ["dolore"],
    "nulla__9": ["nisi", "proident aliqua", "fugiat laborum", "occaecat in"]
  }
}
```
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "sit laborum sed",
  "model_obj_url": "irure Ut laboris",
  "model_stl_url": "irure",
  "model_3mf_url": "in",
  "model_jscad": {}
}
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "ut anim dolore nisi in"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -78498034.8241512,
  "outer_height": -99753829.32853334,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": false,
  "to_layer": "bottom",
  "trace_width": 12542183.610685378
}
```
...
{
  "tempor4b4": {
    "top_margin": "ipsum laborum aliqua",
    "bottom_margin": -20602772.5178573
  },
  "et_d9e": {
    "left_margin": -93257567.30753411,
    "right_margin": 63760244.22811884,
    "top_margin": "consequat do occaecat et"
  },
  "in_b": {
    "left_margin": 24323316.919996828,
    "right_margin": "et irure ut",
    "top_margin": 92422138.28662074,
    "bottom_margin": "in"
  }
}
```
