...
```json
{
  ...
  "supplier_part_numbers": {
    "tempor379": ["aute et do voluptate", "proident pariatur ipsum culpa sit"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "B1",
  "manufacturer_part_number": "fugiat aliqua dolore labore",
  "supplier_part_numbers": {
    "nonbc": [],
    "sedd__": [
      "id qui in",
...
```json
{
  ...
  "supplier_part_numbers": {
    "culpa_c": [
      "labore dolore",
      "Ut sed reprehenderit culpa",
      "voluptate irure",
      "voluptate fugiat"
    ],
    "fugiat_bd": [],
    "eiusmod4": ["quis elit id"]
  },
  "capacitance": "1uF"
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "non consectetur",
  "supplier_part_numbers": {
    "qui98d": [
      "non nisi ullamco sunt",
      "non",
      "velit enim culpa ad cupidatat",
      "in culpa aliqua labore"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "D1",
  "manufacturer_part_number": "exercitation cupidatat deserunt officia pariatur",
  "supplier_part_numbers": {
    "velit6": ["minim", "irure dolor", "ut"],
    "ipsum_84": ["incididunt exercitation veniam sint", "proident"],
    "ipsum_0": ["aliquip fugiat"],
    "eu0": [
      "quis tempor est nisi irure",
      "Duis sit Ut consectetur",
      "enim nostrud anim",
      "incididunt sit"
    ]
  }
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "occaecat deserunt labore nulla",
  "supplier_part_numbers": {
    "Duis_2": [
      "est dolore ad laborum eu",
      "et ut",
      "nulla",
      "ut eu amet minim"
    ],
    "cupidatat_b2": [
      "esse consectetur",
      "incididunt occaecat",
      "ipsum dolor pariatur ex",
      "est Duis Excepteur qui ad"
    ],
    "ipsum_6": [
      "est eu",
      "in velit magna voluptate aute",
      "laborum ea aute",
      "dolore nostrud",
      "adipisicing nulla aute proident"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "consequat ut",
  "supplier_part_numbers": {
    "amet_1c7": [
      "elit laboris",
      "pariatur eu cillum cupidatat Ut",
      "deserunt labore",
      "nulla et enim qui",
      "adipisicing id in"
    ],
    "deserunt_6": [
      "cillum consequat consectetur in dolor",
      "elit Duis officia ullamco dolor",
      "fugiat quis magna"
    ]
  },
  "voltage": "5V"
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "laborum ut sunt cupidatat ullamco",
  "supplier_part_numbers": {
    "Lorem_0": ["ullamco", "qui sint ut magna"],
    "sint_9": [
      "consectetur sed consequat mollit",
      "magna do ut fugiat culpa",
      "commodo ut",
      "sint ipsum fugiat consectetur",
      "sint velit et aliquip"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "dolore sint",
    "veniam",
    "veniam velit irure commodo",
    "eu dolore",
    "magna labore velit"
  ],
  "connected_source_net_ids": [
    "occaecat dolore Duis in labore",
    "cupidatat dolor",
    "do ea"
  ]
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": "quis reprehenderit ullamco eu",
  "pin_styles": {},
  "box_width": "Ut in",
  "symbol_name": "commodo laborum occaecat",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "color": "velit irure dolor cupidatat"
}
```
...
```json
{
  ...
  "message": "irure cillum consequat sint"
}
```
...
```json
{
  ...
  "supplier_part_numbers": {
    "elit34": [
      "in",
      "ut",
      "occaecat dolor qui ex sunt",
      "laboris",
      "quis magna in nostrud sint"
    ]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "layer": "top",
  "footprinter_string": "eiusmod",
  "model_obj_url": "aliquip sint nostrud",
  "model_stl_url": "velit dolor incididunt",
  "model_3mf_url": "aute",
  "model_jscad": {}
}
```
...
```json
{
  ...
  "minim_3": {
    "left_margin": "do",
    "top_margin": "ea nostrud",
    "bottom_margin": "laboris voluptate consectetur sint"
  }
}
```
