...
```json
{
  ...
  "ftype": "ea dolor nulla elit sit",
  "source_component_id": "source_component_1",
  "name": "E1",
  "manufacturer_part_number": "qui magna",
  "supplier_part_numbers": {
    "est_f4": [
      "laborum ad cupidatat ex sunt",
      "dolor",
      "commodo esse magna Excepteur in",
      "aliqua ullamco",
      "laborum exercitation"
    ],
    "ipsum_13e": [
      "in id labore quis elit",
      "do Ut",
      "dolor",
      "occaecat",
      "ea exercitation magna ex"
    ],
    "proident1_4": ["elit pariatur in sit aute"]
  }
}
```
...
```json
{
  ...
  "name": "N1",
  "member_source_group_ids": ["ea et", "id do quis labore aliquip"],
  "is_power": true,
  "is_ground": true,
  "is_digital_signal": true,
  "is_analog_signal": true,
  "trace_width": 56785429.99237445
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "C1",
  "manufacturer_part_number": "commodo pariatur qui do",
  "supplier_part_numbers": {
    "ipsum26": [
      "Excepteur incididunt pariatur",
      "incididunt sed",
      "ea sed proident aliqua"
    ],
    "dolor0dd": ["dolor velit incididunt cupidatat voluptate"]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "G1",
  "manufacturer_part_number": "laborum ut cupidatat",
  "supplier_part_numbers": {
    "commodo_36b": [],
    "Lorem8": [],
    "consecteturc3": [
      "ullamco adipisicing et do voluptate",
      "mollit amet nulla culpa"
    ]
  }
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "P1",
  "manufacturer_part_number": "minim sint sunt in",
  "supplier_part_numbers": {
    "minim_b78": [
      "quis dolore",
      "cupidatat adipisicing ut",
      "Excepteur in id",
      "non",
      "ullamco proident ad nostrud in"
    ]
  },
  "voltage": "5V"
}
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "name": "R1",
  "manufacturer_part_number": "ad qui Lorem",
  "supplier_part_numbers": {
    "dolore1bd": ["eiusmod nostrud ea ad velit"],
    "id_7": ["anim non"]
  },
  "resistance": "1k"
}
...
```json
{
  ...
  "connected_source_port_ids": [
    "cupidatat aliqua adipisicing enim",
    "esse ex Excepteur fugiat",
    "sed Lorem",
    "mollit deserunt dolor qui dolore"
  ],
  "connected_source_net_ids": [
    "laborum",
    "ad anim nostrud nulla ea",
    "eu officia incididunt qui aute"
  ]
}
```
...
```json
{
  ...
  "source_component_id": "source_component_1",
  "schematic_component_id": "schematic_component_1",
  "pin_spacing": -91256350.01318572,
  "pin_styles": {},
  "box_width": "occaecat",
  "symbol_name": "cillum dolor veniam minim tempor",
  "port_arrangement": {
    "left_size": 3,
    "right_size": 3
  },
...
```json
{
  ...
  "message": "consectetur esse irure cupidatat reprehenderit"
}
```
...
```json
{
  ...
  "stroke_width": "0.1mm",
  "color": "sit occaecat officia Excepteur"
}
```
...
```json
{
  ...
  "color": "deserunt pariatur sunt dolor"
}
```
...
```json
{
  ...
  "message": "velit ipsum incididunt minim",
...
```json
{
  ...
  "radius_x": "veniam sunt Duis labore",
  "radius_y": "enim",
  "layer": "top"
}
```
...
```json
{
  ...
  "message": "fugiat ullamco reprehenderit aliquip",
  "center": {
    "x": "3mm",
    "y": "1mm"
  },
...
```json
{
  ...
  "supplier_part_numbers": {
    "magna_f8": ["in ex nostrud", "Ut"],
    "ullamcoaea": ["in", "ex ut aliquip"],
    "laborecfe": [
      "laborum",
      "est irure eu voluptate",
...
```json
{
  ...
  "supplier_part_numbers": {
    "ullamco__6": [
      "dolore exercitation ullamco nostrud",
      "deserunt et aliqua officia"
    ]
  }
}
```
...
```json
{
  ...
  "layers": ["top", "bottom"],
  "description": "quis eiusmod dolore est non"
}
```
...
```json
{
  ...
  "shape": "oval",
  "outer_width": -60389499.77888692,
  "outer_height": -74381317.54716873,
  "hole_width": "1mm",
  "hole_height": "1mm",
  "x": "3mm",
  "y": "1mm",
...
```json
{
  ...
  "via": true,
  "to_layer": "bottom",
  "trace_width": "dolor enim reprehenderit sed"
}
```
...
{
  "in_a1": {
    "left_margin": 33166645.89090225,
    "right_margin": "id",
    "top_margin": "irure pariatur",
    "bottom_margin": -94325774.2668821
  }
}
```
